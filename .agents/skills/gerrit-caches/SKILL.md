---
name: gerrit-caches
description: Implements or modifies caches in Gerrit's Java backend. Use when adding a new cache, changing cache configuration, implementing CacheSerializer, or working with CacheModule, Cache, LoadingCache, or CacheLoader in the Gerrit project.
---
