...
description: Implements REST API entrypoints in Gerrit's Java backend. Use when
adding new REST endpoints, REST collections, or REST views, or when working with
RestResource, RestCollection, RestReadView, RestModifyView, or module bindings
for REST API in the Gerrit project.
---
