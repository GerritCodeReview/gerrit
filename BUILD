...
API_DEPS = [
    "//java/com/google/gerrit/acceptance:acceptance-framework_deploy.jar",
    "//java/com/google/gerrit/acceptance:liblib-src.jar",
    "//java/com/google/gerrit/acceptance:acceptance-framework-javadoc",
