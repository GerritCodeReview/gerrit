...
define "gerrit" do
  ...
  define "gerrit-util-cli" do
    compile.with ARGS4J, GUAVA,
    GUICE.guice, GUICE.assistedinject
    package :jar
  end
  ...
  desc "Gerrit Code Review - Patch commons-net"
  ...
  desc "Gerrit Code Review - SSHd"
  define "gerrit-sshd" do
    compile.with projects(
    "gerrit-launcher",
    "gerrit-httpd",
    "gerrit-server",
  ...
  desc "Gerrit Code Review - Pgm"
  define "gerrit-pgm" do
    compile.with projects(
    "gerrit-main",
    "gerrit-util-cli",
    "gerrit-cache-h2",
  ...
  desc "Gerrit Code Review - Acceptance Tests"
  define "gerrit-acceptance-tests" do
    compile.with projects(
    "gerrit-httpd",
    "gerrit-sshd",
    "gerrit-server",
    ...
    "gerrit-pgm"),
    project("gerrit-server").compile.dependencies(),
    project("gerrit-sshd").compile.dependencies(),
    project("gerrit-httpd").compile.dependencies(),
    project("gerrit-openid").compile.dependencies(),
    COMMONSPOOL,
    COMMONSCOLLECTION,
    JETTY
    test
