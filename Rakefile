...
require File.join(File.dirname(__FILE__), 'buildr/prologcc.rb')
...
define "gerrit" do
  ...
  desc "Gerrit Code Review - Common"
  define "gerrit-common" do
    compile.with projects("gerrit-gwtexpui", "gerrit-reviewdb", "gerrit-prettify",
    "gerrit-patch-jgit"), JGIT, GWT, GWTJSONRPC, JSR305, GUAVA, GWTORM
    package :jar
  end

  desc "Gerrit Code Review - Server"
  define "gerrit-server" do

    prologcc = prologcc(_('src/main/prolog/gerrit_common.pl'))
    compile.from(prologcc)

    compile.with projects("gerrit-antlr", "gerrit-extension-api",
    "gerrit-util-ssl", "gerrit-patch-commonsnet", "gerrit-common",
    "gerrit-reviewdb", "gerrit-util-cli", "gerrit-patch-jgit"),
    EASYMOCK, LOG4J, VELOCITY, JGIT, JGITJUNIT, COMMONS, SLF4J,
    BOUNCYCASTLE, MIMEUTIL, GWTJSONRPC, GUICE, AOP, H2, GUAVA,
    JSR305, CHARDET, BRICS, PROLOGCAFE, PEGDOWN, GWTORM, ARGS4J,
    ANTLR, GWTJSONRPC, GSON, JCRAFT, PARABOILED
    package :jar
  end

  desc "Gerrit Code Review - Server"
  define "gerrit-cache-h2" do
    compile.with projects("gerrit-server", "gerrit-extension-api"),
    GUICE, GUAVA, H2, SLF4J, JGIT
    package :jar
  end

  desc "Gerrit Code Review - Launcher"
  define "gerrit-launcher" do
    compile
    package :jar
  end

  desc "Gerrit Code Review - Main"
  define "gerrit-main" do
    compile.with projects("gerrit-launcher")
    package :jar
  end

  desc "Gerrit Code Review - HTTPd"
  define "gerrit-httpd" do
    compile.with projects("gerrit-launcher", "gerrit-server",
    "gerrit-prettify", "gerrit-gwtexpui"),
    project("gerrit-server").compile.dependencies(),
    TOMCAT, JGITHTTP
    package :jar
  end

  desc "Gerrit Code Review - OpenID servlet and RPC"
  define "gerrit-openid" do
    compile.with projects("gerrit-launcher", "gerrit-httpd",
    "gerrit-server", "gerrit-gwtexpui"),
    project("gerrit-server").compile.dependencies(),
    TOMCAT, OPENID4JAVA
    package :jar
  end
