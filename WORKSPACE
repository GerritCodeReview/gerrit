...
http_archive(
    ...
    sha256 = "a8cf422473b90a0163dcc62fab3b28c665e5eef8b11ef23a3a44e516905ca360",
    strip_prefix = "rbe_autoconfig-5.0.0",
    urls = [
        "https://gerrit-bazel.storage.googleapis.com/rbe_autoconfig/v5.0.0.tar.gz",
        "https://github.com/davido/rbe_autoconfig/releases/download/v5.0.0/v5.0.0.tar.gz",
    ],
)
...
http_archive(
    name = "rules_nodejs",
    sha256 = "b2289c7b52efe7467d1e9aa197a090b3717d5730d002a21aece2fb009e0035c6",
