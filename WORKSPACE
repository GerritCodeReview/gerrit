...
#    This @npm directory is not a managed directory, so npm install must be used to install
#    packages. Converting it to managed directory probably requires changes in CI scripts.
