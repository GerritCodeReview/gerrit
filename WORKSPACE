...
load("//tools/bzl:bower_support.bzl", "bower_archive", "npm_binary")
...
load("//polygerrit-ui/app/node_modules_licenses:licenses.bzl", "attach_license", "define_license", "nested_node_module_workspace")

nested_node_module_workspace(
    name = "qwer",
    nested_module = "@webcomponents/webcomponentsjs",
    parent_module = ["@ui_npm//polymer-resin"],
)
