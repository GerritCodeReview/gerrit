...
# TODO(davido): Consider to rename guava.jar to caffeine-guava.jar on fetch to
# prevent potential naming collision between caffeine guava adapater and guava:
