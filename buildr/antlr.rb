...
module Buildr
  ...
  module ANTLR
#    REQUIRES = [ "org.antlr:antlr:jar:3.2", "antlr:antlr:jar:2.7.7", "org.antlr:stringtemplate:jar:3.2"]
    REQUIRES = ["org.antlr:antlr:jar:3.2", "org.antlr:antlr-runtime:jar:3.2", "org.antlr:stringtemplate:jar:3.2", "antlr:antlr:jar:2.7.7"]
