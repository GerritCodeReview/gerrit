...
Ensure that properties used from outside the lexical scope of their containing class (like Lit element properties accessed by parent components or templates) do not use `private` visibility. Such properties should use `protected` or `public` as appropriate.
