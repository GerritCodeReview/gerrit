...
def test_git_clone_push(tmp_dir, repo):
    ...
    git.push(repo_path, "origin", "HEAD:refs/heads/master")
    assert git.commit_id(repo, "refs/heads/master") == new_commit
...
def _create_new_commit(repo_path):
    ...
    return git.commit_id(repo_path)
