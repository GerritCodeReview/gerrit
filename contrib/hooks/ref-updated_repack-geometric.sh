...
#
# Since this an event based approach to repository maintenance, it is recommended
# that another time based GC approach, perhapse a more significant and costly one,
# repacking refs, creating bitmpas... be used in parallel with this script. This
