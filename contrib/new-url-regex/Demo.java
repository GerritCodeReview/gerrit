...
/**
 * This class demonstrates key extraction based on the Gerrit's new URL schema.
 * It shows, that we can extract a proper sharding key using a single RE2-based regular
 * expression.
 */
public class Demo {
  ...
  public static void main(String args[]) {
    ...
    String[] examplePaths = {
      // - GWT UI Calls
      // Note that # will not be sent to the server.
