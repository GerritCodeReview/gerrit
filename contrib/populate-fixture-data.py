...
# import sh  # Run "pip install sh" if you do not have this module
...
ADMIN_DIGEST = HTTPDigestAuth('admin',
                              'secret')
...
def digestAuth(user):
  return HTTPDigestAuth(user['username'],
                        user['http_password'])
...
def fetchRandomText():
  return requests.get(
    'http://www.randomtext.me/download/lorem/p-11/5-15'
...
def createChange(user, projectName):
  randomCommitMessage = fetchRandomText()
  change = {
    "project": projectName,
