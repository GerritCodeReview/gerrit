...
find ./ -name '*.html' -type f -not -path "*/node_modules/*" -not -path "*/samples/*" -not -path "*/gr-diff/gr-diff-root.html" -exec sh -c 'echo {}' \n \; >$html_files
...
find ./polygerrit-ui/app -name '*.html' -type f -not -path "*/node_modules/*" -not -path "*_test.html" -not -path "*/modulizer_out/*" -not -path "*/styles/themes/dark-theme.html" -exec sh -c './rename-html.sh {}' \;
