...
find ./modulizer_out -name '*_test.html' -type f -not -path "*/node_modules/*" -exec sh -c 'sed -i "/import {a11ySuite} from 'wct-browser-legacy/a11ySuite.js';/d" {}' \n \;
...
sed -i "/import './change-list/gr-embed-dashboard/gr-embed-dashboard.js';/d"
