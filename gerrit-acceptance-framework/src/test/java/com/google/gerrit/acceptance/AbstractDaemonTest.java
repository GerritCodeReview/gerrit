...
public abstract class AbstractDaemonTest {
  ...
  public void assumeSshIfRequired() {
    if (useSsh) {
      // If the test uses ssh, we use assume() to make sure ssh is enabled on the test suite.
      // JUnit will skip tests annotated with @UseSsh if we disable them using the command line
      // flag.
