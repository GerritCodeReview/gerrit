...
class InProcessProtocol extends TestProtocol<InProcessProtocol.Context> {
   ...
   * <p>
   * Confusingly, Gerrit has two ideas of what a "context" object: one for Guice
   * {@link RequestScoped}, and one for its own simplified version of request
   * scoping using {@link ThreadLocalRequestContext}. This class provides both,
   * in essence just delegating the {@code ThreadLocalRequestContext} scoping to
   * the Guice scoping mechanism.
   * <p>
