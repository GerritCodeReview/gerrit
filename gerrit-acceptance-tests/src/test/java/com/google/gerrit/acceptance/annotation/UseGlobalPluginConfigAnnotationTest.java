...
public class UseGlobalPluginConfigAnnotationTest extends AbstractDaemonTest {
  ...
  public void testOne() {
    assertThat(pluginConfig.getGlobalPluginConfig("test").getString("section", null, "name")).isEqualTo("value");
  }
  ...
  public void testOneWithSubsection() {
    assertThat(pluginConfig.getGlobalPluginConfig("test").getString("section", "subsection", "name")).isEqualTo("value");
  }
  ...
  public void testMultiple() {
    assertThat(pluginConfig.getGlobalPluginConfig("test").getString("section", null, "name")).isEqualTo("value");
    assertThat(pluginConfig.getGlobalPluginConfig("test").getString("section1", null, "name")).isEqualTo("value1");
    assertThat(pluginConfig.getGlobalPluginConfig("test").getString("section", "subsection", "name")).isEqualTo("value");
    assertThat(pluginConfig.getGlobalPluginConfig("test").getString("section", "subsection1", "name")).isEqualTo("value1");
  }
  ...
  public void testList() {
    assertThat(pluginConfig.getGlobalPluginConfig("test").getStringList("section", null, "name"))
        .asList()
  ...
  public void testListWithSubsection() {
    assertThat(pluginConfig.getGlobalPluginConfig("test").getStringList("section", "subsection", "name"))
        .asList()
        .containsExactly("value-1", "value-2");
  }
