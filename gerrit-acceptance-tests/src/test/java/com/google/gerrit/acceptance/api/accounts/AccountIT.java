...
public class AccountIT extends AbstractDaemonTest {
  ...
  public void getAccountExternalIds() throws Exception {
    List<AccountExternalIdInfo> expectedIdInfoList =
        getExternalIds(user).stream().map(AccountIT::toInfo).sorted().collect(Collectors.toList());
    ...
    assertThat(expectedIdInfoList).containsExactlyElementsIn(expectedIdInfoList);
  }
