...
public class AccountIT extends AbstractDaemonTest {
  ...
  private void assertGpgKeyEmailNotificationSent(TestAccount account) {
    ...
    String subject = m.headers().get("Subject") != null
        ? ((EmailHeader.String) m.headers().get("Subject")).getString() : "";
    assertThat(subject).isEqualTo("[Gerrit Code Review] New GPG Keys Added");
