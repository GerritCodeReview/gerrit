...
public class ChangeIT extends AbstractDaemonTest {
  ...
  public void testOtherBranchCommit_Positive() throws Exception {
    ...
    assertTrue(Iterables.getOnlyElement(info.revisions.values()).commit.otherBranchCommit);
  }

  @Test
  public void testOtherBranchCommit_Negative() throws Exception {
    assertFalse(Iterables
        .getOnlyElement(get(createChange().getChangeId()).revisions.values()).commit.otherBranchCommit);
  }
