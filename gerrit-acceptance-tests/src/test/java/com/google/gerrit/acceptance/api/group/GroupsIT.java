...
public class GroupsIT extends AbstractDaemonTest {
  ...
  public void testListAllGroups() throws Exception {
    List<String> expectedGroups =
        FluentIterable.from(groupCache.all())
            .transform(
  ...
  private void assertMembers(Iterable<AccountInfo> members, String... expectedNames) {
    ...
    assertThat(memberNames).containsExactlyElementsIn(Arrays.asList(expectedNames)).inOrder();
  }
  ...
  private static void assertIncludes(Iterable<GroupInfo> includes, String... expectedNames) {
    ...
    assertThat(includeNames).containsExactlyElementsIn(Arrays.asList(expectedNames)).inOrder();
  }
