...
public class CheckAccessIT extends AbstractDaemonTest {
  ...
  public void nonexistentEmail() throws Exception {
    exception.expect(RestApiException.class);
    gApi.projects().name(normalProject.get()).checkAccess(            new AccessCheckInput("doesnotexist@invalid.com", null));
  }
  ...
  public void accessible() throws Exception {
    List<TestCase> inputs =
        ImmutableList.of(
            ...
            new TestCase(privilegedUser.email, secretRefProject.get(), "refs/heads/secret/master", 200),
