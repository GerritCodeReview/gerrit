...
public class ReviewIT extends AbstractDaemonTest {
  ...
  @Test
  public void apiReviewTriplet() throws GitAPIException,
  ...
  @Test
  public void apiReviewId() throws GitAPIException,
      IOException, RestApiException {
    PushOneCommit.Result r = createChange();
    ReviewInput in = new ReviewInput();
    in.message = "Looks good!";
  ...
  private PushOneCommit.Result createChange() throws GitAPIException, IOException {
