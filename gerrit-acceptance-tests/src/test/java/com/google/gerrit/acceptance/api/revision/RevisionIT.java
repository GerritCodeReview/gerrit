...
public class RevisionIT extends AbstractDaemonTest {
  ...
  public void actionsETag() throws Exception {
    ...
    String oldETag = checkETag(r2, null);
    current(r2).review(ReviewInput.approve());
    oldETag = checkETag(r2, oldETag);
  ...
  private String checkETag(PushOneCommit.Result r, String oldETag)
      throws Exception {
    String eTag = getRevisionActions.getETag(parseRevisionResource(r));
