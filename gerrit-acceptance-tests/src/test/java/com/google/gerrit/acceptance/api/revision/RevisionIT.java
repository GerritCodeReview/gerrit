...
public class RevisionIT extends AbstractDaemonTest {
  ...
  private void cherryPickToChangeRevision(boolean isDestChangeMerged, boolean isDestChangePrivate)
      throws Exception {
