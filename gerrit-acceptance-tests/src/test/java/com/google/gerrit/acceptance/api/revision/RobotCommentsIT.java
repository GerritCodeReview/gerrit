...
public class RobotCommentsIT extends AbstractDaemonTest {
  ...
  public void specificRobotCommentCanBeRetrieved() throws Exception {
    ...
    RobotCommentInfo specificRobotCommentInfo = gApi.changes().id(changeId)
        .current().robotComment(robotCommentInfo.id).get();
  ...
  public void fixIdIsGeneratedForFixSuggestion() throws Exception {
    ...
    assertThatList(robotCommentInfos).onlyElement().onlyFixSuggestion().fixId()
        .isNotEmpty();
    assertThatList(robotCommentInfos).onlyElement().onlyFixSuggestion().fixId()
  ...
  public void descriptionOfFixSuggestionIsMandatory() throws Exception {
    ...
    exception.expectMessage(String.format(
        "A description is required for the "
  ...
  public void pathOfFixReplacementIsMandatory() throws Exception {
    ...
    exception.expect(BadRequestException.class);
    exception.expectMessage(String.format(
        "A file path must be given for the "
