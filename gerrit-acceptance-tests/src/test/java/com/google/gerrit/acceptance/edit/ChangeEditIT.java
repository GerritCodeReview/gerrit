...
public class ChangeEditIT extends AbstractDaemonTest {
  ...
  public void updateMessage() throws Exception {
    ...
    edit = editUtil.byChange(change);
    assertThat(msg).isEqualTo(edit.get().getEditCommit().getFullMessage());
    ...
    assertThat(msg).isEqualTo(
        info.revisions.get(info.currentRevision).commit.message);
  }
  ...
  public void updateMessageRest() throws Exception {
    ...
    Optional<ChangeEdit> edit = editUtil.byChange(change);
    assertThat(in.message).isEqualTo(edit.get().getEditCommit()
        .getFullMessage());
