...
public abstract class AbstractPushForReview extends AbstractDaemonTest {
  ...
  @Test
  public void testPushForMasterWithApproval() throws GitAPIException,
      OrmException, IOException, JSchException, RestApiException {
    // add two approvals: Code-Review-1
    PushOneCommit.Result r = pushTo("refs/for/master/%l=Code-Review-1");
    r.assertOkStatus();
