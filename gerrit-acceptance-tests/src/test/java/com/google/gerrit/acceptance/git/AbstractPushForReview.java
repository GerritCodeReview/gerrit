...
public abstract class AbstractPushForReview extends AbstractDaemonTest {
  ...
  public void pushForMasterWithSimilarityMatch() throws Exception {
    grant(Permission.SIMILARITY_MATCH, project, "refs/heads/master");
    ...
    PushOneCommit c1 = pushFactory.create(
        db, admin.getIdent(), testRepo, PushOneCommit.SUBJECT,
        PushOneCommit.FILE_NAME, "abcdefghijklmn\n", "");
    ...
    PushOneCommit c2 = pushFactory.create(
        db, admin.getIdent(), testRepo, PushOneCommit.SUBJECT,
        PushOneCommit.FILE_NAME, "abcdefghijklmn\nabc", "");
    c2.setParent(r.getCommit());
    PushOneCommit.Result r2 =
        c2.to("refs/for/master%topic=similarity,similarity-match");
    r2.assertOkStatus();
