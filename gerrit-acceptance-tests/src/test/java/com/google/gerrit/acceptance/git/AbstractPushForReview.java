...
public abstract class AbstractPushForReview extends AbstractDaemonTest {
  ...
  public void pushCommitWithSameChangeIdAsPredecessorChange() throws Exception {
    ...
    RevCommit commitChange2 = createCommit(testRepo, commitChange1.getFullMessage());
    assertThat(GitUtil.getChangeId(testRepo, commitChange1).get())
        .isEqualTo(GitUtil.getChangeId(testRepo, commitChange2).get());
