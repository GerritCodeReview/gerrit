...
public class ImplicitMergeCheckIT extends AbstractDaemonTest {
  ...
  public void implicitMergeViaFastForward() throws Exception {
    ...
    c.assertMessage(implicitMergeOf(m.getCommitId()));
  }
  ...
  public void implicitMergeViaRealMerge() throws Exception {
    ...
    ObjectId base = repo().getRef("HEAD").getObjectId();
  ...
  private void setCheckImplicitMerges() throws Exception {
    MetaDataUpdate md = metaDataUpdateFactory.create(project);
    md.setMessage("Set receive.checkImplicitMerges = true");
    ProjectConfig cfg = ProjectConfig.read(md);
    cfg.getProject().setCheckImplicitMerges(InheritableBoolean.TRUE);
    cfg.commit(md);
