...
public class RevisionEditIT extends AbstractDaemonTest {
  ...
  @Test
  public void updateExistingFile() throws GitAPIException, IOException,
  ...
  @Test
  public void addNewFile() throws GitAPIException, IOException,
      OrmException, AuthException, InvalidChangeOperationException,
      NoSuchChangeException {
    String changeId = newChange();
    Change change = getChange(changeId);
  ...
  public void writeNoChanges() throws GitAPIException, IOException,
      OrmException, AuthException, InvalidChangeOperationException,
      NoSuchChangeException {
    String changeId = newChange();
    Change change = getChange(changeId);
