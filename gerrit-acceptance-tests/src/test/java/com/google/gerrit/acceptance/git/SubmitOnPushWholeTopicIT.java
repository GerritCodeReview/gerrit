...
import com.google.gerrit.acceptance.rest.change.SubmoduleSubscriptionsIT;
...
@NoHttpd
public class SubmitOnPushWholeTopicIT extends SubmoduleSubscriptionsIT {
  ...
  public void testSubscriptionUpdateOfManyChanges() throws Exception {
    ...
    ObjectId superHEAD = pushChangeTo(superRepo, "master");
