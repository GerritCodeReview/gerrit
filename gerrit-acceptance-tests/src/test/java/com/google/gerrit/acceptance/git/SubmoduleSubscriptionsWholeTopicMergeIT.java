...
public class SubmoduleSubscriptionsWholeTopicMergeIT
  ...
  public void testUpdateManySubmodules() throws Exception {
    ...
    addSubscriptionEntry(config, "sub1", "master");
    addSubscriptionEntry(config, "sub2", "master");
    addSubscriptionEntry(config, "sub3", "master");
    pushSubscriptionConfig(superRepo, "master", config);

    ObjectId superPreviousId = pushChangeTo(superRepo, "master");

    ObjectId sub1Id = uploadChangeTo(sub1, "refs/for/master",
        "some message", "same-topic");
    ObjectId sub2Id = uploadChangeTo(sub2, "refs/for/master",
        "some message", "same-topic");
    ObjectId sub3Id = uploadChangeTo(sub3, "refs/for/master",
        "some message", "same-topic");
