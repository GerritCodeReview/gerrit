...
public class SubmoduleSubscriptionsWholeTopicMergeIT
  ...
  public void testUpdateManySubmodules() throws Exception {
    ...
    addSubmoduleSubscription(cfg, "subscribed1", "master");
    addSubmoduleSubscription(cfg, "subscribed2", "master");
    addSubmoduleSubscription(cfg, "subscribed3", "master");
    pushSubscriptionConfig(superRepo, "master", cfg);
    ...
    ObjectId newId = superRepo.getRepository().resolve("HEAD~1");
