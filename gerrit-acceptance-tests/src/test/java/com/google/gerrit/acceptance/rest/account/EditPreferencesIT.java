...
public class EditPreferencesIT extends AbstractDaemonTest {
  ...
  public void getSetEditPreferences() throws Exception {
    ...
    EditPreferencesInfo out = newGson().fromJson(r.getReader(),
        EditPreferencesInfo.class);

    // compare to default values
    assertEditPreferences(out, new EditPreferencesInfo());
    ...
    assertEditPreferences(out, newGson().fromJson(r.getReader(),
        EditPreferencesInfo.class));
  }
  ...
  private void assertEditPreferences(EditPreferencesInfo out,
    ...
    assertThat(out.showLineNumbers).isEqualTo(in.showLineNumbers);
