...
public class UserPreferencesIT extends AbstractDaemonTest {
  ...
  public void getSetUserPreferences() throws Exception {
    ...
    assertUserPrefserences(out, new UserPreferences());
    ...
    assertUserPrefserences(out, newGson().fromJson(r.getReader(),
        UserPreferences.class));
  }

  private void assertUserPrefserences(UserPreferences out, UserPreferences in) {
