...
public abstract class AbstractSubmit extends AbstractDaemonTest {
  ...
  @Test
  public void submitChangeFromCommitAlreadyOnOtherBranch() throws Exception {
  ...
  @Test
  public void submitChangeFromCommitAlreadyOnOtherBranchWithDependentCommit() throws Exception {
    // Chain of two commits
    // Push both to topic-branch
    // Push the first commit for review
    //
