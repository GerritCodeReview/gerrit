...
import com.google.gerrit.extensions.api.changes.CreateChangeInput;
...
public class CreateChangeIT extends AbstractDaemonTest {
  ...
  public void createEmptyChange_MissingDestination() throws IOException {
    ...
    RestResponse r = adminSession.put("/changes/new");
  ...
  public void createEmptyChange_MissingMessage() throws IOException {
    ...
    RestResponse r = adminSession.put("/changes/new", in);
    assertEquals(HttpStatus.SC_BAD_REQUEST, r.getStatusCode());
