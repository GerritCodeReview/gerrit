...
public class DeleteDraftPatchSetIT extends AbstractDaemonTest {
  ...
  public void deletePatchSet() throws GitAPIException,
    ...
    RestResponse r = deletePatchSetWithPost(changeId, ps, session);
  ...
  public void deleteDraftPatchSetNoACL() throws GitAPIException,
    ...
    RestResponse r = deletePatchSetWithDelete(changeId, ps, userSession);
  ...
  public void deleteDraftPatchSetAndChange() throws GitAPIException,
    ...
    assertEquals("p~master~" + changeId, c.id);
    assertEquals(Change.Status.DRAFT, c.status);
    RestResponse r = deletePatchSetWithDelete(changeId, ps, session);
    ...
    r = deletePatchSetWithPost(changeId, ps, session);
    assertEquals(204, r.getStatusCode());
  ...
  private static RestResponse deletePatchSetWithPost(String changeId,
      PatchSet ps, RestSession s) throws IOException {
    return s.post("/changes/"
      + changeId
      + "/revisions/"
      + ps.getRevision().get()
      + "/delete");
  ...
  private static RestResponse deletePatchSetWithDelete(String changeId,
      PatchSet ps, RestSession s) throws IOException {
