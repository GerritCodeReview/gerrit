...
public class SubmitByMergeIfNecessaryIT extends AbstractSubmitByMerge {
  ...
  public void submitWithFastForward() throws Exception {
    ...
    assertEqualsExceptTime(admin.getIdent(), head.getAuthorIdent());
    assertEqualsExceptTime(admin.getIdent(), head.getCommitterIdent());
  }
  ...
  public void submitMultipleChanges() throws Exception {
    ...
    assertThat(tip.getParent(0).getId()).isEqualTo(
        initialHead.getId());
    assertEqualsExceptTime(admin.getIdent(), tip.getAuthorIdent());
    assertEqualsExceptTime(admin.getIdent(), tip.getCommitterIdent());
    ...
    assertEqualsExceptTime(admin.getIdent(), tip.getAuthorIdent());
    assertEqualsExceptTime(serverIdent.get(), tip.getCommitterIdent());
