...
public class SubmitResolvingMergeCommitIT extends AbstractSubmit {
  @Inject
  ...
  private void assertChangeSetMergeable(ChangeData change,
    ...
    assertThat(cs.isMergeable()).isEqualTo(expected);
  }
  ...
  private PushOneCommit.Result createChange(TestRepository<?> repo,
    ...
    return createChange(repo, "master", subject, "x", "x", "");
  }
