...
public class SubmoduleSubscriptionsIT extends AbstractDaemonTest {
  ...
  public void testSubscriptionUnsubscribe() throws Exception {
    ...
    pushRandomChangeTo(subRepo, "master");
    pushRandomChangeTo(subRepo, "master");
    pushRandomChangeTo(superRepo, "master", "commit after unsubscribe");
    pushRandomChangeTo(subRepo, "master", "commit after unsubscribe");
  ...
  private void syncHeadTo(TestRepository<?> repo, String branch)
      throws Exception {
  ...
  private ObjectId pushRandomChangeTo(TestRepository<?> repo, String branch, String message)
      throws Exception {
  ...
  private ObjectId pushRandomChangeTo(TestRepository<?> repo, String branch)
      throws Exception {
    return pushRandomChangeTo(repo, branch, "some change");
  }
