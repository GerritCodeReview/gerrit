...
public class SuggestReviewersIT extends AbstractDaemonTest {
  ...
  public void setUp() throws Exception {
    ...
    user1 = accounts.create("user1", "user1@example.com", "users1");
    accounts.create("user2", "user2@example.com", "users2");
    accounts.create("user3", "user3@example.com", "users1", "users2");
  ...
  @Test
  public void suggestReviewers() throws GitAPIException,
    ...
    changeId = createChange(user1);
    reviewers = suggestReviewers(changeId, "u", 6);
    assertEquals(reviewers.size(), 6);
  }
