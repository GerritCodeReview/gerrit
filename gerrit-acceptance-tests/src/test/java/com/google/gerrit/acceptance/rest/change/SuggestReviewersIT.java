...
public class SuggestReviewersIT extends AbstractDaemonTest {
  ...
  public void defaultReviewerSuggestion() throws Exception{
    ...
    addReviewer(changeId1, reviewer1);

    String changeId2 = createChangeFromApi();
    addReviewer(changeId2, reviewer1);
    addReviewer(changeId2, reviewer2);
  ...
  private void addReviewer(String changeId, TestAccount reviewer)
    ...
    gApi.changes().id(changeId).addReviewer(reviewer.email);
  }

  private void reviewChange(String changeId)
      throws RestApiException {
    ReviewInput ri = new ReviewInput();
