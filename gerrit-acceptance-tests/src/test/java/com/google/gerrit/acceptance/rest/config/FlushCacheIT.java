...
public class FlushCacheIT extends AbstractDaemonTest {
  ...
  public void flushCache_Forbidden() throws Exception {
    userSession.post("/config/server/caches/accounts/flush").assertForbidden();
  }

  @Test
  public void flushCache_NotFound() throws Exception {
    adminSession.post("/config/server/caches/nonExisting/flush").assertNotFound();
  }

  @Test
  public void flushCacheWithGerritPrefix() throws Exception {
    adminSession.post("/config/server/caches/gerrit-accounts/flush").assertOK();
  }

  @Test
  public void flushWebSessionsCache() throws Exception {
    adminSession.post("/config/server/caches/web_sessions/flush").assertOK();
  }
  ...
  public void flushWebSessionsCache_Forbidden() throws Exception {
    ...
    try {
      ...
      userSession.post("/config/server/caches/web_sessions/flush").assertForbidden();
    } finally {
