...
public class ListGroupsIT extends AbstractDaemonTest {
  ...
  /**
   * The REST endpoint to list groups returns a map that maps the group names
   * to GroupInfo entities. This test checks that all fields of the returned
   * GroupInfo entities are set correctly.
  */
  @Test
