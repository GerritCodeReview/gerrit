...
public class AccessIT extends AbstractDaemonTest {
  ...
  public void addAccessSection() throws Exception {
    ...
    accessInput.addition.put(REFS_HEADS, accessSectionInfo);
    pApi.access(accessInput);

    assertThat(pApi.access().local).isEqualTo(accessInput.addition);
  }
  ...
  public void removePermission() throws Exception {
    ...
    // Remove locally
    accessInput.addition.get(REFS_HEADS).permissions
  ...
  public void removePermissionRulesAndCleanupEmptyEntries() throws Exception {
    ...
    // Remove locally
    accessInput.addition.get(REFS_HEADS)
  ...
  public void getPermissionsWithDisallowedUser() throws Exception {
    ...
    // Disallow READ
    accessInput.addition.put(REFS_ALL, accessSectionInfo);
    pApi.access(accessInput);
  ...
  public void removeGlobalCapabilityAsUser() throws Exception {
    ...
    accessInput.deduction.put(AccessSection.GLOBAL_CAPABILITIES,
        accessSectionInfo);
