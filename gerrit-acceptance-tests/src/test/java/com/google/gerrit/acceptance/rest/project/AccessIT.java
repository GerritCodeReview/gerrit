...
public class AccessIT extends AbstractDaemonTest {
  ...
  public void addAccessSection() throws Exception {
    ...
    accessInput.additions.put(REFS_HEADS, accessSectionInfo);
  ...
  public void removePermission() throws Exception {
    ...
    removal.deductions.put(REFS_HEADS, accessSectionToRemove);
    pApi.access(removal);

    // Remove locally
    accessInput.additions.get(REFS_HEADS).permissions
  ...
  public void removePermissionRulesAndCleanupEmptyEntries() throws Exception {
    ...
    // Remove locally
    accessInput.additions.get(REFS_HEADS)
  ...
  public void getPermissionsWithDisallowedUser() throws Exception {
    ...
    // Disallow READ
    accessInput.additions.put(REFS_ALL, accessSectionInfo);
    pApi.access(accessInput);
  ...
  public void setPermissionsWithDisallowedUser() throws Exception {
    ...
    accessInfoToApply.additions.put(REFS_HEADS, accessSectionInfoToApply);
  ...
  public void addGlobalCapabilityAsUser() throws Exception {
    ...
    accessInput.additions.put(AccessSection.GLOBAL_CAPABILITIES,
        accessSectionInfo);
  ...
  public void removeGlobalCapabilityAsUser() throws Exception {
    ...
    accessInput.deductions.put(AccessSection.GLOBAL_CAPABILITIES,
        accessSectionInfo);
  ...
  private ProjectAccessInput newProjectAccessInput() {
    ...
    p.additions = new HashMap<>();
    p.deductions = new HashMap<>();
    return p;
  }
