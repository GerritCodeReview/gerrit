...
public class TagUpdateIT extends AbstractDaemonTest {
  ...
  @Test
  public void updateAnnotated_noPushPermission_withPushAnnotatedPermission()
      throws Exception {
  ...
  @Test
  public void forceUpdateLightweight_withPushPermission() throws Exception {
    grant(Permission.PUSH, project, "refs/tags/*");
  ...
  /** Granting "Create Reference" permission necessary for tag update */
  @Test
  public void updateLightweight_withPushAndCreatePermission() throws Exception {
    grant(Permission.PUSH, project, "refs/tags/*");
  ...
  @Test
  public void forceUpdateLightweight_withForcePushPermission() throws Exception {
  ...
  /**
   * Granting "Create Reference" permission necessary for tag update even
   * if Push+force is already granted
   */
  @Test
  public void forceUpdateLightweight_withForcePushAndCreatePermission() throws Exception {
    grant(Permission.PUSH, project, "refs/tags/*", true);
    grant(Permission.CREATE, project, "refs/tags/*");
  ...
  @Test
  public void forceUpdateAnnotated_withPushPermission() throws Exception {
    grant(Permission.PUSH, project, "refs/tags/*");
  ...
  @Test
  public void updateAnnotated_withPushAndPushAnnotatedPermission()
      throws Exception {
    grant(Permission.PUSH, project, "refs/tags/*");
    grant(Permission.PUSH_TAG, project, "refs/tags/*");
  ...
  /** Need "Create Reference" permission to make Push+force working */
  @Test
  public void forceUpdateLightweight_withCreateReferencePermission()
      throws Exception {
    grant(Permission.PUSH, project, "refs/tags/*", true);
    grant(Permission.CREATE, project, "refs/tags/*", true);
