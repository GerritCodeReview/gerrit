...
public class TagsIT extends AbstractDaemonTest {
  ...
  public void listTags() throws Exception {
    ...
    PushOneCommit.Tag tag2 = new PushOneCommit.Tag("v2.0", "annotation");
    ...
    assertEquals(tag2.message, result.get(1).message);
  }

  @Test
  public void listTagsOfNonVisbleBranch() throws Exception {
    grant(Permission.SUBMIT, project, "refs/for/refs/heads/master");
