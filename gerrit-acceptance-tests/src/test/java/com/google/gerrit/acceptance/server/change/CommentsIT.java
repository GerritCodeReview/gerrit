...
public class CommentsIT extends AbstractDaemonTest {
  ...
  public void deleteCommentByUser() throws Exception {
    ...
    PushOneCommit push =
        pushFactory.create(db, user.getIdent(), testRepo, SUBJECT, fileName, FILE_CONTENT);
  ...
  public void deleteCommentByRewritingCommitHistory() throws Exception {
    ...
    gApi.changes()
        ...
        .revision(revId)
        .comment(targetCommentInfo.get().id)
        .delete(input);
    ...
    if (notesMigration.writeChanges()) {
      ...
      assertCommitDataList(
          commitDataListBefore, commitDataListAfter, targetCommentInfo.get().id, expectedMsg);
    }
