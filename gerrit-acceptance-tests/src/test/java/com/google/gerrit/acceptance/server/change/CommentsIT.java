...
public class CommentsIT extends AbstractDaemonTest {
  ...
  public void publishCommentsAllRevisions() throws Exception {
    ...
    assertThat(messages.get(0).body()).isEqualTo(
        ...
        + "-- \n"
        + "To view, visit " + url + "1\n"
        + "To unsubscribe, visit " + url + "settings\n"
        + "\n"
        + "Gerrit-MessageType: comment\n"
        + "Gerrit-Change-Id: " + r2.getChangeId() + "\n"
        + "Gerrit-PatchSet: 2\n"
        + "Gerrit-Project: " + project + "\n"
        + "Gerrit-Branch: master\n"
        + "Gerrit-Owner: Administrator <admin@example.com>\n"
        + "Gerrit-Reviewer: User <user@example.com>\n"
