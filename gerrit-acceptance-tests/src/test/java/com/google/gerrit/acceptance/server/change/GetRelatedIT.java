...
//  }
  ...
  @Test
  public void getRelatedAmendParendChange_FIXED_AFTER_SWITCHING_TO_GET_RELATED_BY_ANCESTOR()
      throws Exception {
    // Create two commits and push.
    RevCommit c1_1 = commitBuilder()
        .add("a.txt", "1")
     ...
     * =========
     *
     * 1. When looking at ps1_1:
     *
     * ps2_1
     * ps1_1
     *
     * 2. When looking at ps1_2:
     *
     * ps2_1
     * ps1_2
     *
...
//        changeAndCommit(id2, c2_1, 1, 1));
  ...
  public void getRelatedExtendInTheMiddleOfSeries_FIXED_AFTER_SWITCHING_TO_GET_RELATED_BY_ANCESTORS()
     ...
     * =========
     *
     * 1. When looking at ps3_1:
     *
     * ps3_1
     * ps1_1
     *
     * 2. When looking at ps2_1:
     *
     * ps2_1
     * ps1_1
     *
     * 3. When looking at ps1_1:
     *
     * ps3_1
     * ps2_1
     * ps1_1
     *
     *
     * Actual (for all three cases above):
     * ===================================
     *
     * ps3_1
     * ps2_1
...
//    }
  ...
  @Test
  @Ignore("Got broken after switching to RelatedByAncestors algorithmm")
