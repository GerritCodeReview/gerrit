...
public class PatchListCacheIT extends AbstractDaemonTest {
  ...
  @Test
  public void listPatchesAgainstBase() throws GitAPIException,
  ...
  @Test
  public void listPatchesAgainstOtherPatchSetWithRebase() throws GitAPIException,
      IOException, PatchListNotAvailableException, OrmException {
    add(git, FILE_D, "4");
    createCommit(git, admin.getIdent(), SUBJECT_1);
    pushHead(git, "refs/heads/master", false);
  ...
  private PatchSet getCurrentPatchSet(String changeId) throws OrmException {
    return db.patchSets().get(getCurrentPatchSetId(changeId));
  }

  private PatchSet.Id getCurrentPatchSetId(String changeId) throws OrmException {
