...
public class PatchListCacheIT extends AbstractDaemonTest {
  ...
  public void largeObjectTombstoneGetsCached() {
    ...
    abstractPatchListCache.put(key, new PatchListCacheImpl.LargeObjectTombstone());
    assertThat(abstractPatchListCache.getIfPresent(key))
        .isInstanceOf(PatchListCacheImpl.LargeObjectTombstone.class);
  }
