...
public class AbstractMailIT extends AbstractDaemonTest {
  ...
  protected static CommentInput newComment(String path, Side side, int line,
      String message) {
   ...
   */
  protected static String newPlaintextBody(String changeURL,
      String changeMessage, String c1, String f1, String fc1) {
  ...
  protected static String textFooterForChange(String changeId,
      String timestamp) {
