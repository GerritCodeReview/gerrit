...
public class PageLinks {
  ...
  public static String toChangeInEditMode(Change.Id c, @Nullable Project.NameKey project) {
    return toChangeNoSlash(c, project) + ",edit/";
  }

  public static String toChange(Change.Id c, @Nullable Project.NameKey project, String p) {
    return toChange(c, project) + p;
  }

  public static String toChange(Change.Id c, @Nullable Project.NameKey project) {
    return toChangeNoSlash(c, project) + "/";
  }

  public static String toChange(
      Change.Id c, @Nullable Project.NameKey project, String b, String p) {
    String u = toChange(c, project);
    if (b != null) {
      u += b + "..";
    }
    u += p;
  ...
  private static String toChangeNoSlash(Change.Id c, @Nullable Project.NameKey project) {
    if (project != null) {
