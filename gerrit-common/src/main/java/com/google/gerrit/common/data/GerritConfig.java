...
public class GerritConfig implements Cloneable {
  ...
  protected boolean avatarIntegrationEnabled;
  ...
  public void setAvatarIntegrationEnabled(boolean enabled) {
    avatarIntegrationEnabled = enabled;
  }

  public boolean isAvatarIntegrationEnabled() {
    return avatarIntegrationEnabled;
  }
}
