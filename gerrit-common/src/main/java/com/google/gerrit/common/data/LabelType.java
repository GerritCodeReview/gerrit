...
public class LabelType {
  ...
  protected boolean copyAllScoresOnMergeFirestParentUpdate;
  ...
  public boolean isCopyAllScoresOnMergeBaseUpdate() {
    return copyAllScoresOnMergeFirestParentUpdate;
  }

  public void setCopyAllScoresOnMergeFirstParentUpdate(
      boolean copyAllScoresOnMergeFirstParentUpdate) {
    this.copyAllScoresOnMergeFirestParentUpdate =
