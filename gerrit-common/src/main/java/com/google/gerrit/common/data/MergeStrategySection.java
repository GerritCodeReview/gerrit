...
public class MergeStrategySection extends RefConfigSection {
  ...
  public boolean equals(Object obj) {
    ...
    if (obj instanceof MergeStrategySection
        && ((name == null && ((MergeStrategySection) obj).name == null) || //
        (name != null && name.equals(name)))
        && ((useContentMerge == null && ((MergeStrategySection) obj).useContentMerge == null) || //
        (useContentMerge != null && useContentMerge
            .equals(((MergeStrategySection) obj).useContentMerge)))
        && ((submitType == null && ((MergeStrategySection) obj).submitType == null) || //
        (submitType != null && submitType
            .equals(((MergeStrategySection) obj).submitType)))) {
      equals = true;
    }
