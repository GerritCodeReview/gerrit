...
public abstract class ProjectConfigSection {
  ...
  public static boolean isValidReferenceSection(String name) {
    return name.startsWith("refs/") || name.startsWith("^refs/");
  }

  protected String name;

  public ProjectConfigSection() {
  }

  public ProjectConfigSection(String refPattern) {
  ...
  public void setRefPattern(String name) {
    this.name = name;
  }
}
