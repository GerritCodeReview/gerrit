...
class ElasticChangeIndex extends AbstractElasticIndex<Change.Id, ChangeData>
  ...
  private class QuerySource implements ChangeDataSource {
    ...
    private ChangeData toChangeData(JsonElement json) {
      ...
      decodeUnresolvedCommentCount(source,
          ChangeField.UNRESOLVED_COMMENT_COUNT.getName(), cd);
    ...
    private void decodeUnresolvedCommentCount(JsonObject doc, String fieldName,
        ChangeData out) {
