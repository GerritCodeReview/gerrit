...
class ElasticRestClientProvider implements Provider<RestClient> {
  ...
  private static class ElasticVersionException extends RuntimeException {
    private static final long serialVersionUID = 1L;

    ElasticVersionException(String message) {
      super(message);
    }

    ElasticVersionException(String message, Throwable cause) {
      super(message, cause);
    }
  }

  public static class FailedToGetVersion extends ElasticVersionException {
    private static final long serialVersionUID = 1L;
