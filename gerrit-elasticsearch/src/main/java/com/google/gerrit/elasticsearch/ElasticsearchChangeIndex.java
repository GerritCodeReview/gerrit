...
class ElasticsearchChangeIndex implements ChangeIndex, LifecycleListener {
  ...
  ElasticsearchChangeIndex(
    ...
    String hostname = cfg.getString("index", null, "hostname");
    if (Strings.isNullOrEmpty(hostname)) {
      throw new IllegalStateException("index.hostname must be supplied");
    }

    int port = cfg.getInt("index", null, "port", DEFAULT_PORT);
