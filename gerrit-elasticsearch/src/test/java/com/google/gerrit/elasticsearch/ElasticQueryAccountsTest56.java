...
public class ElasticQueryAccountsTest56 extends AbstractQueryAccountsTest {
  private static final ElasticsearchVersion VERSION = ElasticsearchVersion.V5_6;
  ...
  protected Injector createInjector() {
    ...
    ElasticTestUtils.configure(elasticsearchConfig, nodeInfo.port, indicesPrefix, VERSION);
