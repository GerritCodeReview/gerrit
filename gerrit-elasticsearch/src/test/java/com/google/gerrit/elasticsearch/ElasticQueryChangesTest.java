...
public class ElasticQueryChangesTest extends AbstractQueryChangesTest {
  ...
  private static void createIndexes() {
    ChangeMapping mapping = new ChangeMapping();
    node.client()
        .admin()
        .indices()
        .prepareCreate("gerrit")
        .addMapping("open_changes", gson.toJson(mapping.openChanges))
        .addMapping("closed_changes", gson.toJson(mapping.closedChanges))
        .execute()
        .actionGet();
  }
