...
public class ElasticQueryChangesTest extends AbstractQueryChangesTest {
  ...
  private static void createIndexes() {
    node.client()
        ...
        .addMapping("open_changes", gson.toJson(ElasticChangeIndex.MAPPING.openChanges))
        .addMapping("closed_changes", gson.toJson(ElasticChangeIndex.MAPPING.closedChanges))
        .execute()
        .actionGet();
  }
