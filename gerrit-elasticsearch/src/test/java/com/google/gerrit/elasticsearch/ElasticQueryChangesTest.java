...
import static com.google.gerrit.elasticsearch.ElasticChangeIndex.getMappingProperties;
...
public class ElasticQueryChangesTest extends AbstractQueryChangesTest {
  ...
  public static void startIndexService() throws InterruptedException, ExecutionException {
    ...
    node.client()
        ...
        .addMapping("open_changes", getMappingProperties("open_changes"))
        .addMapping("closed_changes", getMappingProperties("closed_changes"))
        .execute()
        .actionGet();
  ...
  private static String getHttpPort()
    ...
    if (httpAddress.indexOf(':') < 0) {
      throw new RuntimeException("Seams that port is not included in Elastcsearch http_address");
    }
