...
import static com.google.gerrit.elasticsearch.AbstractElasticIndex.getMappingProperties;
  ...
  static void createIndexes(Node node) {
    node.client()
        ...
        .addMapping(ElasticAccountIndex.ACCOUNTS,
            getMappingProperties(AccountSchemaDefinitions.INSTANCE.getLatest(),
                ElasticAccountIndex.ACCOUNTS))
        .execute()
        .actionGet();
  }
