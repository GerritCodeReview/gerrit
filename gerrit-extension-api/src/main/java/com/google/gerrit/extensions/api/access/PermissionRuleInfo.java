...
public class PermissionRuleInfo {
  ...
  public boolean equals(Object obj) {
    if (obj instanceof PermissionRuleInfo) {
      ...
      if (!Objects.equals(action, p.action)) { return false; }
      if (force != p.force) { return false; }
      if (!Objects.equals(min, p.min)) { return false; }
      if (!Objects.equals(max, p.max)) { return false; }
      return true;
    }
    return false;
  }
