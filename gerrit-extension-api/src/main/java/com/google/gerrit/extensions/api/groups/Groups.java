...
public interface Groups {
  ...
  abstract class QueryRequest {
    ...
    /**
     * Executes query and returns the matched groups as a map that maps group
     * name to GroupInfo entity..
     */
    public abstract SortedMap<String, GroupInfo> get() throws RestApiException;
