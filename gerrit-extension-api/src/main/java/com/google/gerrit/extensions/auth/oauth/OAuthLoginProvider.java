...
public interface OAuthLoginProvider {
  ...
  /**
   * Returns a unique identifier for the OAuth2 provider.
   *
   * This identifier can be used in the Gerrit configuration to elect
   * the default OAuth2 provider for Git over HTTP communication if
   * multiple providers are installed.
   *
   * @return the identifier of the OAuth2 provider.
   */
