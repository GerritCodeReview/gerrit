...
public class OAuthToken implements Serializable {
  ...
  /**
   * Time of expiration of this token, or {@code Long#MAX_VALUE} if this token
   * never expires, or time of expiration is unknown.
   */
  ...
  public OAuthToken(String token, String secret, String raw, long expiresAt,
      String providerId) {
    this.token = token;
    this.secret = secret;
    this.raw = raw;
