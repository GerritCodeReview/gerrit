...
public class AccountGeneralPreferencesInfo {
  ...
  public static AccountGeneralPreferencesInfo defaults() {
    AccountGeneralPreferencesInfo p = new AccountGeneralPreferencesInfo();
    p.changesPerPage = DEFAULT_PAGESIZE;
    p.showSiteHeader = true;
    p.useFlashClipboard = true;
    p.copySelfOnEmail = false;
