...
public enum ChangeStatus {
   ...
   * </ul>
   */
  NEW(ChangeStatusConstants.STATUS_NEW),
   ...
   * </ul>
   */
  SUBMITTED(ChangeStatusConstants.STATUS_SUBMITTED),
   ...
   * </ul>
   */
  DRAFT(ChangeStatusConstants.STATUS_DRAFT),
   ...
   */
  MERGED(ChangeStatusConstants.STATUS_MERGED),
  ...
  private ChangeStatus(final char c) {
    code = c;
    closed = !(ChangeStatusConstants.MIN_OPEN <= c && c <= ChangeStatusConstants.MAX_OPEN);
  }
  ...
  public static ChangeStatus forCode(final char c) {
    for (final ChangeStatus s : ChangeStatus.values()) {
      if (s.code == c) {
        return s;
      }
    }
