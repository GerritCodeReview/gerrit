...
public abstract class DownloadCommand {
  ...
  /** @return name of the download command */
  public abstract String getName();

  /**
   * Returns the download command for the given download scheme and project.
   *
   * The returned download command can contain placeholders for the username
   * (<code>${username}</code>) and for a change ref (<code>${ref}</code>).
   *
