...
public interface WebLoginListener {
   ...
   */
  void afterLogin(ServletRequest request, HttpServletResponseRecorder response);
   ...
   */
  void afterLogout(ServletRequest request, HttpServletResponseRecorder response);
}
