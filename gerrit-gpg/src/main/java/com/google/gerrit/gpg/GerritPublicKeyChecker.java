...
public class GerritPublicKeyChecker extends PublicKeyChecker {
  ...
  private GerritPublicKeyChecker(Factory factory) {
     ...
     * <p>
     * If set, top-level key passed to {@link #check(PGPPublicKey)} must belong
     * to the given user. (Other keys checked in the course of verifying the
     * web of trust are checked against the set of identities in the database
