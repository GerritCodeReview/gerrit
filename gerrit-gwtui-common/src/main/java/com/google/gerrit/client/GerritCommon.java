...
public class GerritCommon {
  public static final GerritCommonConstants C =
      GWT.create(GerritCommonConstants.class);
  public static final GerritCommonResources RESOURCES =
      GWT.create(GerritCommonResources.class);

  static ServerInfo myServerInfo;
  static String xGerritAuth;
