...
public class AccountPreferencesInfo extends JavaScriptObject {
  ...
  public static AccountPreferencesInfo createDefault() {
    ...
    p.emailingOptionsStrategy(defaultPrefs.getEmailStrategy());
    return p;
  }
  ...
  public final EmailingStrategy emailingOptionsStrategy() {
    String s = emailingOptionsStrategyRaw();
    return s != null ? EmailingStrategy.valueOf(s) : null;
  }

  private final native String emailingOptionsStrategyRaw()
  /*-{ return this.emailing_options_strategy }-*/;
  ...
  public final void emailingOptionsStrategy(EmailingStrategy s) {
    emailingOptionsStrategyRaw(s != null ? s.toString() : null);
  }
  private final native void emailingOptionsStrategyRaw(String s)
  /*-{ this.emailing_options_strategy = s }-*/;
