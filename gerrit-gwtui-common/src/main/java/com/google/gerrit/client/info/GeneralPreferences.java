...
public class GeneralPreferences extends JavaScriptObject {
  ...
  public final native boolean polyGerritDesktopSiteOnMobile()
      /*-{ return this.polygerrit_desktop_site_on_mobile }-*/;
  ...
  public final native void polyGerritDesktopSiteOnMobile(boolean p) /*-{ this.polygerrit_desktop_site_on_mobile = p }-*/;
