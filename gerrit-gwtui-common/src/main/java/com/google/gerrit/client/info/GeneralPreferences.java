...
public class GeneralPreferences extends JavaScriptObject {
  ...
  private native String
      themeTableFontHeaderColor() /*-{ return this.theme_table_font_header_color }-*/;
  ...
  private native void themeTableHeaderFontColor(
      String b) /*-{ this.theme_table_header_font_color = b }-*/;
