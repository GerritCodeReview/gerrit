...
public class GeneralPreferences extends JavaScriptObject {
  ...
  public static GeneralPreferences createDefault() {
    ...
    p.showMyVotesInChangeTable(d.showMyVotesInChangeTable);
  ...
  public final native boolean showMyVotesInChangeTable()
  /*-{ return this.show_my_votes_in_change_table || false }-*/;
  ...
  public final native void showMyVotesInChangeTable(boolean d)
  /*-{ this.show_my_votes_in_change_table = d }-*/;
