...
public class Dispatcher {
  public static String toPatch(PatchSet.Id diffBase, PatchSet.Id revision, String fileName) {
    return toPatch("", diffBase, revision, fileName, null, 0);
  }

  public static String toPatch(
      PatchSet.Id diffBase, PatchSet.Id revision, String fileName, DisplaySide side, int line) {
  ...
  public static String toSideBySide(PatchSet.Id diffBase, PatchSet.Id revision, String fileName) {
    return toPatch("sidebyside", diffBase, revision, fileName, null, 0);
  }

  public static String toUnified(PatchSet.Id diffBase, PatchSet.Id revision, String fileName) {
  ...
  private static void change(final String token) {
    ...
    if (rest.isEmpty()) {
      ...
      Gerrit.display(
          token,
          panel == null ? new ChangeScreen(id, null, null, false, mode) : new NotFoundScreen());
      return;
    }
    ...
    GWT.runAsync(
        new AsyncSplit(token) {
          ...
          public void onSuccess() {
            Gerrit.display(token, new Unified(baseId, id.getParentKey(), id.get(), side, line));
          }
        });
  }
