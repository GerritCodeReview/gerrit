...
public class Gerrit implements EntryPoint {
  ...
  /*
  private void loadActions(HostPageData hpd, final String token) {
    if (hpd.pluginActions != null) {
      for (final PluginAction action : hpd.pluginActions) {
        pluginActions.add(action.name);
      }
    } else {
      pluginActions.add("Missing");
    }
  }
*/
