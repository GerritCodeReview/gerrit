...
public class RecentlyAccessed implements Serializable {
  ...
  private static final String RECENTLY_ACCESSED_KEY = "recently-accessed";
  ...
  private static RecentlyAccessed load() {
    ...
    if (storage != null) {
      final String s = storage.getItem(RECENTLY_ACCESSED_KEY);
  ...
  private void save() {
    ...
    if (storage != null) {
      ...
      storage.setItem(RECENTLY_ACCESSED_KEY, b.toString());
    }
  }
}
