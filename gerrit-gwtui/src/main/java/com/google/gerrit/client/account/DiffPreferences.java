...
public class DiffPreferences extends JavaScriptObject {
  public static DiffPreferences create(AccountDiffPreference in) {
    ...
    p.theme(in.getTheme());
    p.autoHideEmptyPane(in.isAutoHideEmptyPane());
    return p;
  }
  ...
  public final void copyTo(AccountDiffPreference p) {
    ...
    p.setTheme(theme());
    p.setAutoHideEmptyPane(autoHideEmptyPane());
  }
  ...
  public final native void autoHideEmptyPane(boolean a) /*-{ this.auto_hide_empty_pane = a }-*/;
  ...
  public final native boolean autoHideEmptyPane() /*-{ return this.auto_hide_empty_pane || false }-*/;
