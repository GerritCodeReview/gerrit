...
public class EditPreferences extends JavaScriptObject {
  public static EditPreferences create(EditPreferencesInfo in) {
    ...
    p.showTrailingSpace(in.showWhitespaceErrors);
    p.syntaxHighlighting(in.syntaxHighlighting);
    p.showLineNumbers(in.hideLineNumbers);
    p.theme(in.theme);
    return p;
  }
  ...
  public final void copyTo(EditPreferencesInfo p) {
    ...
    p.showLineNumbers = showLineNumbers();
    p.theme = theme();
  }
  ...
  public final native void showLineNumbers(boolean s) /*-{ this.show_line_numbers = s }-*/;
  ...
  public final native boolean showTrailingSpace() /*-{ return this.show_trailing_space }-*/;
  public final native boolean syntaxHighlighting() /*-{ return this.syntax_highlighting }-*/;
  public final native boolean showLineNumbers() /*-{ return this.show_line_numbers }-*/;
