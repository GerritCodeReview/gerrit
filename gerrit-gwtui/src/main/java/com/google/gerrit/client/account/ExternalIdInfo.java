...
public class ExternalIdInfo extends JavaScriptObject implements Comparable<ExternalIdInfo> {
  ...
  public static boolean isUsername(String identity) {
    return isScheme(identity, SCHEME_USERNAME);
  }

  public static String describe(String identity) {
  ...
  private static boolean isScheme(String id, String scheme) {
  ...
  @Override
  public int compareTo(ExternalIdInfo a) {
