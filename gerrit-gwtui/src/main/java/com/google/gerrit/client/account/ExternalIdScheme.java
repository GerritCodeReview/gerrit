...
public final class ExternalIdScheme {
  /**
   * Scheme used for {@link AuthType#LDAP},
   * {@link AuthType#CLIENT_SSL_CERT_LDAP},
  ...
  /**
   * Scheme for the username used to authenticate an account,
   * e.g. over SSH.
   */
  public static final String SCHEME_USERNAME = "username:";

  public static boolean isUsername(final String identity) {
    return isScheme(identity, SCHEME_USERNAME);
  }

  public static String describe(final String identity) {
  ...
  private static boolean isScheme(String id, final String scheme) {
