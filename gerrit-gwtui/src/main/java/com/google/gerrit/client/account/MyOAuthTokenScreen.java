...
public class MyOAuthTokenScreen extends SettingsScreen {
  ...
  protected void onLoad() {
    ...
    AccountApi.self().view("oauthtoken")
        .get(new ScreenLoadCallback<OAuthTokenInfo>(this) {
      @Override
      protected void preDisplay(OAuthTokenInfo tokenInfo) {
        display(tokenInfo);
      }
  ...
  private void display(final OAuthTokenInfo tokenInfo) {
    AccountApi.self().view("preferences")
        .get(new GerritCallback<AccountPreferencesInfo>() {
      @Override
      public void onSuccess(AccountPreferencesInfo prefs) {
        display(tokenInfo, prefs);
      }
    });
  }

  private void display(OAuthTokenInfo tokenInfo,
      AccountPreferencesInfo prefs) {
    if (tokenInfo != null) {
