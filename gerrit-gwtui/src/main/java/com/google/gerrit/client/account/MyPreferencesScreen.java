...
public class MyPreferencesScreen extends SettingsScreen {
  ...
  private CheckBox emailOnFirstPatchSetOfChange;
  ...
  protected void onInitUI() {
    ...
    emailOnFirstPatchSetOfChange = new CheckBox(Util.C.emailOnFirstPatchSetOfChange());
    emailOnFirstPatchSetOfChange.addClickHandler(onClickSave);
    ...
    formGrid.setText(row, labelIdx, "");
    formGrid.setWidget(row, fieldIdx, emailOnFirstPatchSetOfChange);
    row++;
  ...
  private void enable(final boolean on) {
    ...
    emailOnFirstPatchSetOfChange.setEnabled(on);
  ...
  private void display(final AccountGeneralPreferences p) {
    ...
    emailOnFirstPatchSetOfChange.setValue(p.isEmailOnFirstPatchSetOfChange());
  ...
  private void doSave() {
    ...
    p.setEmailOnFirstPatchSetOfChange(emailOnFirstPatchSetOfChange.getValue());
