...
public class MyPreferencesScreen extends SettingsScreen {
  ...
  protected void onInitUI() {
    ...
    emailingOptionsStrategy.addItem(Util.C.messageEnabled(),
        AccountGeneralPreferences.EmailingStrategy.ENABLED.name());
    emailingOptionsStrategy
        .addItem(
            Util.C.messageCCMeOnMyComments(),
            AccountGeneralPreferences.EmailingStrategy.CC_ON_OWN_COMMENTS
                .name());
    emailingOptionsStrategy
        .addItem(
            Util.C.messageDisabled(),
            AccountGeneralPreferences.EmailingStrategy.DISABLED
                .name());
  ...
  private void display(AccountPreferencesInfo p) {
    ...
    setListBox(emailingOptionsStrategy,
        AccountGeneralPreferences.EmailingStrategy.ENABLED,
  ...
  private void doSave() {
    ...
    p.emailingOptionsStrategy(getListBox(emailingOptionsStrategy,
        EmailingStrategy.ENABLED, EmailingStrategy.values()));
