...
public class MyPreferencesScreen extends SettingsScreen {
  ...
  protected void onInitUI() {
    ...
    preselectRevision.addItem(
        ...
        AccountGeneralPreferences.PreselectRevision.PRESELECT_BASE.name());
    preselectRevision.addItem(com.google.gerrit.client.changes.Util.C
        .PreselectDiffAgainstPreviousRevision(),
        AccountGeneralPreferences.PreselectRevision.PRESELECT_PREVIOUS_REVISION
            .name());
  ...
  private void display(final AccountGeneralPreferences p) {
    ...
    setListBox(preselectRevision,
        AccountGeneralPreferences.PreselectRevision.PRESELECT_BASE,
  ...
  private void doSave() {
    ...
    p.setPreselectRevision(getListBox(preselectRevision,
        AccountGeneralPreferences.PreselectRevision.PRESELECT_BASE,
        AccountGeneralPreferences.PreselectRevision.values()));
