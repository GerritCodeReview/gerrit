...
public class MyPreferencesScreen extends SettingsScreen {
  ...
  private CheckBox publishChangeOnPush;
  ...
  protected void onInitUI() {
    ...
    publishChangeOnPush = new CheckBox(Util.C.publishChangeOnPush());
    ...
    formGrid.setText(row, labelIdx, "");
    formGrid.setWidget(row, fieldIdx, publishChangeOnPush);
    row++;
    ...
    e.listenTo(publishChangeOnPush);
    e.listenTo(diffView);
  ...
  private void enable(final boolean on) {
    ...
    publishChangeOnPush.setEnabled(on);
  ...
  private void display(AccountPreferencesInfo p) {
    ...
    publishChangeOnPush.setValue(p.publishChangeOnPush());
  ...
  private void doSave() {
    ...
    p.publishChangeOnPush(publishChangeOnPush.getValue());
