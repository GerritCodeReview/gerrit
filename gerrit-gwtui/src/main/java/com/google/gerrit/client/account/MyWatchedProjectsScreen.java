...
import com.google.gerrit.client.ui.ProjectListPopup.ProjectListPopupOnOpenRowEvent;
...
public class MyWatchedProjectsScreen extends SettingsScreen implements
  ...
  protected void onInitUI() {
    ...
    projectListPopup
        .addProjectListPopupOnOpenRowHandler(new ProjectListPopup.ProjectListPopupOnOpenRowHandler() {
