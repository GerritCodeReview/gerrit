...
public class SshKeyInfo extends JavaScriptObject {
  public final native int id() /*-{ return this.id || 0; }-*/;
  ...
  public static native SshKeyInfo create(int id, String sshPublicKey,
      String encodedKey, String algorithm, String comment, boolean valid) /*-{
    return {'id': id, 'ssh_public_key': sshPublicKey, 'encoded_key': encodedKey, 'algorithm': algorithm, 'comment': comment, 'valid': valid};
  }-*/;
