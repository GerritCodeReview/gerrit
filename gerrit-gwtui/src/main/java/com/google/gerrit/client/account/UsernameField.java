...
class UsernameField extends Composite {
  ...
  private void doSetUserName() {
    ...
    AccountApi.setUsername("self", newName, new GerritCallback<NativeString>() {
      @Override
      public void onSuccess(NativeString result) {
        Gerrit.getUserAccount().setUserName(result.asString());
        userNameLbl.setText(result.asString());
