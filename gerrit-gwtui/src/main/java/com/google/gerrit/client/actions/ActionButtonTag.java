...
public class ActionButtonTag extends Button implements ClickHandler {
  ...
  public ActionButtonTag(Project.NameKey project, ActionInfo action) {
    this(project, null, null, null, null, action);
  }

  public ActionButtonTag(Project.NameKey project, TagInfo tag,
      ActionInfo action) {
    this(project, tag, null, null, null, action);
  }

  public ActionButtonTag(ChangeInfo change, ActionInfo action) {
    this(null, null, change, null, null, action);
  }

  public ActionButtonTag(ChangeInfo change, RevisionInfo revision,
      ActionInfo action) {
    this(null, null, change, null, revision, action);
  }

  private ActionButtonTag(Project.NameKey project, TagInfo tag,
