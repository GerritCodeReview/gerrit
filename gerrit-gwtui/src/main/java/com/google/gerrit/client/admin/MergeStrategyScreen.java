...
public class MergeStrategyScreen extends ProjectScreen {
  ...
  private Button cancelMergeStrategy;
  ...
  private void initEdit() {
    ...
    editMergeStrategy.addClickHandler(new ClickHandler() {
      ...
      public void onClick(ClickEvent event) {
        ...
        cancelMergeStrategy.setVisible(true);
    ...
    cancelMergeStrategy.setVisible(false);
    cancelMergeStrategy.addClickHandler(new ClickHandler() {
      @Override
      public void onClick(ClickEvent event) {
    ...
    editPanel.add(cancelMergeStrategy);
  ...
  void display(final ProjectMergeStrategies result) {
    ...
    mergeStrategies.display(result.getLocal());
