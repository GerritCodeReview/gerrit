...
public abstract class PaginatedProjectScreen extends ProjectScreen {
  protected int pageSize;
  protected String match;
  protected int start;

  public PaginatedProjectScreen(Project.NameKey toShow) {
    super(toShow);
  ...
  public abstract String getScreenToken();
