  ...
  protected void onInitUI() {
    ...
    projectNameTxtBox.addKeyUpHandler(new KeyUpHandler() {
      ...
      public void onKeyUp(KeyUpEvent event) {
        final String newProjectName = projectNameTxtBox.getText().trim();
        final String currentProjectName = getProjectKey().toString();
        renameButton.setEnabled(!newProjectName.isEmpty()
            && !currentProjectName.equals(newProjectName));
      }
    });
