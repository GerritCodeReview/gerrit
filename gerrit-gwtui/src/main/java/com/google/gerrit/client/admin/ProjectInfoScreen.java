...
public class ProjectInfoScreen extends ProjectScreen {
  ...
  private ListBox allNotInTarget;
  ...
  private void enableForm(boolean isOwner) {
    ...
    allNotInTarget.setEnabled(isOwner);
  ...
  private void initProjectOptions() {
    ...
    allNotInTarget = newInheritedBooleanBox();
    saveEnabler.listenTo(allNotInTarget);
    grid.add(Util.C.useAllNotInTarget(), allNotInTarget);
  ...
  void display(ConfigInfo result) {
    ...
    setBool(allNotInTarget, result.use_all_not_in_target());
  ...
  private void doSave() {
    ...
    ProjectApi.setConfig(getProjectKey(), descTxt.getText().trim(),
        ...
        getBool(signedOffBy), getBool(allNotInTarget), getBool(requireChangeID),
