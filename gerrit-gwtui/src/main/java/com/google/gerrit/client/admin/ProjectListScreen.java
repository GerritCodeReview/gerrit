    ...
    projects = new ProjectsTable() {
      ...
      protected void initColumnHeaders() {
        ...
        if (Gerrit.getGitwebLink() != null) {
          table.setText(0, ProjectsTable.C_PROJECT_REPO_BROWSER, Util.C.projectRepoBrowser());
          table.getFlexCellFormatter().
            addStyleName(0, ProjectsTable.C_PROJECT_REPO_BROWSER, Gerrit.RESOURCES.css().dataHeader());
        }
      }
      ...
      protected void insert(int row, ProjectInfo k) {
        ...
        if (Gerrit.getGitwebLink() != null) {
          table.getFlexCellFormatter().
            addStyleName(row, ProjectsTable.C_PROJECT_REPO_BROWSER, Gerrit.RESOURCES.css().dataCell());
        }
      }
      ...
      protected void populate(final int row, final ProjectInfo k) {
        ...
        if (l != null) {
          table.setWidget(row, ProjectsTable.C_PROJECT_REPO_BROWSER, new Anchor(l.getLinkName(), false, l.toProject(k
              .name_key())));
        }
