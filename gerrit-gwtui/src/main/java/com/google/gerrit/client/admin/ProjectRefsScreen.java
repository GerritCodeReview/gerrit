...
public abstract class ProjectRefsScreen extends ProjectScreen {
  protected int pageSize;
  protected String match;
  protected int start;

  protected abstract String getToken(Project.NameKey key);

  public ProjectRefsScreen(Project.NameKey toShow) {
    super(toShow);
    pageSize = Gerrit.getUserPreferences().changesPerPage();
  }

  protected String getTokenForScreen(String filter, int skip) {
    String token = getToken(getProjectKey());
