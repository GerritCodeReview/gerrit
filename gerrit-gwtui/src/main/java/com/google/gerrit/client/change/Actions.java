...
class Actions extends Composite {
  ...
  @UiField Button deleteDraftChange;
  @UiField Button deleteDraftPatchSet;
  ...
  private void initChangeActions(ChangeInfo info, boolean hasUser) {
    ...
    if (hasUser) {
      ...
      a2b(actions, "delete", deleteDraftChange);
  ...
  private void initRevisionActions(ChangeInfo info, RevisionInfo revInfo,
    ...
    if (hasUser) {
      ...
      a2b(actions, "delete", deleteDraftPatchSet);
  ...
  @UiHandler("deleteDraftPatchSet")
  void onDeleteDraftPatchSet(ClickEvent e) {
    DraftActions.delete(changeId, revision);
  }

  @UiHandler("deleteDraftChange")
  void onDeleteDraftChange(ClickEvent e) {
