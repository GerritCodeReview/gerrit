...
public class ChangeActions {
  ...
  static void publish(
    ...
    ChangeApi.publish(
        id.get(), Project.NameKey.asStringOrNull(project), revision, cs(project, id, draftButtons));
  }
  ...
  static void markPrivate(@Nullable Project.NameKey project, Change.Id id, Button... draftButtons) {
    ChangeApi.markPrivate(
        id.get(), Project.NameKey.asStringOrNull(project), cs(project, id, draftButtons));
  }
