...
import static com.google.gerrit.common.RevisionUtil.toParentNo;
...
public class ChangeScreen extends Screen {
  ...
  private RevisionInfo resolveRevisionOrPatchSetId(ChangeInfo info,
    ...
    if (revOrId == null) {
      ...
      int parentNo = toParentNo(number);
