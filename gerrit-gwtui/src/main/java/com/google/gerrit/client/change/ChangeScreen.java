...
import com.google.gerrit.client.change.FileTable.Mode;
...
public class ChangeScreen extends Screen {
  ...
  void onPublishEdit(@SuppressWarnings("unused") ClickEvent e) {
    EditActions.publishEdit(
        changeInfo.projectNameKey(), changeId, publishEdit, rebaseEdit, deleteEdit);
  }

  @UiHandler("rebaseEdit")
  void onRebaseEdit(@SuppressWarnings("unused") ClickEvent e) {
    EditActions.rebaseEdit(
        changeInfo.projectNameKey(), changeId, publishEdit, rebaseEdit, deleteEdit);
  }
  ...
  void onPublish(@SuppressWarnings("unused") ClickEvent e) {
    ChangeActions.publish(changeInfo.projectNameKey(), changeId, revision, publish, deleteRevision);
  }
  ...
  void onDeleteRevision(@SuppressWarnings("unused") ClickEvent e) {
    if (Window.confirm(Resources.C.deleteDraftRevision())) {
      ChangeActions.delete(
          changeInfo.projectNameKey(), changeId, revision, publish, deleteRevision);
    }
  }
