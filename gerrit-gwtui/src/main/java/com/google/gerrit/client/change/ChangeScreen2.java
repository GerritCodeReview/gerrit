...
public class ChangeScreen2 extends Screen {
  ...
  private void loadConfigInfo(final ChangeInfo info, String base) {
    ...
    if (preselectRevision == PreselectDiffAgainst.PRIOR_REVISION_ME_LAST_COMMENTED_ON
        && last != null
  ...
  private void renderDiffBaseListBox(ChangeInfo info) {
    ...
    for (int i = list.length() - 1; i >= 0; i--) {
      ...
      if (basename1 != null
          && preselectRevision == PreselectDiffAgainst.PRIOR_REVISION_ME_LAST_COMMENTED_ON
