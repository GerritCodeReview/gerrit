...
//              }
  ...
  public static class PutInput extends JavaScriptObject {
    public static PutInput create(String hashtag) {
      PutInput input = createObject().cast();
      input.init(hashtag);
      return input;
    }
  ...
  public static class PutResult extends JavaScriptObject {
