...
public class LocalComments {
  ...
  private static class InlineComment {
    ...
    InlineComment(PatchSet.Id psId, @Nullable Project.NameKey project, CommentInfo commentInfo) {
      this.psId = psId;
  ...
  public LocalComments(Change.Id changeId, @Nullable Project.NameKey project) {
  ...
  public LocalComments(PatchSet.Id psId, @Nullable Project.NameKey project) {
  ...
  private static InlineComment getInlineComment(String key) {
    ...
    InlineComment inlineComment = new InlineComment(psId, id.project, info);
