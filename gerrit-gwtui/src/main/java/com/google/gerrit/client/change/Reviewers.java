...
class Reviewers extends Composite {
  ...
  // TODO(davido): move to REST API Oracle
  ...
  Reviewers() {
    ...
    // TODO(davido): HintTextBox swallows escape event,
    // but we want to close the form on escape here.
    // Use NpTextBox for now.
  ...
  void init(Style style, KeyCommandSet keysAction) {
    this.style = style;
  ...
  // TODO(davido): stolen from ChangeScreen2
