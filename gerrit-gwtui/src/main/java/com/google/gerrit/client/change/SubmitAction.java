...
class SubmitAction {
  static void call(JsArray<ChangeAndCommit> sameTopicChanges,
      JsArray<ChangeAndCommit> relatedBrancahChanges,
    ...
    new SubmitDialog(changeInfo, sameTopicChanges, relatedBrancahChanges,
        new SubmitDialog.Handler() {
          @Override
          public void onWithParentsSubmit() {
            call(changeInfo, revisionInfo, false);
          }

          @Override
          public void onWithTopicSubmit() {
            call(changeInfo, revisionInfo, true);
          }
        }).center();
  }
