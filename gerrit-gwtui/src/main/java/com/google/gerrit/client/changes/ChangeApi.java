...
public class ChangeApi {
  ...
  public static void deleteDraftChange(int id, AsyncCallback<JavaScriptObject> cb) {
    call(id, "delete").post(JavaScriptObject.createObject(), cb);
  }

  /** Delete a specific draft patch set. */
  public static void deleteDraftPatchSet(int id, String commit, AsyncCallback<JavaScriptObject> cb) {
    call(id, commit, "delete").post(JavaScriptObject.createObject(), cb);
  }
