...
public class ChangeInfo extends JavaScriptObject {
  ...
  public static class RevisionInfo extends JavaScriptObject {
    ...
    public final native boolean edit() /*-{ return this.edit || false; }-*/;
    ...
    public static void sortRevisionInfoByNumber(JsArray<RevisionInfo> list) {
      Collections.sort(Natives.asList(list), new Comparator<RevisionInfo>() {
        ...
        public int compare(RevisionInfo a, RevisionInfo b) {
          ...
          // TODO(davido): uncomment this the day GWT supports JDK 7
          //return Boolean.compare(a.edit(), b.edit());
          return Boolean.valueOf(a.edit())
              .compareTo(Boolean.valueOf(b.edit()));
        }
      });
    }

    public final String id() {
      String id = String.valueOf(_number());
      if (edit()) {
        id += "+";
      }
      return id;
