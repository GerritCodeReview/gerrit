...
import com.google.gerrit.client.changes.ChangeTable2.ApprovalViewType;
...
public abstract class PagedSingleListScreen extends Screen {
  ...
  protected void onInitUI() {
    ...
    section = new ChangeTable2.Section(null, ApprovalViewType.STRONGEST, null);
