...
class PatchSetComplexDisclosurePanel extends ComplexDisclosurePanel implements OpenHandler<DisclosurePanel> {
  ...
  public abstract class ActionDialog extends CommentedActionDialog<ChangeDetail> {
    final FocusWidget enableOnFailure;
    final boolean redirect;

    public ActionDialog(FocusWidget enableOnFailure, boolean redirect,
        String dialogTitle, String dialogHeading) {
      super(dialogTitle, dialogHeading);
      this.enableOnFailure = enableOnFailure;
      this.redirect = redirect;
    }

    public AsyncCallback<ChangeDetail> createCallback() {
