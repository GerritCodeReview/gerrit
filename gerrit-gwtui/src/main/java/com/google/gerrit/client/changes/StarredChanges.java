...
public class StarredChanges {
  ...
  private static void start() {
    ...
    StarredChangesInfo in = StarredChangesInfo.create(req);
  ...
  static class StarredChangesInfo extends JavaScriptObject {
    ...
    static StarredChangesInfo create(ToggleStarRequest r) {
      StarredChangesInfo m = createObject().cast();
      m.init0();
      if (r.getAddSet() != null) {
