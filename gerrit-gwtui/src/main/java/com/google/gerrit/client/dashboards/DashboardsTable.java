...
public class DashboardsTable extends NavigationTable<DashboardInfo> {
  public DashboardsTable() {
    keysNavigation.add(new PrevKeyCommand(0, 'k', Util.C.dashboardListPrev()));
    keysNavigation.add(new NextKeyCommand(0, 'j', Util.C.dashboardListNext()));
    keysNavigation.add(new OpenKeyCommand(0, 'o', Util.C.dashboardListOpen()));
    keysNavigation.add(new OpenKeyCommand(0, KeyCodes.KEY_ENTER,
                                                  Util.C.dashboardListOpen()));
    initColumnHeaders();
  }
