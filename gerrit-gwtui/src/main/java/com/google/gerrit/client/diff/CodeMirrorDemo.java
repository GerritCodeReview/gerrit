...
public class CodeMirrorDemo extends Screen {
  ...
  private void registerCmEvents(CodeMirror cm) {
    ...
    CodeMirror.disableUnwantedKey("vim", "A");
    CodeMirror.disableUnwantedKey("vim", "C");
    CodeMirror.disableUnwantedKey("vim", "D");
    CodeMirror.disableUnwantedKey("vim", "I");
    CodeMirror.disableUnwantedKey("vim", "O");
    CodeMirror.disableUnwantedKey("vim", "P");
    CodeMirror.disableUnwantedKey("vim", "R");
    CodeMirror.disableUnwantedKey("vim", "S");
    CodeMirror.disableUnwantedKey("vim", "U");
    CodeMirror.disableUnwantedKey("vim", "X");
    CodeMirror.disableUnwantedKey("vim", "Y");
    CodeMirror.disableUnwantedKey("vim", "~");
  }
  ...
  private int getCursorLine(CodeMirror cm) {
    int line = cm.getCursor().getLine();
    LineHandle handle = cm.getLineHandle(line);
