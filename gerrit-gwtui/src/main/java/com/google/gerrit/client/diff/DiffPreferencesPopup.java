...
KeyPressHandler, KeyDownHandler {
  ...
  public DiffPreferencesPopup(ListenableAccountDiffPreference prefs) {
    ...
    content.setWidget(2, 0, lbContext = new Label(DiffConstants.I.context()));
    content.setWidget(2, 1, context = new ListBox());
    content.setWidget(3, 0, lbSyntaxHighlighting = new Label(DiffConstants.I.syntaxHighlighting()));
    content.setWidget(3, 1, syntaxHighlighting = new CheckBox());
    content.setWidget(4, 0, lbIntralineDifference = new Label(DiffConstants.I.intralineDifference()));
    content.setWidget(4, 1, intralineDifference = new CheckBox());
    content.setWidget(5, 0, lbWhitespaceErrors = new Label(DiffConstants.I.whitespaceErrors()));
    content.setWidget(5, 1, whitespaceErrors = new CheckBox());
    content.setWidget(6, 0, lbShowTabs = new Label(DiffConstants.I.showTabs()));
    content.setWidget(6, 1, showTabs = new CheckBox());
    content.setWidget(7, 0, lbExpandAllComments = new Label(DiffConstants.I.expandAllComments()));
    content.setWidget(7, 1, expandAllComments = new CheckBox());
    content.setWidget(8, 0, update = new Button("Update"));
    content.setWidget(8, 1, save = new Button("Save"));
    body.add(content);
