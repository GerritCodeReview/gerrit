  ...
  public void registerKeys() {
    ...
    if (Gerrit.isSignedIn()) {
      ...
      keysAction.add(new KeyCommand(KeyCommand.M_CTRL | KeyCommand.M_ALT,
          KeyCodes.KEY_E, 'e', Gerrit.C.keyEditor()) {
        @Override
        public void onKeyPress(KeyPressEvent event) {
        }
    ...
    keysAction.add(new KeyCommand(KeyCommand.M_SHIFT, KeyCodes.KEY_M, 'm',
        PatchUtil.C.markAsReviewedAndGoToNext()) {
      @Override
      public void onKeyPress(KeyPressEvent event) {
    ...
    keysAction.add(new KeyCommand(KeyCommand.M_SHIFT, KeyCodes.KEY_F, 'f',
