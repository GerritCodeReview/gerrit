...
abstract class DiffTable extends Composite {
  ...
  private void addInlineImage(String srcUrl, Element parent, boolean modified) {
    ...
    // TODO: Unified view style is not good. The images should have a margin between
    // themselves and the user should be able to scroll to see the full images. The
    // latter issue also affects side-by-side view when the images are too high. One
    // approach would be displaying the images side-by-side in both modes and making
    // sure their heights are less than the viewport.
