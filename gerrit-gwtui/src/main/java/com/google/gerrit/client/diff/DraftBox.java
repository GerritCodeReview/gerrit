...
class DraftBox extends CommentBox implements HasMouseMoveHandlers {
  ...
  private HandlerRegistration regMouseMove;
  ...
  protected void onLoad() {
    ...
    regMouseMove = addMouseMoveHandler(new MouseMoveHandler() {
      @Override
