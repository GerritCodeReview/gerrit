...
class UnifiedDiffTable2 extends DiffTable {
  interface Binder extends UiBinder<HTMLPanel, UnifiedDiffTable2> {}
  private static Binder uiBinder = GWT.create(Binder.class);

  interface UnifiedStyle extends CssResource {
  ...
  @Override
  int getHeaderHeight() {
    return 2 * fileCommentRow.getOffsetHeight() +
        2 * patchSetSelectBoxA.getOffsetHeight();
  }
}
