...
public class EditScreen extends Screen {
  ...
  private Runnable gotoLine() {
    return new Runnable() {
      @Override
      public void run() {
        String n = Window.prompt(EditConstants.I.gotoLineNumber(), "0");
        if (n != null) {
          try {
            ...
            // We don't want to popup another dialog just to say
            // "The number you havepovided is invalid, try again"
          }
        }
      }
    };
