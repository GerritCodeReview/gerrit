...
public class ProjectApi {
  ...
  public static void setConfig(Project.NameKey name, String description,
    ...
    in.setUseAllNotInTarget(useAllNotInTarget);
  ...
  private static class ConfigInput extends JavaScriptObject {
    ...
    final void setUseAllNotInTarget(InheritableBoolean v) {
      setUseAllNotInTargetRaw(v.name());
    }
    private final native void setUseAllNotInTargetRaw(String v)
    /*-{ if(v)this.use_all_not_in_target=v; }-*/;
