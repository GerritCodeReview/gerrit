...
public class ProjectApi {
  private static class ProjectInput extends JavaScriptObject {
    ...
    final native void setProjectName(String n) /*-{ if(n)this.project_name=n; }-*/;
    ...
    final native void setCreateEmptyCcommit(boolean cc) /*-{ if(cc)this.create_empty_commit=cc; }-*/;
  }
