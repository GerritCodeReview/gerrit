 ...
 * processing it.
 * <p>
 * In the event of an unchecked exception during {@code onSuccess}, all
 * {@code onSuccess} methods are still called, and the <em>first</em> caught
 * exception will be rethrown from the <em>last</em> {@code onSuccess} method.
 */
