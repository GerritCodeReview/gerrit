...
public class BranchLink extends InlineHyperlink {
  ...
  public BranchLink(Project.NameKey project, ChangeStatus status,
      String branch, String topic) {
    this(text(branch, topic), query(project, status, branch, topic));
  }

  public BranchLink(String text, Project.NameKey project, ChangeStatus status,
      String branch, String topic) {
  ...
  public static String query(Project.NameKey project, ChangeStatus status,
      String branch, String topic) {
