...
import com.google.gwtexpui.globalkey.client.NpFlowPanel;
...
public abstract class CodeMirrorActionDialog<T> extends AutoCenterDialogBox
  ...
  public CodeMirrorActionDialog(final String title, final String heading,
    ...
    CodeMirror.initLibrary(new CallbackGroup().add(CallbackGroup
        .<Void> emptyCallback()));
    final NpFlowPanel mwrap = new NpFlowPanel();
