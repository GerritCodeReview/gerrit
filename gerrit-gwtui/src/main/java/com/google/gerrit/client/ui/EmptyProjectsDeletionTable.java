...
public class EmptyProjectsDeletionTable extends NavigationTable<ProjectData> {
  private CheckBox cbSelectAll;
  private ValueChangeListener valueChangeListener;

  public EmptyProjectsDeletionTable() {
  ...
  private void populateSelectAllRow() {
    ...
    cbSelectAll.addValueChangeHandler(new ValueChangeHandler<Boolean>() {
      ...
      public void onValueChange(ValueChangeEvent<Boolean> event) {
        changeAllProjectsSelection(event.getValue(), true);
      }
    });
  ...
  public void resetSelectAllRow() {
    if (cbSelectAll.getValue() == true) {
