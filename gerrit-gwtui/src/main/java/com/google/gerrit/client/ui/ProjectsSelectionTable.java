...
public class ProjectsSelectionTable extends ProjectsTable {
  ...
  protected void populate(final int row, final ProjectData k) {
    ...
    if (!k.getNameKey().equals(Gerrit.getConfig().getWildProject())) {
      ...
      cb.addValueChangeHandler(new ValueChangeHandler<Boolean>() {
        ...
        public void onValueChange(ValueChangeEvent<Boolean> event) {
          handlerManager.fireEvent(new CheckBoxSelectionEvent(event.getValue(), k.getName()));
        }
      });
    ...
    if (k.getParentNameKey() != null) {
      table.setWidget(row, 4, new Hyperlink(k.getParentNameKey().get(), link(k.getParentNameKey())));
    }
  ...
  public void populateSelectAllRow() {
    ...
    cbSelectAll.addValueChangeHandler(new ValueChangeHandler<Boolean>() {
      ...
      public void onValueChange(ValueChangeEvent<Boolean> event) {
        ...
        handlerManager.fireEvent(new ChangeAllCheckBoxSelectionEvent(event.getValue()));
      }
    });
  ...
  public void addChangeAllCheckBoxSelectionHandler(ChangeAllCheckBoxSelectionHandler handler) {
    handlerManager.addHandler(ChangeAllCheckBoxSelectionEvent.getType(), handler);
  }
