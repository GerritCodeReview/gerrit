...
public interface Modes extends ClientBundle {
  ...
  @Source("idl.dl") @DoNotEmbed DataResource idl();
  @Source("jade.dl") @DoNotEmbed DataResource jade();
  ...
  @Source("ttfn-cfg.js") @DoNotEmbed DataResource ttcn_cfg();
  ...
  @Source("yaml-formatter.js") @DoNotEmbed DataResource yaml_formatter();
