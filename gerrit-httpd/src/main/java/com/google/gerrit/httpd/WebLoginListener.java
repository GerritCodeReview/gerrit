...
public interface WebLoginListener {
   ...
   */
  void onLogin(int userId, HttpServletRequest request, HttpServletResponse response);
   ...
   */
  void onLogout(int userId, HttpServletRequest request, HttpServletResponse response);
}
