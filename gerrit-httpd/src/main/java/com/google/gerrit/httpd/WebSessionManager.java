...
public class WebSessionManager {
  ...
  Val createVal(Key key, Account.Id who, boolean remember,
      ExternalId.Key lastLogin, String sid, String auth) {
  ...
  public static final class Val implements Serializable {
    ...
    Val(Account.Id accountId, long refreshCookieAt, boolean persistentCookie,
        ExternalId.Key externalId, long expiresAt, String sessionId,
        String auth) {
