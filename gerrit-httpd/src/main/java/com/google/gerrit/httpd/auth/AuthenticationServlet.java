...
public class AuthenticationServlet extends HttpServlet {
  ...
  private Account.Id create(ReviewDb db, AuthUser user) throws OrmException, ConfigInvalidException, IOException {
    ...
    if (username != null) {
      extIds.add(ExternalId.createUsername(username, id, null)); //TODO(dpursehouse) OK to use null password?
    }
    if (email != null) {
