...
public class BasicHttpAuthProtocolHandler implements HttpAuthProtocolHandler {
    ...
    try {
      usernamePassword =
          new String(
              ...
              MoreObjects.firstNonNull(req.getCharacterEncoding(), "UTF-8"));
  ...
  @Override
  public HttpAuthRequest handleAnonymous(HttpServletRequest req, HttpServletResponse resp) {
  ...
  private static class Response extends HttpServletResponseWrapper {
    ...
    @SuppressWarnings("deprecation") //TODO(dpursehouse) do we need this method?
    @Override
