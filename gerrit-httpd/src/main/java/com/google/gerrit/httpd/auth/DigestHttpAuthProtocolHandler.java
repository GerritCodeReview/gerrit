 ...
 */
@Singleton
public class DigestHttpAuthProtocolHandler implements HttpAuthProtocolHandler {
  ...
  public HttpAuthRequest handleAnonymous(HttpServletRequest req,
    ...
    return new HttpAuthRequest(null, null, req, new Response(req, resp));
  }
  ...
  public HttpAuthRequest handle(HttpServletRequest req, HttpServletResponse resp)
    ...
    if (user == null //
      ...
      new Response(req, resp).status(HttpServletResponse.SC_UNAUTHORIZED);
      ...
      public void checkCredentials(Object credentials) throws AuthException {
        ...
        try {
          if (tokens.checkToken(nonce, "") == null) {
            ((Response) getResponse()).stale = true;
