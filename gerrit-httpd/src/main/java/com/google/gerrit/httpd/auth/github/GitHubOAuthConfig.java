...
class GitHubOAuthConfig {
  ...
  GitHubOAuthConfig(@GerritServerConfig Config config, AuthConfig authConfig)
    ...
    gitHubUrl = trimTrailingSlash(Preconditions.checkNotNull(
        config.getString(CONF_SECTION, null, "url"),
        "GitHub `url` must be povided"));
    gitHubApiUrl = trimTrailingSlash(Preconditions.checkNotNull(
        config.getString(CONF_SECTION, null, "apiUrl"),
        "GitHub `apiUrl` must be provided"));
