...
public class OAuthWebFilter implements Filter {
  ...
  private final Provider<OAuthProtocol> oauthProvider;

  @Inject
  public OAuthWebFilter(GitHubOAuthConfig config, Provider<OAuthProtocol> oauthProtocol,
      Provider<GitHubLogin> loginProvider,
      Provider<CurrentUser> currentUserProvider) {
    this.config = config;
    this.oauthProvider = oauthProtocol;
  ...
  public void doFilter(ServletRequest request, ServletResponse response,
    ...
    if (oauthProvider.get().isOAuthRequest(httpRequest) && !ghLogin.isLoggedIn()) {
