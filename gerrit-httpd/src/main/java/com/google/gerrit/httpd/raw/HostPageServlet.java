...
public class HostPageServlet extends HttpServlet {
  ...
  private final DynamicSet<RegisteredWebUiPlugin> webUiPlugins;
  ...
  HostPageServlet(final Provider<CurrentUser> cu, final Provider<WebSession> w,
      ...
      final DynamicSet<RegisteredWebUiPlugin> webUiPlugins)
  ...
  private String[] getPluginUrls() {
    ...
    for (RegisteredWebUiPlugin plugin : webUiPlugins) {
  ...
  private class Page {
    ...
    Page() throws IOException {
      ...
      pageData.plugnisUrls =getPluginUrls();
