...
public class IndexServlet extends HttpServlet {
  ...
  protected static String computeCanonicalPath(final String canonicalURL) throws URISyntaxException {
  ...
  protected static SoyMapData getTemplateData(final String canonicalURL, final String cdnPath)
