...
public class IndexServlet extends HttpServlet {
  ...
  IndexServlet(String canonicalURL, @Nullable String cdnPath, @Nullable String staticVersion) throws URISyntaxException {
    ...
    SoyTofu.Renderer renderer =
        builder
            ...
            .setData(getTemplateData(canonicalURL, cdnPath, staticVersion));
  ...
  static SoyMapData getTemplateData(String canonicalURL, String cdnPath, String staticVersion) throws URISyntaxException {
