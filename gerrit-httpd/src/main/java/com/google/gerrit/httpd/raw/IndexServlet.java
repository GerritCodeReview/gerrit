...
public class IndexServlet extends HttpServlet {
  protected final String canonicalURL;
  protected final String cdnPath;
  protected final String indexSource;

  IndexServlet(final String canonicalURL, @Nullable String cdnPath)
  ...
  protected String render() throws ServletException {
  ...
  protected String computeCanonicalPath() throws ServletException {
  ...
  protected SoyMapData getTemplateData() throws ServletException {
    String canonicalPath = computeCanonicalPath();
