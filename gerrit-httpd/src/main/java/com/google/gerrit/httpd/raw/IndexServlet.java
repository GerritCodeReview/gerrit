...
public class IndexServlet extends HttpServlet {
  ...
  IndexServlet(String canonicalURL, @Nullable String cdnPath, @Nullable String version) throws URISyntaxException {
  ...
  static SoyMapData getTemplateData(String canonicalURL, String cdnPath, String version) throws URISyntaxException {
