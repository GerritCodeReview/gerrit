...
public class IndexServlet extends HttpServlet {
  ...
  IndexServlet(String canonicalURL, @Nullable String cdnPath, @Nullable String faviconURL)
    ...
    SoyTofu.Renderer renderer =
      ...
      .setData(getTemplateData(canonicalURL, cdnPath, faviconURL));
  ...
  static SoyMapData getTemplateData(String canonicalURL, String cdnPath, String faviconURL)
      throws URISyntaxException {
