...
public class ProjectDocLoader extends CacheLoader<ProjectDocResourceKey, Resource> {
  ...
  ProjectDocLoader(GitRepositoryManager repoManager,
    ...
    this.webUrl = webUrl;
    this.suppressHtml = cfg.getBoolean("site", "suppressHtml", false);
  ...
  private Policy loadPolicy(SitePaths sitePaths, Config cfg)
    ...
    return AntiSamyPolicy.CUSTOM.equals(policy)
        ...
        : Policy.getInstance(getClass().getResourceAsStream(
