...
public class RestApiServlet extends HttpServlet {
  ...
  public static final String ATTRIBUTE_ERROR_TRACE =
      RestApiServlet.class.getName() + "/ErrorTraceThrowable";
  ...
  public static void replyError(HttpServletRequest req, HttpServletResponse res,
    ...
    replyError(req, res, statusCode, msg, CacheControl.NONE, null);
  }
