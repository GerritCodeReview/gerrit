...
public class RestApiServlet extends HttpServlet {
  ...
  protected final void service(HttpServletRequest req, HttpServletResponse res)
    ...
    Object inputRequestPayload = null;
    ...
    try {
      ...
      if (view instanceof RestModifyView<?, ?>) {
        ...
        inputRequestPayload = parseRequest(req, m.inputType());
        result = m.apply(rsrc, inputRequestPayload);
      ...
      globals.auditService.dispatch(new HttpAuditEvent(globals.webSession.get()
          ...
          auditStartTs, params, req.getMethod(), inputRequestPayload, status,
          result));
    }
  }
