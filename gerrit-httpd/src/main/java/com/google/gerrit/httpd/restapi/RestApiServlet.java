...
public class RestApiServlet extends HttpServlet {
  ...
  public static final String XD_AUTHORIZATION = "$a";
  public static final String XD_CONTENT_TYPE = "$ct";
  public static final String XD_METHOD = "$m";
  public static final String XD_X_GERRIT_AUTH = "$xga";
  ...
  protected final void service(HttpServletRequest req, HttpServletResponse res)
    ...
    try {
      ...
      checkCors(req, res, !qp.xd.isEmpty());
      if (!qp.xd.isEmpty()) {
        req = applyXdOverrides(req, qp.xd);
      }
