...
final class GerritJsonServlet extends JsonServlet<GerritJsonServlet.GerritCall> {
  ...
  private final Gson auditGson = gerritAuditGsonBuilder();
  ...
  private static Gson gerritAuditGsonBuilder() {
    final Gson gson =
        gerritDefaultGsonBuilder().setDateFormat(DateFormat.LONG)
  ...
  protected void service(final HttpServletRequest req,
    ...
    try {
      ...
      try {
        ...
        log.warn("Error occurred during audit event dispatch",
            ignoreExceptionWhileLogging);
      } finally {
    ...
    try {
      ...
      if (note != null) {
        ...
        final List<Object> args =
            extractParams(note, call, auditGson);
