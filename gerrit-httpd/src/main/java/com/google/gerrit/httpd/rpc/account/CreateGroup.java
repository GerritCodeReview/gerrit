...
class CreateGroup extends Handler<AccountGroup.Id> {
  ...
  private final PerformCreateGroupImpl.Factory performCreateGroupFactory;
  private final IdentifiedUser user;
  private final String groupName;

  @Inject
  CreateGroup(final PerformCreateGroupImpl.Factory performCreateGroupFactory,
  ...
  public AccountGroup.Id call() throws OrmException, NameAlreadyUsedException {
    PerformCreateGroup performCreateGroup = performCreateGroupFactory.create();
