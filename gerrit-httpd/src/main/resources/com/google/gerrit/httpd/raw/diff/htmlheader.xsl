...
<xsl:template match="/">
   <html>
      ...
      <body>
        <script src="/static/daisydiff/js/tooltip/wz_tooltip.js" type="text/javascript"></script>
        <script src="/static/daisydiff/js/tooltip/tip_balloon.js" type="text/javascript"></script>
        <script src="/static/daisydiff/js/dojo/dojo.js" type="text/javascript"></script>
        <script src="/static/daisydiff/js/diff.js" type="text/javascript"></script>
