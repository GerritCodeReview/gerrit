...
public class IndexServletTest {
  class TestIndexServlet extends IndexServlet {
    ...
    TestIndexServlet(String canonicalURL, String cdnPath, Boolean mobileDesktopSite) throws URISyntaxException {
      super(canonicalURL, cdnPath, false);
    }
  ...
  public void noPathAndNoCDN() throws URISyntaxException {
    SoyMapData data = IndexServlet.getTemplateData("http://example.com/", null, false);
  ...
  public void pathAndNoCDN() throws URISyntaxException {
    SoyMapData data = IndexServlet.getTemplateData("http://example.com/gerrit/", null, false);
  ...
  public void noPathAndCDN() throws URISyntaxException {
    SoyMapData data =
        IndexServlet.getTemplateData("http://example.com/", "http://my-cdn.com/foo/bar/", false);
    assertThat(data.getSingle("canonicalPath").stringValue()).isEqualTo("");
  ...
  public void pathAndCDN() throws URISyntaxException {
    SoyMapData data =
        IndexServlet.getTemplateData("http://example.com/gerrit", "http://my-cdn.com/foo/bar/", false);
    assertThat(data.getSingle("canonicalPath").stringValue()).isEqualTo("/gerrit");
    assertThat(data.getSingle("staticResourcePath").stringValue())
        .isEqualTo("http://my-cdn.com/foo/bar/");
  }
  ...
  public void renderTemplate() throws URISyntaxException {
    ...
    TestIndexServlet servlet = new TestIndexServlet(testCanonicalUrl, testCdnPath, false);
