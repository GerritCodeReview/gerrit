...
public class ApprovalCategoryConstraintsConfigTest {
  ...
  static private ApprovalCategory.Id TEST_CATEGORY = new ApprovalCategory.Id("TEST");
  ...
  public void refOnly() throws InvalidConstraintException {
    check("refs/heads/master", "refs/heads/master", Short.MIN_VALUE,
        Short.MAX_VALUE);
  }
  ...
  static private Allow parseAllow(String value, ApprovalCategory.Id categoryId)
    ...
    try {
      Method m =
          ApprovalCategoryConstraintsConfig.class.getDeclaredMethod(
              "parseAllow", String.class, ApprovalCategory.Id.class);
      m.setAccessible(true);
      return (Allow) m.invoke(null, value, categoryId);
