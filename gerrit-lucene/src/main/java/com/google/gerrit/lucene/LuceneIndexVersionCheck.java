...
public class LuceneIndexVersionCheck implements LifecycleListener {
  ...
  public static File gerritIndexConfig(SitePaths sitePaths) {
    return new File(sitePaths.index_dir, "gerrit_lucene_index.config");
  }

  private final SitePaths sitePaths;

  @Inject
  LuceneIndexVersionCheck(SitePaths sitePaths) {
