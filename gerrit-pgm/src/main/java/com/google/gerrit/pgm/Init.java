  ...
  private SiteInit createSiteInit() {
    ...
    m.add(new AbstractModule() {
      ...
      protected void configure() {
        ...
        List<String> plugins = Optional.fromNullable(installPlugins).or(Lists.<String> newArrayList());
        bind(new TypeLiteral<List<String>>() {}).annotatedWith(InstallPlugins.class).toInstance(plugins);
      }
    });
