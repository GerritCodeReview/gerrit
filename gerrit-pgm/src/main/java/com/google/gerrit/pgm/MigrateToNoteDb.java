...
public class MigrateToNoteDb extends SiteProgram {
  ...
  @Option(
      name = "--project",
      usage =
          "Only rebuild these projects, do no other migration; incompatible with --change and --skip-project;"
  ...
  @Option(
      name = "--change",
      usage =
          "Only rebuild these changes, do no other migration; incompatible with --project and --skip-project;"
              + " recommended for debugging only")
