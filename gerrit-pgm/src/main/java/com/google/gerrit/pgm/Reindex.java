  ...
  private Injector createSysInjector() {
    ...
    modules.add(new FactoryModule() {
      ...
      protected void configure() {
        ...
        // reindexing isn't creating any new patch sets and hence the
        // ReplacePatchSetSender is not used, return a
        // NoOp-ReplacePatchSetSender to avoid possible NPEs
        bind(ReplacePatchSetSender.Factory.class).toProvider(
            new Provider<ReplacePatchSetSender.Factory>() {
          @Override
        ...
        bind(ChangeQueryBuilder.Factory.class).toProvider(
            new Provider<ChangeQueryBuilder.Factory>() {
          @Override
          public ChangeQueryBuilder.Factory get() {
            return null;
          }
        });
        bind(AccountInfo.Loader.Factory.class).toProvider(
            new Provider<AccountInfo.Loader.Factory>() {
          @Override
