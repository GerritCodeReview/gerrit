...
public abstract class ConsoleUI {
  ...
  public abstract <T extends Enum<?>, A extends EnumSet<? extends T>> T readEnum(T def, A allowed, String fmt, Object... args);
  ...
  private static class Interactive extends ConsoleUI {
    ...
    @Override
    public <T extends Enum<?>, A extends EnumSet<? extends T>> T readEnum(T def, A allowed, String fmt, Object... args) {
      final String prompt = String.format(fmt, args);
      for (; ; ) {
