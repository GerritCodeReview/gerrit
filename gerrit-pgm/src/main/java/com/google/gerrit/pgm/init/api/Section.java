...
public class Section {
  ...
  public <T extends Enum<?>, E extends EnumSet<? extends T>> T select(
      final String title, final String name, final T defValue) {
    return select(title, name, defValue, false);
  }

  public <T extends Enum<?>, E extends EnumSet<? extends T>> T select(
      final String title, final String name, final T defValue, boolean nullIfDefault) {
  ...
  public <T extends Enum<?>, E extends EnumSet<? extends T>> T select(
      final String title, final String name, final T defValue, E allowedValues) {
