...
public class Section {
  ...
  public <T extends Enum<?>, E extends EnumSet<? extends T>> T select(final String title, final String name, final T defValue, E allowedValues) {
    return select(title, name, defValue, allowedValues, false);
  }

  public  <T extends Enum<?>, A extends EnumSet<? extends T>> T select(
      final String title, final String name, final T defValue, A allowedValues, final boolean nullIfDefault) {
