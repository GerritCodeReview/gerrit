...
public class RestApi {
  ...
  private native static void put(String path,
      AsyncCallback<JavaScriptObject> cb) /*-{
    var put = $wnd['do_rest_put'];
    if (put) {
      put(path, function(result) {
        cb.@com.google.gwt.user.client.rpc.AsyncCallback::onSuccess(Ljava/lang/Object;)(result);
      });
    }
  }-*/;
  ...
  private native static void put(String path,
    ...
    var put = $wnd['do_rest_put_content'];
    if (put) {
      put(path, content, function(result) {
        cb.@com.google.gwt.user.client.rpc.AsyncCallback::onSuccess(Ljava/lang/Object;)(result);
      });
    }
  }-*/;
  ...
  private native static void post(String path,
      JavaScriptObject content, AsyncCallback<JavaScriptObject> cb) /*-{
    var post = $wnd['do_rest_post'];
    if (post) {
      post(path, content, function(result) {
        cb.@com.google.gwt.user.client.rpc.AsyncCallback::onSuccess(Ljava/lang/Object;)(result);
      });
    }
  }-*/;
  ...
  private native static void post(String path,
      String content, AsyncCallback<JavaScriptObject> cb) /*-{
    var post = $wnd['do_rest_post_string_content'];
    if (post) {
      post(path, content, function(result) {
        cb.@com.google.gwt.user.client.rpc.AsyncCallback::onSuccess(Ljava/lang/Object;)(result);
      });
  ...
  private native static void delete(String path,
      AsyncCallback<JavaScriptObject> cb) /*-{
    var delete = $wnd['do_rest_delete'];
    if (delete) {
      delete(path, function(result) {
        cb.@com.google.gwt.user.client.rpc.AsyncCallback::onSuccess(Ljava/lang/Object;)(result);
      });
    }
  }-*/;
