...
public final class Screen extends SimplePanel {
  public static void registerToken(String token, Callback b) {
    register(false, token, b);
  }

  public static void registerRegex(String pattern, Callback b) {
    register(true, pattern, b);
  }

  private native static void register(boolean re, String p, Callback b) /*-{
    $wnd.Gerrit.screen(re?new $wnd.RegExp(p):p, $entry(function(c) {
