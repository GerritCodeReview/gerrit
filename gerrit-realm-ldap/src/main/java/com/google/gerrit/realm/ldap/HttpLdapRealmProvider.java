...
public class HttpLdapRealmProvider extends LdapRealmProvider {

  public static final String NAME = "HTTP_LDAP";
  ...
  public Class<? extends RealmConfigurationInitializer> getConfigurationInitializer() {
    return HttpLdapRealmConfigurationInitializer.class;
  }
}
