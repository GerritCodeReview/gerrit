...
import com.google.gerrit.realm.ldap.httpd.LdapAuthModule;

public class LdapRealmProvider implements RealmProvider {
  ...
  public Class<? extends RealmConfigurationInitializer> getConfigurationInitializer() {
    return LdapRealmConfigurationInitializer.class;
  }
