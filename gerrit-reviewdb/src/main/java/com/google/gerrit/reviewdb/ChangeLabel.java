...
public class ChangeLabel {
  ...
  public static class LabelKey extends
    ...
    public boolean equals(Object o) {
      if (o instanceof LabelKey) {
        final LabelKey b = (LabelKey) o;
        return this.get().toLowerCase().equals(b.get().toLowerCase());
      }
      return false;
    }
  }
  ...
  public ChangeLabel(Change.Id changeId, String labelValue) {
    this.key = new Key(changeId, new LabelKey(labelValue));
  }

  public Change.Id getChangeId() {
    return this.key.getParentKey();
  }
