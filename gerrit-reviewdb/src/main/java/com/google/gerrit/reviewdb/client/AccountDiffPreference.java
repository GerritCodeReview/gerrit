...
public class AccountDiffPreference {
  ...
  @Column(id = 20)
  protected boolean autoHideEmptyPane;
  ...
  public AccountDiffPreference(AccountDiffPreference p) {
    ...
    this.autoHideEmptyPane = p.autoHideEmptyPane;
  }
  ...
  public boolean isAutoHideEmptyPane() {
    return autoHideEmptyPane;
  }

  public void setAutoHideEmptyPane(boolean autoHideEmptyPane) {
    this.autoHideEmptyPane = autoHideEmptyPane;
  }
}
