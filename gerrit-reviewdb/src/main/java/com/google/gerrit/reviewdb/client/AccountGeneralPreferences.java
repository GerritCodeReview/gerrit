...
public final class AccountGeneralPreferences {
  ...
  public static enum EmailingStrategy {
    ENABLED,
    CC_ON_OWN_COMMENTS,
    DISABLED
  }
  ...
  public EmailingStrategy getEmailStrategy() {
    if (emailStrategy == null) {
      return EmailingStrategy.ENABLED;
    }
    return EmailingStrategy.valueOf(emailStrategy);
  }

  public void setEmailStrategy(EmailingStrategy strategy) {
