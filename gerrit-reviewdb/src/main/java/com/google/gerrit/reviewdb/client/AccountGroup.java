...
public final class AccountGroup {
  ...
  /** Common UUID assigned to the "Change Owners" placeholder group. */
  public static final AccountGroup.UUID CHANGE_OWNERS =
      new AccountGroup.UUID("global:Change-Owners");
