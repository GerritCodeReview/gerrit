...
public final class PatchLineComment {
  ...
  public String toString() {
    ...
    builder.append("message=").append(message != null ? message : "")
      .append(',');
    builder.append("parentUuid=").append(parentUuid != null ? parentUuid : "")
      .append(',');
    builder.append("range=").append(range != null ? range.toString() : "")
      .append(',');
