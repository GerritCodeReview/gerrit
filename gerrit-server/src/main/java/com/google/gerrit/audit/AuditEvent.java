...
public class AuditEvent {
  ...
  public static final String UNKNOWN_USER = "N/A";
   ...
   */
  public AuditEvent(String sessionId, String who, String what, List<?> params) {
   ...
   */
  public AuditEvent(String sessionId, String who, String what, long when,
    ...
    this.who = getValueWithDefault(who, UNKNOWN_USER);
    this.what = what;
    this.when = when;
