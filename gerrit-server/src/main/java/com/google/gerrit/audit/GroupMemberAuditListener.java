...
public interface GroupMemberAuditListener {
  ...
  void onAddGroupsToGroup(Id actor, Collection<AccountGroupById> added) throws IOException;

  void onDeleteGroupsFromGroup(Id actor, Collection<AccountGroupById> deleted) throws IOException;
}
