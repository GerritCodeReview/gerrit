...
public class ChangeHookRunner implements ChangeHooks, LifecycleListener {
    ...
    public void doPatchsetCreatedHook(final Change change, final PatchSet patchSet,
        ...
        ChangeKind kind = changeKindCache.getChangeKind(db, change, patchSet);
        switch (kind) {
          case TRIVIAL_REBASE:
        ...
        addArg(args, "--trivial-rebase", String.valueOf(isTrivialRebase));
        addArg(args, "--message-updated-only", String.valueOf(noCodeChange));
