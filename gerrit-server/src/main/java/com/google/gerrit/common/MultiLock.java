...
/**
 * This interface allows you to lock different resources of a type atomically.
 *
...
public class MultiLock<T> {
   ...
   *
   * If one of the locks could not be obtained, no lock will be obtained and
   * {@code false} will be returned. If all locks for the given set could be
   * obtained {@code true will be returned}.
   *
   * @param set the set of items to hold a lock for
   * @return If the operation could succeed and all locks were successfully
   *         locked.
   */
  ...
  /**
   * Releases locks for all given items. The items in the set must have been
   * locked before.
   *
