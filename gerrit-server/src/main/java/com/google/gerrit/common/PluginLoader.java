...
public class PluginLoader {
  ...
  private HashMap<String, Plugin> plugInCache = new HashMap<String, Plugin>();
  ...
  private void loadPlugIns() throws IOException, ClassNotFoundException {

    Collection<File> plugInJars = getPlugIns();
  ...
  private Collection<File> getPlugIns() throws IOException {
    ...
    return FileUtils.listFiles(plugInsDir,
