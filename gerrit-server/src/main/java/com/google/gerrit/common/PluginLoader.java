...
public class PluginLoader {
  ...
  private Plugin loadPlugin(File jarFile) throws IOException,
    ...
    ClassLoader jarClassLoader = URLClassLoader.newInstance(getPluginURLs(jarFile), PluginLoader.class.getClassLoader());
  ...
  private Collection<File> getPluginFiles() throws IOException {
