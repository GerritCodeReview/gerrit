...
public class SequencedEventSource extends EventSourceImpl {
  ...
  public SequencedEventSource(ProjectCache projectCache,
    ...
    dq = new LinkedBlockingDeque<Event>(1000);
  }

  @Override
  public synchronized void addChangeListener(ChangeListener listener, CurrentUser user,
    ...
    addChangeListener(listener, user);
  }
