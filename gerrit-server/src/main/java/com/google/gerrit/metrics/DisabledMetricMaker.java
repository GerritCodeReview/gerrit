...
/** Exports no metrics, useful for running in FlumeJava. */
public class DisabledMetricMaker extends MetricMaker {
  ...
  @Override
  public <F1, F2> Counter2<F1, F2> newCounter(String name, Description desc, Field<F1> field1,
      Field<F2> field2) {
  ...
  @Override
  public <F1, F2, F3> Counter3<F1, F2, F3> newCounter(String name, Description desc,
  ...
  @Override
  public <F1, F2> Timer2<F1, F2> newTimer(String name, Description desc, Field<F1> field1,
      Field<F2> field2) {
  ...
  @Override
  public <F1, F2, F3> Timer3<F1, F2, F3> newTimer(String name, Description desc, Field<F1> field1,
      Field<F2> field2, Field<F3> field3) {
  ...
  @Override
  public <V> CallbackMetric0<V> newCallbackMetric(String name, Class<V> valueClass,
      Description desc) {
