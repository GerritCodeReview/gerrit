...
public abstract class MetricMaker {
  ...
  /** Metric recording rate of events occurring over a time span. */
  public abstract Rate newRate(String name, Description desc);
