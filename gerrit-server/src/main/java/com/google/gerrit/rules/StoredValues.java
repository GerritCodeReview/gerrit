...
public final class StoredValues {
  ...
  public static final StoredValue<IdentifiedUser> CURRENT_USER = create(IdentifiedUser.class);
  public static final StoredValue<Branch.NameKey> BRANCH_NAMEKEY = create(Branch.NameKey.class);
  public static final StoredValue<Project.NameKey> PROJECT_NAMEKEY = create(Project.NameKey.class);
