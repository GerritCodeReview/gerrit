...
public class ChangeMessagesUtil {
  public final static String ABANDON =
      "autogenerated:gerrit:abandoned";
  public final static String CHANGE_INSERTER =
      "autogenerated:gerrit:changeInserter";
  public final static String CHERRY_PICK_CHANGE =
      "autogenerated:gerrit:cherryPickChange";
  public final static String DELETE_ASSIGNEE =
      "autogenerated:gerrit:deleteAssignee";
  public final static String DELETE_REVIEWER =
      "autogenerated:gerrit:deleteReviewer";
  public final static String DELETE_VOTE =
      "autogenerated:gerrit:deleteVote";
  public final static String MERGED_BY_PUSH_OP =
      "autogenerated:gerrit:mergedByPushOp";
  public final static String MERGE_OP =
      "autogenerated:gerrit:mergeOp";
  public final static String MOVE =
      "autogenerated:gerrit:move";
  public final static String PATCH_SET_INSERTER =
      "autogenerated:gerrit:publishDraftPatchSet";
  public final static String PUBLISH_DRAFT_PATCH_SET =
      "autogenerated:gerrit:publishDraftPatchSet";
  public final static String PUT_TOPIC =
      "autogenerated:gerrit:putTopic";
  public final static String REPLACE_OP =
      "autogenerated:gerrit:replaceOp";
  ...
  public final static String SET_ASSIGNEE_OP =
      "autogenerated:gerrit:setAssigneeOp";
  public final static String SET_HASHTAGS_OP =
      "autogenerated:gerrit:setHashtagOp";
  public final static String SUBMIT_STRATEGY_OP =
      "autogenerated:gerrit:submitStrategyOp";

  public static ChangeMessage newMessage( BatchUpdate.ChangeContext ctx,
      String body, String tag) throws OrmException {
    return newMessage(
