...
public abstract class ReviewerStatusUpdate {
  public static ReviewerStatusUpdate create(ObjectId commitId,
      Id reviewerId, Timestamp ts, Account.Id updatedBy, Account.Id reviewer,
  ...
  public static String generateId(ObjectId commitId, Id reviewerId,
    ...
    h.putString(commitId.abbreviate(10).name(), UTF_8);
