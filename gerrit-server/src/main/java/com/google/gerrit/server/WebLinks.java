...
public class WebLinks {
  ...
  private final DynamicSet<FileHistoryWebLink> fileLogLinks;
  ...
  public WebLinks(DynamicSet<PatchSetWebLink> patchSetLinks,
    ...
    this.fileLogLinks = fileLogLinks;
   ...
   */
  public FluentIterable<WebLinkInfo> getFileHistoryLinks(final String project, final String revision,
      final String file) {
    return filterLinks(fileLogLinks, new Function<WebLink, WebLinkInfo>() {
  ...
  public FluentIterable<WebLinkInfoCommon> getFileHistoryLinksCommon(final String project, final String revision,
      final String file) {
    return FluentIterable
        ...
        .transform(new Function<WebLink, WebLinkInfoCommon>() {
          ...
          public WebLinkInfoCommon apply(WebLink webLink) {
            WebLinkInfo info = ((FileHistoryWebLink)webLink).getFileHistoryWebLink(project, revision, file);
