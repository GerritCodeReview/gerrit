...
public class AccountCacheImpl implements AccountCache {
  ...
  public AccountState get(Account.Id accountId) {
    // TODO: Replace Guava cache with Caffeine (Issue 11484).
    // We do this to prevent locking, this is due to the deadlocks created
    // due to either circular or unknown issue.
    try {
