...
public class AccountDeactivator implements Runnable {
  ...
  static class Lifecycle implements LifecycleListener {
    ...
    private AccountDeactivator deactivator;
    private AccountDeactivatorConfig cfg;
    private boolean supportAutomaticAccountActivityUpdate;
    ...
    Lifecycle(
      ...
      this.cfg = cfg;
      this.supportAutomaticAccountActivityUpdate = gcfg.getBoolean("auth", "autoUpdateAccountActiveStatus", false);
    }
