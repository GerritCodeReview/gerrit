...
public class AuthRequest {
  ...
  public static AuthRequest forUser(String username) {
    AuthRequest r =
        new AuthRequest(ExternalId.Key.create(SCHEME_GERRIT, username));
  ...
  public static AuthRequest forExternalUser(String username) {
    AuthRequest r =
        new AuthRequest(ExternalId.Key.create(SCHEME_EXTERNAL, username));
    r.setUserName(username);
    return r;
  }
  ...
  public static AuthRequest forEmail(String email) {
    AuthRequest r =
        new AuthRequest(ExternalId.Key.create(SCHEME_MAILTO, email));
