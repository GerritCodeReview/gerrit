...
public class AuthorizedKeys {
  ...
  @VisibleForTesting
  public static final String INVALID_KEY_COMMENT = "# INVALID ";

  @VisibleForTesting
  public static final String DELETED_KEY_COMMENT = "# DELETED";

  public static SortedMap<Integer, Optional<AccountSshKey>> parse(
      Account.Id accountId, String s) {
    SortedMap<Integer, Optional<AccountSshKey>> keys = new TreeMap<>();
    int seq = 1;
