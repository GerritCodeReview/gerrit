...
public class DeleteWatchedProjects
    implements RestModifyView<AccountResource, DeleteWatchedProjectsInput> {
  ...
  public Response<?> apply(
      AccountResource rsrc, DeleteWatchedProjectsInput input)
