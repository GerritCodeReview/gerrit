...
public class ExternalIdsUpdate {
  ...
  public static class Server {
    ...
    public ExternalIdsUpdate create() {
      return new ExternalIdsUpdate(repoManager, allUsersName, serverIdent.get(), serverIdent.get());
    }
  }
  ...
  private static final Retryer<Void> RETRYER =
      RetryerBuilder.<Void>newBuilder()
          .retryIfException(e -> e instanceof LockFailedException)
          .withWaitStrategy(
              WaitStrategies.join(
