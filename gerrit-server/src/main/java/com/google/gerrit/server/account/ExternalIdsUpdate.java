...
public class ExternalIdsUpdate {
  ...
  public static class Server {
    ...
    public ExternalIdsUpdate create() {
      return new ExternalIdsUpdate(
          repoManager, allUsersName, externalIdCache, serverIdent, serverIdent);
    }
  }
   ...
   */
  public synchronized void insert(Collection<ExternalId> extIds) throws IOException, OrmException {
    try (Repository repo = repoManager.openRepository(allUsersName);
      ...
      ObjectId newRev = commit(repo, rw, ins, rev, noteMap);
   ...
   */
  public synchronized void upsert(Collection<ExternalId> extIds) throws IOException {
    try (Repository repo = repoManager.openRepository(allUsersName);
        RevWalk rw = new RevWalk(repo);
        ObjectInserter ins = repo.newObjectInserter()) {
      ObjectId rev = readRevision(repo);
   ...
   */
  public void delete(ExternalId extId) throws IOException, ConfigInvalidException {
   ...
   */
  public synchronized void delete(Account.Id accountId, Collection<ExternalId.Key> extIdKeys)
      throws IOException, ConfigInvalidException {
    try (Repository repo = repoManager.openRepository(allUsersName);
        RevWalk rw = new RevWalk(repo);
        ObjectInserter ins = repo.newObjectInserter()) {
  ...
  public void deleteAll(Account.Id accountId) throws IOException, ConfigInvalidException {
   ...
   */
  public synchronized void replace(Collection<ExternalId> toDelete, Collection<ExternalId> toAdd)
      throws IOException, ConfigInvalidException, OrmException {
  ...
  private ObjectId commit(
      ...
      throws IOException {
    return commit(repo, rw, ins, rev, noteMap, COMMIT_MSG, authorIdent, committerIdent);
  }
