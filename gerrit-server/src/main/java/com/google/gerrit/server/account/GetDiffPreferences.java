...
public class GetDiffPreferences implements RestReadView<AccountResource> {
  ...
  private DiffPreferencesInfo readFromGit(Account.Id id)
  ...
  private static DiffPreferencesInfo initFromDb(AccountDiffPreference a) {
    ...
    // Nullifying of false values is needed in both cases:
    // when read was successful and for default values.
