...
public interface GroupBackend {
   ...
   * @return the group
   * @throws IllegalArgumentException when the backend does not handle the UUID.
   */
  @Nullable
  ExtGroup get(AccountGroup.UUID uuid);

  /** @return suggestions for the group name. */
  Set<GroupReference> suggest(String name);
