...
public class GroupIncludeCacheImpl implements GroupIncludeCache {
  ...
  private static final String PARENT_GROUPS_NAME = "groups_parentGroups";
  private static final String SUBGROUPS_NAME = "groups_subgroups";
  private static final String GROUP_ACCOUNTS = "groups_accounts";
  ...
  public static Module module() {
    return new CacheModule() {
      ...
      protected void configure() {
        ...
        cache(GROUP_ACCOUNTS, AccountGroup.UUID.class,
  ...
  GroupIncludeCacheImpl(
      @Named(GROUP_ACCOUNTS) LoadingCache<AccountGroup.UUID, Set<Account.Id>> accounts,
