...
public class GroupIncludeCacheImpl implements GroupIncludeCache {
  ...
  public static Module module() {
    return new CacheModule() {
      ...
      protected void configure() {
        ...
        cache(ACCOUNTS_NAME, AccountGroup.UUID.class,
  ...
  private final LoadingCache<AccountGroup.UUID, Set<Account.Id>> accountsOf;
  ...
  GroupIncludeCacheImpl(
      ...
      @Named(ACCOUNTS_NAME) LoadingCache<AccountGroup.UUID, Set<Account.Id>> accountsOf,
  ...
  public Set<Id> accountsOf(AccountGroup.UUID groupId) {
    try {
      return accountsOf.get(groupId);
    } catch (ExecutionException e) {
      log.warn("Cannot load account of group", e);
      return Collections.emptySet();
    }
  }
