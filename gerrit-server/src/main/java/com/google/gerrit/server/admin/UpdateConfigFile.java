...
class UpdateConfigFile implements RestModifyView<ConfigFileResource, Input> {
  static final Logger log = LoggerFactory.getLogger(UpdateConfigFile.class);
  static class Input {
    PutInput raw;
  }

  @Override
  public Object apply(ConfigFileResource rsrc, Input input)
      throws IOException, BadRequestException {
    File current = rsrc.getConfigFile();
