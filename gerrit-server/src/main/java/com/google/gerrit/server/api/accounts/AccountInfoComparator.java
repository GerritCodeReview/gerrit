...
public class AccountInfoComparator implements Comparator<AccountInfo> {
  public static AccountInfoComparator nullsFirst() {
    return new AccountInfoComparator();
  }

  public static AccountInfoComparator nullsLast() {
    return new AccountInfoComparator().orderNullsLast();
  }
  ...
  private AccountInfoComparator orderNullsLast() {
    this.nullsLast = true;
    return this;
  }
