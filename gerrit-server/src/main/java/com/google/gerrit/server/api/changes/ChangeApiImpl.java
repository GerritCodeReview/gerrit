...
import com.google.gerrit.extensions.api.changes.ChangeInfo;
...
class ChangeApiImpl implements ChangeApi {
  ...
  @Override
  public ChangeInfo revert() throws RestApiException {
    return revert(new RevertInput());
  }

  @Override
  public ChangeInfo revert(RevertInput in) throws RestApiException {
    try {
      return revert.get().apply(change, in);
    } catch (OrmException e) {
