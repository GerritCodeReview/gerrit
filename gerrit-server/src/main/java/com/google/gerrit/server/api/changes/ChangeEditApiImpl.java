...
public class ChangeEditApiImpl implements ChangeEditApi {
  ...
  @Inject
  public ChangeEditApiImpl(@Assisted ChangeResource changeResource,
  ...
  public String getCommitMessage() throws RestApiException {
    try {
      ...
      throw new RestApiException("Cannot get the commit message of the "
          + "change edit", e);
    }
  }
  ...
  public void modifyCommitMessage(String newCommitMessage)
    ...
    try {
      ...
      throw new RestApiException("Cannot modify the commit message of the "
          + "change edit", e);
    }
  }
  ...
  private ChangeEditResource getOrCreateChangeEditResource(String filePath)
    ...
    // if it doesn't exist. We try do mimic this behavior.
    try {
