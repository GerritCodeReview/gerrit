...
import static com.google.gerrit.reviewdb.Account.FieldName.FULL_NAME;
import static com.google.gerrit.reviewdb.Account.FieldName.REGISTER_NEW_EMAIL;
...
public class InternalRealm implements Realm {
  ...
  public AuthRequest authenticate(AuthRequest who) throws AccountException {
    ...
    try {
      ...
      String hash = InternalPasswordHasher.hashPassword(password, salt);
      ...
      throw new AccountException("Cannot connect to db");
    } finally {
      if (db != null) {
        db.close();
      }
