...
public class LdapPasswordCredentialsVerifier extends PasswordCredentialsVerifier {
  private static final Logger log = LoggerFactory.getLogger(LdapPasswordCredentialsVerifier.class);
