...
public interface OAuthLoginService {
  ...
  /**
   * Performs a login with an OAuth2 provider.
   *
   ...
   *
   * @throws AccountException if the login failed.
   */
  OAuthUserInfo login(String username, String secret) throws AccountException;
}
