...
public class CacheMetrics {
  ...
  public CacheMetrics(MetricMaker metrics,
    ...
    Field<String> fName = Field.ofString("cache_name");
    final CallbackMetric1<String, Long> memEnt = metrics.newCallbackMetric(
        "caches/memory_cached", Long.class,
        new Description("Memory entries").setGauge().setUnit("entries"), fName);
