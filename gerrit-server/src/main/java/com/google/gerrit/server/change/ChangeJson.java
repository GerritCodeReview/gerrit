...
public class ChangeJson {
  ...
  private final LoadingCache<Project.NameKey, ProjectControl> projectControls;
  ...
  private ChangeControl control2(ChangeData cd) throws OrmException {
    ChangeControl ctrl;
    try {
