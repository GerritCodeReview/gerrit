...
public class ChangesCollection implements
    RestCollection<NullResource, ChangeResource> {
  ...
  @Override
  public RestView<NullResource> list() {
  ...
  @Override
  public ChangeResource parse(NullResource root, String id)
      throws InvalidApiResourceException, OrmException,
