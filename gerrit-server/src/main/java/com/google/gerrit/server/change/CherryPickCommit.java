...
@Singleton
public class CherryPickCommit implements RestModifyView<ProjectResource, CherryPickCommitInput> {
  ...
  @Override
  public ChangeInfo apply(ProjectResource rsrc, CherryPickCommitInput input)
  ...
  private void checkAndCleanInput(CherryPickCommitInput input) throws BadRequestException {
    commit = input.commit;
