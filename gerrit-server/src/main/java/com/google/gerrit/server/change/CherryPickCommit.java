...
public class CherryPickCommit implements RestModifyView<CommitResource, CherryPickInput> {
  ...
  public ChangeInfo apply(CommitResource rsrc, CherryPickInput input)
    ...
    input = checkAndCleanInput(input);
  ...
  private CherryPickInput checkAndCleanInput(CherryPickInput input) throws BadRequestException {
    ...
    CherryPickInput result = new CherryPickInput();
