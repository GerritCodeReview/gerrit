...
class EditCommitMessage implements RestModifyView<RevisionResource, Input>,
  ...
  @Inject
  EditCommitMessage(final ReviewDb db, final Provider<CurrentUser> currentUser,
  ...
  public ChangeInfo apply(RevisionResource rsrc, Input input)
    ...
    try {
      return json.format(ChangeUtil.editCommitMessage(patchSetId, rsrc
          .getControl().getRefControl(), (IdentifiedUser)currentUser.get(),
          input.message, db, commitMessageEditedSenderFactory, git, myIdent,
  ...
  public UiAction.Description getDescription(RevisionResource resource) {
    return new UiAction.Description()
        ...
        .setVisible(
            currentUser.get() instanceof IdentifiedUser
