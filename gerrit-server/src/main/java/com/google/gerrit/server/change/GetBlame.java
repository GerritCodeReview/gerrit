...
public class GetBlame implements RestReadView<FileResource> {
  ...
  private List<BlameInfo.BlameLine> blame(ObjectId id, String path,
    Repository repository)
    throws GitAPIException, QueryParseException, OrmException, IOException {
    ...
    try (RevWalk rw = new RevWalk(repository)) {
      for (Region region : blameRegions) {
        ...
        PersonIdent sourceAuthor = region.getSourceAuthor();
