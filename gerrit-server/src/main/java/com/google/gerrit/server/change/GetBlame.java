...
public class GetBlame implements RestReadView<FileResource> {
  ...
  public void setBase(@SuppressWarnings("unused") boolean on) {
    // Ignoring method parameter to support usage of argument without requiring
    // to specify boolean value.
    this.base = true;
  }
  ...
  private List<BlameInfo> blame(ObjectId id, String path,
    ...
    for (Region region : blameRegions) {
      ...
      ranges.put(blameInfo, new RangeInfo(
  ...
  private static BlameInfo toBlameInfo(
