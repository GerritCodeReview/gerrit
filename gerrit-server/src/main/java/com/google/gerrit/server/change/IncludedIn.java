...
class IncludedIn implements RestReadView<ChangeResource> {
  ...
  private final DynamicMap<com.google.gerrit.extensions.config.IncludedIn> includedIn;

  @Inject
  IncludedIn(
      Provider<ReviewDb> db,
      GitRepositoryManager repoManager,
      DynamicMap<com.google.gerrit.extensions.config.IncludedIn> includedIn) {
    this.db = db;
  ...
  static class IncludedInInfo {
    ...
    Map<String, Collection<String>> systems;

    IncludedInInfo(IncludedInDetail in, Map<String, Collection<String>> s) {
