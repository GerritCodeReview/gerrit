...
import com.google.gerrit.server.change.ChangeJson.RevisionInfo;
...
public class ListRevisionEdits implements RestReadView<ChangeResource> {
  ...
  @Inject
  ListRevisionEdits(RevisionEditCommands editCommands,
  ...
  public Map<String, RevisionInfo> apply(ChangeResource rsrc)
    ...
    Map<PatchSet.Id, PatchSet> map = editCommands.read(rsrc.getChange());
