...
public class Move extends RetryingRestModifyView<ChangeResource, MoveInput, ChangeInfo>
  ...
  private class Op implements BatchUpdateOp {
     ...
     * branch to another. In the end, we think only keeping in the minimum votes is the best way
     * since it's simple for us and less confusing for our users. See the discussion in the
     * following proposal: https://gerrit-review.googlesource.com/c/gerrit/+/129171
     */
