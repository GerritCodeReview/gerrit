  ...
  private class Op extends BatchUpdate.Op {
    ...
    private RobotComment createRobotCommentFromInput(
      ...
      robotComment.fixSuggestions =
          createFixSuggestionsFromInput(ctx, robotCommentInput.fixSuggestions);
      return robotComment;
    }

    private List<FixSuggestion> createFixSuggestionsFromInput(
        ChangeContext ctx, List<FixSuggestionInfo> fixSuggestionInfos) throws OrmException {
      if (fixSuggestionInfos == null) {
      ...
      for (FixSuggestionInfo fixSuggestionInfo : fixSuggestionInfos) {
        fixSuggestions.add(createFixSuggestionFromInput(ctx, fixSuggestionInfo));
      }
      return fixSuggestions;
    }

    private FixSuggestion createFixSuggestionFromInput(
        ChangeContext ctx, FixSuggestionInfo fixSuggestionInfo) throws OrmException {
