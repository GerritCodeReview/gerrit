...
public class PostReview
  ...
  public Response<ReviewResult> apply(
    ...
    // Remove after the backend lives for a time.
    if (!input.strictLabels) {
      throw new BadRequestException(
          "strictLabels option is deprecated, all labels must be within the permitted ranges.");
    }
  ...
  private void checkLabels(RevisionResource rsrc, Map<String, Short> labels)
