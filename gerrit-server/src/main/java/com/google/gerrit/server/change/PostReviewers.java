...
public class PostReviewers implements RestModifyView<ChangeResource, AddReviewerInput> {
  ...
  private void addReviewers(
    ...
    try (BatchUpdate bu =
      ...
      Op op = new Op(rsrc, result, reviewers);
  ...
  private class Op extends BatchUpdate.Op {
    ...
    final private ChangeResource rsrc;
    final private Map<Account.Id, ChangeControl> reviewers;
    final private PostResult result;
