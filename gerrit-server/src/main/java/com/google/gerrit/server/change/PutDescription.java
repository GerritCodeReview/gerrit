...
public class PutDescription implements RestModifyView<RevisionResource, Input>,
  ...
  @Inject
  PutDescription(Provider<ReviewDb> dbProvider, ChangeMessagesUtil cmUtil,
      BatchUpdate.Factory batchUpdateFactory, PatchSetUtil psUtil) {
  ...
  public UiAction.Description getDescription(RevisionResource rsrc) {
    return new UiAction.Description().setLabel("Edit Description")
        .setVisible(rsrc.getControl().canEditTopicName());
  }
}
