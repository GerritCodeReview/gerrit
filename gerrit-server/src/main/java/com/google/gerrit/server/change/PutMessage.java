...
public class PutMessage
  ...
  protected Response<?> applyImpl(
    ...
    String sanitizedCommitMessage = CommitMessageUtil.getWellFormedCommitMessage(input.message);
    ...
    try (Repository repository = repositoryManager.openRepository(resource.getProject());
      ...
      try (BatchUpdate bu =
        ...
        ObjectId newCommit =
            createCommit(objectInserter, patchSetCommit, sanitizedCommitMessage, TimeUtil.nowTs());
