...
public class Reviewed {
  ...
  public static class PutReviewed implements RestModifyView<FileResource, Input> {
    ...
    @Override
    public Response<String> apply(FileResource resource, Input input) throws OrmException, BadRequestException {
  ...
  public static class DeleteReviewed implements RestModifyView<FileResource, Input> {
    ...
    @Override
    public Response<?> apply(FileResource resource, Input input) throws OrmException, BadRequestException {
      checkNotEdit(resource.getPatchKey().getParentKey());
