...
public class Submit implements RestModifyView<RevisionResource, SubmitInput>,
  ...
  private final ParameterizedString tooltipPattern;
  ...
  Submit(@GerritPersonIdent PersonIdent serverIdent,
    ...
    this.tooltipPattern = new ParameterizedString(Objects.firstNonNull(cfg.getString(
        "change", null, "submitTooltip"), DEFAULT_TOOLTIP));
  }
  ...
  public UiAction.Description getDescription(RevisionResource resource) {
    ...
    Map<String, String> params = ImmutableMap.of(
        "patchSetNumber", String.valueOf(resource.getPatchSet().getPatchSetId()),
        "branch", resource.getChange().getDest().getShortName());

    return new UiAction.Description()
      .setLabel(label)
      .setTitle(tooltipPattern.replace(params))
