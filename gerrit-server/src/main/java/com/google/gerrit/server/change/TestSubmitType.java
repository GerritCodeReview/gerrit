...
public class TestSubmitType implements RestModifyView<RevisionResource, Input> {
  private final TestSubmitTypeExt testSubmitTypeExt;
  ...
  TestSubmitType(ReviewDb db,
      ...
      RulesCache rules) {
    this.testSubmitTypeExt = new TestSubmitTypeExt(db, changeDataFactory, rules);
  }

  @Override
  public SubmitType apply(RevisionResource rsrc, Input input)
      throws AuthException, BadRequestException {
    return testSubmitTypeExt.apply(rsrc, input).getSubmitType();
  }
