...
public class WorkInProgressOp extends BatchUpdate.Op {
  ...
  private void addMessage(BatchUpdate.ChangeContext ctx, ChangeUpdate update) throws OrmException {
    ...
    StringBuilder buf = new StringBuilder(c.isWorkInProgress() ? "Ready For Review" : "Work In Progress");
    ...
    ChangeMessage cmsg =
        ChangeMessagesUtil.newMessage(
            ...
            !m.isEmpty()
                ? null
                : c.isWorkInProgress() ? ChangeMessagesUtil.TAG_SET_READY : ChangeMessagesUtil.TAG_SET_WIP);
