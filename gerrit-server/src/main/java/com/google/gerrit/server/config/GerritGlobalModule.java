...
public class GerritGlobalModule extends FactoryModule {
  ...
  protected void configure() {
    ...
    DynamicSet.setOf(binder(), new TypeLiteral<WebLink<RevisionResource>>() {});
    DynamicSet.setOf(binder(), new TypeLiteral<WebLink<FileResource>>() {});
    DynamicSet.setOf(binder(), new TypeLiteral<WebLink<ProjectResource>>() {});
    DynamicSet.setOf(binder(), new TypeLiteral<WebLink<BranchResource>>() {});
