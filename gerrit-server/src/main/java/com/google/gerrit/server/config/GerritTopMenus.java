...
class GerritTopMenus {
  ...
  GerritTopMenus(Provider<CurrentUser> cup,
      ...
      GerritConstantsProperties gcp) throws IOException {
  ...
  private String nameLink(Project.NameKey nameKey) {
    if (nameKey.get().equals(ConfigServerApi.PROJECT_MENU_VAR)) {
      return ConfigServerApi.PROJECT_MENU_VAR; // To prevent URL-encoding of ${projectName} variable
    } else {
