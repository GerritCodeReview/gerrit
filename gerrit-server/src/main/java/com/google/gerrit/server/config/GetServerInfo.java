...
public class GetServerInfo implements RestReadView<ConfigResource> {
  ...
  public ServerInfo apply(ConfigResource rsrc) throws MalformedURLException {
    ...
    info.auth = new AuthInfo(authConfig, realm, emailSender);
  ...
  public static class AuthInfo {
    ...
    public AuthInfo(AuthConfig cfg, Realm realm, EmailSender emailSender) {
      authType = cfg.getAuthType();
      useContributorAgreements = toBoolean(cfg.isUseContributorAgreements());
      editableAccountFields = getEditableAccountFields(realm, emailSender);
    }

    private List<Account.FieldName> getEditableAccountFields(Realm realm,
