            ...
            for (Entry<ProjectConfigEntry> e : pluginConfigEntries) {
              ...
              if ((newValue == null && oldValue != null)
                ...
                switch (configEntry.getType()) {
                  case BOOLEAN:
                    configEntry.onUpdate(p,
                        oldValue != null ? Boolean.parseBoolean(oldValue) : null,
                        newValue != null ? Boolean.parseBoolean(newValue) : null);
                    break;
                  case INT:
                    configEntry.onUpdate(p,
                        oldValue != null ? Integer.parseInt(oldValue) : null,
                        newValue != null ? Integer.parseInt(newValue) : null);
                    break;
                  case LONG:
                    configEntry.onUpdate(p,
                        oldValue != null ? Long.parseLong(oldValue) : null,
                        newValue != null ? Long.parseLong(newValue) : null);
                    break;
                  case LIST:
                  case STRING:
                  default:
