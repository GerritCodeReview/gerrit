...
@Singleton
public class TrackingValueExtractorProvider implements Provider<TrackingValueExtractor> {
  ...
  private Class<? extends TrackingValueExtractor> getImpl() {
    ...
    try {
      return (Class<? extends TrackingValueExtractor>) Class.forName("com.google.gerrit.CustomTrackingValueExtractor");
