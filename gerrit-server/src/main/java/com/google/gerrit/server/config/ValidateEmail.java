...
import com.google.gerrit.server.config.ValidateEmail.Input;
...
@Singleton
public class ValidateEmail implements RestModifyView<ConfigResource, Input> {
  ...
  @Inject
  public ValidateEmail(Provider<CurrentUser> self,
