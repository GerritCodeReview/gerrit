...
public class MarkdownFormatter {
  ...
  public byte[] markdownToDocHtml(byte[] data, String charEnc)
      throws UnsupportedEncodingException {
    RootNode root = parseMarkdown(data, charEnc);
  ...
  private RootNode parseMarkdown(byte[] data, String charEnc) {
    return new PegDownProcessor(ALL & ~(HARDWRAPS))
      .parseMarkdown(RawParseUtils
        .decode(Charset.forName(charEnc), data).toCharArray());
  }
