...
public class ChangeEditUtil {
  ...
  private RevCommit squashEdit(Repository repo, RevWalk rw,
    ...
    return writeSquashedCommit(myIdent, rw, inserter, parent, edit);
  }
  ...
  private RevCommit writeSquashedCommit(PersonIdent myIdent2, RevWalk rw,
  ...
  private ObjectId commit(ObjectInserter inserter,
