...
public class RevisionEdit {
  private static final String REFS_EDITS = "refs/users/";
  ...
  public String getRefName() {
    return getChangeEditsRef(user, psid.getParentKey()).toString();
  }
  ...
  public static Map<String, Ref> getChangeEditsRefs(Repository repo,
    ...
    String changeEditsRef = getChangeEditsRef(user, changeId).toString();
