...
public interface ChangeMessageModifier {
   ...
   *
   * mergeTip and original commit are guaranteed to be have their body parsed,
   ...
   *        called before.</li>
   *        </ul>
   * @param original the commit of the change being submitted. <b>note that it's
   *        commit message may be different than newCommitMessage argument.
   * @param mergeTip the current HEAD of the destination branch, which will be a
   *        parent of a new commit being generated
   * @param destination a branch onto which change is being submitted
