...
public interface ChangeReportFormatter {
  ...
  public abstract static class Input {
    ...
    public abstract static class Builder {
      ...
      abstract Boolean draft();

      abstract Boolean edit();

      abstract Boolean _private();

      abstract Boolean wip();
      ...
      public Input build() {
        ...
        setDraft(draft() == null ? Change.Status.DRAFT == change().getStatus() : draft());
        setEdit(edit() == null ? false : edit());
        set_private(_private() == null ? change().isPrivate() : _private());
        setWip(wip() == null ? change().isWorkInProgress() : wip());
        return autoBuild();
      }
    }
  }
