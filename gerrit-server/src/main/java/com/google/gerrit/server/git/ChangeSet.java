...
public abstract class ChangeSet {
  public static ChangeSet create(Iterable<Change> changes) {
    ...
    ImmutableSetMultimap.Builder<Project.NameKey, Branch.NameKey> pbb = ImmutableSetMultimap.builder();
    ImmutableSetMultimap.Builder<Project.NameKey, Change.Id> pcb = ImmutableSetMultimap.builder();
    ...
    return new AutoValue_ChangeSet(pb.build(), bb.build(), ib.build(), pbb.build(), pcb.build());
  }
  ...
  public abstract ImmutableSetMultimap<Project.NameKey, Branch.NameKey> byProjectBranches();
  public abstract ImmutableSetMultimap<Project.NameKey, Change.Id> byProjectChanges();
