...
class CreateCodeReviewNotes {
  private static final String REFS_NOTES_SUBMITTED = "refs/notes/submitted";
  ...
  CreateCodeReviewNotes(ReviewDb reviewDb, Repository db, PersonIdent gerritIdent) {
    schema = reviewDb;
    this.db = db;
    ...
    try {
      ...
      for (;;) {
        ...
        if (result == Result.LOCK_FAILURE) {
          ...
          NoteMap merged = null; // TODO: NoteMapMerger.merge(base, ours,
                                 // theirs);
