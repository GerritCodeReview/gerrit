...
public class GarbageCollection {
  ...
  private static void logGcConfiguration(Project.NameKey projectName,
    ...
    b = new StringBuilder();
    try {
      PackConfig packCfg = new PackConfig(repo);
      for (Method m : packCfg.getClass().getDeclaredMethods()) {
        if (m.getName().startsWith("get")) {
          b.append(m.getName().substring(3));
          b.append('=').append(m.invoke(packCfg));
          b.append(", ");
        }
      }
    ...
    logGcInfo(projectName, "pack config: " + b.toString());
  }
  ...
  private static void logGcError(Project.NameKey projectName, String msg) {
    StringBuilder b = new StringBuilder();
    b.append("[").append(projectName.get()).append("] ");
    b.append(msg);
  ...
  private static void logGcError(Project.NameKey projectName, Exception e) {
    StringBuilder b = new StringBuilder();
    b.append("[").append(projectName.get()).append("]");
