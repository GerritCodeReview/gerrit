...
@Singleton
public class LocalDiskRepositoryManager extends CachingGitRepositoryManager implements GitRepositoryManager {
  ...
  @Override
  protected SortedSet<Project.NameKey> scan() {
