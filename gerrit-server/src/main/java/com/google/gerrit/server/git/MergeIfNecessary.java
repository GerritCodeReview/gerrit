...
public class MergeIfNecessary extends SubmitStrategy {
  ...
  MergeIfNecessary(final GenericFactory identifiedUserFactory,
      final PersonIdent myIdent, final ReviewDb db, Repository repo,
  ...
  protected CodeReviewCommit _run(final CodeReviewCommit mergeTip,
    ...
    CodeReviewCommit newMergeTip = getFirstFastForward(mergeTip, rw, toMerge);
