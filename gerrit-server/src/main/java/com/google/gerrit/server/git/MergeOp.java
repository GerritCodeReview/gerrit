 ...
 * be merged cleanly.
 */
public class MergeOpBranch {
  public interface Factory {
    MergeOpBranch create(Branch.NameKey branch);
  }

  private static final Logger log = LoggerFactory.getLogger(MergeOpBranch.class);
  ...
  @Inject
  MergeOpBranch(AccountCache accountCache,
