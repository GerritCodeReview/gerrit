...
public class MergeOp {
  ...
  private void mergeImpl() throws MergeException, OrmException {
    ...
    final List<RefMergeStrategy> refStrategies = new ArrayList<RefMergeStrategy>(
        projectCache.get(destProject.getNameKey()).getLocalRefMergeStrategies());
  ...
  private List<RefMergeStrategy> extractNonMatchersRefStrategies(
    ...
    for (RefMergeStrategy refMerge : refStrategies){
      if (RefControl.refMatch(refMerge.getRefPattern(), destBranch)) {
