...
class OldReceiveCommitsImpl implements ReceiveCommits {
  ...
  private final Set<Account.Id> reviewersFromCommandLine = Sets.newLinkedHashSet();
  private final Set<Account.Id> ccFromCommandLine = Sets.newLinkedHashSet();
  ...
  private final ListMultimap<Error, String> errors = LinkedListMultimap.create();
  ...
  @Override
  public void processCommands(Collection<ReceiveCommand> commands,
  ...
  private class ReplaceRequest {
    ...
    PatchSet.Id insertPatchSet(RequestState state) throws OrmException,
      ...
      ReplaceOp replaceOp = replaceOpFactory.create(requestScopePropagator,
          projectControl, magicBranch.dest,
