...
public class ProjectConfig extends VersionedMetaData {
  ...
  private static final String KEY_COPY_ALL_SCORES_ON_COMMIT_MESSAGE_ONLY_CHANGE = "copyAllScoresOnCommitMessageOnlyChange";
  ...
  private void loadLabelSections(Config rc) throws IOException {
    ...
    for (String name : rc.getSubsections(LABEL)) {
      ...
      label.setCopyAllScoresOnCommitMessageOnlyChange(
          rc.getBoolean(LABEL, name, KEY_COPY_ALL_SCORES_ON_COMMIT_MESSAGE_ONLY_CHANGE, false));
