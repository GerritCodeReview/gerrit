...
public class ProjectConfig extends VersionedMetaData {
  ...
  private static final String KEY_USE_ALL_NOT_IN_TARGET = "useAllNotInTarget";
  ...
  protected void onLoad() throws IOException, ConfigInvalidException {
    ...
    p.setUseAllNotInTarget(getEnum(rc, RECEIVE, null, KEY_USE_ALL_NOT_IN_TARGET, InheritableBoolean.INHERIT));
  ...
  protected boolean onSave(CommitBuilder commit) throws IOException,
    ...
    set(rc, RECEIVE, null, KEY_USE_ALL_NOT_IN_TARGET, p.getUseAllNotInTarget(), InheritableBoolean.INHERIT);
