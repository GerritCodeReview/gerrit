...
/** Provider for the {@link ReceiveCommitsExecutor}. */
public class ReceiveCommitsExecutorProvider
    implements Provider<WorkQueue.Executor> {
  private final Config config;
  private final WorkQueue queues;

  @Inject
  ReceiveCommitsExecutorProvider(@GerritServerConfig Config config,
      WorkQueue queues) {
    this.config = config;
    this.queues = queues;
  }
