...
public class RevisionEdit {
  ...
  /**
   * Returns reference for change edit with sharded user and change id:
   * refs/edits/UU/UUUU/CC/CCCC/
   * <p>
   * @param user identified user
   * @param changeId change id
   * @return ref reference for change edit with sharded user and change id
   */
  public static StringBuilder getChangeEditsRef(IdentifiedUser user,
      Change.Id changeId) {
