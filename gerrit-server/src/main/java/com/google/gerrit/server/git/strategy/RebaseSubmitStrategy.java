...
public class RebaseSubmitStrategy extends SubmitStrategy {
  ...
  private class RebaseMultipleParentsOp extends SubmitStrategyOp {
    ...
    public void updateRepoImpl(RepoContext ctx)
      ...
      // the commit messages can not be modified in the process. Users of
      // RebaseAlways strategy for whom changed commit footers are important
      // would be well advised to prohibit uploading patches with merge commits.
