  ...
  static class Arguments {
    interface Factory {
      Arguments create(
          ...
          Set<CodeReviewCommit> allIncomingCommits,
    ...
    final Set<CodeReviewCommit> incomingCommits;
    ...
    Arguments(
        ...
        @Assisted Set<CodeReviewCommit> incomingCommits,
      ...
      this.incomingCommits = incomingCommits;
