...
public class SubmitStrategyFactory {
  ...
  public SubmitStrategy create(SubmitType submitType, ReviewDb db,
      ...
      Set<CodeReviewCommit> allIncomingCommits, Branch.NameKey destBranch,
      IdentifiedUser caller, MergeTip mergeTip, CommitStatus commits,
    ...
    SubmitStrategy.Arguments args = argsFactory.create(submitType, destBranch,
        ...
        alreadyAccepted, allIncomingCommits, submissionId, notifyHandling,
