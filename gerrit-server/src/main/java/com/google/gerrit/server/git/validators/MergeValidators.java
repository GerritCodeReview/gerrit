...
public class MergeValidators {
  private final DynamicSet<MergeValidationListener> commitValidationListeners;
  ...
  @Inject
  MergeValidators(final DynamicSet<MergeValidationListener> commitValidationListeners,
  ...
  public void validatePreMergeCommit(final CodeReviewCommit commit, ProjectState destProject,
    ...
    List<MergeValidationListener> validators =
        new LinkedList<MergeValidationListener>();
  ...
  public static class PluginCommitValidationListener implements
    ...
    public PluginCommitValidationListener(
        final DynamicSet<MergeValidationListener> commitValidationListeners) {
      this.commitValidationListeners = commitValidationListeners;
    }
    ...
    public void onPreMergeCommit(final CodeReviewCommit commit,
        ...
        final Branch.NameKey destBranch)
        throws MergeValidationException {
      for (MergeValidationListener validator : commitValidationListeners) {
        validator.onPreMergeCommit(commit, destProject, destBranch);
      }
    }
  }
