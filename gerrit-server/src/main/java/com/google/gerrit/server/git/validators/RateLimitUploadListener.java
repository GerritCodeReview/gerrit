...
import com.google.gerrit.server.git.validators.RateLimiterModule.Holder;
  ...
  public void onBeginNegotiate(
      ...
      try {
        ...
        String msg =
            MessageFormat.format(
                "Cannot get rate limits for anonymous access from remote host ''{}''", remoteHost);
        log.warn(msg, e);
      }
    }
    if (limiter != null && !limiter.tryAcquire()) {
      throw new RateLimitException(
          MessageFormat.format(
              "Exceeded rate limit of {} fetch requests/hour",
