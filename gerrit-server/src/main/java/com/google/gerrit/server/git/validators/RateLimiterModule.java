...
public class RateLimiterModule extends CacheModule {
  static final String CACHE_NAME = "rate_limits_by_account";

  @Override
  protected void configure() {
    DynamicSet.bind(binder(), UploadValidationListener.class).to(RateLimitUploadListener.class);
    cache(CACHE_NAME, Account.Id.class, RateLimiter.class).loader(Loader.class);
  }

  private static class Loader extends CacheLoader<Account.Id, RateLimiter> {
    @Override
