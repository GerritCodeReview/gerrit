 ...
 *
 * Invoke by Gerrit before it begins to send a pack to the client.
 *
 * Implementors can block the upload operation by throwing a
 * UploadValidationException. The exception's message text will be reported to
