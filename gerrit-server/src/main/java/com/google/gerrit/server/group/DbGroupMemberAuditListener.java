...
class DbGroupMemberAuditListener implements GroupMemberAuditListener {
  ...
  private static void logOrmExceptionForAccounts(Id me,
  ...
  public void onAddGroupsToGroup(Id me, Collection<AccountGroupById> added) {
    ...
    try {
      ...
      logOrm("Cannot log add groups to group event performed by user ", me,
          added, e);
    }
  }
  ...
  public void onDeleteGroupsFromGroup(Id me,
    ...
    try {
      ...
      logOrm("Cannot log delete groups from group event performed by user ",
          me, removed, e);
    }
  }

  private static void logOrm(String header, Id me,
  ...
  private static <T> void logOrmException(Id me, Collection<T> values,
