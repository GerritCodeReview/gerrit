...
class DbGroupMemberAuditListener implements GroupMemberAuditListener {
  ...
  @Override
  public void onAddAccountsToGroup(Id me, Collection<AccountGroupMember> toBeAdded)
      throws IOException {
  ...
  @Override
  public void onDeleteAccountsFromGroup(Id me, Collection<AccountGroupMember> toBeRemoved)
      throws IOException {
    try {
  ...
  public void onAddGroupsToGroup(Id actor, Collection<AccountGroupById> added)
    ...
    try {
      ...
      throw new IOException("Cannot log add group to group event", e);
    }
  }

  @Override
  public void onDeleteGroupsFromGroup(Id me, Collection<AccountGroupById> removed)
      throws IOException {
    try {
