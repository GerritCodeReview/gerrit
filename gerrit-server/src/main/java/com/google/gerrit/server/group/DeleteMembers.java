...
public class DeleteMembers implements RestModifyView<GroupResource, Input> {
  ...
  public Response<?> apply(GroupResource resource, Input input)
    ...
    if (!control.canRemoveMember()) {
      throw new AuthException("Cannot delete any members from group " + resource.getName());
    }

    ImmutableSet.Builder<Account.Id> membersToRemove = ImmutableSet.builder();
    ...
    groupsUpdateProvider
        .get()
        .removeGroupMembers(db.get(), internalGroup.getGroupUUID(), membersToRemove.build());
