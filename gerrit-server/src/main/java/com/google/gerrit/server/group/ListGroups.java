...
public class ListGroups implements RestReadView<TopLevelResource> {
  ...
  private final static String MESSAGE = "You should have exact one --project with --suggestion";
  ...
  @Option(name = "--suggestion", usage = "to get a suggestion of groups from"
      + " the match group substring (requires --match and exact one --project,"
      + " will disable --visible-to-all and --owned, if set)")
