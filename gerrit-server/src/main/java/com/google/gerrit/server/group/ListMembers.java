...
import com.google.gerrit.server.group.MembersCollection.AccountInfo;
import com.google.gerrit.server.group.MembersCollection.GroupInfo;
...
public class ListMembers implements RestReadView<GroupResource> {
  ...
  @Override
  public Object apply(final GroupResource resource) throws AuthException,
