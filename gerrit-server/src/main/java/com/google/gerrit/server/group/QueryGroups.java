...
public class QueryGroups implements RestReadView<TopLevelResource> {
  ...
  /**
   * This option is used by {@link GroupsCollection} to decide if it should use
   * {@link QueryGroups} or {@link ListGroups} for listing its members.
   */
  @Option(name = "--expectList", usage = "expect results as list")
  public void setExpectList(@SuppressWarnings("unused") boolean expectList) {
  }
