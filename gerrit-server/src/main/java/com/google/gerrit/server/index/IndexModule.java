...
public class IndexModule extends LifecycleModule {
  ...
  ListeningExecutorService getInteractiveIndexExecutor(
    ...
    return MoreExecutors.listeningDecorator(workQueue.createQueueWithMetrics(threads, "Index-Interactive"));
  }
  ...
  ListeningExecutorService getBatchIndexExecutor(
    ...
    return MoreExecutors.listeningDecorator(workQueue.createQueueWithMetrics(batchThreads, "Index-Batch"));
  }
