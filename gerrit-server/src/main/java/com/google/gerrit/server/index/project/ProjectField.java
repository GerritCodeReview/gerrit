...
public class ProjectField {
  ...
  public static final FieldDef<ProjectState, Iterable<String>> NAME_PART =
      prefix("name_part").buildRepeatable(
          p -> SchemaUtil.getNameParts(p.getProject().getName()));

  public static final FieldDef<ProjectState, Iterable<String>> ANCESTOR_NAMES =
      exact("ancestor_names").buildRepeatable(
