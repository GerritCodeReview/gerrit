...
public class ProjectSchemaDefinitions extends SchemaDefinitions<ProjectState> {
  ...
  static final Schema<ProjectState> V1 = schema(
      ProjectField.NAME,
      ProjectField.DESCRIPTION,
      ProjectField.PARENT_NAME,
      ProjectField.NAME_PART,
      ProjectField.ANCESTOR_NAMES);

  public static final ProjectSchemaDefinitions INSTANCE =
      new ProjectSchemaDefinitions();
