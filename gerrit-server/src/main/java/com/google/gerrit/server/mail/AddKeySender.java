...
public class AddKeySender extends OutgoingEmail {
  public interface Factory {
    ...
    public AddKeySender create(IdentifiedUser user, List<PGPPublicKey> gpgKey);
  }

  private final IdentifiedUser callingUser;
  private final IdentifiedUser user;
  private final AccountSshKey sshKey;
  private final List<PGPPublicKey> gpgKeys;
  ...
  public AddKeySender(EmailArguments ea,
      IdentifiedUser callingUser,
      @Assisted IdentifiedUser user,
      @Assisted List<PGPPublicKey> gpgKeys) {
    super(ea, "addkey");
    this.callingUser = callingUser;
    this.user = user;
    this.sshKey = null;
  ...
  public String getGpgKeys() {
    if (gpgKeys != null) {
      ...
      for (PGPPublicKey key : gpgKeys) {
        output.append(PublicKeyStore.keyToString(key) + "\n");
      }
