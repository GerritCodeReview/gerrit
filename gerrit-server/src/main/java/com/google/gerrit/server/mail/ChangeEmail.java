...
import com.google.gerrit.server.mail.ProjectWatch.ChangeProjectWatch;
...
public abstract class ChangeEmail extends NotificationEmail {
  ...
  protected Watchers getWatches(NotifyType type) throws OrmException {
    ChangeProjectWatch projectWatch = new ChangeProjectWatch(args,
        project, projectState, changeData);
