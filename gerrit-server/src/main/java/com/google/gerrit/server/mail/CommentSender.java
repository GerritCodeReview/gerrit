...
public class CommentSender extends ReplyToChangeSender {
  ...
  private List<CommentSender.FileCommentGroup> getGroupedInlineComments() {
    ...
    Collections.sort(groups, new Comparator<FileCommentGroup>() {
      @Override
      public int compare(FileCommentGroup a, FileCommentGroup b) {
        return filenameComparator.compare(a.filename, b.filename);
      }
    });
    return groups;
  }
