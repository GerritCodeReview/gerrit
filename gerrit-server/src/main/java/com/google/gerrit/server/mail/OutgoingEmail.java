...
public abstract class OutgoingEmail {
  ...
  public void send() throws EmailException {
    ...
    if (shouldSendMessage()) {
      if (fromId != null) {
        ...
        if (selectedEmailOption == EmailingOptionsStrategy.CC_ON_OWN_COMMENTS) {
        ...
        } else if (selectedEmailOption == EmailingOptionsStrategy.DISABLED
        ...
        for (Account.Id id : rcptTo) {
          ...
          if (thisUser.getGeneralPreferences().getEmailingOptionsStrategy()
                  == EmailingOptionsStrategy.DISABLED) {
            removeUser(thisUser);
          }
  ...
  public void removeUser(Account user) {
    ...
    for (Address recipient : smtpRcptTo) {
      if (recipient.email.equals(fromEmail)) {
       smtpRcptTo.remove(recipient);
      }
    }
