...
/** Configures Soy Tofu object for rendering email templares. */
@Singleton
public class SoyTofuProvider implements Provider<SoyTofu> {
  ...
  @Inject
  SoyTofuProvider(SitePaths site) {
    this.site = site;
  }
  ...
  private void addTemplate(SoyFileSet.Builder builder, String name)
    ...
    // Load the template as a file in the mail templates directory if present.
    ...
    // Otherwsie load the template as a resource.
