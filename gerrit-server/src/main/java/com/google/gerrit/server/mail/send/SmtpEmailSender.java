...
public class SmtpEmailSender implements EmailSender {
  ...
  private void render(Writer out, final Map<String, EmailHeader> callerHeaders, String textBody,
      @Nullable String htmlBody) throws IOException, EmailException {
  ...
  private static void setMissingHeader(final Map<String, EmailHeader> hdrs, String name,
      String value) {
