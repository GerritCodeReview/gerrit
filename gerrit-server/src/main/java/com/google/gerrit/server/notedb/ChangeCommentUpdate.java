...
public class ChangeCommentUpdate {
   ...
   * @throws ConfigInvalidException
   */
  private ObjectId redoCommitList(
      Repository repo,
  ...
  private void updateMetaRefHeadToTargetCommit(
      Repository repo, String metaRefStr, ObjectId targetCommitObjId, ObjectId tip)
      throws IOException {
    ...
    refUpdate.setRefLogMessage("Remove a comment", true);
