 ...
 * its drafts branch.
 */
public class ChangeDraftNotes extends AbstractChangeNotes<ChangeDraftNotes> {
  @Singleton
  public static class Factory {
    ...
    public ChangeDraftNotes create(Change change, Account.Id accountId) {
      return new ChangeDraftNotes(repoManager, draftsProject, change,
          accountId);
    }
  }
  ...
  private static class Parser {
    ...
    private void parseDraftComments() throws IOException, ConfigInvalidException {
      ...
      noteMap = CommentsInNotesUtil.parseCommentsFromNotes(repo,
          ChangeDraftNotesUtil.draftRefName(author, changeId),
  ...
  ChangeDraftNotes(GitRepositoryManager repoManager,
  ...
  protected String getRefName() {
    return ChangeDraftNotesUtil.draftRefName(author, getChange().getId());
  }
