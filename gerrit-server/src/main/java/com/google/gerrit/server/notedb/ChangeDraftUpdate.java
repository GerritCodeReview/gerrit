...
public class ChangeDraftUpdate extends AbstractChangeUpdate {
  ...
  private final ChangeDraftNotes draftNotes;
  ...
  private ChangeDraftUpdate(
      ...
      ChangeDraftNotes.Factory draftNotesFactory,
  ...
  protected String getRefName() {
    return ChangeDraftNotesUtil.draftRefName(accountId, getChange().getId());
  }
  ...
  protected boolean onSave(CommitBuilder commit) throws IOException,
    ...
    msg.append("Update patch set ").append(psId.get());
    msg.append("\n\n");

    msg.append("Editing draft comments for user with accountId: ");
    msg.append(accountId.get());
