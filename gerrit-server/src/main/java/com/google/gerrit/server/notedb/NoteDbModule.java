...
public class NoteDbModule extends FactoryModule {
  ...
  public void configure() {
    ...
    if (!useTestBindings) {
      ...
      bind(new TypeLiteral<Cache<ChangeNoteCache.Key, ChangeNotesState>>() {})
          .annotatedWith(Names.named(ChangeNoteCache.CHANGE_NOTES))
          .toInstance(CacheBuilder.newBuilder()
              .<ChangeNoteCache.Key, ChangeNotesState>build());
    }
  }
}
