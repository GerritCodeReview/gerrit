...
public abstract class NotesMigration {
   ...
   * NoteDb, but any attempts to write will cause an error.
   */
   ...
   * are simply ignored; if {@code true}, any attempts to write will cause an
   * error.
   */
  ...
  public boolean ignoreChangeWrites() {
