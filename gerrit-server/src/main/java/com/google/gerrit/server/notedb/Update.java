 ...
 */
public abstract class Update extends VersionedMetaData {
  protected NotesMigration migration;
  protected GitRepositoryManager repoManager;
  protected MetaDataUpdate.User updateFactory;
  protected ChangeControl ctl;
