...
public class NoteDbMigrator implements AutoCloseable {
  ...
  public static class Builder {
    ...
    Builder(
      ...
      // Reload gerrit.config/notedb.config on each migrator invocation, so we know it starts with
      // the right state. This allows multiple migrations within the same Gerrit process, e.g. trial
