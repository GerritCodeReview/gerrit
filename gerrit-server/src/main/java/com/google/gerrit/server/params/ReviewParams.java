...
public class ReviewParams extends RequestParams {
  ...
  private static final ApprovalTypes approvalTypes =
      new ApprovalTypes();
  ...
  public static class Review {
    ...
    private final Set<ApprovalCategoryValue.Id> labels;
    ...
    public Review() {
      labels = new HashSet<ApprovalCategoryValue.Id>();
      query = null;
      message = null;
    ...
    public static ActionType getActionTypeByName(final String name) {
  ...
  private void parseReview(final JsonObject obj)
    ...
    final JsonElement action = obj.get("action");
    if (action == null) {
    ...
    final Review.ActionType type = review.getActionTypeByName(action.toString());
    if (type == Review.ActionType.NULL) {
