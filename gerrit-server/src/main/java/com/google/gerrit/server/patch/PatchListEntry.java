...
public class PatchListEntry {
  ...
  static PatchListEntry empty(final String fileName) {
    return new PatchListEntry(ChangeType.MODIFIED, PatchType.UNIFIED, null,
        fileName, EMPTY_HEADER, Collections.<BaseEdit> emptyList());
  }
  ...
  PatchListEntry(final FileHeader hdr, List<BaseEdit> editList) {
  ...
  private PatchListEntry(final ChangeType changeType,
      ...
      final byte[] header, final List<BaseEdit> edits) {
  ...
  void writeTo(final OutputStream out) throws IOException {
    ...
    for (final BaseEdit e : edits) {
      ...
      if (e instanceof LineEdit) {
        List<BaseEdit> intlEdits = ((LineEdit) e).getEdits();
  ...
  static PatchListEntry readFrom(final InputStream in) throws IOException {
    ...
    final BaseEdit[] editArray = new BaseEdit[editCount];
  ...
  private static List<BaseEdit> toList(BaseEdit[] l) {
