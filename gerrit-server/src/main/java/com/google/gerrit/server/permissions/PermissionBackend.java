...
public abstract class PermissionBackend {
  ...
  public abstract static class WithUser extends AcceptsReviewDb<WithUser> {
     ...
     *
     * <p>{@code conds} may contain duplicate entries. When duplicates exist, implementations should
     * set a result into all instances to ensure {@code testOrFalse} does not get invoked.
     *
