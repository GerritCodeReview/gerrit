...
public class PluginLoader implements LifecycleListener {
  ...
  private JarPlugin loadJarPlugin(String name, File srcJar, FileSnapshot snapshot,
  ...
  private JsPlugin loadJsPlugin(String name, File srcJar, FileSnapshot snapshot) {
    return new JsPlugin(name, srcJar, snapshot, ApiType.JS);
  }
