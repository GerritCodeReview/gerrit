...
public class CreateBranch implements RestModifyView<ProjectResource, Input> {
  ...
  private ObjectId parseStartingRevision(Repository repo,
      Project.NameKey projectName, String startingRevision)
    ...
    try {
      ...
      log.error("Invalid revision syntax \"" + startingRevision + "\"", err);
      throw new InvalidRevisionException();
    }
  }
