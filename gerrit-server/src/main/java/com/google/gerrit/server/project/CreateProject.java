...
class CreateProject implements RestModifyView<TopLevelResource, Input> {
  ...
  public Object apply(TopLevelResource resource, Input input)
    ...
    args.contentMerge = input.submitType == SubmitType.FAST_FORWARD_ONLY
        ? InheritableBoolean.FALSE : Objects.firstNonNull(input.useContentMerge, InheritableBoolean.INHERIT);
