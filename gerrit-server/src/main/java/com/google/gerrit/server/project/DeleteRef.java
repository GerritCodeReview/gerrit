...
public class DeleteRef {
  ...
  public static class Factory {
    private final Provider<IdentifiedUser> iu;
    private final GitRepositoryManager rm;
    private final GitReferenceUpdated ru;
    private final RefValidationHelper rvh;
    private final Provider<InternalChangeQuery> qp;

    @Inject
    Factory(Provider<IdentifiedUser> identifiedUser,
        GitRepositoryManager repoManager,
        GitReferenceUpdated referenceUpdated,
        RefValidationHelper.Factory refHelperFactory,
        Provider<InternalChangeQuery> queryProvider) {
      this.iu = identifiedUser;
      this.rm = repoManager;
      this.ru = referenceUpdated;
      this.rvh = refHelperFactory.create(DELETE);
      this.qp = queryProvider;
    }

    public DeleteRef forResource(ProjectResource r) {
      return new DeleteRef(iu, rm, ru, rvh, qp, r);
    }
  }

  protected DeleteRef(Provider<IdentifiedUser> identifiedUser,
      GitRepositoryManager repoManager,
      GitReferenceUpdated referenceUpdated,
      RefValidationHelper refDeletionValidator,
      Provider<InternalChangeQuery> queryProvider,
      ProjectResource resource) {
    this.identifiedUser = identifiedUser;
    this.repoManager = repoManager;
    this.referenceUpdated = referenceUpdated;
    this.refDeletionValidator = refDeletionValidator;
