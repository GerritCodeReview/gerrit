...
import com.google.gerrit.extensions.common.PermissionRuleActionInfo;
...
public class GetAccess implements RestReadView<ProjectResource> {
  ...
  @Inject
  public GetAccess(GroupControl.Factory groupControlFactory,
    ...
    accessSectionInfo.permissions = Maps.newHashMap();
      for (Permission p : section.getPermissions()) {
        ...
        for (PermissionRule r : p.getRules()) {
          ...
          PermissionRuleActionInfo.values()[r.getAction().ordinal()],r.getForce());
          if(r.hasRange()) {
            info.max = r.getMax();
            info.min = r.getMin();
          }
