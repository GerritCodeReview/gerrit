...
public class ListTags implements RestReadView<ProjectResource> {
  ...
  public List<TagInfo> apply(ProjectResource resource)
    ...
    try (Repository repo = getRepository(resource.getNameKey());
      ...
      for (Ref ref : all.values()) {
        tags.add(createTagInfo(ref, rw, control.controlForRef(ref.getName()), control, links));
      }
    }
  ...
  public static TagInfo createTagInfo(Ref ref, RevWalk rw, RefControl control, ProjectControl pcntl, WebLinks links)
...
>>>>>>> 1d3fc36251... Add support for tag web links
        .filter(tags, true);
  }
}
