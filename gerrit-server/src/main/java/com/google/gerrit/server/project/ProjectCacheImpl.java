...
public class ProjectCacheImpl implements ProjectCache {
  ...
  private final List<ProjectEvictListener> evictListeners =
      Collections.synchronizedList(new LinkedList<ProjectEvictListener>());
  ...
  public void evict(final Project p) {
    if (p != null) {
      ...
      synchronized (evictListeners) {
        final Iterator<ProjectEvictListener> it = evictListeners.iterator();
        while (it.hasNext()) {
          final ProjectEvictListener l = it.next();
