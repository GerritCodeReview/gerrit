...
public class ProjectState {
  ...
  public MergeStrategySection getMostSpecificMergeStrategy(final String destBranch)
      throws NoSuchRefPatternMatches, InvalidNameException {
    ...
    final List<MergeStrategySection> refStrategiesMatchers =
        filterRefStrategies(refStrategies);
