...
public class RefFilter<T extends RefInfo> {
  ...
  public RefFilter<T> setSubString(String subString) {
    this.matchSubstring = subString;
    return this;
  }

  public RefFilter<T> setRegex(String regex) {
    this.matchRegex = regex;
    return this;
  }

  public RefFilter<T> setStart(int start) {
    this.start = start;
    return this;
  }

  public RefFilter<T> setLimit(int limit) {
    this.limit = limit;
    return this;
  }
