...
public class SetAccessUtil {
   ...
   * permission.
   */
  void validateChanges(ProjectControl projectControl, ProjectConfig config,
      List<AccessSection> removals,
      List<AccessSection> additions)
      throws BadRequestException, AuthException, InvalidNameException,
  ...
  void setParentName(ProjectControl projectControl,
