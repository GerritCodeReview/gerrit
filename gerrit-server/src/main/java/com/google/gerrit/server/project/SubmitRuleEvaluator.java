...
public class SubmitRuleEvaluator {
  ...
  public static SubmitTypeRecord defaultTypeError() {
    return createTypeError("Error evaluating project rules, check server log");
  }
  ...
  public List<SubmitRecord> canSubmit() throws OrmException {
    ...
    if (results.isEmpty()) {
      ...
      return ruleError("Submit rule '" + getSubmitRule() + "' for change "
  ...
  private List<SubmitRecord> invalidResult(Term rule, Term record, String reason) {
    return ruleError("Submit rule " + rule + " for change " + cd.getId()
        + " of " + getProjectName() + " output invalid result: " + record
