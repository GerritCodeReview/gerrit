...
import com.google.gerrit.reviewdb.client.ChangeSet;
import com.google.gerrit.reviewdb.client.ChangeSetApproval;
import com.google.gerrit.reviewdb.client.ChangeSetElement;
...
public class TopicControl {
  ...
  public boolean canAbandon() {
    return isOwner() // owner (aka creator) of the change can abandon
        ...
        || getCurrentUser().getCapabilities().canAdministrateServer() // site
                                                                      // administers
                                                                      // are god
    ;
  }
  ...
  public List<SubmitRecord> canSubmit(ReviewDb db, ChangeSet.Id changeSetId,
    ...
    final List<ChangeSetElement> topicChangeSet =
    ...
    for (Change change : changesInTopic) {
      ...
      List<SubmitRecord> result =
          cc.canSubmit(db, db.patchSets().get(change.currentPatchSetId()), true);
      if (result.isEmpty()) {
