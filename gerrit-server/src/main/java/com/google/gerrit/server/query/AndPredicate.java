...
public class AndPredicate<T, C> extends Predicate<T, C> {
  private final List<Predicate<T, C>> children;
  private final int cost;

  protected AndPredicate(final Predicate<T, C>... that) {
    this(Arrays.asList(that));
  }

  protected AndPredicate(final Collection<? extends Predicate<T, C>> that) {
  ...
  public Predicate<T, C> copy(final Collection<? extends Predicate<T, C>> children) {
    return new AndPredicate<T, C>(children);
  }
