...
public class ChangeQueryRewriter extends QueryRewriter<ChangeData, PatchSet> {
  ...
  public Predicate<ChangeData, PatchSet> r05_byBranchOpenPrev(
  ...
  public Predicate<ChangeData, PatchSet> r05_byBranchOpenNext(
      @Named("P") final ProjectPredicate p,
      @Named("B") final BranchPredicate b,
  ...
  public Predicate<ChangeData, PatchSet> r05_byBranchMergedPrev(
      @Named("P") final ProjectPredicate p,
      @Named("B") final BranchPredicate b,
      @Named("S") final SortKeyPredicate.After s,
      @Named("L") final IntPredicate<ChangeData, PatchSet> l) {
  ...
  public Predicate<ChangeData, PatchSet> r05_byBranchMergedNext(
      @Named("P") final ProjectPredicate p,
      @Named("B") final BranchPredicate b,
      @Named("S") final SortKeyPredicate.Before s,
      @Named("L") final IntPredicate<ChangeData, PatchSet> l) {
