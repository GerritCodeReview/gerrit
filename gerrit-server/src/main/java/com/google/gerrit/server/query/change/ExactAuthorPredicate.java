...
public class ExactAuthorPredicate extends ChangeIndexPredicate {
  public ExactAuthorPredicate(String email) {
    super(EXACT_AUTHOR, FIELD_EXACTAUTHOR, email.toLowerCase(Locale.US));
  }

  @Override
  public boolean match(ChangeData object) throws OrmException {
    try {
      return ChangeField.getAuthorNameAndEmail(object).contains(getValue().toLowerCase(Locale.US));
    } catch (IOException e) {
