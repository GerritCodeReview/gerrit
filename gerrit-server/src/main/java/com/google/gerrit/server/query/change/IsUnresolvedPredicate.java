...
public class IsUnresolvedPredicate extends IntegerRangeChangePredicate {
  IsUnresolvedPredicate() throws QueryParseException {
    super(ChangeField.UNRESOLVED_COMMENT_COUNT, ">0");
  }
  ...
  @Override
  protected Integer getValueInt(ChangeData object) throws OrmException {
    return ChangeField.UNRESOLVED_COMMENT_COUNT.get(object, null);
  }
}
