...
class IsWatchedByPredicate extends AndPredicate<ChangeData> {
  ...
  IsWatchedByPredicate(
      ChangeQueryBuilder.Arguments args, ChangeCache changeCache, boolean checkIsVisible)
  ...
  private static List<Predicate<ChangeData>> filters(
      ChangeCache changeCache, ChangeQueryBuilder.Arguments args, boolean checkIsVisible)
      throws QueryParseException {
