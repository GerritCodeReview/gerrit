...
public class PrefetchableAndPredicate extends AndPredicate<ChangeData>
    implements Prefetchable {

  public PrefetchableAndPredicate(
      Collection<? extends Predicate<ChangeData>> that) {
    super(that);
  }

  public PrefetchableAndPredicate(Predicate<ChangeData>... that) {
    super(that);
  }
