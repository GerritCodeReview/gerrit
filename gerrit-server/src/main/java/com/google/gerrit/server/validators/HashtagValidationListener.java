...
public interface HashtagValidationListener {
   ...
   *
   * @param updatedChange the change on which the hashtags are updated, note it
   *        is null when it is commit message hashtags of new change.
   * @param toAdd the hashtags to be added
   * @param toRemove the hashtags to be removed
   * @throws ValidationException if validation fails
   */
  public void validateHashtags(Change updatedChange, Set<String> toAdd,
