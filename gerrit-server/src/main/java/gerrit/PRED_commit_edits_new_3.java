 ...
 *
 * <pre>
 *   'commit_edits_new'(+FileNameRegex, +EditRegex, +Qualifier)
 * </pre>
 */
public class PRED_commit_edits_new_3 extends PRED_commit_edits_3 {
  public PRED_commit_edits_new_3(Term a1, Term a2, Term a3, Operation n) {
    super(a1, a2, a3, n, Revision.New);
  }
}
