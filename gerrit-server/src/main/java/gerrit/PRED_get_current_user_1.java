...
class PRED_get_current_user_1 extends Predicate.P1 {
  private static final long serialVersionUID = 1L;
  private static final SymbolTerm user = SymbolTerm.intern("user", 1);

  PRED_get_current_user_1(Term a1, Operation n) {
    arg1 = a1;
    cont = n;
  }
  ...
  public Operation exec(Prolog engine) throws PrologException {
    ...
    if (curUser instanceof IdentifiedUser) {
      ...
      resultTerm = SymbolTerm.intern("anonymous");
    } else if (curUser instanceof PeerDaemonUser) {
      resultTerm = SymbolTerm.intern("peerdaemon");
