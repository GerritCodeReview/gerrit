...
public class CacheTest {
  ...
  @Before
  public void createConfig() throws ConfigInvalidException, FileNotFoundException, IOException {
    String config = "[cache]\n\tdirectory = cache";
    ...
    def = new CacheProvider<String, String>(null, "name", STRING, STRING);
  ...
  @Test
  public void testNonPersistentWithExpiration() throws Exception {
  ...
  public void testNonPersistentWithLoader() throws Exception {
    ...
    LoadingCache<String, String> cache = (LoadingCache<String, String>) def.get();
