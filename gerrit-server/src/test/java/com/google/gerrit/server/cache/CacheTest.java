...
public class CacheTest {
  ...
  public void createConfig()
      throws ConfigInvalidException, FileNotFoundException, IOException {
    String config = "[cache]\n\tdirectory = cache";
  ...
  public void testNonPersistent() throws Exception {
    ...
    assertThat("value").isEqualTo(cache.getIfPresent("key"));
    assertThat(cache.getIfPresent("other")).isNull();
  }
  ...
  public void testNonPersistentWithLoader() throws Exception {
    ...
    assertThat("key_0").isEqualTo(cache.get("key"));
    assertThat(cache.getIfPresent("other")).isNull();
  ...
  public void testNonPersistentWithLoaderAndExpriration() throws Exception {
    ...
    ticker.set(SECONDS.toNanos(2));
    assertThat("key_1").isEqualTo(cache.get("key"));
  }
  ...
  private void waitForExecutor()
    ...
    assumeThat(((ThreadPoolExecutor) executorService).getMaximumPoolSize(),
        is(1));
