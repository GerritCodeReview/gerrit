...
public class ScheduleConfigTest {
  ...
  private static DateTime now = DateTime.parse("2014-06-13T10:00:00-00:00");
  ...
  private static long initialDelay(String startTime, String interval) throws ConfigInvalidException {
  ...
  private static Config readConfig(final String dat) throws ConfigInvalidException {
