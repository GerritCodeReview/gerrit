...
public class QueryListTest extends TestCase {
  ...
  public void testParseSimple() throws Exception {
    ...
    assertThat(Q_P.equals(ql.getQuery(N_FOO))).isTrue();
    assertThat(Q_B.equals(ql.getQuery(N_BAR))).isTrue();
  }
  ...
  public void testParseComplex() throws Exception {
    ...
    assertThat(Q_COMPLEX.equals(ql.getQuery(N_FOO))).isTrue();
  }

  @Test
  public void testParseBad() throws Exception {
    try {
      QueryList.parse(L_BAD, null);
  ...
  public void testAsText() throws Exception {
    final String expectedText = HEADER + "#\n" + F_PROPER;
    QueryList ql = QueryList.parse(F_SIMPLE, null);
