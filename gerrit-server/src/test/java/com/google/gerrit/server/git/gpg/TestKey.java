...
class TestKey {
   ...
   * </pre>
   */
  static final TestKey KEY1 = new TestKey(
   ...
   * </pre>
   */
  static final TestKey KEY2 = new TestKey(
      "-----BEGIN PGP PUBLIC KEY BLOCK-----\n"
      + "Version: GnuPG v1\n"
      + "\n"
   ...
   * </pre>
   */
  static final TestKey KEY3 = new TestKey(
      "-----BEGIN PGP PUBLIC KEY BLOCK-----\n"
      + "Version: GnuPG v1\n"
      + "\n"
   ...
   * </pre>
   */
  static final TestKey KEY4 = new TestKey(
      "-----BEGIN PGP PUBLIC KEY BLOCK-----\n"
      + "Version: GnuPG v1\n"
      + "\n"
  ...
  private TestKey(String pub, String sec) {
    this.pub = pub;
    this.sec = sec;
  }
  ...
  PGPPublicKey getPublicKey() throws IOException {
    return new PGPPublicKeyRing(newStream(pub),
  ...
  PGPSecretKey getSecretKey() throws PGPException, IOException {
    return new PGPSecretKeyRing(newStream(sec),
        new BcKeyFingerprintCalculator()).getSecretKey();
  }

  String getFirstUserId() throws IOException {
