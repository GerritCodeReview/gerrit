...
public class StalenessCheckerTest extends GerritBaseTests {
  ...
  public void refStateToByteArray() {
    assertThat(
            new String(
                RefState.toByteArray(
                    P1, "refs/heads/foo", ObjectId.fromString(SHA1)),
                UTF_8))
        .isEqualTo(P1 + ":refs/heads/foo:" + SHA1);
    assertThat(
            new String(RefState.toByteArray(P1, "refs/heads/foo", null), UTF_8))
  ...
  public void refStatePatternToByteArray() {
    assertThat(new String(RefStatePattern.toByteArray(P1, "refs/*"), UTF_8))
        .isEqualTo(P1 + ":refs/*");
  }
