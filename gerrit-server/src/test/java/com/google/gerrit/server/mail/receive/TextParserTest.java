...
public class TextParserTest extends AbstractParserTest {
  ...
  private static final String changeURL =
      "https://gerrit-review.googlesource.com/#/changes/123/1";

  @Test
  public void testSimpleChangeMessage() {
    MailMessage.Builder b = newMailMessageBuilder();
    b.textContent("Looks good to me\n" + quotedFooter);

    List<Comment> comments = new ArrayList<>();
    comments.add(newComment("c1", "gerrit-server/test.txt", "comment", 2));
    comments.add(newComment("c2", "gerrit-server/readme.txt", "comment", 2));
    comments.add(newComment("c3", "gerrit-server/readme.txt", "comment", 3));
  ...
  @Test
  public void testSimpleInlineComments() {
    MailMessage.Builder b = newMailMessageBuilder();
    b.textContent(newPlaintextBody("Looks good to me",
        "I have a comment on this.", null, "Also have a comment here.",
        null, null) + quotedFooter);

    List<Comment> comments = new ArrayList<>();
    comments.add(newComment("c1", "gerrit-server/test.txt", "comment", 2));
    comments.add(newComment("c2", "gerrit-server/test.txt", "comment", 3));
    comments.add(newComment("c3", "gerrit-server/readme.txt", "comment", 3));
  ...
  @Test
  public void testSimpleFileComment() {
    MailMessage.Builder b = newMailMessageBuilder();
    b.textContent(newPlaintextBody("Looks good to me",
        null, null, "Also have a comment here.",
        "This is a nice file", null) + quotedFooter);
  ...
  public void testNoComments() {
    MailMessage.Builder b = newMailMessageBuilder();
    b.textContent(newPlaintextBody(null, null, null, null, null, null) +
        quotedFooter);
  ...
  @Test
  public void testNoChangeMessage() {
    MailMessage.Builder b = newMailMessageBuilder();
    b.textContent(newPlaintextBody(null, null, null,
        "Also have a comment here.", "This is a nice file", null) +
        quotedFooter);
  ...
  @Test
  public void testAllCommentsGmail() {
    MailMessage.Builder b = newMailMessageBuilder();
    b.textContent((newPlaintextBody("Looks good to me",
        null, null, "Also have a comment here.",
        "This is a nice file", null) + quotedFooter).replace("> ", ">> "));
  ...
  private static String newPlaintextBody(String changeMessage, String c1,
      String c2, String c3, String f1, String f2) {
    return (changeMessage == null ? "" : changeMessage + "\n") +
        ...
        (c1 == null ? "" : c1 + "\n") +
        "> \n" +
        "> " + changeURL + "/gerrit-server/test.txt@3\n" +
        ...
        (c2 == null ? "" : c2 + "\n") +
        "> \n" +
        "> " + changeURL + "/gerrit-server/readme.txt\n" +
        "> File  \n" +
        "> gerrit-server/readme.txt:\n" +
        (f2 == null ? "" : f2 + "\n") +
        "> \n" +
        "> " + changeURL + "/gerrit-server/readme.txt@3\n" +
        "> PS1, Line 3: E\n" +
