...
public class ChangeBundleTest {
  ...
  public void diffChangesTakesMaxEntityTimestampFromReviewDb() throws Exception {
    ...
    ChangeBundle b1 =
        new ChangeBundle(
            c1, messages(), patchSets(), approvals(a), comments(), reviewers(), REVIEW_DB);
    ChangeBundle b2 =
        new ChangeBundle(
            c2, messages(), patchSets(), approvals(a), comments(), reviewers(), REVIEW_DB);
    assertDiffs(
        b1,
        b2,
        "effective last updated time differs for Change.Id "
    ...
    b2 =
        new ChangeBundle(
            c2, messages(), patchSets(), approvals(a), comments(), reviewers(), NOTE_DB);
    assertNoDiffs(b1, b2);
  }
  ...
  public void diffChangesIgnoresChangeTimestampIfAnyOtherEntitiesExist() {
    ...
    ChangeBundle b2 =
        new ChangeBundle(
            c1, messages(), patchSets(), approvals(a), comments(), reviewers(), NOTE_DB);
