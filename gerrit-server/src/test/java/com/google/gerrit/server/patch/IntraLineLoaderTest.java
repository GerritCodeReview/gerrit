...
public class IntraLineLoaderTest {
  ...
  @Test
  public void indentationIsLeftShifted() throws Exception {
    String a = " abc\n";
    String b = "  abc\n";
    assertThat(intraline(a,b)).isEqualTo(wordEdit(1, 1, 0, 1));
    // Deletion shifting does not work yet, but (0, 0, 0, 1) would be better
  }

  @Test
  public void nonIndentationWhitespaceChangeIsRightShifted() throws Exception {
    String a = "abc def\n";
    String b = "abc  def\n";
    assertThat(intraline(a,b)).isEqualTo(wordEdit(4, 4, 4, 5));
  }

  @Test
  public void multilineIndentationChange() throws Exception {
    String a = " abc\n  def\n";
    String b = "  abc\n   def\n";
    List<Edit> expected = new EditList();
    expected.add(new Edit(1, 1, 0, 1));
    expected.add(new Edit(6, 6, 6, 7));
    assertThat(intraline(a, b)).isEqualTo(expected);
    // Deletion shifting does not work yet, but [(0, 0, 0, 1), (5, 5, 6, 7)]
    // would be better
  }
