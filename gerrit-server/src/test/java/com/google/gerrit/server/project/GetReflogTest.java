...
public class GetReflogTest {
  ...
  @Mock GitRepositoryManager repoManagerMock;
  @Mock ReflogReader reflogReaderMock;
  ...
  public void setUp() throws Exception {
    ...
    lenient().when(repositoryMock.getReflogReader(repoBranchInfo.ref)).thenReturn(reflogReaderMock);
  }
