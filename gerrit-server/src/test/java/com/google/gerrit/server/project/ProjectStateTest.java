...
public class ProjectStateTest extends TestCase {
  ...
  public void testMatchWithOnlyLocalMergeContent() throws Exception {
    final MergeStrategySection oneProjectSectionToMaster =
        new MergeStrategySection("refs/heads/master");
    oneProjectSectionToMaster
        .setUseContentMerge(MergeStrategySection.UseContentMerge.FALSE);
    ...
    final MergeStrategySection allProjectsSection =
        new MergeStrategySection(RefConfigSection.ALL);
    allProjectsSection
        .setUseContentMerge(MergeStrategySection.UseContentMerge.TRUE);
    allProjectsSection
        .setSubmitType(MergeStrategySection.SubmitType.MERGE_IF_NECESSARY);

    final MergeStrategySection expectedMostSpecificSection =
        new MergeStrategySection("refs/heads/master");
  ...
  public void testMatchWithOnlyLocalAction() throws Exception {
    ...
    final MergeStrategySection allProjectsSectionAll =
        new MergeStrategySection(RefConfigSection.ALL);
    ...
    final MergeStrategySection allProjectsSectionMaster =
        new MergeStrategySection("refs/heads/master");
  ...
  private void execute(final List<MergeStrategySection> oneProjectSections,
    ...
    assertEquals(mostSpecificWanted, state
        .getMostSpecificMergeStrategy(destBranch));
