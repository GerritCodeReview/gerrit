...
public class Util {
  ...
  static public PermissionRule grantLabel(ProjectConfig project,
  ...
  static PermissionRule grant(ProjectConfig project, String permissionName,
  ...
  public void add(ProjectConfig pc) {
    ...
    all.put(pc.getProject().getNameKey(),
        new ProjectState(projectCache, allProjectsName, projectControlFactory,
            envFactory, mgr, rulesCache, pc));
  }
  ...
  private ProjectState newProjectState(ProjectConfig local) {
    ...
    all.put(local.getProject().getNameKey(), new ProjectState(projectCache,
        allProjectsName, projectControlFactory, envFactory, mgr, rulesCache,
        local));
  ...
  private class MockUser extends CurrentUser {
    ...
    MockUser(String name, AccountGroup.UUID[] groupId) {
      // super(RefControlTest.this.util.getCapabilityControFactory());
