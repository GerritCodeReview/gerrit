...
public class RenameChangesTaskTest extends LoggingMockingTestCase {
  ...
  public void testNoChange() throws OrmException,
    ...
    expect(changeAccess.byProject(new Project.NameKey("dummySource")))
  ...
  public void testSingleChange() throws OrmException,
    ...
    // Updating changes
    change.setProject(new Project.NameKey("dummyDestination"));
  ...
  public void testMultipleChanges() throws OrmException,
    ...
    // Updating changes
    change1.setProject(new Project.NameKey("dummyDestination"));
    change2.setProject(new Project.NameKey("dummyDestination"));
    control.checkOrder(true);
  ...
  public void testMultipleChangesRollback() throws OrmException,
    ...
    control.checkOrder(false);
    expect(changeAccess.byProject(new Project.NameKey("dummyDestination")))
        .andReturn(new ListResultSet<Change>(changes)).anyTimes();
    change1.setProject(new Project.NameKey("dummySource"));
    change2.setProject(new Project.NameKey("dummySource"));
    control.checkOrder(true);
    changeAccess.update(setEq(Lists.newArrayList(change1,change2)));
