...
public class ReparentChildProjectsTaskTest extends LoggingMockingTestCase {
  ...
  public void testNoProjects() throws ProjectRenamingFailedException {
    ...
    ReparentChildProjectsTask task = createTask("dummySource",
        "dummyDestination");
    task.carryOut();
    task.rollback();
  }
  ...
  public void testProjectWithoutParent() throws ProjectRenamingFailedException {
    ...
    expect(projectCache.get(new Project.NameKey("projectA")))
  ...
  public void testProjectWithoutMatch() throws ProjectRenamingFailedException {
    ...
    expect(projectCache.get(new Project.NameKey("projectB")))
  ...
  public void testAbortOnError() throws ConfigInvalidException, IOException,
    ...
    expect(projectCache.get(new Project.NameKey("child")))
  ...
  public void testProjectMultipleMatches() throws ConfigInvalidException,
    ...
    expect(projectCache.get(new Project.NameKey("child1")))
    ...
    expect(projectCache.get(new Project.NameKey("child2")))
    ...
    expect(projectCache.get(new Project.NameKey("otherProject")))
  ...
  private ReparentChildProjectsTask createTask(String sourceName,
      String destinationName) {
    ReparentChildProjectsTask.Factory factory = injector.getInstance(
        ReparentChildProjectsTask.Factory.class);
    ReparentChildProjectsTask renameParentsTask = factory.create(
