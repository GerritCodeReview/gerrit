...
public class OrPredicateTest extends TestCase {
  ...
  public void testChildren() {
    ...
    final Predicate<String, String> n = or(a, b);
  ...
  public void testCopy() {
    ...
    final Predicate<String, String> n2 = or(a, b);
  ...
  private static <T, C> List<Predicate<T, C>> list(final Predicate<T, C>... predicates) {
