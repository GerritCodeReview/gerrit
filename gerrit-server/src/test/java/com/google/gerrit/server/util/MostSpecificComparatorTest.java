...
public class MostSpecificComparatorTest {
   ...
   * glob pattern's Levenshtein distance to decrease by 1.
   */
  @Test
  public void charOneTest() {
    cmp = new MostSpecificComparator("refs/heads/abc/spam/branch2");
    // These should both be a Levenshtein distance of 12 from the refname
    moreSpecificFirst("^refs/heads/.*spam.*", "refs/heads/abc/*");
    cmp = new MostSpecificComparator("refs/heads/abc/spam/branch1");
    System.out.format("compare: %d%n", cmp.compare("^refs/heads/.*spam.*", "refs/heads/abc/*"));
    // These also should both be a Levenshtein distance of 12 from the refname
    moreSpecificFirst("^refs/heads/.*spam.*", "refs/heads/abc/*");
  }
