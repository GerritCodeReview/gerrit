...
public class SshCommandDetailCacheImpl implements SshCommandDetailCache {

  private static final String CACHE_NAME = "sshd_commands";
    ...
    return new CacheModule() {
      ...
      protected void configure() {
        cache(CACHE_NAME, new TypeLiteral<Class<?>>() {}, new TypeLiteral<Set<String>>() {})
            .loader(Loader.class);
        bind(SshCommandDetailCache.class).to(SshCommandDetailCacheImpl.class);
      }
    };
  }

  @Inject
  SshCommandDetailCacheImpl(@Named(CACHE_NAME) LoadingCache<Class<?>, Set<String>> cache) {
