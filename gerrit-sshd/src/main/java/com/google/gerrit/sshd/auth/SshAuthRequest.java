...
public class SshAuthRequest extends AuthRequest {
  ...
  public SshAuthRequest(String username, SocketAddress clientAddress) {
    this(username, null, clientAddress);
  }
   ...
   * @param clientAddress remote SSH client address
   */
  public SshAuthRequest(String username, String password, SocketAddress clientAddress) {
  ...
  public void checkPassword(String pwd) throws AuthException {
    super.checkPassword(pwd);
    // TODO check public key also
  }
}
