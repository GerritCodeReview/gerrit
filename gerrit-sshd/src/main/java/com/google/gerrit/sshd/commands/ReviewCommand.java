...
public class ReviewCommand extends SshCommand {
  ...
  protected void run() throws UnloggedFailure {
    ...
    if (json) {
      ...
      if (abandonChange) {
        throw error("json and abandon abandon are mutually exclusive");
      }
      if (changeComment != null) {
        throw error("json and message actions are mutually exclusive");
      }
      if (projectControl != null) {
        throw error("json and project actions are mutually exclusive");
      }
    }
    ...
    for (final PatchSet patchSet : patchSets) {
      try {
        ...
        writeError("error: Invalid application/json in request\n");
