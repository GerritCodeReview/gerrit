...
public class ReviewCommand extends SshCommand {
  ...
  @Argument(index = 0, required = true, multiValued = true, metaVar = "{COMMIT | CHANGE,PATCHSET}",
      usage = "list of commits or change/patch sets to review")
  ...
  @Option(name = "--project", aliases = "-p", usage = "project containing the change(s)")
  ...
  @Option(name = "--submit", aliases = "-s", usage = "submit the specified change(s)")
  private boolean submitChange;

  @Option(name = "--force-message", usage = "publish the message, "
      + "even if the label score cannot be applied due to the change(s) being closed")
