...
import com.google.gerrit.server.change.DropDraftPatchSet;
...
public class ReviewCommand extends SshCommand {
  ...
  @Inject
  private DropDraftPatchSet dropDraftPatchSet;
  ...
  private void approveOne(final PatchSet patchSet) throws Exception {
    ...
    try {
      ...
      if (publishPatchSet) {
        ...
        dropDraftPatchSet.apply(new RevisionResource(
            new ChangeResource(ctl), patchSet),
            new DropDraftPatchSet.Input());
      }
