...
public class SetHeadCommand extends SshCommand {
  ...
  @Argument(index = 0, required = true, metaVar = "PROJECT_NAME", usage = "name of the project")
  private ProjectControl project;

  @Option(name = "--new-head", required = true, metaVar = "REF_NAME", usage = "new HEAD reference")
