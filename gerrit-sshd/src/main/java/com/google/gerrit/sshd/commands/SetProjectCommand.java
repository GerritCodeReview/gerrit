...
final class SetProjectCommand extends SshCommand {
  ...
  private void validate() throws UnloggedFailure {
    checkIfBothSet(contentMerge, "--use-content-merge",
        noContentMerge, "--no-content-merge");

    checkIfBothSet(contributorAgreements, "--use-contributor-agreements",
        noContributorAgreements, "--no-contributor-agreements");

    checkIfBothSet(signedOffBy, "--use-signed-off-by",
        noSignedOffBy, "--no-signed-off-by");

    checkIfBothSet(requireChangeID, "--require-change-id",
