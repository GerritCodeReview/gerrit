...
final class TestSubmitRule extends SshCommand {
  ...
  @Option(name = "-s",
      usage = "Read prolog script from stdin. (Otherwise uses rules.pl from refs/meta/config)")
  private boolean useStdin;

  @Option(name = "--use-submit-filters",
  ...
  protected void run() throws UnloggedFailure {
    ...
    try {
      ...
      // thus will leak
      // information that a change-id is valid even though the user can't 'see'
      // the change.
  ...
  public void runSubmitFilters(ProjectState projectState, List<Term> results,
