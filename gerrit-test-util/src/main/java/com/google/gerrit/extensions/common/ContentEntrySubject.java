...
public class ContentEntrySubject extends Subject<ContentEntrySubject, ContentEntry> {
  ...
  private static final Subject.Factory<ContentEntrySubject, ContentEntry>
      DIFF_INFO_SUBJECT_FACTORY =
          new Subject.Factory<ContentEntrySubject, ContentEntry>() {
            @Override
            public ContentEntrySubject createSubject(
                FailureMetadata failureMetadata, ContentEntry contentEntry) {
              return new ContentEntrySubject(failureMetadata, contentEntry);
            }
          };
