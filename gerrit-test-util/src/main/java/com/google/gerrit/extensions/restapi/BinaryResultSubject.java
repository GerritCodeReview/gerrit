...
public class BinaryResultSubject extends Subject<BinaryResultSubject, BinaryResult> {
  ...
  private static final Subject.Factory<BinaryResultSubject, BinaryResult>
      BINARY_RESULT_SUBJECT_FACTORY =
          new Subject.Factory<BinaryResultSubject, BinaryResult>() {
            @Override
            public BinaryResultSubject createSubject(
                FailureMetadata failureMetadata, BinaryResult binaryResult) {
              return new BinaryResultSubject(failureMetadata, binaryResult);
            }
          };
