  ...
  protected Module createTestSysModule() {
    return new AbstractModule() {
      ...
      protected void configure() {
        super.configure();
        // GerritServer isn't restarted between tests. TestTicker allows to replace actual Ticker in
        ...
        // gerrit code should be written - i.e. Ticker must not be stored in fields and must always
