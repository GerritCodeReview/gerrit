...
public abstract class AbstractDaemonTest {
  ...
  @After
  public void verifyChangeNotesCommits() throws RestApiException, IOException {
    if (testMethodDescription.verifyChangeNotesCommits()) {
      verifyNoAccountDetailsInChangeNotesCommits();
    }
  }
   ...
   * verification is disabled by default and can be enabled using {@link VerifyChangeNotesCommits}
   * annotation either on test class or method.
   */
  protected void verifyNoAccountDetailsInChangeNotesCommits() throws RestApiException, IOException {
