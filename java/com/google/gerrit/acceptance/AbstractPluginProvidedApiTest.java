...
import com.google.gerrit.extensions.registration.PluginProvidedApi.Client;
import com.google.gerrit.extensions.registration.PluginProvidedApi.PluginApiException;
...
public class AbstractPluginProvidedApiTest extends AbstractDaemonTest {
  ...
  protected static class PluginUsingApiAttributeFactory implements ChangePluginDefinedInfoFactory {
    ...
    public Map<Change.Id, PluginDefinedInfo> createPluginDefinedInfos(
      ...
      pluginDefinedInfo.message = null;
      try {
        String result = (new Client<String, String>(pluginProvidedApi)).call("");
        pluginDefinedInfo.message = result;
