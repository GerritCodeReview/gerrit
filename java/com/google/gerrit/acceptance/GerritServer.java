  ...
  public abstract static class Description {
    public static Description forTestClass(
      ...
      return new AutoValue_GerritServer_Description(
          ...
          getLogLevelThreasholdAnnotation(testDesc));
    }
    ...
    private static Level getLogLevelThreasholdAnnotation(org.junit.runner.Description testDesc) {
      LogThreshold logLevelThreashold = testDesc.getTestClass().getAnnotation(LogThreshold.class);
      if (logLevelThreashold == null) {
        return Level.DEBUG;
      }
      return Level.toLevel(logLevelThreashold.level());
    }
    ...
    abstract Level logLevelThreashold();
