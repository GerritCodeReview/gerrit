...
public class SshSession {
  ...
  public String execMina(String command) throws Exception {
  ...
  @SuppressWarnings("resource")
  public String execJsch(String command) throws Exception {
        ...
        .orElseThrow(
            () ->
                new IllegalStateException(
                    "account " + account.id + " must have a username to use SSH"));
  }
}
