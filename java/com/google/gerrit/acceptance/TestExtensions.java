...
public class TestExtensions {
  ...
  public static class TestRetryListener implements RetryListener {
    ...
    @Override
    public void onRetry(String actionType, @Nullable String actionName, Throwable cause) {
      this.retries.add(new Retry(actionType, actionName, cause));
    }
    ...
    public record Retry(String actionType, @Nullable String actionName, Throwable cause) {
      public Retry {
