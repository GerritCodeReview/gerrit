 ...
 *
 * <p>Records how often {@link Counter0} and {@link Timer1} metrics are
 * invoked. Metrics for other types are not recorded.
 *
 * <p>Allows test to check how much a {@link Counter0} and {@link Timer1}
 * metric is increased by an operation.
 *
 * <p>Example:
 *
 * <pre>
