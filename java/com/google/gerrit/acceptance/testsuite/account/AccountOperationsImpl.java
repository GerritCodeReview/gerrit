...
public class AccountOperationsImpl implements AccountOperations {
  ...
  private Account.Id createAccount(TestAccountCreation testAccountCreation) throws Exception {
    ...
    Consumer<AccountDelta.Builder> accountCreation =
        deltaBuilder ->
            createDeltaFromTestAccountCreation(deltaBuilder, testAccountCreation, accountId);
  ...
  private static void createDeltaFromTestAccountCreation(
  ...
  private static AccountDelta.Builder setPreferredEmail(
  ...
  private static AccountDelta.Builder setUsername(
