...
public class GroupOperationsImpl implements GroupOperations {
  ...
  private AccountGroup.UUID createNewGroup(TestGroupCreation groupCreation)
    ...
    GroupDelta groupDelta = toInternalGroupUpdate(groupCreation);
  ...
  private static GroupDelta toInternalGroupUpdate(TestGroupCreation groupCreation) {
  ...
  private class PerGroupOperationsImpl implements PerGroupOperations {
    ...
    private void updateGroup(TestGroupUpdate groupUpdate)
      ...
      GroupDelta groupDelta = toInternalGroupUpdate(groupUpdate);
      groupsUpdate.updateGroup(groupUuid, groupDelta);
    }

    private GroupDelta toInternalGroupUpdate(TestGroupUpdate groupUpdate) {
      GroupDelta.Builder builder = GroupDelta.builder();
