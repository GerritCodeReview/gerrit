...
public class ContributorAgreement implements Comparable<ContributorAgreement> {
  ...
  protected List<Pattern> excludeProjects;
  protected List<Pattern> matchProjects;
  ...
  public List<Pattern> getExcludeProjects() {
  ...
  public void setExcludeProjects(List<Pattern> excludeProjects) {
    this.excludeProjects = excludeProjects;
  }

  public List<Pattern> getMatchProjects() {
  ...
  public void setMatchProjects(List<Pattern> matchProjects) { this.matchProjects = matchProjects; }
