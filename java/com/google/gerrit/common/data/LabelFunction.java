...
public enum LabelFunction {
  ...
  LabelFunction(
      ...
      boolean isBlock,
      boolean isRequired,
      boolean requiresMaxValue,
      boolean isNegativeCanBlock) {
    this.name = name;
  ...
  /**
   * Whether the label function should let negative values > lowest negative be allowed to block
   * until a max positive vote is cast.
   */
