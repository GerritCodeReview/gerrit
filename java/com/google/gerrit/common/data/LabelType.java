...
public class LabelType {
  ...
  public static final boolean DEF_IGNORE_AUTHOR_SELF_APPROVAL = false;
  ...
  protected boolean ignoreAuthorSelfApproval;
  ...
  public LabelType(String name, List<LabelValue> valueList) {
    ...
    setIgnoreAuthorSelfApproval(DEF_IGNORE_AUTHOR_SELF_APPROVAL);
  ...
  public boolean ignoreAuthorSelfApproval() {
    return ignoreAuthorSelfApproval;
  }

  public void setIgnoreAuthorSelfApproval(boolean ignoreAuthorSelfApproval) {
    this.ignoreAuthorSelfApproval = ignoreAuthorSelfApproval;
  }
