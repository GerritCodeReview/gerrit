...
public abstract class Permission implements Comparable<Permission> {
  ...
  public Builder toBuilder() {
    ...
    return b.setRulesBuilders(
        b.getRules().stream().map(PermissionRule::toBuilder).collect(toImmutableList()));
  }
  ...
  public abstract static class Builder {
    ...
    public Builder setRulesBuilders(ImmutableList<PermissionRule.Builder> value) {
      rulesBuilders.clear();
      rulesBuilders.addAll(value);
      return this;
    }

    public Builder add(PermissionRule.Builder rule) {
      return setRulesBuilders(
          ImmutableList.<PermissionRule.Builder>builder()
              .addAll(getRulesBuilders())
              .add(rule)
              .build());
    }
    ...
    public Builder removeRule(GroupReference group) {
      return setRulesBuilders(
          getRulesBuilders().stream()
              .filter(r -> !sameGroup(r.build(), group))
