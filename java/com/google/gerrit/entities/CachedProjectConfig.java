...
public abstract class CachedProjectConfig {
  ...
  /** Returns the {@link SubmitTypeRule}s keyed by their name. */
  public abstract ImmutableMap<SubmitType, SubmitTypeRule> getSubmitTypeSections();
  ...
  public abstract static class Builder {
    ...
    @CanIgnoreReturnValue
    public Builder addSubmitTypeSection(SubmitTypeRule submitType) {
    ...
    protected abstract ImmutableMap.Builder<SubmitType, SubmitTypeRule> submitTypeSectionsBuilder();
