...
public abstract class CachedProjectConfig {
  ...
  /** Returns the {@link SubmitTypeOverrideRule}s keyed by their name. */
  public abstract ImmutableMap<SubmitType, SubmitTypeOverrideRule> getSubmitTypeSections();
  ...
  public abstract static class Builder {
    ...
    @CanIgnoreReturnValue
    public Builder addSubmitTypeSection(SubmitTypeOverrideRule submitType) {
    ...
    protected abstract ImmutableMap.Builder<SubmitType, SubmitTypeOverrideRule>
