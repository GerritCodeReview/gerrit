...
public abstract class SubmitRequirement {
   ...
   */
  public abstract Optional<String> applicabilityExpression();
  ...
  public abstract static class Builder {
    ...
    public abstract Builder setApplicabilityExpression(Optional<String> applicabilityExpression);

    public abstract Builder setBlockingExpression(String blockingExpression);

    public abstract Builder setOverrideExpression(Optional<String> overrideExpression);

    public abstract Builder setCanInherit(boolean canInherit);
