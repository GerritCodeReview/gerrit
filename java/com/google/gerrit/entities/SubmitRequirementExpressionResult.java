...
public abstract class SubmitRequirementExpressionResult {
  ...
  public static SubmitRequirementExpressionResult create(
    ...
    return create(
        ...
        predicateResult.getAtomExplanations());
  }
  ...
  public static SubmitRequirementExpressionResult create(
    ...
    return create(expression, status, passingAtoms, failingAtoms, ImmutableMap.of());
  }
  ...
  public static SubmitRequirementExpressionResult create(
    ...
    return new AutoValue_SubmitRequirementExpressionResult(
        expression, status, errorMessage, passingAtoms, failingAtoms, Optional.of(atomExplanations));
  }
  ...
  public abstract static class Builder {
    ...
    public abstract Builder atomExplanations(Optional<ImmutableMap<String, String>> atomExplanations);
