...
public abstract class SubmitRequirementResult {
  ...
  public Optional<String> errorMessage() {
    ...
    if (submittabilityExpressionResult().isPresent() && submittabilityExpressionResult().get().errorMessage().isPresent()) {
      return Optional.of(
  ...
  public abstract static class Builder {
    ...
    public abstract Builder submittabilityExpressionResult(Optional<SubmitRequirementExpressionResult> value);
