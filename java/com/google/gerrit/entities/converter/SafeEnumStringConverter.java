 ...
 * constant in the specified enum, then the enum's default value is returned as a fallback.
 */
public class SafeEnumStringConverter<T extends Enum<T> & DefaultEnum<T>> {
  ...
  public T convert(String value) {
    try {
      ...
      return Iterables.getFirst(values, null).getDefaultValue();
    }
  }
