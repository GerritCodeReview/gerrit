...
public interface ChangeApi {
  ...
  class NotImplemented implements ChangeApi {
    ...
    @Override
    public void setMessage(CommitMessageInput in) {
      throw new NotImplementedException();
    }
    ...
    @Override
    public void markAsReviewed(boolean reviewed) {
      throw new NotImplementedException();
    }

    @Override
    public PureRevertInfo pureRevert() {
      throw new NotImplementedException();
    }

    @Override
    public PureRevertInfo pureRevert(String claimedOriginal) {
      throw new NotImplementedException();
    }
  }
}
