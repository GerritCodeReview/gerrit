...
public interface ChangeApi {
  ...
  ChangeInfo applyPatch(ApplyPatchAsPatchSetInput in) throws RestApiException;
  ...
  class NotImplemented implements ChangeApi {
    ...
    @Override
    public ChangeInfo applyPatch(ApplyPatchAsPatchSetInput in) throws RestApiException {
      throw new NotImplementedException();
    }
