...
public interface Changes {
   ...
   * is not recommended to store references to {@code ChangeApi} instances. Also note that the change
   * numeric id without a project name parameter may fail to identify a unique change element, because
   * the potential conflict with other changes imported from Gerrit instances with a different Server-Id.
   *
