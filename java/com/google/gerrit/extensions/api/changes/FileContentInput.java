...
public class FileContentInput {
  ...
  /**
   * The file mode in decimal format.
   *
   * <p>Supported values are {@code 100644} (regular file), {@code 100755} (executeable file),
   * {@code 120000} (symlink) and {@code 160000} (gitlink).
   *
