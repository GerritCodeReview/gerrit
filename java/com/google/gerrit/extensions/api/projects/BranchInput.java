 ...
 *       commit. Cannot be used in combination with setting a revision. Can be used to review the
 *       initial content of a branch (create the branch with an empty initial commit, make a second
 *       commit with the initial content, e.g. by merging in another branch, and push the commit for
 *       review)..
