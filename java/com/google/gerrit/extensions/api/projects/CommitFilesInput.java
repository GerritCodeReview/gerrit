...
public class CommitFilesInput {
  ...
  /**
   * Optional expected current commit (SHA-1) of the target branch. When set, a direct commit is
   * rejected if the branch no longer points at this commit (optimistic concurrency / lost-update
   * protection). Ignored by the create-change variant.
   */
