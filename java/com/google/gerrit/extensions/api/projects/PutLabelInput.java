...
public class PutLabelInput {
  public List<LabelTypeInput> adds;
  public List<LabelTypeInput> updates;
  public List<LabelTypeInput> removes;

  public PutLabelInput() {
    this.adds = new ArrayList<>();
    this.updates = new ArrayList<>();
    this.removes = new ArrayList<>();
  }

  public static class LabelTypeInput {
    public String name;
