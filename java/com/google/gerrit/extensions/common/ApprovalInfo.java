...
public class ApprovalInfo extends AccountInfo {
   ...
   *
   * <p>
   * Web UIs may use the tag to filter out approvals, e.g. initially hide approvals that have a tag
   * that starts with the {@code autogenerated:} prefix.
   */
  public String tag;
   ...
   *
   * <p>
   * If present, the user is permitted to vote on the label regarding the range values. If absent,
   * the user is not permitted to vote on that label.
   */
  ...
  public ApprovalInfo(Integer id, Integer value, @Nullable VotingRangeInfo permittedVotingRange,
      @Nullable String tag, Timestamp date) {
    super(id);
    this.value = value;
  ...
  public boolean equals(Object o) {
    if (o instanceof ApprovalInfo) {
      ...
      return super.equals(o) && Objects.equals(tag, approvalInfo.tag)
          && Objects.equals(value, approvalInfo.value) && Objects.equals(date, approvalInfo.date)
