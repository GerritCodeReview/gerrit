...
public class ChangeInfo {
   ...
   * or patchset and conflicts are allowed. In particular this field is only populated if the change
   * info is returned by one of the following REST endpoints: {@link
