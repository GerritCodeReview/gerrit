...
public class ConflictsInfo {
   ...
   *
   * <p>If {@code false}, and {@link #ours} and {@link #theirs} are not present, the revision was not
   * created as a result of performing a Git merge and hence doesn't contain conflicts.
   */
