...
public class SubmitRequirementExpressionInfo {
   ...
   *
   * <p>
   * This is used to provide more information about complex atoms, which may otherwise be opaque and
   * hard to debug.
   *
   * <p>
   ...
   * {@link com.google.gerrit.entities.SubmitRequirementExpressionResult.Status}.
   */
  public enum Status {
