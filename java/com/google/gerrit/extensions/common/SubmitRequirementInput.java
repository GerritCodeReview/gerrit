...
public class SubmitRequirementInput {
  ...
  /**
   * Expression string to be evaluated on a change. Decides if this submit requirement should be
   * applicable on the given change.
   */
  ...
  /**
   * Expression string to be evaluated on a change. When evaluated to true, this submit requirement
   * becomes fulfilled regardless of the evaluation of the {@link #submittabilityExpression}.
   */
