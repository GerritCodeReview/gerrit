...
@ExtensionPoint
public interface ExternalChangeIncludedIn {
  /**
   * Returns additional entries for IncludedInInfo as multimap where the key is the row title and
   * the values are a list of external systems or artifacts that include the given change.
   *
   ...
   *
   * @param changeId the ID of the change that needs to be checked if it is included
   * @param project the name of the project
   * @param commit the commit ID for the latest patch-set
   * @param tags the tags that include the commit
   * @param branches the branches that include the change commit
