...
public interface ExternalIncludedIn {
   ...
   *
   * @param changeId the ID of the change that needs to be checked if it is included (can be null)
   * @param project the name of the project
   * @param commit the ID of the commit, it can be used alongside or as an alternative to changeId
   *     to find additional included-ins
