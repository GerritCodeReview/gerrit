...
public class DynamicSet<T> implements Iterable<T> {
   ...
   * inside the list of items and not using a direct lookup by hash-code or equals. Using this
   * method is therefore significantly slower than a normal {@link java.util.Set#contains(Object)}
   * and is executed with an O(N) elapsed time based on N registered items in the set.
   *
