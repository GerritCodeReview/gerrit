 ...
 * class loader of the consuming plugin. This also means, the consuming plugin cannot access the
 * MyAPI class at compile time and only available at run time. Due to this reason, reflection is
 * used to invoke the required method. For example:
 *
 * <pre>
