...
/**
 * RestView that supports accepting input and deleting a resource that is missing (special case for
 * creating a change edit by deleting a path in the non-existing change edit).
 *
 ...
 *
 * <p>The RestDeleteView is only invoked when the parse method of the {@code RestCollection} throws
 ...
 */
public interface RestDeleteView<P extends RestResource, C extends RestResource, I>
    extends RestView<C> {
