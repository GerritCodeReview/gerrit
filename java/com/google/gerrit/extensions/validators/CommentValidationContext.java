 ...
 *
 * This is used to provided additional context around that comment that can be used by the validator
 * to determine what validations should be run. For example, a comment validator may only want to
 * validate a comment if it's on a change in the project foo.
 *
