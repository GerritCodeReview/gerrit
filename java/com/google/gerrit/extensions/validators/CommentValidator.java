...
public interface CommentValidator {
   ...
   * argument containing all new comments that need to be validated and (if present) the new change
   * message. This allows validators to statelessly count the new comments. Note that after this one
   * call the method may be called again one or more times for texts that are not comments, but
   * similar in nature.
   *
