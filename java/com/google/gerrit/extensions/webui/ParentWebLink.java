...
public interface ParentWebLink extends WebLink {
   ...
   * @param subject Subject of the patch set (as part of the commit message)
   * @param branchName Branch of the patch set; can be null if there is no change for this commit
