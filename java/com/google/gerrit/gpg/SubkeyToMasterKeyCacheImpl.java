...
@Singleton
public class SubkeyToMasterKeyCacheImpl implements SubkeyToMasterKeyCache {
  ...
  public static Module module() {
    return new CacheModule() {
      ...
      protected void configure() {
        ...
        bind(SubkeyToMasterKeyCache.class).to(SubkeyToMasterKeyCacheImpl.class);
      }
    };
  }
  ...
  @Inject
  SubkeyToMasterKeyCacheImpl(@Named(SUBKEY_MASTER_KEY) Cache<String, String> cache) {
    this.cache = cache;
  }
