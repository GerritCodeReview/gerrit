...
public class GitOverHttpServlet extends GitServlet {
  ...
  public static final String GIT_OVER_HTTP_COMMAND_STATUS_HEADER = "X-git-over-http-command-status";
  ...
  static class GerritUploadPackErrorHandler implements UploadPackErrorHandler {
    ...
    public void upload(HttpServletRequest req, HttpServletResponse rsp, UploadPackRunnable r)
        throws IOException {
      rsp.setHeader(GIT_OVER_HTTP_COMMAND_STATUS_HEADER, "FAIL");
      try {
        r.upload();
        rsp.setHeader(GIT_OVER_HTTP_COMMAND_STATUS_HEADER, "OK");
