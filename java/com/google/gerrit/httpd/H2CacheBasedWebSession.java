  ...
  public static Module module() {
    return new CacheModule() {
      ...
      protected void configure() {
        ...
        DynamicItem.itemOf(binder(), WebSessionCleaner.class);
        DynamicItem.bind(binder(), WebSessionCleaner.class).to(WebSessionManager.Cleaner.class);
        DynamicSet.bind(binder(), AccountActivationListener.class)
            .to(InactiveAccountSessionCleanup.class);
      }
    };
  }
