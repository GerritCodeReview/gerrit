...
class ProjectOAuthFilter implements Filter {
  ...
  private boolean verify(HttpServletRequest req, Response rsp) throws IOException {
    ...
    if (hdr != null) {
      ...
      if (hdr.startsWith(BEARER)) {
        ...
        AccountState accountState = validateAndGetAccount(authInfo.username, req, rsp);
   ...
   */
  @Nullable
  private AccountState validateAndGetAccount(String username, HttpServletRequest req, Response rsp)
      throws IOException {
