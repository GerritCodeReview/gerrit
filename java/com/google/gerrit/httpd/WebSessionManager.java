...
public class WebSessionManager {
  ...
  @Inject
  WebSessionManager(@GerritServerConfig Config cfg, ExternalIdKeyFactory externalIdKeyFactory, @Assisted Cache<String, Val> cache) {
  ...
  Val createVal(
    ...
    Val val = new Val(who, refreshCookieAt, remember, lastLogin, expiresAt, sid, auth, externalIdKeyFactory);
