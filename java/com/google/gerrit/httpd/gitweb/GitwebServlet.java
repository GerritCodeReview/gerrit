    ...
    new Thread(
            () -> {
              try {
                ...
                logger.atFine().withCause(e).log("Unexpected error copying input to CGI");
              }
            },
            "Gitweb-InputFeeder")
        .start();
            ...
            () -> {
              try (BufferedReader br =
                ...
                while ((line = br.readLine()) != null) {
                  logger.atSevere().log("CGI: %s", line);
                }
              } catch (IOException e) {
                logger.atFine().withCause(e).log("Unexpected error copying stderr from CGI");
              }
            },
            "Gitweb-ErrorLogger")
        .start();
