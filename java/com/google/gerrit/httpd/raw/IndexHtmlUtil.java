...
public class IndexHtmlUtil {
  ...
  public static ImmutableMap<String, Object> dynamicTemplateData(
    ...
    CachedServerConfig.ServerConfigData configData = cachedServerConfig.getServerConfig();
    initialData.put(
        addCanonicalUrl("/config/server/info", canonicalURL), configData.serverInfoJson);
    initialData.put(
        addCanonicalUrl("/config/server/version", canonicalURL), configData.serverVersionJson);
    initialData.put(
        addCanonicalUrl("/config/server/top-menus", canonicalURL), configData.topMenusJson);
