...
public class IndexPreloadingUtil {
  ...
  public static RequestedPage parseRequestedPage(String requestedURL) {
    if (requestedURL == null) {
      return RequestedPage.PAGE_WITHOUT_PRELOADING;
    }

    String changeRequestsPath = computeChangeRequestsPath(requestedURL, RequestedPage.CHANGE);
  ...
  public static String computeChangeRequestsPath(String requestedURL, RequestedPage page) {
    Matcher matcher;
    switch (page) {
      case CHANGE:
