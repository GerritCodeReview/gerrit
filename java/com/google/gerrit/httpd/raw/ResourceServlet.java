...
public abstract class ResourceServlet extends HttpServlet {
   ...
   * option is disabled.
   *
   * @return true if the {@link #processResourceBeforeWrite(HttpServletRequest, HttpServletResponse,
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse rsp) throws IOException {
    ...
    boolean requiresPostProcess = shouldProcessResourceBeforeWrite(req, rsp, p);
    ...
    if (requiresPostProcess) {
      r = processResourceBeforeWrite(req, rsp, r);
    }
    byte[] tosend = r.raw;
