 ...
 */
class RepositoryCompatibilityJsonWriter extends JsonWriter {
  private final RepositoryProjectCompatibility repositoryProjectCompatibility;
  private String lastName;

  RepositoryCompatibilityJsonWriter(
      RepositoryProjectCompatibility repositoryProjectCompatibility, Writer out) {
    super(out);
  ...
  public JsonWriter name(String name) throws IOException {
    if (repositoryProjectCompatibility == RepositoryProjectCompatibility.REPOSITORY_ONLY
        && "project".equals(name)) {
  ...
  public JsonWriter value(String value) throws IOException {
    super.value(value);
    if (repositoryProjectCompatibility == RepositoryProjectCompatibility.PROJECT_AND_REPOSITORY
        && "project".equals(lastName)) {
