...
public abstract class  Field<I, T> {
  ...
  public boolean setIfPossible(I object, StoredValue doc) {
    ...
    if (FieldType.STRING_TYPES.stream().anyMatch(t -> t.getName().equals(type().getName()))) {
      ...
      return true;
    } else if (FieldType.LONG.getName().equals(type().getName())) {
      ...
      return true;
    } else if (FieldType.TIMESTAMP.getName().equals(type().getName())) {
