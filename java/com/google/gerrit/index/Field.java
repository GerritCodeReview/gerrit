...
public abstract class  Field<I, T> {
  ...
  public static TypeToken<Iterable<Integer>> ITERABLE_INTEGER_TYPE = new TypeToken<Iterable<Integer>>(){};
  ...
  public static TypeToken<Iterable<String>> ITERABLE_STRING_TYPE = new TypeToken<Iterable<String>>(){};
  public static TypeToken<byte[]> BYTE_ARRAY_TYPE = new TypeToken<byte[]>(){};
  public static TypeToken<Iterable<byte[]>> ITERABLE_BYTE_ARRAY_TYPE = new TypeToken<Iterable<byte[]>>(){};
  ...
  @FunctionalInterface
  public interface FromBytesSetter<I> {
    void set(I object, byte[] value);
  }

  @FunctionalInterface
  public interface FromBytesIterableSetter<I> {
    void set(I object, Iterable<byte[]> value);
  }
  ...
  public abstract static class Builder<I, T> {
    ...
    public abstract Builder<I, T> fieldFromBytesSetter(Optional<FromBytesSetter<I>> value);

    public abstract Builder<I, T> fieldFromIterableBytesSetter(
        Optional<FromBytesIterableSetter<I>> value);
    ...
    public final Field build(Field.Getter<I, T> getter, Field.Setter<I, T> setter, Field.FromBytesIterableSetter<I> fromBytesIterableSetter) {
      return this.getter(getter).fieldSetter(Optional.of(setter)).fieldFromIterableBytesSetter(Optional.of(fromBytesIterableSetter)).build();
    }
  ...
  public abstract Optional<FromBytesSetter<I>> fieldFromBytesSetter();
  public abstract Optional<FromBytesIterableSetter<I>> fieldFromIterableBytesSetter();
  ...
  public boolean setIfPossible(I object, StoredValue doc) {
    ...
    if (this.fieldType().equals(STRING_TYPE)) {
      ...
      if(bytes!= null && fieldFromBytesSetter().isPresent()){
        fieldFromBytesSetter().get().set(object, bytes);
        return true;
      }
      ...
      if(bytes!= null && fieldFromIterableBytesSetter().isPresent()){
        fieldFromIterableBytesSetter().get().set(object, bytes);
        return true;
      }
    }
    return false;
