...
public final class FieldDef<I, T> implements SchemaField<I, T> {
  ...
  public static class Builder<T> {
    ...
    public <I> FieldDef<I, T> build(
        Getter<I, T> getter, Optional<Field<I, T>.FieldSpec<I, T>> fieldSpec) {
    ...
    public <I> FieldDef<I, T> build(
        Getter<I, T> getter, Setter<I, T> setter, Optional<Field<I, T>.FieldSpec<I, T>> fieldSpec) {
    ...
    public <I> FieldDef<I, Iterable<T>> buildRepeatable(
        Getter<I, Iterable<T>> getter,
        Optional<Field<I, Iterable<T>>.FieldSpec<I, Iterable<T>>> fieldSpec) {
      return new FieldDef<>(name, type, stored, true, getter, null, fieldSpec);
    }

    public <I> FieldDef<I, Iterable<T>> buildRepeatable(
        Getter<I, Iterable<T>> getter,
        Setter<I, Iterable<T>> setter,
        Optional<Field<I, Iterable<T>>.FieldSpec<I, Iterable<T>>> fieldSpec) {
