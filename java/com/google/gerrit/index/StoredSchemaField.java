...
public abstract class StoredSchemaField<I, T> {
  ...
  public class StoredSearchSpec implements SchemaField<I, T> {
    ...
    public StoredSearchSpec(String name, SearchOption searchOption) {
      checkName(name);
      this.name = name;
   ...
   * @param searchOption the tokenization option, enabled by the new {@link StoredSearchSpec}
   * @return the added {@link StoredSearchSpec}.
   */
  public StoredSearchSpec addSearchSpec(String name, SearchOption searchOption) {
    StoredSearchSpec searchSpec = new StoredSearchSpec(name, searchOption);
    checkArgument(
