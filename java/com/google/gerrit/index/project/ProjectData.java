...
public class ProjectData {
  ...
  public ImmutableList<ProjectData> getParents() {
    List<ProjectData> parents = new ArrayList<>();
    Optional<ProjectData> curr = parent;
  ...
  public ImmutableList<String> getParentNames() {
    return getParents().stream().map(p -> p.getProject().getName()).collect(toImmutableList());
  }
}
