...
public abstract class IndexPredicate<I> extends OperatorPredicate<I> implements Matchable<I> {
  ...
  public FieldType<?> getType() {
    ...
    if((fieldType.equals(Field.INTEGER_TYPE)  || fieldType.equals(Field.ITERABLE_INTEGER_TYPE)) && searchOptions.equals(SearchOptions.EXACT)){
    ...
    } else if(fieldType.equals(Field.STRING_TYPE) || fieldType.equals(Field.ITERABLE_STRING_TYPE)){
