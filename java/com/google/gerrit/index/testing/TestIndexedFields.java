...
public final class TestIndexedFields {
  ...
  /**
   * The list of {@link IndexedField} below are field types, that are currently supported and used
   * in different index implementations
   *
   * <p>They are used in unit tests to make sure this types can be extracted to index and assigned
   * back to object.
   */
  ...
  public static final IndexedField<TestIndexedData, Entities.Change> STORED_PROTO_FIELD =
      IndexedField.<TestIndexedData, Entities.Change>builder(
              "TestChange", new TypeToken<Change>() {})
          .stored()
