...
import com.google.gerrit.server.account.HttpPasswordFallbackAuthTokenAccessor;
        ...
        .createChildInjector(
            new FactoryModule() {
              ...
              protected void configure() {
                ...
                bind(AuthTokenAccessor.class).to(HttpPasswordFallbackAuthTokenAccessor.class);
