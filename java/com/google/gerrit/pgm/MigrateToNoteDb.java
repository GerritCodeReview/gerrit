...
public class MigrateToNoteDb extends SiteProgram {
  ...
  public int run() throws Exception {
    ...
    try {
      ...
      try (PrintWriter w =
          new PrintWriter(
              new OutputStreamWriter(new NonClosingOutputStream(System.out), UTF_8), true)) {
        gcAllUsers.run(w);
      }
    } finally {
      stop();
   ...
   * System.out}. By wrapping {@code System.out} in NonClosingOutputStream, {@code System.out} is
   * not closed when the outer auto-closing wrappers close. And hence, {@code System.out} stays
   * usable.
   */
  public static class NonClosingOutputStream extends OutputStream implements AutoCloseable {
    ...
    public void close() throws IOException {
      ...
      //
      // (This behavior is the default of OutputStream, we override nonetheless to make our
      // intention explicit)
    }
  }
}
