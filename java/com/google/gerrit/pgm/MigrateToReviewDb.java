...
public class MigrateToReviewDb extends SiteProgram {
  ...
  public int run() throws Exception {
    ...
    try {
      ...
      if (!s.equals(Optional.of(NotesMigrationState.READ_WRITE_WITH_SEQUENCE_REVIEW_DB_PRIMARY))) {
        throw die("Must be in NoteDb with change code enabled, found " + s);
      }
