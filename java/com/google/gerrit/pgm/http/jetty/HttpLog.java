...
import static com.google.gerrit.httpd.GitOverHttpServlet.GIT_OVER_HTTP_COMMAND_STATUS_HEADER;
...
class HttpLog extends AbstractLifeCycle implements RequestLog {
  ...
  public void log(Request req, Response rsp) {
    ...
    set(event, P_COMMAND_STATUS, rsp.getHeader(GIT_OVER_HTTP_COMMAND_STATUS_HEADER));
