...
class HttpLog extends AbstractLifeCycle implements RequestLog {
  ...
  public void log(Request req, Response rsp) {
    ...
    if (user != null) contextMap.putValue(P_USER, user);
    ...
    if (traceId != null) set(contextMap, P_TRACE_ID, traceId);
    ...
    if (ctxMetrics != null) {
      set(contextMap, P_CPU_TOTAL, ctxMetrics.getTotalCpuTime());
      set(contextMap, P_CPU_USER, ctxMetrics.getUserCpuTime());
      set(contextMap, P_MEMORY, ctxMetrics.getAllocatedMemory());
    }
