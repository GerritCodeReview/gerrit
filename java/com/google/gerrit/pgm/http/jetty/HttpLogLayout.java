...
public final class HttpLogLayout extends AbstractStringLayout {
  ...
  public String toSerializable(final LogEvent event) {
    ...
    buf.append(val);
    buf.append(' ');
    String va2 = event.getContextData().getValue(HttpLog.P_RESOURCE);
    buf.append(val2);
    buf.append(' ');
    String va3 = event.getContextData().getValue(HttpLog.P_PROTOCOL);
    buf.append(val3);
    buf.append('"');

    buf.append(' ');
    String va4 = event.getContextData().getValue(HttpLog.P_STATUS);
    buf.append(val4);
