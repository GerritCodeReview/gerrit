 ...
 * flavour-neutral {@link JettyServer}. The EE10 counterpart lives in {@code
 * ee10/JettyServerFlavour.java} (same FQDN, hand-written, excluded from the to_jakarta transform);
