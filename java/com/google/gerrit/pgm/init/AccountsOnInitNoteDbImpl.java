...
import com.google.gerrit.server.account.AccountsRepoReader;
...
public class AccountsOnInitNoteDbImpl implements AccountsOnInit {
  ...
  @Inject
  public AccountsOnInitNoteDbImpl(
      InitFlags flags, SitePaths site, AllUsersNameOnInitProvider allUsers) {
    this.flags = flags;
    this.site = site;
  ...
  public boolean hasAnyAccount() throws IOException {
    ...
    try (Repository repo = new FileRepository(path)) {
      return AccountsRepoReader.hasAnyAccount(repo);
    }
  }
