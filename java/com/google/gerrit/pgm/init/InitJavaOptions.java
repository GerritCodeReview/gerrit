...
public class InitJavaOptions implements InitStep {
  ...
  private static final String JAVA_ADD_OPENS_JAVA_UTIL_ALL_UNNAMED =
  ...
  public void run() throws Exception {
    ...
    if (!javaOptions.contains(JAVA_ADD_OPENS_JAVA_UTIL_ALL_UNNAMED)) {
      javaOptions.add(JAVA_ADD_OPENS_JAVA_UTIL_ALL_UNNAMED);
    }
