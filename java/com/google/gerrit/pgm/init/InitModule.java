...
import com.google.gerrit.server.notedb.RepoSequence.LightweighAccountsSequenceProvider;
...
public class InitModule extends FactoryModule {
  ...
  protected void configure() {
    ...
    bind(IncrementingSequence.class)
        .annotatedWith(Names.named(Sequences.NAME_ACCOUNTS_LIGHTWEIGHT))
        .toProvider(LightweighAccountsSequenceProvider.class);
