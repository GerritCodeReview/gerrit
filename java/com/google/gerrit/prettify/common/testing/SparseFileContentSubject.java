...
public class SparseFileContentSubject extends Subject {
  ...
  public static Subject.Factory<SparseFileContentSubject, SparseFileContent> sparseFileContent() {
    return SparseFileContentSubject::new;
  }

  public IntegerSubject getSize() {
    return check("getSize()").that(sparseFileContent.getSize());
  }

  public IntegerSubject getRangesCount() {
    return check("getRangesCount()").that(sparseFileContent.getRangesCount());
  }
  ...
  public MapSubject lines() {
    ...
    return com.google.common.truth.Truth.assertThat(lines);
  }
}
