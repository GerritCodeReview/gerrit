...
public class RefNames {
  ...
  /**
   * Whether the ref is a NoteDb meta ref in a regular repository, which isn't All-Users or
   * All-Projects.
   */
  public static boolean isNoteDbMetaRef(String ref) {
    return ref.startsWith(REFS_CHANGES) || ref.startsWith(REFS_CACHE_AUTOMERGE) || isRefsEdit(ref);
  }
