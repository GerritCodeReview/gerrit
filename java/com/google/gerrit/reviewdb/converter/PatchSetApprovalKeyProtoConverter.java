...
public enum PatchSetApprovalKeyProtoConverter
  ...
  private ProtoConverter<Reviewdb.PatchSet_Id, PatchSet.Id> patchSetIdConverter =
      PatchSetIdProtoConverter.INSTANCE;
  private ProtoConverter<Reviewdb.Account_Id, Account.Id> accountIdConverter =
      AccountIdProtoConverter.INSTANCE;
  private ProtoConverter<Reviewdb.LabelId, LabelId> labelIdConverter =
