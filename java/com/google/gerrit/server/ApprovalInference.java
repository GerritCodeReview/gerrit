...
/**
 * Computes approvals for a given patchset by looking at approvals applied to the given patchset and
 * by additionally inferring approvals from the patchset's parents. The latter is done by asserting
 * a change's kind and checking the project config for allowed forward-inference.
 *
...
public class ApprovalInference {
  ...
  /**
   * Returns all approvals that apply to the given patchset. Honors direct and indirect (approval on
   * parents) approvals.
   */
