...
public abstract class AssigneeStatusUpdate {
  public static AssigneeStatusUpdate create(
      ...
      Optional<Account.Id> currentAssignee,
      Boolean hasCurrentAssignee) {
    return new AutoValue_AssigneeStatusUpdate(ts, updatedBy, currentAssignee, hasCurrentAssignee);
  }
  ...
  public abstract Boolean hasCurrentAssignee();
}
