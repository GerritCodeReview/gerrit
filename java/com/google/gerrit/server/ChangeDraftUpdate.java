...
public interface ChangeDraftUpdate {
   ...
   * published comment is successfully updated. Please use {@link
   * com.google.gerrit.server.notedb.ChangeDraftUpdateExecutor}.
   */
  ...
  /** Whether all updates in this updater can run async. */
  boolean canRunAsync();
