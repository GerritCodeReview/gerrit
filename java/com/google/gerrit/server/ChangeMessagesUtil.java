...
public class ChangeMessagesUtil {
  ...
  public static final String GERRIT_PREFIX = "gerrit:";

  public static final String TAG_ABANDON = AUTOGENERATED_TAG_PREFIX + GERRIT_PREFIX + "abandon";
  public static final String TAG_CHERRY_PICK_CHANGE =
      AUTOGENERATED_TAG_PREFIX + GERRIT_PREFIX + "cherryPickChange";
  public static final String TAG_DELETE_ASSIGNEE =
      AUTOGENERATED_TAG_PREFIX + GERRIT_PREFIX + "deleteAssignee";
  public static final String TAG_DELETE_REVIEWER =
      AUTOGENERATED_TAG_PREFIX + GERRIT_PREFIX + "deleteReviewer";
  public static final String TAG_DELETE_VOTE =
      AUTOGENERATED_TAG_PREFIX + GERRIT_PREFIX + "deleteVote";
  public static final String TAG_MERGED = AUTOGENERATED_TAG_PREFIX + GERRIT_PREFIX + "merged";
  public static final String TAG_MOVE = AUTOGENERATED_TAG_PREFIX + GERRIT_PREFIX + "move";
  public static final String TAG_RESTORE = AUTOGENERATED_TAG_PREFIX + GERRIT_PREFIX + "restore";
  public static final String TAG_REVERT = AUTOGENERATED_TAG_PREFIX + GERRIT_PREFIX + "revert";
  public static final String TAG_SET_ASSIGNEE =
      AUTOGENERATED_TAG_PREFIX + GERRIT_PREFIX + "setAssignee";
  public static final String TAG_UPDATE_ATTENTION_SET =
      AUTOGENERATED_TAG_PREFIX + GERRIT_PREFIX + "updateAttentionSet";
  public static final String TAG_SET_DESCRIPTION =
      AUTOGENERATED_TAG_PREFIX + GERRIT_PREFIX + "setPsDescription";
  public static final String TAG_SET_HASHTAGS =
      AUTOGENERATED_TAG_PREFIX + GERRIT_PREFIX + "setHashtag";
  public static final String TAG_SET_PRIVATE =
      AUTOGENERATED_TAG_PREFIX + GERRIT_PREFIX + "setPrivate";
  public static final String TAG_SET_READY =
      AUTOGENERATED_TAG_PREFIX + GERRIT_PREFIX + "setReadyForReview";
  public static final String TAG_SET_TOPIC = AUTOGENERATED_TAG_PREFIX + GERRIT_PREFIX + "setTopic";
  public static final String TAG_SET_WIP =
      AUTOGENERATED_TAG_PREFIX + GERRIT_PREFIX + "setWorkInProgress";
  public static final String TAG_UNSET_PRIVATE =
      AUTOGENERATED_TAG_PREFIX + GERRIT_PREFIX + "unsetPrivate";
  public static final String TAG_UPLOADED_PATCH_SET =
      AUTOGENERATED_TAG_PREFIX + GERRIT_PREFIX + "newPatchSet";
  public static final String TAG_UPLOADED_WIP_PATCH_SET =
      AUTOGENERATED_TAG_PREFIX + GERRIT_PREFIX + "newWipPatchSet";
  ...
  public static boolean isAutoGeneratedGerrit(@Nullable String tag) {
    return tag != null && tag.startsWith(AUTOGENERATED_TAG_PREFIX + GERRIT_PREFIX);
  }
