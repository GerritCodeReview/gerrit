...
public class ChangeMessagesUtil {
  ...
  /**
   * The ID of a change message is different between NoteDb and ReviewDb. In NoteDb, it's the commit
   * SHA-1, but in ReviewDb it's generated randomly. To make sure the change message can be deleted
   * from both NoteDb and ReviewDb, the index of the change message must be used rather than its ID.
   *
