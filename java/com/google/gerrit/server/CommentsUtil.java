...
public class CommentsUtil {
  ...
  public Optional<HumanComment> getDraft(ChangeNotes notes, IdentifiedUser user, HumanComment.Key key) {
  ...
  public void putHumanComments(ChangeUpdate update, HumanComment.Status status, Iterable<HumanComment> comments) {
  ...
  private static List<HumanComment> commentsOnFile(Collection<HumanComment> allComments, String file) {
