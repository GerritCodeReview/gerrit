 ...
 *
 * <p><This class implements a one-way synchronization from the the global {@code CREATE} capability
 * in {@code All-Projects} to a {@code CREATE} permission on {@code refs/groups/*} in {@code
 * All-Users}.
 */
@Singleton
