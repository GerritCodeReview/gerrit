...
public class IdentifiedUser extends CurrentUser {
  ...
  String getGenericCommitterEmail(Account ua) {
  ...
  String getCommitterName(Account ua, String email) {
  ...
  public PersonIdent newCommitterIdent(Instant when, ZoneId zoneId) {
    ...
    if (email == null || email.isEmpty()) {
      email = getGenericCommitterEmail(ua);
    }
    String name = getCommitterName(ua, email);
    return new PersonIdent(name, email, when, zoneId);
  }

  public PersonIdent newCommitterIdent(String sourceCommitterEmail, Instant when, ZoneId zoneId) {
    final Account ua = getAccount();
    String email =
        hasEmailAddress(sourceCommitterEmail) ? sourceCommitterEmail : ua.preferredEmail();
    if (email == null || email.isEmpty()) {
      email = getGenericCommitterEmail(ua);
    }
    String name = getCommitterName(ua, email);
