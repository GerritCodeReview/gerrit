...
public class PublishCommentsOp implements BatchUpdateOp {
  ...
  public void postUpdate(Context ctx) {
    ...
    if (notify.shouldNotify()) {
      List<Comment> genericComments = new ArrayList<>();
      genericComments.addAll(comments);
      email.create(notify, changeNotes, ps, user, message, genericComments, null, labelDelta).sendAsync();
    }
    commentAdded.fire(
