...
public class PublishCommentsOp implements BatchUpdateOp {
  ...
  public boolean updateChange(ChangeContext ctx)
	  ...
	  logger.atInfo().log("Updating change %d at meta-ref %s", ctx.getChange().getChangeId(), ctx.getNotes().getMetaId());
    ...
    logger.atInfo().log("New ChangeUpdate %s for change %d", changeUpdate, ctx.getChange().getChangeId());
