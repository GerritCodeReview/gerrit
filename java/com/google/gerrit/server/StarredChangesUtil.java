  ...
  abstract class StarField {
    ...
    public static StarField parse(String s) {
      ...
      if (p >= 0) {
        ...
        // NOTE: This code branch should not be removed. In 992877d06d3492f78a3b189eb5579ddb86b9f0da
        // we accidentally changed index writing to write <account_id> instead of <account_id>:star.
        // As some servers might have picked that up and wrote index entries with the short format,
        // we should keep support its parsing.
        id = Ints.tryParse(s);
      }
      if (id == null) {
        return null;
    ...
    public final String toString() {
      // NOTE: The ":star" addition should not be removed. This method is used for writing change
      // index data. Historically, we supported different kinds of labels, which were stored in this
