...
public class AccountAttributeLoader {
  ...
  private final Map<Account.Id, AccountAttribute> created;
  ...
  public synchronized AccountAttribute get(@Nullable Account.Id id) {
    ...
    AccountAttribute attribute = created.get(id);
    if (attribute == null) {
      attribute = new AccountAttribute(id.get());
      created.put(id, attribute);
    }
    return attribute;
  }
