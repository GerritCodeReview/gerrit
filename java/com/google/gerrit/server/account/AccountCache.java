...
public interface AccountCache {
   ...
   * If not cached yet the account is loaded. If the account can't be loaded (e.g. because it is
   ...
   *     account IDs, if the account can't be loaded (e.g. because it is missing), the entry will be
