...
public interface Accounts {
  ...
  /**
   * Loads the account from the given revision.
   *
   * @return the account data if exists in the revision, otherwise {@code false}
   */
  Optional<Account> loadAccountFromRevision(
