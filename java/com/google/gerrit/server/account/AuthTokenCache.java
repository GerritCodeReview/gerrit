...
public class AuthTokenCache {
  ...
  static class Loader extends CacheLoader<Account.Id, List<AuthToken>> {
    ...
    private final DirectAuthTokenAccessor tokenAccessor;

    @Inject
    Loader(AccountCache accountCache, DirectAuthTokenAccessor tokenAccessor) {
    ...
    public ImmutableList<AuthToken> load(Account.Id accountId) throws Exception {
      try (TraceTimer timer =
        ...
        ImmutableList<AuthToken> tokens = tokenAccessor.getTokens(accountId);
