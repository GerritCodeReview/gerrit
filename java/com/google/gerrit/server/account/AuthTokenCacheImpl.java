...
public class AuthTokenCacheImpl implements AuthTokenCache {
  ...
  static final List<AuthToken> NO_SUCH_USER = none();
  static final List<AuthToken> NO_TOKENS = none();
  ...
  private static List<AuthToken> none() {
  ...
  static class Loader extends CacheLoader<Account.Id, List<AuthToken>> {
    ...
    @Override
    public List<AuthToken> load(Account.Id accountId) throws Exception {
