...
public class AuthTokenExpiryNotificationConfig {
   ...
   *   <li>The expiration date is sooner than startDays from now
   * </ul>
   *
  ...
  public List<Instant> calculateNotificationTimes(Instant expirationDate) {
    ...
    // Check if expiration is too soon (before startDays)
    Instant firstNotificationTime = expirationDate.minus(startDays, ChronoUnit.DAYS);
