...
public class ExternalGroupsKeyReader {
  ...
  @Inject
  ExternalGroupsKeyReader(GitRepositoryManager repoManager, AllUsersName allUsersName) {
    this.repoManager = repoManager;
    this.allUsersName = allUsersName;
  }

  @AutoValue
  public abstract static class GroupsSnapshot {
    /**
    ...
    public static GroupsSnapshot create(String hash, ImmutableList<Ref> groupsRefs) {
      return new AutoValue_ExternalGroupsKeyReader_GroupsSnapshot(hash, groupsRefs);
    }
  }

  /** Retrieves a snapshot key of all internal groups refs from NoteDb */
  public GroupsSnapshot getSnapshot() throws IOException {
    try (Repository repo = repoManager.openRepository(allUsersName)) {
      ...
      return GroupsSnapshot.create(hash, groupsRefs);
    }
  }
}
