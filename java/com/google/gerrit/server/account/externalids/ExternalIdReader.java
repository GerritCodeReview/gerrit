...
public class ExternalIdReader {
  ...
  private final AllUsersObjectIdByRefCache refsCache;
  ...
  ExternalIdReader(
      ...
      AllUsersObjectIdByRefCache refsCache,
  ...
  ObjectId readRevision() {
    return refsCache.get(RefNames.REFS_EXTERNAL_IDS).orElse(ObjectId.zeroId());
  }
