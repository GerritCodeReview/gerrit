...
public class ExternalIdTestUtil {
  ...
  public static String insertExternalIdWithoutAccountId(
    ...
    return insertExternalId(
        ...
        ident,
        (ins, noteMap) -> {
          ExternalId extId = ExternalId.create(ExternalId.Key.parse(externalId, false), accountId);
  ...
  public static String insertExternalIdWithKeyThatDoesntMatchNoteId(
    ...
    return insertExternalId(
        ...
        (ins, noteMap) -> {
          ExternalId extId = ExternalId.create(ExternalId.Key.parse(externalId, false), accountId);
          ObjectId noteId = ExternalIdNotes.computeNoteId(ExternalId.Key.parse(externalId + "x", false));
          Config c = new Config();
          extId.writeToConfig(c);
          byte[] raw = c.toText().getBytes(UTF_8);
          ObjectId dataBlob = ins.insert(OBJ_BLOB, raw);
