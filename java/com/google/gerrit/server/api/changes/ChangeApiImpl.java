...
class ChangeApiImpl implements ChangeApi {
  ...
  private final Provider<GetPureRevert> getPureRevert;
  ...
  ChangeApiImpl(
      ...
      Provider<GetPureRevert> getPureRevert,
  ...
  public PureRevertInfo pureRevert(@Nullable String claimedOriginal) throws RestApiException {
    try {
      getPureRevert.get().setClaimedOriginal(claimedOriginal);
      return getPureRevert.get().apply(change);
    } catch (Exception e) {
