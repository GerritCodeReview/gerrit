...
import com.google.gerrit.server.restapi.change.MetaDiff;
...
class ChangeApiImpl implements ChangeApi {
  ...
  private final Provider<MetaDiff> metaDiffProvider;
  ...
  ChangeApiImpl(
      ...
      Provider<MetaDiff> metaDiffProvider,
  ...
  public ChangeInfoDifference metaDiff(
      ...
      throws RestApiException {
    try (DynamicOptions dynamicOptions = new DynamicOptions(injector, dynamicBeans)) {
      MetaDiff metaDiff = metaDiffProvider.get();
