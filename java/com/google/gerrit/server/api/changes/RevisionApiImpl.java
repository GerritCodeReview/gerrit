...
import com.google.gerrit.server.restapi.change.revisions.CherryPick;
import com.google.gerrit.server.restapi.change.revisions.GetArchive;
import com.google.gerrit.server.restapi.change.revisions.GetCommit;
import com.google.gerrit.server.restapi.change.revisions.GetDescription;
import com.google.gerrit.server.restapi.change.revisions.GetMergeList;
import com.google.gerrit.server.restapi.change.revisions.GetPatch;
import com.google.gerrit.server.restapi.change.revisions.GetRelated;
import com.google.gerrit.server.restapi.change.revisions.GetRevisionActions;
import com.google.gerrit.server.restapi.change.revisions.ListPortedComments;
import com.google.gerrit.server.restapi.change.revisions.ListPortedDrafts;
import com.google.gerrit.server.restapi.change.revisions.Mergeable;
import com.google.gerrit.server.restapi.change.revisions.PostReview;
import com.google.gerrit.server.restapi.change.revisions.PutDescription;
...
import com.google.gerrit.server.restapi.change.revisions.comments.Comments;
import com.google.gerrit.server.restapi.change.revisions.comments.ListRevisionComments;
import com.google.gerrit.server.restapi.change.revisions.drafts.CreateDraftComment;
import com.google.gerrit.server.restapi.change.revisions.drafts.DraftComments;
import com.google.gerrit.server.restapi.change.revisions.drafts.ListRevisionDrafts;
import com.google.gerrit.server.restapi.change.revisions.files.Files;
import com.google.gerrit.server.restapi.change.revisions.files.Reviewed;
import com.google.gerrit.server.restapi.change.revisions.fixes.ApplyProvidedFix;
import com.google.gerrit.server.restapi.change.revisions.fixes.ApplyStoredFix;
import com.google.gerrit.server.restapi.change.revisions.fixes.Fixes;
import com.google.gerrit.server.restapi.change.revisions.fixes.PreviewFix;
import com.google.gerrit.server.restapi.change.revisions.reviewers.RevisionReviewers;
