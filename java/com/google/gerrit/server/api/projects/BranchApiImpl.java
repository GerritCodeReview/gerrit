...
import com.google.gerrit.server.restapi.project.PutContentReview;
...
public class BranchApiImpl implements BranchApi {
  ...
  private final PutContentReview putContentReview;
  ...
  BranchApiImpl(
      ...
      PutContentReview putContentReview,
      GetReflog getReflog,
    ...
    this.putContentReview = putContentReview;
  ...
  @Override
  public ChangeInfo commitFilesForReview(CommitFilesInput input) throws RestApiException {
    try {
      return putContentReview.apply(resource(), input).value();
    } catch (Exception e) {
      throw asRestApiException("Cannot create change for files", e);
    }
  }
