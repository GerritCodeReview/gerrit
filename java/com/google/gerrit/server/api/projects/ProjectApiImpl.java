...
public class ProjectApiImpl implements ProjectApi {
  ...
  @Override
  public Map<String, Collection<String>> commitsIn(
      Collection<String> commits, Collection<String> refs) throws RestApiException {
    try {
      ...
      throw asRestApiException("Could not extract commits included in data", e);
    }
  }
