...
public class ApprovalCopier {
  ...
  private ApprovalCopyResult computeCopyResult(
    ...
    if (experimentFeatures.isFeatureEnabled(
      ...
      forcedCopyCondition = cfg.getString("change", null, "codeReviewLabelCopyEnforcement");
      forcedNonCopyCondition = cfg.getString("change", null, "codeReviewLabelCopyRestriction");
    }
