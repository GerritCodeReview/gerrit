...
public class ApprovalCopier {
  ...
  public abstract static class Result {
     ...
     * </ul>
     */
    public abstract ImmutableSet<ApprovalData> copiedApprovals();
     ...
     */
    public abstract ImmutableSet<ApprovalData> outdatedApprovals();
    ...
    public static Result create(
        ImmutableSet<ApprovalData> copiedApprovals, ImmutableSet<ApprovalData> outdatedApprovals) {
     ...
     */
    @AutoValue
    public abstract static class ApprovalData {
      /** The approval. */
      ...
      public static ApprovalData create(
          PatchSetApproval approval,
          ImmutableSet<String> passingAtoms,
          ImmutableSet<String> failingAtoms) {
        return new AutoValue_ApprovalCopier_Result_ApprovalData(
            approval, passingAtoms, failingAtoms);
      }

      public static ApprovalData createForMissingLabelType(PatchSetApproval approval) {
        return new AutoValue_ApprovalCopier_Result_ApprovalData(
    ...
    try {
      ...
      try (ManualRequestContext ignored = requestContext.open()) {
        ...
        return new AutoValue_ApprovalCopier_ApprovalCopyResult(
            canCopy, passingAtoms.build(), failingAtoms.build());
      }
  ...
  private Result computeForPatchSet(
    ...
    Table<String, Account.Id, Result.ApprovalData> copiedApprovalsByUser = HashBasedTable.create();
    ImmutableSet.Builder<Result.ApprovalData> outdatedApprovalsBuilder = ImmutableSet.builder();
    ...
    for (PatchSetApproval priorPsa : priorApprovals) {
      ...
      if (!labelType.isPresent()) {
        logger.atFine().log(
            ...
            targetPsId.get(),
            projectName);
        outdatedApprovalsBuilder.add(Result.ApprovalData.createForMissingLabelType(priorPsa));
        continue;
      }
  ...
  abstract static class ApprovalCopyResult {
     ...
     * Result.ApprovalData#passingAtoms()} for more details.
     *
    ...
    public static ApprovalCopyResult createForMissingCopyCondition() {
      return new AutoValue_ApprovalCopier_ApprovalCopyResult(
          /* canCopy= */ false,
    ...
    public static ApprovalCopyResult createForNonParseableCopyCondition() {
      return new AutoValue_ApprovalCopier_ApprovalCopyResult(
          /* canCopy= */ false,
          /* passingAtoms= */ ImmutableSet.of(),
          /* failingAtoms= */ ImmutableSet.of());
