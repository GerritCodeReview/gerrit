...
/** Utilities for {@link PatchSetApproval.UUID}. */
public class PatchSetApprovalUuid {

  /**
   * Generator for {@link PatchSetApproval.UUID}.
   *
   * <p>Since {@link PatchSetApproval.UUID} must be unique for each granted {@link
   * PatchSetApproval}, implementations must generate globally unique UUID for each {@link #get}
   * invocation.
   */
  ...
  /** Default implementation of {@link Generator}. */
  @Singleton
