...
public interface GroupAuditEvent {
  ...
  /**
   * Gets the {@link AccountGroup.Id} of the updated group.
   *
   * @return the {@link AccountGroup.Id} of the updated group.
   */
  AccountGroup.Id getUpdatedGroup();
