...
/** Authentication request for a remote user connecting through an SSH connection. */
public class SshAuthRequest extends AuthRequest {
   ...
   * @param clientAddress remote SSH client address
   */
  public SshAuthRequest(String username, PublicKey pubKey, SocketAddress clientAddress) {
   ...
   * @param clientAddress remote SSH client address
   */
  public SshAuthRequest(
      String username, String password, PublicKey pubKey, SocketAddress clientAddress) {
  ...
  @Override
  public void checkPassword(Object credentials) throws AuthException {
    if (credentials instanceof String) {
      super.checkPassword(credentials);
      return;
    } else if (credentials instanceof PublicKey && Objects.equals(getPubKey(), credentials)) {
      return;
    }
