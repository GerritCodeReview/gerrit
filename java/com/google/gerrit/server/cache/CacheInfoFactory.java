...
public class CacheInfoFactory {
  ...
  public static CacheInfo create(Cache<?, ?> cache, boolean skipDiskStats) {
    return create(null, cache, skipDiskStats);
  }

  public static CacheInfo create(String name, Cache<?, ?> cache) {
    return create(name, cache, false);
  }

  public static CacheInfo create(String name, Cache<?, ?> cache, boolean skipDiskStats) {
