...
public class PerThreadCache implements AutoCloseable {
  ...
  /**
   * Optional HTTP request associated with the pre-thread cache, should the thread associated with
   */
  ...
  public static PerThreadCache create(HttpServletRequest httpRequest) {
