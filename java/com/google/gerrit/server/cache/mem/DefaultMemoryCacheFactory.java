...
class DefaultMemoryCacheFactory implements MemoryCacheFactory {
  ...
  private <K, V> Caffeine<K, V> create(CacheDef<K, V> def) {
    ...
    if (guavaWeigher == null) {
      ...
      weigher = newWeigher(guavaWeigher);
    }
  ...
  private static <K, V> com.github.benmanes.caffeine.cache.Weigher<K, V> newWeigher(
      Weigher<K, V> guavaWeigher) {
    return new com.github.benmanes.caffeine.cache.Weigher<K, V>() {
      @Override
