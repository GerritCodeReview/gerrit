...
public class ProjectSerializer {
  ...
  public static Project deserialize(Cache.ProjectProto proto) {
    Project.Builder builder =
        Project.builder(Project.nameKey(proto.getName()), Timestamp.valueOf(LocalDateTime.now()))
            //Timestamp.from(Instant.ofEpochMilli(proto.getRegisteredOn()))) NO PROTO see CachedAccountDetails
  ...
  public static Cache.ProjectProto serialize(Project autoValue) {
    Cache.ProjectProto.Builder builder =
        Cache.ProjectProto.newBuilder()
            ...
            //.setRegisteredOn(autoValue.getRegisteredOn().toInstant().toEpochMilli()) NO PROTO??
