...
public class SubmitRequirementSerializer {
  public static SubmitRequirement deserialize(Cache.SubmitRequirementProto proto) {
    return SubmitRequirement.builder()
        ...
        .setApplicabilityExpression(
            Optional.ofNullable(Strings.emptyToNull(proto.getApplicabilityExpression())))
        .setBlockingExpression(proto.getBlockingExpression())
        .setOverrideExpression(
            Optional.ofNullable(Strings.emptyToNull(proto.getOverrideExpression())))
        .setCanInherit(proto.getCanInherit())
        .build();
  }
  ...
  public static Cache.SubmitRequirementProto serialize(SubmitRequirement submitRequirement) {
    return Cache.SubmitRequirementProto.newBuilder()
        ...
        .setApplicabilityExpression(submitRequirement.applicabilityExpression().orElse(""))
        .setBlockingExpression(submitRequirement.blockingExpression())
        .setOverrideExpression(submitRequirement.overrideExpression().orElse(""))
        .setCanInherit(submitRequirement.canInherit())
        .build();
  }
}
