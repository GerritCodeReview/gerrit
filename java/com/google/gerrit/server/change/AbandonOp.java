...
import com.google.gerrit.server.mail.EmailModule.AbandonedChangeEmailDecoratorFactories;
...
public class AbandonOp implements BatchUpdateOp {
  ...
  private final AbandonedChangeEmailDecoratorFactories abandonedChangeEmailDecoratorFactories;
  ...
  @Inject
  AbandonOp(
      AbandonedChangeEmailDecoratorFactories abandonedChangeEmailDecoratorFactories,
    ...
    this.abandonedChangeEmailDecoratorFactories = abandonedChangeEmailDecoratorFactories;
    this.cmUtil = cmUtil;
    this.psUtil = psUtil;
  ...
  public void postUpdate(PostUpdateContext ctx) {
    ...
    try {
      ChangeEmailNew changeEmail =
          abandonedChangeEmailDecoratorFactories.createChangeEmail(
              ctx.getProject(), change.getId());
      changeEmail.setChangeMessage(mailMessage, ctx.getWhen());
      OutgoingEmailNew email = abandonedChangeEmailDecoratorFactories.createEmail(changeEmail);
