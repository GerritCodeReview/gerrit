 ...
 *
 * <p>A reviewed flag is a tuple of (patchset ID, file, account ID) and records whether the user
 * has reviewed a file in a patchset. Each user can easily have thousands of reviewed flags and the
...
public interface AccountPatchReviewStore {
  ...
  /**
   * Find the latest patchset, that is smaller or equals to the given patchset, where at least,
