...
public class AddToAttentionSetOp implements BatchUpdateOp {
  ...
  public interface Factory {
    AddToAttentionSetOp create(Set<Account.Id> attentionUserIdSet, String reason);
  }
  ...
  public boolean updateChange(ChangeContext ctx) throws RestApiException {
    ...
    String message = "Added to attention set: ";
    ...
    for (Account.Id attentionUserId : attentionUserIdSet) {
      ...
      if (existingEntry != null && existingEntry.operation() == Operation.ADD) {
        // We can ignore accounts that are already in the attention set.
        continue;
      }
