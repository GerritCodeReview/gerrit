...
/* ö Document how this is extracted from the URL */
// ö We may need two: (Add|Delete)AttentionSetResource
public class AttentionSetEntryResource implements RestResource {  // ö Verify all REST related names
  // ö Shorten this name?
