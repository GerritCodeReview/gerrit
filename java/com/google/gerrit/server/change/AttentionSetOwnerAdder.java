...
public class AttentionSetOwnerAdder implements Runnable {
  ...
  public void run() {
    ...
    try (ManualRequestContext ctx = oneOffRequestContext.open()) {
      // readdOwnerForInactiveOpenChanges skips failures instead of throwing, so retrying will never
      ...
      retryHelper
          .changeUpdate(
              "readdOwnerForInactiveOpenChanges",
              updateFactory -> {
      ...
      logger.atSevere().withCause(e).log("Failed to readd owners.");
    }
  }
