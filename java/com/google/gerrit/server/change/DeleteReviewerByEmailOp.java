...
public class DeleteReviewerByEmailOp extends ReviewerOp {
  ...
  public boolean updateChange(ChangeContext ctx) {
    ...
    // The reviewer is not a registered Gerrit user, thus the email address can be used in ChangeMessage without replacement (it does not classify as Gerrit user identifiable information).
