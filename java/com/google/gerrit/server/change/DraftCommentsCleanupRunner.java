...
public class DraftCommentsCleanupRunner implements Runnable {
  ...
  public static class Module extends LifecycleModule {
    ...
    protected void configure() {
      ...
      bind(DraftsCleanupRunner.class);
    }
  }
  ...
  static class Lifecycle implements LifecycleListener {
    ...
    private final DraftsCleanupRunner runner;
    private final Config cfg;

    @Inject
    Lifecycle(WorkQueue queue, DraftsCleanupRunner runner, @GerritServerConfig Config cfg) {
      this.queue = queue;
      this.runner = runner;
      this.cfg = cfg;
    }
  ...
  @Inject
  DraftsCleanupRunner(DeleteZombieCommentsRefs.Factory factory) {
