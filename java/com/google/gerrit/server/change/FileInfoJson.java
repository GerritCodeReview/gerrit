 ...
 *
 * <p>This class uses a Gerrit config to choose between the old or new diff cache implementations.
 * We are temporarily keeping both implementations. The old implementation should be deprecated
 * soon.
 *
