...
/** Implementation of {@link FileInfoJsonImpl} using the new diff cache {@link DiffOperations}. */
public class FileInfoJsonNewImpl implements FileInfoJsonImpl {
  ...
  private Throwable handleAndThrow(DiffNotAvailableException e)
      throws ResourceConflictException, PatchListNotAvailableException {
