...
public class ReviewerAdder {
  ...
  public abstract static class Options {
    ...
    public static Options forCcingSelf() {
      return builder()
          .ignoreIfChangeOwner(true)
          .allowGroup(false)
          .allowByEmail(false)
  ...
  private void prepareImpl(ChangeNotes notes, Result.Builder resultBuilder)
    ...
    // * If multiple steps fail, they may concatenate multiple errors together.
    // * Thus if a previous step fails and a subsequent one succeeds, it needs to clear any errors
    //   from previous steps.
