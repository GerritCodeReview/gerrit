...
public class ReviewerAddition implements BatchUpdateOp {
  interface Factory {
    ...
    default ReviewerAddition empty() {
  ...
  @Override
  public boolean updateChange(ChangeContext ctx) throws IOException, OrmException {
  ...
  private boolean updateOne(ChangeContext ctx, Result.Builder resultBuilder)
    ...
    patchSet = psUtil.get(ctx.getNotes(), change.currentPatchSetId());
