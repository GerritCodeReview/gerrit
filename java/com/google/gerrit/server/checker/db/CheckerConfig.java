 ...
 * which deals with checkers should use {@link com.google.gerrit.server.checker.Checkers} or {@link
 * com.google.gerrit.server.checker.CheckersUpdate} instead.
 *
 * <h2>Internal details</h2>
 *
 * <p>Each checker is represented by a commit on a branch as defined by {@link
 * RefNames#refsCheckers(String)}. Previous versions of the checker exist as older commits on the
...
public class CheckerConfig extends VersionedMetaData {
  ...
  private CheckerConfig(String checkerUuid) {
    ...
    this.ref = RefNames.refsCheckers(checkerUuid);
  }
