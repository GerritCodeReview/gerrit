 ...
 * {@link
 * com.google.gerrit.server.checker.Checkers#checkersOf(com.google.gerrit.reviewdb.client.Project.NameKey)}.
 * Updates to the repository to checkers map are done automatically when creating/updating checkers
 * through {@link com.google.gerrit.server.checker.CheckersUpdate}.
 *
...
public class CheckersByRepositoryNotes extends VersionedMetaData {
  ...
  protected String getRefName() {
    return RefNames.REFS_META_CHECKERS;
  }
