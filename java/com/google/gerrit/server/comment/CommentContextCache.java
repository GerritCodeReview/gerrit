...
public interface CommentContextCache {
   ...
   * @param patchSet Integer value representing the patchset number where the comment was written.
   * @param commentId A unique ID of the comment
   * @param path String representing the path of the file where the comment was written.
   * @return {@code List} of {@code ContextLine} containing the line text and line number of the
   *     context.
   */
  ImmutableList<ContextLine> get(
      Project.NameKey project, Change.Id changeId, Integer patchSet, String commentId, String path);
   ...
   */
  ImmutableMap<CommentContextKey, List<ContextLine>> getAll(
