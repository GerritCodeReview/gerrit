...
public class CommentContextCacheImpl implements CommentContextCache {
  ...
  public List<LabeledContextLineInfo> get(
    ...
    Key k = Key.create(project, psId, commentId, pathHash, startLine, endLine);
  ...
  abstract static class Key {
    static CommentContextCacheImpl.Key create(
      ...
      return new AutoValue_CommentContextCacheImpl_Key(
          projectKey, psId, commentId, pathHash, startLine, endLine);
    }
    ...
    abstract Integer startLine();

    abstract Integer endLine();
      ...
      public byte[] serialize(Key object) {
        return Protos.toByteArray(
            Cache.CommentContextKeyProto.newBuilder()
                ...
                .setStartLine(object.startLine())
                .setEndLine(object.endLine())
                .build());
      }
  ...
  enum CommentContextSerializer implements CacheSerializer<List<LabeledContextLineInfo>> {
    INSTANCE;
    ...
    public List<LabeledContextLineInfo> load(Key key) throws Exception {
      ...
      Comment comment =
          commentsUtil
              ...
              .orElse(null);
      return commentContextUtil.getContext(
          key.projectKey(),
          comment.getCommitId(),
