...
import com.google.gerrit.sshd.commands.ReloadConfig;
...
public class ConfigUpdatedEvent {
  ...
  public Update accept(Set<ConfigKey> entries) {
    return createUpdate(entries, UpdateResult.ACCEPTED);
  }
  ...
  public static class ConfigUpdateEntry {
    ...
    /** Note: The toString() is used to format the output from {@link ReloadConfig}. */
    @Override
    public String toString() {
