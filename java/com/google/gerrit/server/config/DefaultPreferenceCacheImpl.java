...
@Singleton
public class DefaultPreferenceCacheImpl implements DefaultPreferencesCache {
  ...
  public static Module module() {
    return new CacheModule() {
      ...
      protected void configure() {
        ...
        bind(DefaultPreferenceCacheImpl.class);
        bind(DefaultPreferencesCache.class).to(DefaultPreferenceCacheImpl.class);
      }
    };
  }
  ...
  private static class Loader extends CacheLoader<ObjectId, CachedPreferences> {
    ...
    public CachedPreferences load(ObjectId key) throws IOException, ConfigInvalidException {
      try (Repository allUsersRepo = repositoryManager.openRepository(allUsersName)) {
        ...
        return CachedPreferences.fromConfig(defaultPrefs.getConfig());
      }
    }
  }
}
