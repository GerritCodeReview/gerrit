...
import com.google.gerrit.server.config.GerritServerConfigProvider.ConfigPair;
...
public class GerritServerConfigReloader {
  ...
  public List<ConfigUpdatedEvent.Update> reloadConfig() {
    ...
    synchronized (lock) {
      ConfigPair configs = configProvider.updateConfig();
      ConfigUpdatedEvent updateEvent = new ConfigUpdatedEvent(configs.oldConfig, configs.newConfig);
