...
@Singleton
public class MetricsReservoirConfigImpl implements MetricsReservoirConfig, Provider<ReservoirType> {
  ...
  @Inject
  public MetricsReservoirConfigImpl(@GerritServerConfig Config gerritConfig) {
    this.reservoirType =
