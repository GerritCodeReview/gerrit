...
public abstract class PluginConfig {
  ...
  @VisibleForTesting
  public static PluginConfig forTest(String pluginName, Config cfg) {
    return create(pluginName, cfg, Optional.empty());
  }

  public static PluginConfig create(
      String pluginName, Config cfg, Optional<CachedProjectConfig> projectConfig) {
    ImmutableMap.Builder<AccountGroup.UUID, GroupReference> groupReferences =
        ImmutableMap.builder();
    projectConfig.ifPresent(pc -> groupReferences.putAll(pc.getGroups()));
    return new AutoValue_PluginConfig(
        pluginName, copyConfig(cfg), projectConfig, groupReferences.build());
  }
  ...
  public static class Update {
    ...
    public PluginConfig asPluginConfig() {
      return PluginConfig.create(pluginName, cfg, projectConfig.map(ProjectConfig::getCacheable));
    }
