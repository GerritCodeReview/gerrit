...
public final class SitePaths {
  ...
  /**
   * Use SecureStore to access sensitive information instead of direct access to file. Other
   * implementations may exist that use a different strategy than plain text read/write.
   */
  @Deprecated public final Path secure_config;
