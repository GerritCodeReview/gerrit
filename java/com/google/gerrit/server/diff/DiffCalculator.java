...
public class DiffCalculator {
  ...
  public DiffInfo createDiffInfo(DiffContent.DiffFileInfo fileA, DiffContent.DiffFileInfo fileB, WebLinksUtils webLinksUtils, PatchScript ps, ProjectState state, boolean webLinksOnly) {
  ...
  public static class DiffContent {
    public static class DiffFileInfo {
      public final PatchScript.PatchScriptFileInfo psFileInfo;
  ...
  private FileMeta createFileMeta(ProjectState state, DiffContent.DiffFileInfo file, List<WebLinkInfo> webLinks) {
    ...
    meta.name = file.name;
    meta.contentType = FileContentUtil
        .resolveContentType(state, file.name, file.psFileInfo.getMode(), file.psFileInfo.getMimeType());
  ...
  public Content getDiffContent(PatchScript ps) {
