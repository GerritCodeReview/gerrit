...
/**
 * The interface provide different types of links which can be displayed in diff view. internal use
 * only
 */
public interface DiffWebLinksProvider {

  /**
   * @return links associated with the diff view
   */
  ImmutableList<DiffWebLinkInfo> getDiffLinks();

  /**
   * @return links associated with the diff side
   */
