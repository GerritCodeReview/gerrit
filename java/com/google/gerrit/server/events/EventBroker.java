...
public class EventBroker implements EventDispatcher {
  ...
  protected final GerritInstanceId gerritInstanceId;
  ...
  public EventBroker(
      ...
      @Nullable @GerritInstanceId GerritInstanceId gerritInstanceId) {
  ...
  protected void setEventOrigin(Event event) {
    event.eventInstanceOrigin = gerritInstanceId.toString();
  }
