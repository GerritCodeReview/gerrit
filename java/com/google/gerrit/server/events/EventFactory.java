...
public class EventFactory {
  ...
  public ChangeAttribute asChangeAttribute(ReviewDb db, Change change) {
    ...
    try {
      ...
      logger
          .atSevere()
          .withCause(e)
          .log("Error while getting full commit message for change %s", a.number);
    }
  ...
  public void addPatchSetFileNames(
    ...
    try {
      ...
      logger.atWarning().withCause(e).log("Cannot get patch list");
    }
  }
  ...
  public PatchSetAttribute asPatchSetAttribute(
    ...
    try {
      ...
      logger.atWarning().withCause(e).log("Cannot get size information for %s.", pId);
    }
    return p;
  }
