...
public class GsonEventDeserializerProvider implements Provider<Gson> {
  ...
  private static class ProjectNameKeySerializer implements JsonSerializer<NameKey> {
    @Override
    public JsonElement serialize(NameKey src, Type typeOfSrc, JsonSerializationContext context) {
