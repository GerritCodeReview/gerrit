...
public class ExperimentFeaturesConstants {
  ...
  /**
   * Whether reviewers present in commit message footer are automatically added as reviewers on the
   * created revert.
   */
  public static final String DISABLE_ADDING_REVIEWERS_FROM_FOOTER =
      "GerritBackendFeature__disable_adding_reviewers_from_footer";
}
