...
public class CustomKeyedValuesEdited {
  ...
  @Inject
  public CustomKeyedValuesEdited(PluginSetContext<CustomKeyedValuesEditedListener> listeners, EventUtil util) {
  ...
  private static class Event extends AbstractChangeEvent implements CustomKeyedValuesEditedListener.Event {
    ...
    @Override
    public Map<String, String> getAddedCustomKeyedValues() {
      return added;
    }

    @Override
    public Collection<String> getRemovedCustomKeys() {
      return removed;
    }
  }
}
