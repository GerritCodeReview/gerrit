...
public class EventUtil {
  private static final ImmutableSet<ListChangesOption> DEFAULT_OPTIONS =
      Sets.immutableEnumSet(ListChangesOption.SKIP_MERGEABLE, (ListChangesOption.SKIP_DIFFSTAT));
