...
public abstract class FlowCustomCondition {
   ...
   */
  public abstract Optional<String> documentation();
  ...
  public static FlowCustomCondition.Builder builder(String name) {
    return new AutoValue_FlowCustomCondition.Builder()
        .name(name)
  ...
  public abstract static class Builder {
    ...
    /** Sets an optional documentation string for the custom condition. */
    public abstract Builder documentation(Optional<String> documentation);

    /** Sets an optional documentation string for the custom condition. */
    public final Builder documentation(String documentation) {
      return documentation(Optional.of(documentation));
    }
