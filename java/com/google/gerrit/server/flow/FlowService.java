...
public interface FlowService {
  ...
  /**
   * Lists the actions for one change.
   *
   * <p>The order of the returned actions is stable, but depends on the flow service
   * implementation.
   *
   * @param projectName The name of the project that contains the change.
   ...
   * @throws StorageException thrown if accessing the flow storage has failed
   */
  ImmutableList<FlowActionInfo> listActions(Project.NameKey projectName, Change.Id changeId)
      throws StorageException;
}
