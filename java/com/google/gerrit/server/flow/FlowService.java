...
public interface FlowService {
  ...
  /** Checks if Flows is enabled for the user.
   * 
   * <p>Certain users may not be permitted to create/view flows.
   *
   ...
   * @throws StorageExcRestApiExceptioneption thrown if checking flow access has failed
   */
