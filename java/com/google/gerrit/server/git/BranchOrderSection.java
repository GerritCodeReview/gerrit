 ...
 *
 * <p>Changes on a development branch can be backported to release branches, and the UI
 * automatically checks if changes in can be merged into stable branches. This is configured by the
