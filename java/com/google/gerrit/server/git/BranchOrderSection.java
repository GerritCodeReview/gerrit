 ...
 *
 * <p>Changes on a development branch can be backported to release branches. The REST API supports
 * automatically checking if changes in can be merged into stable branches. This is configured by the
 * {@code branchOrder.branch} project setting. This class represents the ordered list of branches.
 */
