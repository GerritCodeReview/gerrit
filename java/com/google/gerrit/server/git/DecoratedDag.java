 ...
 * {@link RevCommit} DAG. This reduced DAG is decoration (ref) aware and much faster to walk than
 * a {@link RevWalker}.
 */
public class DecoratedDag extends ObjectIdOwnerMap<DecoratedDag.Node> {
  /**
   * A {@link node} which tracks ref decorations, representing a git commit
   */
  ...
  // The {@link DecoratedDag} includes initial commits (ICs) even if they aren't decorated so that we have
  ...
  public static final String IC_DECORATION = ""; // Fake decoration to keep ICs in {@link DecoratedDag}.
