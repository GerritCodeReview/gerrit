...
public class GarbageCollectionLogFile implements LifecycleListener {
  ...
  @Override
  public void stop() {
    LoggerConfig gcLogger = new LoggerConfig(getLogger(GarbageCollection.class).toString(), null, false);
    gcLogger.removeAppender(getLogger(GarbageCollection.class).toString());

    LoggerConfig gcLogger2 = new LoggerConfig(getLogger(GarbageCollectionRunner.class).toString(), null, false);
