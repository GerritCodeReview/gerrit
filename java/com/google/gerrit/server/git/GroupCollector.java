 ...
 *       a group from a patchset, use that group, otherwise, use the group from the first parent. In
 *       addition to setting this merge commit's group, use the chosen group for all commits that
