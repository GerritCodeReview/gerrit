...
public class MergeUtil {
  ...
  public boolean canMerge(
    ...
    return canMerge(repo, mergeTip, toMerge);
  }

  private boolean canMerge(Repository repo, CodeReviewCommit mergeTip, CodeReviewCommit toMerge) {
  ...
  public boolean canFastForwardOrMerge(
    ...
    return canFastForward(mergeTip, rw, toMerge) || canMerge(repo, mergeTip, toMerge);
  }
