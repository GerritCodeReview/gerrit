...
public class PermissionAwareRepository extends Repository {
  ...
  public PermissionAwareRepository(
      Repository delegate, PermissionBackend.ForProject forProject, RefFilterOptions opts) {
    super(toBuilder(delegate));
    this.delegate = delegate;
    this.permissionAwareReadOnlyRefDatabase =
        new PermissionAwareReadOnlyRefDatabase(delegate, forProject, opts);
  }
