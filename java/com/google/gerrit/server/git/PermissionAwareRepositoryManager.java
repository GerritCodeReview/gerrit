...
public interface PermissionAwareRepositoryManager {
   ...
   * @return a wrapper to the given delegate that will filter calls using the given forProject
   *     filter
   */
  ...
  /**
   * @param repository
   * @return Returns the unwrapped repository, if the argument is not a permission aware repository
   *     (i.e. an instance of {@link PermissionAwareRepositoryWrapper} the call returns the argument
   */
