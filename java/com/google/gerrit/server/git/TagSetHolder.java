...
public class TagSetHolder {
  ...
  public TagMatcher matcher(
      TagCache cache, Repository db, Collection<Ref> include, Iterable<Ref> tags) throws IOException {
  ...
  private TagSet rebuild(TagCache cache, Repository db, TagSet old, TagMatcher m) throws IOException {
    synchronized (buildLock) {
