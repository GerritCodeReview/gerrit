  ...
  private class Executor extends ScheduledThreadPoolExecutor {
    ...
    private void buildMetrics(String queueName, MetricMaker metric) {
      ...
      metric.newCallbackMetric(
          ...
          Long.class,
          new Description("Number of threads that are actively executing tasks").setGauge().setUnit("threads"),
          new Supplier<Long>() {
            @Override
            public Long get() {
      ...
      metric.newCallbackMetric(
          getMetricName(queueName, "scheduledTasksCount"),
          Long.class,
          new Description("Total number of tasks that have been scheduled for execution").setCumulative().setUnit("tasks"),
          new Supplier<Long>() {
            @Override
            public Long get() {
      ...
      metric.newCallbackMetric(
          getMetricName(queueName, "completedTasksCount"),
          Long.class,
          new Description("Total number of tasks that have completed execution").setCumulative().setUnit("tasks"),
          new Supplier<Long>() {
            @Override
            public Long get() {
