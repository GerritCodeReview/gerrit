...
public class MetaDataUpdate implements AutoCloseable {
  ...
  private final Optional<ProjectCache> projectCache;
  ...
  public MetaDataUpdate(
    ...
    this.projectCache = Optional.ofNullable(projectCache);
