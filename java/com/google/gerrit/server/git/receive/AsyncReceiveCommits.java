...
import com.google.gerrit.server.RequestCountMetrics;
...
public class AsyncReceiveCommits {
  ...
  public interface Factory {
    AsyncReceiveCommits create(
        ...
        @Nullable RequestCountMetrics requestCountMetrics);
  }
  ...
  AsyncReceiveCommits(
      ...
      @Assisted @Nullable RequestCountMetrics requestCountMetrics)
