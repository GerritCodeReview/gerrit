...
public class BranchCommitValidator {
  ...
  /** The result of validating a commit. */
  @AutoValue
  public static abstract class Result {
    static Result create(boolean isValid, List<CommitValidationMessage> messages) {
    ...
    /**
     * A list of messages resulting from the validation. Messages may be present regardless of the
     * {@link #isValid()} status.
     */
    abstract List<CommitValidationMessage> messages();
  }
   ...
   *
   * @return A boolean representing the validation result, and list of messages explaining it.
   */
