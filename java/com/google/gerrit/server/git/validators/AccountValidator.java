...
public class AccountValidator {
  ...
  public List<String> validate(
    ...
    if (oldId != null && !ObjectId.zeroId().equals(oldId)) {
      try {
        oldAccount = accounts.loadAccountFromRevision(accountId, allUsersRepo, rw, oldId, null);
    ...
    try {
      newAccount = accounts.loadAccountFromRevision(accountId, allUsersRepo, rw, newId, messages);
    } catch (ConfigInvalidException e) {
