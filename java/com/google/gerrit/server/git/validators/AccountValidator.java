...
/**
 * Validator is used to ensure that new commits on any ref in {@code refs/users} are conforming to
 * the NoteDb format for accounts. Used when a user pushes to one of the refs in {@code refs/users}
 * manually.
 */
