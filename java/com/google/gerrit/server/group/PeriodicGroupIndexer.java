 ...
 * groups can be detect. Only those groups are then reindexed. On startup of a slave all groups are
 * reindexed once. This means callers of slaves may observe outdated group information until the
