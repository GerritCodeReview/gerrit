 ...
 *
 * <p><strong>Warning: </strong>This class represents a low-level API for properties of groups in
 * NoteDb. It may only be used by {@link GroupConfig}. Other classes should use {@link
 * InternalGroupUpdate} to modify the properties of a group.
 */
enum GroupConfigEntry {
   ...
   *
   * <p>This is an optional property. It defaults to {@code null} if not set.
   */
   ...
   *
   * <p>This is an optional property. It defaults to the group itself if not set.
   */
   ...
   *
   * <p>This is an optional property. It defaults to {@code false} if not set.
   */
