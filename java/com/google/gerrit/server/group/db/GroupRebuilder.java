...
public class GroupRebuilder {
  ...
  public void rebuild(Repository allUsersRepo, GroupBundle bundle)
    ...
    // Don't set owner in the InternalGroupUpdate; that would trigger a non-atomic update of
    // refs/meta/config within GroupConfig#onSave. The owner update is instead handled specially in
    // this method using a single commit, in a shared BatchRefUpdate.
