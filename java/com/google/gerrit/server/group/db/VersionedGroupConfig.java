 ...
 * ObjectId field pointing to a specific commit in the group ref, giving this class the ability
 * to point to a previous state of the group and not necessarily the latest
 */
