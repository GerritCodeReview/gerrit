...
public class IndexModule extends LifecycleModule {
  ...
  protected void configure() {
    ...
    if (closeExecutorsOnShutdown) {
      // This listener must be added after adding *IndexCollection as listeners so that it is
      // ensured that the executors are shutdown before closing the indexes.
      // Closing the indexes is done by *IndexCollection.
