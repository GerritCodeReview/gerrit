...
public final class IndexUtils {
  ...
  public static Set<String> accountFields(Set<String> fields) {
    return fields.contains(AccountField.ID2.getName())
        ? fields
        : Sets.union(fields, ImmutableSet.of(AccountField.ID2.getName()));
  }
  ...
  public static Set<String> changeFields(QueryOptions opts) {
    ...
    if (fs.contains(PROJECT.getName()) && fs.contains(LEGACY_ID2.getName())) {
      return fs;
    }
    return Sets.union(fs, ImmutableSet.of(LEGACY_ID2.getName(), PROJECT.getName()));
  }
