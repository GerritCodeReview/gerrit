 ...
 * index.onlineUpgrade is true or upgrade_and_reindex. Reindex is skipped if index.onlineUpgrade is
 * no_reindex.
 */
public abstract class VersionManager implements LifecycleListener {
  ...
  public static boolean shouldPerformOnlineUpgrade(Config cfg) {
    ...
    return onlineUpgrade == OnlineUpgrade.UPGRADE_AND_REINDEX
        || onlineUpgrade == OnlineUpgrade.NO_REINDEX;
  }
