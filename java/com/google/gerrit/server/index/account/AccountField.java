...
import static com.google.gerrit.index.Field.timestampBuilder;
...
public class AccountField {
  ...
  public static final Field<AccountState, Integer> ID_FIELD =
      Field.<AccountState>integerBuilder("Id")
          .stored()
          .build(a -> a.account().id().get());

  public static final Field.FieldSpec ID_FIELD_SPEC = ID_FIELD.integer("id");
  ...
  public static final Field.FieldSpec ID_STR_FIELD_SPEC =  ID_STR_FIELD.exact("id_str");
  ...
  public static final Field.FieldSpec  EXTERNAL_ID_FIELD_SPEC =   EXTERNAL_ID_FIELD.exact("external_id");
   ...
   * capability).
   *
   * <p>Use the {@link AccountField#NAME_PART_NO_SECONDARY_EMAIL_FIELD} if the current user can't see
   * secondary emails.
   */
  ...
  public static final FieldSpec NAME_PART_SPEC = NAME_PART_FIELD.
      prefix("name");
  ...
  public static final FieldSpec FULL_NAME_SPEC = FULL_NAME_FIELD
      .exact("full_name");
  ...
  public static final FieldSpec ACTIVE_FIELD_SPEC =
   ...
   *
   * <p>Use the {@link AccountField#PREFERRED_EMAIL_FIELD} if the current user can't see secondary emails.
   */
  public static final Field<AccountState, Iterable<String>> EMAIL_FIELD =
      Field.<AccountState>iterableStringBuilder("Email").build(
              a ->
  ...
  public static final FieldSpec EMAIL_SPEC =
      EMAIL_FIELD.prefix("email");

  public static final Field<AccountState, String> PREFERRED_EMAIL_FIELD =
      Field.<AccountState>stringBuilder("Email").build(
          a -> a.account().preferredEmail());

  public static final FieldSpec PREFERRED_EMAIL_PREFIX_SPEC = PREFERRED_EMAIL_FIELD
.prefix("preferredemail");
  public static final FieldSpec PREFERRED_EMAIL_EXACT_SPEC = PREFERRED_EMAIL_FIELD
.exact("preferredemail_exact");
  ...
  public static final Field<AccountState, Timestamp> REGISTERED_FIELD =
      Field.<AccountState>timestampBuilder("Registered").build(a -> Timestamp.from(a.account().registeredOn()));

  public static final FieldSpec REGISTERED_SPEC =
      REGISTERED_FIELD.timestamp("registered");

  public static final Field<AccountState, String> USERNAME_FIELD =
      Field.<AccountState>stringBuilder("username").build(a -> a.userName().map(String::toLowerCase).orElse(""));

  public static final FieldSpec USERNAME_SPEC =
  ...
  public static final FieldSpec REF_STATE_SPEC =
  ...
  public static final FieldSpec EXTERNAL_ID_STATE_SPEC = EXTERNAL_ID_STATE_FIELD.storedOnly("external_id_state");
