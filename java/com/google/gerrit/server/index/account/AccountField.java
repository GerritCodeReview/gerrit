...
public class AccountField {
  ...
  public static final IndexedField<AccountState, Iterable<String>> NAME_PART_FIELD =
      IndexedField.<AccountState>iterableStringBuilder("NamePart")
          .required()
  ...
  public static final IndexedField<AccountState, Iterable<String>>
      NAME_PART_NO_SECONDARY_EMAIL_FIELD =
          IndexedField.<AccountState>iterableStringBuilder("NamePartNoEmail")
              .required()
  ...
  public static final IndexedField<AccountState, String> PREFERRED_EMAIL_FIELD =
      IndexedField.<AccountState>stringBuilder("PreferredEmail")
          .build(a -> a.account().preferredEmail());

  public static final SearchSpec PREFERRED_EMAIL_SPEC =
