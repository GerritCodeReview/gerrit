...
public class AccountField {
  ...
  public static final Field.FieldSpec EXTERNAL_ID_FIELD_SPEC =
   ...
   * capability).
   *
   * <p>Use the {@link AccountField#NAME_PART_NO_SECONDARY_EMAIL_FIELD} if the current user can't
   * see secondary emails.
   */
   ...
   *
   * <p>Use the {@link AccountField#PREFERRED_EMAIL_FIELD} if the current user can't see secondary
   * emails.
   */
  ...
  public static final Field<AccountState, String> PREFERRED_EMAIL_FIELD =
      Field.<AccountState>stringBuilder("Email").build(a -> a.account().preferredEmail());
