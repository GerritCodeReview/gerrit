...
public class AccountSchemaDefinitions extends SchemaDefinitions<AccountState> {
  ...
  static final Schema<AccountState> V8 =
      schema(
          /* version= */ 8,
          ImmutableList.of(
              AccountField.ID, AccountField.PREFERRED_EMAIL, AccountField.PREFERRED_EMAIL_EXACT),
          ImmutableList.of(
          ...
          ImmutableList.of(
              ...
              // AccountField.PREFERRED_EMAIL_PREFIX_SPEC,
  ...
  static final Schema<AccountState> V11 =
      new Schema.Builder<AccountState>()
          ...
          // .addIndexFields(AccountField.ID_STR_FIELD)
          // .addFieldSpecs(AccountField.ID_STR_FIELD_SPEC)
          .build();
