...
public class StalenessChecker {
  ...
  public StalenessCheckResult check(Account.Id id) throws IOException {
    ...
    for (Map.Entry<Project.NameKey, RefState> e :
        RefState.parseStates(result.get().getValue(AccountField.REF_STATE_SPEC)).entries()) {
    ...
    ListMultimap<ObjectId, ObjectId> extIdStates =
        parseExternalIdStates(result.get().getValue(AccountField.EXTERNAL_ID_STATE_SPEC));
