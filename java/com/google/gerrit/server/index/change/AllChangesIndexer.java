...
public class AllChangesIndexer extends SiteIndexer<Change.Id, ChangeData, ChangeIndex> {
  ...
  public Result indexAll(ChangeIndex index) {
    ...
    projTask = mpm.beginVolatileSubTask("project-slices", MultiProgressMonitor.UNKNOWN);
    doneTask = mpm.beginVolatileSubTask("changes", MultiProgressMonitor.UNKNOWN);
    ...
    private void schedule() throws ProjectsCollectionFailure {
      ...
      try {
        mpm.waitFor(
            ...
            null,
            EndMonitor.FALSE);
      } catch (UncheckedExecutionException | TimeoutException e) {
