...
public class ChangeIndexRewriter implements IndexRewriter<ChangeData> {
   ...
   *     semantically equivalent predicate with indexed subtrees wrapped to query the index
   *     directly, or with existing {@link ChangeDataSource} children preserved intact when no
   *     children are directly indexed (e.g. a subtree of plugin datasources).
