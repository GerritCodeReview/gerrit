...
public class ChangeIndexer {
   ...
   *     com.google.gerrit.entities.Change.Id)} which reloads the full
   *     change details, including the associated serverId.
   */
  @Deprecated
   ...
   *
   * Load the change full details from NoteDb and update the corresponding
   * entry in the index.
   *
