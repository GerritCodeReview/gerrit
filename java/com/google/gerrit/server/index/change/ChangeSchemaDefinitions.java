...
public class ChangeSchemaDefinitions extends SchemaDefinitions<ChangeData> {
  ...
  /** Add met requirement tracking fields */
  static final Schema<ChangeData> V89 =
      new Schema.Builder<ChangeData>()
          .add(V88)
          .addIndexedFields(
              ChangeField.MET_REQUIREMENT_FIELD, ChangeField.UNSATISFIED_REQUIREMENT_COUNT_FIELD)
          .addSearchSpecs(
              ChangeField.MET_REQUIREMENT_SPEC, ChangeField.UNSATISFIED_REQUIREMENT_COUNT_SPEC)
          .build();
