...
public final class RegexListSearcher<T> {
  public static RegexListSearcher<String> ofStrings(String re, RegexCompiler regexCompiler) {
    return new RegexListSearcher<>(regexCompiler, re, Function.identity());
  }
  ...
  public RegexListSearcher(
      RegexCompiler regexCompiler, String re, Function<T, String> toStringFunc) {
    ...
    Automaton automaton = regexCompiler.toAutomaton(re);
