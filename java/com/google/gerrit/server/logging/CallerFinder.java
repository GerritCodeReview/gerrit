 ...
 * </pre>
 *
 * <p>Another special case is if the entry point is always an inner class of a known interface.
 * E.g. {@link com.google.gerrit.server.permissions.PermissionBackend} is the entry point for all
