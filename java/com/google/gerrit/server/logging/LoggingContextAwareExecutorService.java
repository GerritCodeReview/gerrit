...
public class LoggingContextAwareExecutorService implements ExecutorService {
  ...
  public <T> List<Future<T>> invokeAll(Collection<? extends Callable<T>> tasks)
    ...
    return executorService.invokeAll(tasks.stream().map(LoggingContext::copy).collect(toSet()));
  }
  ...
  public <T> T invokeAny(Collection<? extends Callable<T>> tasks)
    ...
    return executorService.invokeAny(tasks.stream().map(LoggingContext::copy).collect(toSet()));
  }
