...
public abstract class Metadata {
  ...
  public String toStringForLogging() {
    ...
    loggingString.append(className).append('{');
    ...
    for (Method method : methods) {
      ...
      if (returnValue instanceof Optional) {
        ...
        loggingString.append(method.getName()).append('=').append(fieldValueOptional.get());
      } else {
        ...
        loggingString.append(method.getName()).append('=').append(returnValue);
      }
