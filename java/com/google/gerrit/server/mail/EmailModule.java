...
public class EmailModule extends FactoryModule {
  ...
  public static class AttentionSetChangeEmailFactories {
    ...
    public AttentionSetChangeEmail createAttentionSetChangeEmail() {
      return new AttentionSetChangeEmail();
    }

    public ChangeEmailNew createChangeEmail(
        Project.NameKey project,
        Change.Id changeId,
        AttentionSetChangeEmail attentionSetChangeEmail) {
      return changeEmailFactory.create(
          args.newChangeData(project, changeId), attentionSetChangeEmail);
    }
