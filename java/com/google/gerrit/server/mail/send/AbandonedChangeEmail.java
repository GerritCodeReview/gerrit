...
public class AbandonedChangeEmail extends ReplyToChangeSender {
  public interface Factory extends ReplyToChangeSender.Factory<AbandonedChangeEmail> {
    @Override
    AbandonedChangeEmail create(Project.NameKey project, Change.Id changeId);
  }

  @Inject
  public AbandonedChangeEmail(
