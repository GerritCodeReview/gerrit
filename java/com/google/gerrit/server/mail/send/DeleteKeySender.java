...
public class DeleteKeySender extends OutgoingEmail {
  public interface Factory {
    DeleteKeySender create(IdentifiedUser user, Boolean sshKey);

    DeleteKeySender create(IdentifiedUser user, Boolean gpgKey);
  }

  private final PermissionBackend permissionBackend;
  private final IdentifiedUser callingUser;
  private final IdentifiedUser user;
  private final Boolean sshKey;
  private final Boolean gpgKeys;
