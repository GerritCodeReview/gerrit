...
public class DeleteKeySender extends OutgoingEmail {
  public interface Factory {
    DeleteKeySender create(IdentifiedUser user, String keyType);
  }
  ...
  protected boolean shouldSendMessage() {
    if (user.equals(callingUser)) {
      ...
      // the user if their account was compromised and a password was unexpectedly added, changed.
      return true;
    }
