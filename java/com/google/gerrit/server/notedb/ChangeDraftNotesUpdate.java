...
public class ChangeDraftNotesUpdate extends AbstractChangeUpdate implements ChangeDraftUpdate {
  ...
  @Override
  public void markAllDraftCommentsAsFixed(List<Comment> comments) {
    comments.forEach(this::markDraftCommentAsFixed);
  }
  ...
  public static Optional<ChangeDraftNotesUpdate> asChangeDraftNotesUpdate(
    ...
    try {
      return Optional.of(ChangeDraftNotesUpdate.class.cast(obj));
