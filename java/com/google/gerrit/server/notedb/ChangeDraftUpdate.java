...
public class ChangeDraftUpdate extends AbstractChangeUpdate {
  ...
  private ChangeDraftUpdate(
    ...
    this.writeJson = firstNonNull(writeJson, noteUtil.getChangeNoteJson().getWriteJson());
  }
  ...
  private ChangeDraftUpdate(
    ...
    super(
        ...
        when);
    this.draftsProject = allUsers;
    this.writeJson = noteUtil.getChangeNoteJson().getWriteJson();
  }
  ...
  private CommitBuilder storeCommentsInNotes(
    ...
    for (Map.Entry<RevId, RevisionNoteBuilder> e : builders.entrySet()) {
      ...
      byte[] data =
          e.getValue()
              .build(noteUtil.getChangeNoteJson(), noteUtil.getLegacyChangeNoteWrite(), writeJson);
