...
public class ChangeNoteUtil {
  ...
  static Optional<AttentionSetUpdate> attentionStatusFromJson(
    ...
    return account.map(
        id -> AttentionSetUpdate.createFromRead(timestamp, id, inNoteDb.operation, inNoteDb.reason));
  }

  String attentionStatusToJson(AttentionSetUpdate attentionSetUpdate) {
    PersonIdent personIdent =
        new PersonIdent(
            getUsername(attentionSetUpdate.account()), getEmailAddress(attentionSetUpdate.account()));
