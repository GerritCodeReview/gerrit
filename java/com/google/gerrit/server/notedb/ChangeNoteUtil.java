...
public class ChangeNoteUtil {
  ...
  /** Returns the parsed entity, or null if parsing failed. */
  @Nullable
  static AttentionStatus attentionStatusFromJson(Instant timestamp, String attentionString) {
    ...
    return account
        .map(
            id ->
                AttentionStatus.createFromRead(timestamp, id, inNoteDb.operation, inNoteDb.reason))
        .orElse(null);
  }
