...
public class ChangeNotes extends AbstractChangeNotes<ChangeNotes> {
  ...
  public ImmutableListMultimap<ObjectId, HumanComment> getDraftComments(
      Account.Id author, Change.Id virtualId) {
    return getDraftComments(author, virtualId, null);
  }

  public ImmutableListMultimap<ObjectId, HumanComment> getDraftComments(
      Account.Id author, Change.Id virtualId, @Nullable Ref ref) {
   ...
   */
  private void loadDraftComments(Account.Id author, Change.Id virtualId, @Nullable Ref ref) {
