...
public class ChangeNotes extends AbstractChangeNotes<ChangeNotes> {
  ...
  public ImmutableListMultimap<ObjectId, HumanComment> getDraftComments(Account.Id author, ChangeNumberVirtualIdAlgorithm virtualIdFunc) {
   ...
   */
  private void loadDraftComments(Account.Id author, @Nullable ChangeNumberVirtualIdAlgorithm virtualIdFunc, @Nullable Ref ref) {
    if (draftCommentNotes == null || !author.equals(draftCommentNotes.getAuthor()) || ref != null) {
      Change.Id virtualId = virtualIdFunc == null ? getChangeId() : virtualIdFunc.apply(getChange().getServerId(), getChangeId());
