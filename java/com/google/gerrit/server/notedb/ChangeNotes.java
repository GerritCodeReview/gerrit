...
public class ChangeNotes extends AbstractChangeNotes<ChangeNotes> {
  ...
  private ImmutableSortedMap<String, String> customValues;
  ...
  public ImmutableSortedMap<String, String> getCustomValues() {
    if (customValues == null) {
      ImmutableSortedMap.Builder<String, String> b = ImmutableSortedMap.naturalOrder();
      b.putAll(state.customValues());
      customValues = b.build();
    }
    return customValues;
  }
