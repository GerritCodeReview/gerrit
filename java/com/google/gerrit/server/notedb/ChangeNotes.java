...
public class ChangeNotes extends AbstractChangeNotes<ChangeNotes> {
   ...
   * requirements in NoteDb for closed changes, hence the result will be empty for active changes,
   * and contains a single entry (for the latest patchset) for closed changes.
   */
