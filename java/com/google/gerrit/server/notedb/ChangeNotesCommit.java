...
public class ChangeNotesCommit extends RevCommit {
  ...
  protected boolean countTowardsMaxUpdatesLimit(boolean hasChangeMessage) {
    return !isAttentionSetCommitOnly(hasChangeMessage);
  }

  private boolean isAttentionSetCommitOnly(boolean hasChangeMessage) {
