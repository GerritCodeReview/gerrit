...
public abstract class ChangeNotesState {
  ...
  static ChangeNotesState create(
      ...
      List<AttentionSetUpdate> attentionSetUpdateUpdates,
    ...
    return builder()
        ...
        .attentionSetUpdates(attentionSetUpdateUpdates)
  ...
  abstract ImmutableList<AttentionSetUpdate> attentionSetUpdates();
  ...
  abstract static class Builder {
    ...
    static Builder empty(Change.Id changeId) {
      return new AutoValue_ChangeNotesState.Builder()
          ...
          .attentionSetUpdates(ImmutableList.of())
    ...
    abstract Builder attentionSetUpdates(List<AttentionSetUpdate> attentionSetUpdates);
  ...
  enum Serializer implements CacheSerializer<ChangeNotesState> {
    ...
    public byte[] serialize(ChangeNotesState object) {
      ...
      object
          .attentionSetUpdates()
          .forEach(u -> b.addAttentionSetUpdate(toAttentionSetUpdateProto(u)));
    ...
    private static AttentionSetUpdateProto toAttentionSetUpdateProto(
      ...
      return AttentionSetUpdateProto.newBuilder()
          .setDate(attentionSetUpdate.timestamp().toEpochMilli())
    ...
    public ChangeNotesState deserialize(byte[] in) {
      ...
      ChangeNotesState.Builder b =
          builder()
              ...
              .attentionSetUpdates(toAttentionSetUpdateList(proto.getAttentionSetUpdateList()))
