...
public class DeleteChangeMessageRewriter implements NoteDbRewriter {
  public interface Factory {
    DeleteChangeMessageRewriter create(
        Change.Id changeId, int targetMessageIdx, String newChangeMessage);
  }
  ...
  DeleteChangeMessageRewriter(
      ...
      @Assisted int targetMessageIdx,
      @Assisted String newChangeMessage) {
  ...
  private String createNewCommitMessage(RevCommit commit) {
    ...
    Optional<ChangeNotesParser.Range> range = parseCommitMessageRange(commit);
    if (!range.isPresent()) {
