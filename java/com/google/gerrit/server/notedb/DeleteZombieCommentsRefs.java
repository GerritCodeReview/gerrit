...
public class DeleteZombieCommentsRefs {
  ...
  @Nullable private final NoteDbUpdateManager.Factory noteDbUpdateManagerFactory;
  ...
  private DeleteZombieCommentsRefs(
      ...
      @Nullable NoteDbUpdateManager.Factory noteDbUpdateManagerFactory,
   ...
   *
   * @return the number of deletected and delete zombie draft refs.
   */
  @VisibleForTesting
      ...
      for (Ref draftRef : draftRefs) {
        try {
          ...
          if (!zombieDrafts.isEmpty()) {
            deleteZombieComments(notes.getProjectName(), accountId, notes, zombieDrafts);
          }
