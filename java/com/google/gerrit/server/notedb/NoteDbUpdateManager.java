 ...
 * {@link #stage()}.
 *
 * <p>It is possible co configure manager for a non-atomic {@link BatchRefUpdate} of {@link
 * #changeRepo}, but callers should be careful to only use this option in cases when single ref is
 * updated per change in change repo.
 */
