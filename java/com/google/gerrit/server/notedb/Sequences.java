...
public class Sequences {
  ...
  public static final String NAME_ACCOUNTS_LIGHTWEIGHT = "accounts_lightweight";
  public static final String NAME_GROUPS_LIGHTWEIGHT = "groups_lightweight";
  ...
  public Sequences(
      MetricMaker metrics,
      @Named(NAME_ACCOUNTS) IncrementingSequence accountsSeq,
      @Named(NAME_GROUPS) IncrementingSequence groupsSeq,
      @Named(NAME_CHANGES) IncrementingSequence changesSeq) {
