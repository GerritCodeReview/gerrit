...
public class NoteDbMigrator implements AutoCloseable {
  ...
  private static final String META_EVENTS_IN_TRIAL = "metaEventsInTrial";
  ...
  public static boolean getMetaEventsInTrial(Config cfg) {
    return cfg.getBoolean(SECTION_NOTE_DB, NoteDbTable.CHANGES.key(), META_EVENTS_IN_TRIAL, false);
  }
