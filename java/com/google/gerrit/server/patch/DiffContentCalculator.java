...
class DiffContentCalculator {
   ...
   *
   * <p>The method returns instance of {@link DiffCalculatorResult} with the following data: a) All
   * changed lines b) Additional lines to be displayed above and below the changed lines. c) All
   * changed and unchanged lines with comments d) Additional lines to be displayed above and below
   * lines with comments. e) edits with special "fake" edits for unchanged lines with comments
   *
