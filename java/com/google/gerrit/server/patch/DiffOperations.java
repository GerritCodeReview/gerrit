...
public interface DiffOperations {
   ...
   * @param parentNum 1-based integer specifying which parent to use as base. If null or zero, the
   *     only parent will be used or the auto-merge if {@code newCommit} is a merge commit.
