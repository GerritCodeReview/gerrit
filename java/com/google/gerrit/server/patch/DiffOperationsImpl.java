...
public class DiffOperationsImpl implements DiffOperations {
  ...
  private Map<String, FileDiffOutput> getModifiedFiles(DiffParameters diffParams)
      throws DiffNotAvailableException {
    try {
  ...
  static class DiffResult {
    ...
    private DiffResult(FileDiffOutput fileDiff, Map<String, FileDiffOutput> modifiedFiles) {
      this.fileDiff = fileDiff;
      this.modifiedFiles = modifiedFiles;
    }

    static DiffResult create(FileDiffOutput fileDiff, Map<String, FileDiffOutput> modifiedFiles) {
      return new DiffResult(fileDiff, modifiedFiles);
    }
  }
