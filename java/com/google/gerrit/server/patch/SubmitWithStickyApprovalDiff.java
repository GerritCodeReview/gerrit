...
public class SubmitWithStickyApprovalDiff {
  ...
  SubmitWithStickyApprovalDiff(
    ...
    // (November 2021) We divide the max cumulative comment size by 3 since it's a reasonable size
    ...
    // set at 3MB. In this example, we can reach at most 4MB hence we ensure not to exceed the
    // limit of 5MB.
