...
public class SubmitWithStickyApprovalDiff {
  ...
  public String computeDiffFromModifiedFiles(
      ChangeNotes notes, CurrentUser currentUser, List<FileDiffOutput> modifiedFilesList)
  ...
  public List<FileDiffOutput> apply(ChangeNotes notes, CurrentUser currentUser)
      throws AuthException,
          IOException,
          PermissionBackendException,
          InvalidChangeOperationException {
