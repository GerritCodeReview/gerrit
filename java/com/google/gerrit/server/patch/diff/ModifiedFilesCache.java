 ...
 * org.eclipse.jgit.lib.Constants#EMPTY_TREE_ID}, * the diff will be evaluated against the empty
 * tree, and the result will be exactly the same as the * caller can get from {@link
