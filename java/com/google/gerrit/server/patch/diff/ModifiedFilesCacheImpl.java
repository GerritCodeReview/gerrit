...
public class ModifiedFilesCacheImpl implements ModifiedFilesCache {
  ...
  static class ModifiedFilesLoader
     ...
     *
     * <p>Background: In some cases, JGit returns two ADDED/DELETED diff entries for the same file
     * path. This happens e.g. when a file's mode is changed between patchsets, for example
