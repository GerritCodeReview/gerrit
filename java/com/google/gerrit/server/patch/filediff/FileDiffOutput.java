...
public abstract class FileDiffOutput implements Serializable {
   ...
   */
  public abstract Optional<Boolean> tooExpensiveToCompute();
  ...
  public static FileDiffOutput createExpensive(
    ...
    return empty(filePath, oldCommitId, newCommitId).toBuilder()
        .negative(Optional.of(true))
        .tooExpensiveToCompute(Optional.of(true))
        .build();
  }
   ...
   * tooExpensiveToCompute result in this case.
   */
  public boolean isTooExpensive() {
    return tooExpensiveToCompute().isPresent() && tooExpensiveToCompute().get();
  }
  ...
  public int weight() {
    ...
    if (tooExpensiveToCompute().isPresent()) {
      result += 1;
    }
    return result;
  }
  ...
  public abstract static class Builder {
    ...
    public abstract Builder tooExpensiveToCompute(Optional<Boolean> value);
  ...
  public enum Serializer implements CacheSerializer<FileDiffOutput> {
    ...
    public byte[] serialize(FileDiffOutput fileDiff) {
      ...
      if (fileDiff.tooExpensiveToCompute().isPresent()) {
        builder.setTooExpensiveToCompute(fileDiff.tooExpensiveToCompute().get());
      }
