...
abstract class WrappedKey {
  ...
  static Builder builder() {
    return new AutoValue_WrappedKey.Builder();
  }

  @AutoValue.Builder
  public abstract static class Builder {

    public abstract Builder oldParentId(Optional<org.eclipse.jgit.lib.ObjectId> value);

    public abstract Builder newParentId(Optional<org.eclipse.jgit.lib.ObjectId> value);
