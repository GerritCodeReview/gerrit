...
public class FileHeaderUtil {
   ...
   * occurrence of 1 character = (1 / 256). We want to find the limit that makes the prob. of
   * finding {@link #NUL} > 99.9. 1 - (255 / 256) ^ N > 99.9 yields N = 1766. We set the limit to
