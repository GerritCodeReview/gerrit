...
public enum ChangePermission implements ChangePermissionOrLabel {
  ...
  // The change couldn't be restored if its current patch set is locked.
  //
  ...
  RESTORE,
  DELETE,
  // The change couldn't be abandoned if its current patch set is locked.
  //
  // Before checking this permission, the caller should first verify the current patch set of the
  // change is not locked by calling {@code PatchSetUtil.isPatchSetLocked}.
  ...
  // A new patch set couldn't be added if the patch set is locked for the change.
  //
  // Before checking this permission, the caller should first verify the current patch set of the
  // change is not locked by calling {@code PatchSetUtil.isPatchSetLocked}.
  ADD_PATCH_SET(Permission.ADD_PATCH_SET),
  // The change couldn't be rebased if its current patch set is locked.
  //
  // Before checking this permission, the caller should first verify the current patch set of the
  // change is not locked by calling {@code PatchSetUtil.isPatchSetLocked}.
