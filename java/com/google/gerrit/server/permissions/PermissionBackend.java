...
public abstract class PermissionBackend {
  ...
  public abstract static class RefFilterOptions {
    ...
    /**
     * Return all of visible change refs that are available in the change index (which are the most
     * recent changes), even if they are not part of the List<Ref> passed. This allows the caller
     * not to send all the refs/changes.
     */
