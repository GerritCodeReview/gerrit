...
public abstract class PermissionBackend {
  ...
  public abstract static class WithUser {
    ...
    /**
     * Additional filter for changes query for reducing the cardinality of the results for current user.
     *
     * @return additional query filter to add to all user's change queries, null if no filters are required.
     *
     * @since 3.11
     */
