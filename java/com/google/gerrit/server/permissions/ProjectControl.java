...
class ProjectControl {
  ...
  ProjectControl forAbsentUser(Account.Id id) {
    IdentifiedUser identifiedUser = identifiedUserFactory.create(id);
    ProjectControl projectControl =
        new ProjectControl(
            ...
            state);
    // Not per-user, and reusing saves lookup time.
    projectControl.allSections = allSections;
  ...
  private class ForProjectImpl extends ForProject {
    ...
    public ForProject absentUser(Account.Id id) {
      return forAbsentUser(id).asForProject().database(db);
    }
