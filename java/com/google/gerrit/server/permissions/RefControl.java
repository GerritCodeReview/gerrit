...
class RefControl {
  ...
  RefControl forUser(CurrentUser who) {
    return toRefControl(projectControl.forUser(who));
  }

  RefControl forAbsentUser(Account.Id id) {
    return toRefControl(projectControl.forAbsentUser(id));
  }

  private RefControl toRefControl(ProjectControl projectControl) {
