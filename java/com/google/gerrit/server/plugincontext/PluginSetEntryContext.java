...
public class PluginSetEntryContext<T> {
   ...
   * #run(PluginContext.ExtensionImplConsumer)}, {@link #run(PluginContext.ExtensionImplConsumer, java.lang.Class)}, {@link
   * #call(PluginContext.ExtensionImplFunction)} and {@link #call(PluginContext.CheckedExtensionImplFunction, java.lang.Class)}.
   *
