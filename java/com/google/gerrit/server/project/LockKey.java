 ...
 * a {@code name}, and optional {@code args} that further scope the lock (e.g. a project name).
 */
public record LockKey(String namespace, String name, ImmutableList<String> args) {
  ...
  public String toString() {
    return String.join("~", Lists.asList(namespace, name, args().toArray(new String[0])));
  }
}
