...
/**
 * Identifies a {@link LockManager} lock: a {@code namespace} (Gerrit core, or a specific plugin),
 * a {@code name} for the functionality within that namespace that the lock guards (e.g. {@code
 * "change-cleanup"}), and optional {@code args} that further scope the lock (e.g. a project
 * name).
 */
