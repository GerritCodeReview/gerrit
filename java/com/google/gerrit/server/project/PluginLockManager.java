...
public class PluginLockManager {
  ...
  @Inject
  PluginLockManager(DynamicItem<LockManager> lockManager, @PluginName String pluginName) {
    this.lockManager = lockManager;
    this.namespace = "plugins/" + pluginName;
  }

  /**
   * Returns a lock owned by this plugin, identified by {@code functionality} and further scoped by
   * optional {@code args}.
   */
  public Lock getLock(String functionality, String... args) {
    return lockManager
        .get()
        .getLock(String.join("~", Lists.asList(namespace, functionality, args)));
  }
}
