...
public class ProjectCacheImpl implements ProjectCache {
  ...
  public ProjectState get(Project.NameKey projectName) {
    return get(nameOrNull(projectName));
  }

  private String nameOrNull(Project.NameKey projectName) {
    return projectName == null ? null : projectName.get();
  }
  ...
  public ProjectState checkedGet(Project.NameKey projectName) throws IOException {
    return checkedGet(nameOrNull(projectName));
  }
  ...
  public ProjectState checkedGet(Project.NameKey projectName, boolean strict) throws Exception {
    String name = nameOrNull(projectName);
    return strict ? strictCheckedGet(name) : checkedGet(name);
  }
