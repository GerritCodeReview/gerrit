...
public class TestLabels {
  ...
  public static LabelType label(String name, String description, LabelFunction labelFunction, LabelValue... values) {
    return labelBuilder(name, values).setFunction(labelFunction).setDescription(Optional.of(description)).build();
  }
