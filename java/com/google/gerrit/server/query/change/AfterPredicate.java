...
/**
 * Predicate that matches a {@link Timestamp} field from the index in a range from the passed
 * {@code String} representation of the Timestamp value to the maximum supported time.
 */
