...
public class ChangePredicates {
  ...
  public static Predicate<ChangeData> owner(Account.Id id) {
    return new ChangeIndexPredicate(ChangeField.OWNER_SPEC, id.toString(), 5000);
  }
  ...
  public static Predicate<ChangeData> project(Project.NameKey id) {
    return new ChangeIndexPredicate(ChangeField.PROJECT_SPEC, id.get(), 1_000_000);
  }
  ...
  public static Predicate<ChangeData> ref(String refName) {
    return new ChangeIndexPredicate(ChangeField.REF_SPEC, refName, 10_000);
  }
