 ...
 */
public class RegexAuthorPredicate extends SubmitRequirementPredicate {
  protected final RunAutomaton authorEmailPattern;

  public RegexAuthorPredicate(String pattern) throws QueryParseException {
    super("authorregex", pattern);
