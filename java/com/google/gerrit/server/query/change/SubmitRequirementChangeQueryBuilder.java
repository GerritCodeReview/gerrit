...
public class SubmitRequirementChangeQueryBuilder extends ChangeQueryBuilder {
  ...
  public Predicate<ChangeData> met_requirement(String requirementName) throws QueryParseException {
    throw new QueryParseException(
        "Operator 'met_requirement' cannot be used in submit requirement expressions.");
  }
  ...
  public Predicate<ChangeData> unsatisfied_requirement(String requirementName)
      throws QueryParseException {
    throw new QueryParseException(
        "Operator 'unsatisfied_requirement' cannot be used in submit requirement expressions.");
  }
  ...
  public Predicate<ChangeData> unsatisfied_requirements(String value) throws QueryParseException {
    throw new QueryParseException(
        "Operator 'unsatisfied_requirements' cannot be used in submit requirement expressions.");
  }
