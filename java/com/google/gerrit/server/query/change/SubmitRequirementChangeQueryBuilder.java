...
public class SubmitRequirementChangeQueryBuilder extends ChangeQueryBuilder {
  ...
  private final FileEditsPredicate.Factory commitEditsPredicateFactory;

  @Inject
  SubmitRequirementChangeQueryBuilder(
      Arguments args, FileEditsPredicate.Factory commitEditsPredicateFactory) {
    super(def, args);
  ...
  public Predicate<ChangeData> file(String value) throws QueryParseException {
    ...
    return commitEditsPredicateFactory.create(FileEditsArgs.create(filePattern, contentPattern));
  }

  private void validateRegularExpression(String pattern, String errorMessage)
