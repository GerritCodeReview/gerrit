...
public class DeleteToken implements RestModifyView<AccountResource.Token, Input> {
  ...
  private final VersionedAuthorizationTokens.Accessor tokenAccessor;
  ...
  DeleteToken(
      ...
      VersionedAuthorizationTokens.Accessor tokenAccessor,
  ...
  public Response<String> apply(IdentifiedUser user, String id)
