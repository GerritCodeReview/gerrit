...
import com.google.gerrit.server.mail.send.HttpPaswordSender;
...
public class PutHttpPassword implements RestModifyView<AccountResource, HttpPasswordInput> {
  ...
  private final HttpPaswordSender.Factory httpPasswordSenderFactory;
  ...
  PutHttpPassword(
      ...
      HttpPaswordSender.Factory httpPasswordSenderFactory) {
    this.self = self;
  ...
  public Response<String> apply(IdentifiedUser user, String newPassword)
    ...
    try {
      ...
      logger.atSevere().withCause(e).log(
          "Cannot send Http Password added/changed/deleted message to %s", user.getAccount().getPreferredEmail());
    }
