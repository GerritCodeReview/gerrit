...
public class AiCodeReview implements RestModifyView<RevisionResource, AiCodeReviewInput> {
  ...
  @Override
  public Response<AiResponse> apply(RevisionResource resource, AiCodeReviewInput input)
    ...
    AiCodeReviewProvider providerInstance =
        aiCodeReviewsProvider.get(input.pluginName, input.models.getFirst());
    if (providerInstance != null) {
      response = providerInstance.getAiReview(input);
    } else {
