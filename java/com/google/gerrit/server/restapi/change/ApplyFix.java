...
import com.google.gerrit.extensions.common.ApplyFixInfo;
...
@Singleton
public class ApplyFix implements RestModifyView<FixResource, ApplyFixInfo> {
  ...
  @Override
  public Response<EditInfo> apply(FixResource fixResource, ApplyFixInfo nothing)
