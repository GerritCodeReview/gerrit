...
public class ApplyPatch
  ...
  public Response<ChangeInfo> apply(ChangeResource rsrc, ApplyPatchPatchSetInput input)
    ...
    permissionChecker.checkPermissionsForCreatingChange(
        project, projectState, destBranch.branch(), input.author);
    ...
    try (Repository repo = gitManager.openRepository(project);
      ...
      String commitMessage =
          CommitMessageUtil.checkAndSanitizeCommitMessage(
              input.subject != null ? input.subject : destChange.commitMessage());
  ...
  public Description getDescription(ChangeResource rsrc) throws Exception {
    return new Description()
        ...
        .setVisible(
            permissionChecker.testPermissionsForCreatingChange(
                rsrc.getProject(), projectCache.get(rsrc.getProject()).orElseThrow(), null, null));
  }
