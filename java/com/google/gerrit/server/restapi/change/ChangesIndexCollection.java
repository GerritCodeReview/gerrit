...
@Singleton
public class ChangesIndexCollection
    implements RestCollection<TopLevelResource, ChangeResource>, AcceptsPost<TopLevelResource> {
  private final DynamicMap<RestView<ChangeResource>> views;
  private final IndexBy indexBy;

  @Inject
  ChangesIndexCollection(DynamicMap<RestView<ChangeResource>> views, IndexBy indexBy) {
    this.views = views;
  ...
  @Override
  public IndexBy post(TopLevelResource parent) throws RestApiException {
    return indexBy;
  }
}
