...
public class DeleteAttentionSet implements RestModifyView<ChangeResource, AttentionSetInput> {
  ...
  @Override
  public Response<AccountInfo> apply(ChangeResource resource, AttentionSetInput input)
    ...
    try (BatchUpdate bu =
      ...
      RemoveFromAttentionSetOp op = opFactory.create(attentionUserId, input.reason);
