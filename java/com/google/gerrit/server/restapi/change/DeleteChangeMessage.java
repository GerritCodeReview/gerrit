...
public class DeleteChangeMessage
  ...
  public Response<ChangeMessageInfo> applyImpl(
    ...
    DeleteChangeMessageOp deleteChangeMessageOp =
        new DeleteChangeMessageOp(input.id, newChangeMessage);
    ...
    ChangeMessageInfo updatedMessageInfo = createUpdatedChangeMessageInfo(resource, targetIdx);
  ...
  private ChangeMessageInfo createUpdatedChangeMessageInfo(ChangeResource resource, int targetIdx)
    ...
    ChangeMessageInfo info =
        changeMessagesUtil.createChangeMessageInfo(updatedChangeMessage, accountLoader);
    accountLoader.fill();
    return info;
  }
  ...
  private class DeleteChangeMessageOp implements BatchUpdateOp {
    ...
    DeleteChangeMessageOp(String id, String newMessage) {
      this.id = id;
    ...
    public boolean updateChange(ChangeContext ctx) throws OrmException {
      ...
      changeMessagesUtil.deleteChangeMessageByRewritingHistory(
          ctx.getDb(), ctx.getUpdate(psId), id, newMessage);
      return true;
    }
  }
}
