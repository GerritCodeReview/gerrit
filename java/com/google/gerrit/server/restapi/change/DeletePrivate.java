...
@Singleton
public class DeletePrivate implements RestModifyView<ChangeResource, SetPrivateOp.Input> {
  ...
  @Override
  public Response<String> apply(ChangeResource rsrc, @Nullable SetPrivateOp.Input input)
