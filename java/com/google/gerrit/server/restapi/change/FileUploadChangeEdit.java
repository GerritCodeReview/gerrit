...
import com.google.gerrit.extensions.api.changes.FileUploadChangeEditInput;
...
public class FileUploadChangeEdit
    implements RestModifyView<ChangeResource, FileUploadChangeEditInput> {
  ...
  @Override
  public Response<?> apply(ChangeResource rsrc, FileUploadChangeEditInput input)
  ...
  public Response<?> apply(ChangeResource rsrc, String path, String content)
    ...
    if (m.matches() && "base64".equals(m.group(2))) {
      ...
      throw new BadRequestException("file must be encoded with base64");
    }
