...
public class GetPrompt implements RestReadView<RevisionResource> {
  ...
  @Inject
  public GetPrompt(SitePaths sitePaths, GetPatch getPatch) {
  ...
  public Response<String> apply(RevisionResource revisionResource) throws Exception {
    ...
    try {
      ...
      return Response.withStatusCode(
          SC_BAD_REQUEST,
          "Invalid command value. Valid command values are: code_review, commit_message,"
              + " patch_content");
    }
  }
  ...
  public String readPromptTemplate(String fileName) throws Exception {
