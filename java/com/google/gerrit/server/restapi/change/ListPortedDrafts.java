...
public class ListPortedDrafts implements RestReadView<RevisionResource> {
  ...
  public Response<Map<String, List<CommentInfo>>> apply(RevisionResource revisionResource)
    ...
    List<HumanComment> draftComments = loadAllDraftCommentsOfCallingUser(revisionResource);
  ...
  private List<HumanComment> loadAllDraftCommentsOfCallingUser(RevisionResource revisionResource) {
    return commentsUtil.draftByChangeAuthor(
