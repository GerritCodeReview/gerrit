...
public class PostCustomKeyedValues
  ...
  @Inject
  PostCustomKeyedValues(BatchUpdate.Factory updateFactory, SetCustomKeyedValuesOp.Factory customKeyedValuesFactory) {
    this.updateFactory = updateFactory;
    this.customKeyedValuesFactory = customKeyedValuesFactory;
  }

  @Override
  public Response<ImmutableMap<String, String>> apply(ChangeResource req, CustomKeyedValuesInput input)
