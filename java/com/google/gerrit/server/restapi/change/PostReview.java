...
public class PostReview implements RestModifyView<RevisionResource, ReviewInput> {
  ...
  private class Op implements BatchUpdateOp {
    ...
    private void validateComments(Stream<Comment> comments, ChangeInfo change) throws CommentsRejectedException {
      ...
      if (!msg.isEmpty()) {
        ImmutableList<CommentValidationFailure> messageValidationFailure =
            PublishCommentUtil.findInvalidComments(
                ...
                ImmutableList.of(
                    CommentForValidation.create(
                        CommentForValidation.CommentType.CHANGE_MESSAGE, msg)), util.changeInfo(ctx.getChange()));
