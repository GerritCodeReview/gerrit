...
public class PostReviewAttentionSet {
  ...
  private void processManualUpdates(
      BatchUpdate bu,
      RevisionResource revision,
      ReviewInput input,
      ...
      throws BadRequestException, IOException, PermissionBackendException,
          UnprocessableEntityException, ConfigInvalidException {
    // If we specify a user to remove, and it should be removed, we remove it.
    ...
    // If we don't specify a user to remove, and it should be removed, the user will be added.
