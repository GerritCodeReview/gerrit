...
public class PreviewFix {
  ...
  public static class Stored implements RestReadView<FixResource> {
    ...
    public Response<Map<String, DiffInfo>> apply(FixResource resource)
      ...
      Map<String, DiffInfo> result =
          previewFixForAllFiles(
              repoManager,
              patchSet,
              patchScriptFactoryFactory,
              notes,
              state,
  ...
  private static Map<String, DiffInfo> previewFixForAllFiles(
      GitRepositoryManager repoManager,
      PatchSet patchSet,
      PatchScriptFactoryForAutoFix.Factory patchScriptFactoryFactory,
      ChangeNotes notes,
  ...
  private static DiffInfo previewStoredFixForSingleFile(
      Repository git,
      PatchSet patchSet,
      PatchScriptFactoryForAutoFix.Factory patchScriptFactoryFactory,
      ProjectState state,
