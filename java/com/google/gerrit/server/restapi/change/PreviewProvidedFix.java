...
public class PreviewProvidedFix implements RestModifyView<RevisionResource, ApplyProvidedFixInput> {
  ...
  @Inject
  PreviewProvidedFix(
      ProjectCache projectCache, GitRepositoryManager repoManager, PreviewStoredFix previewStoredFix) {
  ...
  public Response<Map<String, DiffInfo>> apply(
    ...
    for (FixReplacementInfo fix : applyProvidedFixInput.fixReplacementInfos) {
    ...
    Map<String, DiffInfo> result =
        previewStoredFix.applyFixPreviewForAllFiles(
