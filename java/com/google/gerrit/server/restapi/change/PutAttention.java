...
import com.google.gerrit.extensions.api.changes.AttentionInput;
...
public class PutAttention implements RestModifyView<ChangeResource, AttentionInput> {
  private final BatchUpdate.Factory updateFactory;
  private final AccountResolver accountResolver;
  private final AddAttentionUserOp.Factory opFactory;
  private final AccountLoader.Factory accountLoaderFactory;
  private final PermissionBackend permissionBackend;
  private final ApprovalsUtil approvalsUtil;

  @Inject
  PutAttention( // ö prune args
      BatchUpdate.Factory updateFactory,
      AccountResolver accountResolver,
      AddAttentionUserOp.Factory opFactory,
  ...
  @Override
  public Response<?> apply(ChangeResource resource, AttentionInput input)
    ...
    try (BatchUpdate bu =
      ...
      AddAttentionUserOp op = opFactory.create(attentionUser);
