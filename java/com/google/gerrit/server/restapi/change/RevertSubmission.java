...
public class RevertSubmission
  ...
  private Map<String, String> destinationToBase;
      ...
      try (Repository repo = repoManager.openRepository(project)) {
        ...
        while (sortedChangesInProject.hasNext()) {
          ...
          ObjectId revCommitId =
              revert.createCommit(revertInput.message, change.getNotes(), user.get());
          cherryPickInput.destination = change.getChange().getDest().branch();
