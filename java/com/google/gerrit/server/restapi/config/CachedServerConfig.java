...
public class CachedServerConfig {
  ...
  CachedServerConfig(
    ...
    this.serverInfoCache =
        CacheBuilder.newBuilder()
            ...
            .ticker(ticker)
            .build(
                new com.google.common.cache.CacheLoader<String, ServerInfo>() {
                  @Override
    ...
    this.versionCache =
        CacheBuilder.newBuilder()
            ...
            .ticker(ticker)
            .build(
                new com.google.common.cache.CacheLoader<String, String>() {
                  @Override
    ...
    this.topMenusCache =
        CacheBuilder.newBuilder()
            ...
            .ticker(ticker)
            .build(
                new com.google.common.cache.CacheLoader<String, List<TopMenu.MenuEntry>>() {
                  @Override
  ...
  public ServerInfo getInfo() throws RestApiException {
    try {
      return serverInfoCache.get(KEY);
