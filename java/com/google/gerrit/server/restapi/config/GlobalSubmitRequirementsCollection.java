...
@Singleton
public class GlobalSubmitRequirementsCollection implements ChildCollection<ConfigResource, GlobalSubmitRequirementResource> {
  ...
  GlobalSubmitRequirementsCollection(
      Provider<ListGlobalSubmitRequirements> list, DynamicMap<RestView<GlobalSubmitRequirementResource>> views) {
    this.list = list;
    this.views = views;
  }
