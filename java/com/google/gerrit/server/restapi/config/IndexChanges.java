...
public class IndexChanges implements RestModifyView<ConfigResource, Input> {
  ...
  ProjectWithChangeNumTuple parseIntoProjectWithChangeNumTuple(String id) throws BadRequestException {
    ...
    return new ProjectWithChangeNumTuple(Project.nameKey(id.substring(0, tilde)), changeId);
  }
}
