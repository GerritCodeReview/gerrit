...
@Singleton
public class IndexSnapshooterCollection implements ChildCollection<ConfigResource, IndexResource> {
  ...
  public IndexResource parse(ConfigResource parent, IdString id) throws IndexNotFoundException {
    IndexTypes indexName = IndexTypes.valueOf(id.get().toUpperCase(Locale.US));
