...
public class ListIndexVersions implements RestReadView<IndexResource> {
  ...
  @Override
  public Response<Map<Integer, IndexInfo.IndexVersionInfo>> apply(IndexResource resource)
      throws AuthException, BadRequestException, ResourceConflictException, Exception {
    IndexInfo info =
        IndexInfo.fromIndexCollection(
            resource.getName(), Iterables.getOnlyElement(resource.getIndexCollections()));
