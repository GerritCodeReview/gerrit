...
public class ListActions implements RestReadView<ChangeResource> {
  ...
  @Override
  public Response<List<FlowActionType>> apply(ChangeResource changeResource)
    ...
    return Response.ok(
        flowServiceUtil
            ...
            .map(
                flowAction -> {
                  FlowActionType flowActionType = new FlowActionType();
                  flowActionType.name = flowAction.name;
