...
public class GroupsCollection
  ...
  /**
   * Parses a account ID from a request body and returns the account.
   *
   * @param id ID of the account, can be a account UUID, a account name or a legacy account ID
   * @return the account
  ...
  /**
   * Parses a account ID from a request body and returns the account if it is a Gerrit internal
   * account.
   *
   * @param id ID of the account, can be a account UUID, a account name or a legacy account ID
   * @return the account
   * @throws UnprocessableEntityException thrown if the account ID cannot be resolved, if the
   *     account is not visible to the calling user or if it's an external account
   */
  ...
  /**
   * Parses a account ID and returns the account without making any permission check whether the
   * current user can see the account.
   *
   * @param id ID of the account, can be a account UUID, a account name or a legacy account ID
   * @return the account, null if no account is found for the given account ID
   */
  public GroupDescription.Basic parseId(String id) {
    ...
    // Might be a account name, be nice and accept unique names.
