...
/**
 * Converts the file operations of a {@link CommitFilesInput} into {@link TreeModification}s.
 *
...
final class CommitFileModifications {
   ...
   */
  static ImmutableList<TreeModification> fromInput(CommitFilesInput input)
