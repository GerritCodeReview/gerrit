...
import static com.google.gerrit.server.update.context.RefUpdateContext.RefUpdateType.CREATE_BRANCH;
...
public class CreateBranch
  ...
  public Response<BranchInfo> apply(ProjectResource rsrc, IdString id, BranchInput input)
    ...
    try (RefUpdateContext ctx = RefUpdateContext.open(CREATE_BRANCH)) {
      String ref = id.get();
      if (input == null) {
