  ...
  public Response<DiffInfo> apply(DiffFileResource rsrc)
    ...
    try (Repository repo = repoManager.openRepository(project);
      ...
      FileDiffOutput fileDiffOutput =
          diffOperations.getModifiedFile(project, oldCommitId, newCommitId, filePath, ws);
      ...
      DiffInfoCreator diffInfoCreator = new DiffInfoCreator(projectState, emptyLinksProvider, intraline);
