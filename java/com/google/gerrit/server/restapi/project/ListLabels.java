  ...
  */
  ...
  for (LabelDefinitionInfo label : allLabels) {
    ...
    Set<LabelPermission.WithValue> can =
            permissionBackend.currentUser().project(rsrc.getNameKey()).ref(branchNameKey.branch()).test(labelType);
  ...
  // from /Users/milutin/Programs/gerrit/javatests/com/google/gerrit/server/permissions/RefControlTest.java
