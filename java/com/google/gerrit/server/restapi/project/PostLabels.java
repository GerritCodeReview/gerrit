...
public class PostLabels
    implements RestCollectionModifyView<ProjectResource, LabelResource, PostLabelsInput> {
  ...
  @Override
  public Response<?> apply(ProjectResource rsrc, PostLabelsInput input)
