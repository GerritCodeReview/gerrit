...
public class SuggestProjectReviewers extends SuggestReviewers implements
  ...
  public SuggestProjectReviewers setExcludeGroups(boolean excludeGroups) {
  ...
  public SuggestProjectReviewers setReviewerState(ReviewerState reviewerState) {
  ...
  @Override
  public Response<List<SuggestedReviewerInfo>> apply(
      ProjectResource rsrc, BranchInfo branch, BranchInput input)
    ...
    return Response.ok(
        reviewersUtil.suggestReviewers(
            ...
            null,
            this,
            projectCache.get(rsrc.getProjectState().getNameKey()).orElseThrow(illegalState(rsrc.getProjectState().getNameKey())),
            getVisibility(BranchNameKey.create(rsrc.getProjectState().getNameKey(), branch.ref)),
            excludeGroups));
  }
