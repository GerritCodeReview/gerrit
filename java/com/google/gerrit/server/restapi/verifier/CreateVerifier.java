...
public class CreateVerifier
  ...
  @Override
  public VerifierInfo apply(TopLevelResource parentResource, IdString id, VerifierInput input)
      throws Exception {
    ...
    Verifier verifier =
        verifiersUpdate
            .get()
            .createGroup(verifierCreationBuilder.build(), verifierUpdateBuilder.build());
