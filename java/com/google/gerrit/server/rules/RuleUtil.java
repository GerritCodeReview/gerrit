...
public class RuleUtil {
   ...
   * loops and other forms of computational overflow. The compiled limit should be used when
   * user-provided Prolog code is compiled by the interpreter before the limit gets applied.
   */
