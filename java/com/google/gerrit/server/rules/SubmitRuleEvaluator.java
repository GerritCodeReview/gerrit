 ...
 * Several points should be noted: - Multiple plugins may be called for a given change. - Each
 * plugin is responsible for handling (or not) inheritance of configurations.
 *
