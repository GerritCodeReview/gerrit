 ...
 * - Multiple plugins may be called for a given change.
 * - Each plugin is responsible for handling (or not) inheritance of configurations.
 *
 * <p>In a nutshell, this interface makes it possible to write validation rules in Java, or even
 * to write adapters for Script Engines (Prolog, JavaScript or even custom expression parsers).
 */
@ExtensionPoint
