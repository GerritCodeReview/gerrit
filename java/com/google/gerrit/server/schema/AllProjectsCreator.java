...
public class AllProjectsCreator {
  ...
  private void initDefaultAcls(ProjectConfig config, AllProjectsInput input) {
    ...
    config.upsertAccessSection(
        AccessSection.HEADS,
        heads -> {
          initDefaultAclsForDefaultReaders(heads, config, input.defaultReadersGroup());
          initDefaultAclsForDefaultUsers(heads, codeReviewLabel, config, input.defaultUsersGroup());
        });
