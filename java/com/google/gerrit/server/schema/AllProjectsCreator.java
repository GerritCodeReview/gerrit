...
public class AllProjectsCreator {
  ...
  private void initAllProjects(Repository git, AllProjectsCreatorInput input)
    ...
    try (MetaDataUpdate md =
      ...
      GroupReference admin =
          input.administratorsGroup().isPresent() ? input.administratorsGroup().get() : null;
      GroupReference batch =
          input.batchUsersGroup().isPresent() ? input.batchUsersGroup().get() : null;
      if (admin != null) {
