 ...
 * override the default {@link DefaultLockManager} binding for {@link LockManager} (e.g. via
 * {@code DynamicItem<LockManager>.set(...)}) to provide distributed locking; {@link #start()}
 * throws if only the default in-memory lock manager is bound.
 */
@Singleton
