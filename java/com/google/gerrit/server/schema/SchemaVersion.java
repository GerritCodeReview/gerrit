...
public abstract class SchemaVersion {
  ...
  private ExecutorService backgroundGcThread = Executors.newFixedThreadPool(1);
  ...
  protected void runGcInBackground(
      GitRepositoryManager repoManager, Project.NameKey repoName, UpdateUI ui) {
    backgroundGcThread.execute(
        new Runnable() {
          @Override
          public void run() {
