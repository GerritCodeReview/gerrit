...
public class SubscriptionGraph {
  ...
  SubscriptionGraph(GitModules.Factory gitmodulesFactory, Set<BranchNameKey> updatedBranches,
      ProjectCache projectCache, MergeOpRepoManager orm, boolean enableSuperProjectSubscriptions)
