 ...
 *
 * This interface shouldn't be used for critical operation, because postUpdate operation might not
 * be called if a process crashed.
 *
 * For each BatchUpdate operation, a new BatchChangeUpdateListener should be created/injected.
...
public interface BatchChangeUpdateListener {
  ...
  default ChangeUpdateListener getChangeUpdateListener(ChangeNotes changeNotes) {return ChangeUpdateListener.EMPTY; }
