...
public class BatchChangeUpdateListenerImpl implements BatchChangeUpdateListener {
  private final AttentionSetObserver attentionSetObserver;
  private final Multimap<ChangeNotes, AttentionSetUpdate> attentionSetUpdates =
  ...
  @Inject
  BatchChangeUpdateListenerImpl(AttentionSetObserver attentionSetObserver) {
          ...
          .forEach(
              attentionSetUpdate ->
                  attentionSetObserver.fire(
                      changeData, accountState, attentionSetUpdate, ctx.getWhen()));
    }
  }
}
