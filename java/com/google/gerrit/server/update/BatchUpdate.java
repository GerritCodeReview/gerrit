...
public class BatchUpdate implements AutoCloseable {
  ...
  private static void executeIndexingAndPostOps(
    ...
    // Execute indexing and all post ops fully asynchronous (e.g. do not await the indexing
    // operation before returning to the caller of BatchRefUpdate)
    // This behaviour is subject to an experiment.
    //
    logOnError(
