...
public class BatchUpdate implements AutoCloseable {
  ...
  public static void execute(
    ...
    MultibatchExecutor.execute(updates, dryrun, listener);
  }
  ...
  public void execute() throws UpdateException, RestApiException {
    execute(ImmutableList.of(this), BatchUpdateListener.NONE, false);
  }
  ...
  ChangesHandle executeChangeOps(BatchUpdateListener batchUpdateListener, boolean dryrun)
      throws Exception {
  ...
  void executePostOps() throws Exception {
