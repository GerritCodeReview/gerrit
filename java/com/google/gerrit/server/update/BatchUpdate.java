...
public class BatchUpdate implements AutoCloseable {
  ...
  public static void execute(
    ...
    // TODO(ifrade): mark this method deprecated. Inject SubmissionExecutor directly in the caller.
  ...
  ChangesHandle executeChangeOps(Submission submission, boolean dryrun) throws Exception {
