...
/** Executes {@link OutgoingEmail#send()} asynchronously. */
public class ExecuteAsyncSendEmail implements Runnable, RequestContext {
  ...
  public void run() {
    ...
    try {
      ...
      logger.atSevere().withCause(e).log(
          "Cannot send emails async for repo %s and user %s",
