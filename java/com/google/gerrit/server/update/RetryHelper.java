...
public class RetryHelper {
  ...
  public <T> T execute(
      ...
      throws Exception {
    try {
      return executeWithAttempCount(actionType, action, opts, exceptionPredicate);
    } catch (Throwable t) {
  ...
  /**
   * Executes an action with recording the number of attempts as metric.
   *
  ...
  /**
   * Executes an action with recording the timeout as metric.
   *
   * @param actionType the type of the action
   * @param action the action which should be executed and retried on failure
