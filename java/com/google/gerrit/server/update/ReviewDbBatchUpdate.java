...
public class ReviewDbBatchUpdate extends BatchUpdate {
  ...
  private final boolean geteMetaEventsInTrial;
  ...
  ReviewDbBatchUpdate(
    ...
    this.notesMigration = onlineProjectsMigrationChecker.getNotesMigration();
    ...
    this.geteMetaEventsInTrial = NoteDbMigrator.getMetaEventsInTrial(cfg);
  }
