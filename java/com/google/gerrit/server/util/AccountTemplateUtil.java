...
/**
 * Utility functions for the text that can be persisted in data storage and should not contain user
...
public class AccountTemplateUtil {
  ...
  /** Builds user-readable text from the text, that might contain {@link #ACCOUNT_TEMPLATE}. */
