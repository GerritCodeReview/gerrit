...
import com.google.gerrit.server.mail.send.AttentionSetChangeEmail;
import com.google.gerrit.server.mail.send.AttentionSetChangeEmail.AttentionSetChange;
...
public class AttentionSetEmail {
  ...
  private static class AsyncSender implements Runnable, RequestContext {
    ...
    public void run() {
      ...
      try {
        AttentionSetChangeEmail changeEmailParams =
