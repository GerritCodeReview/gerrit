...
public class AttentionSetUtil {
   ...
   * If the user doesn't exist or not active on the change, the same exception is thrown to disallow
   * probing for account existence based on exception type.
   */
  public static Account.Id resolveAccount(
    ...
    try {
      ...
      possibleExceptionForNotFoundOrInactiveAccount.addSuppressed(ex);
