// Copyright (C) 2923 The Android Open Source Project
//
...
public interface CustomKeyedValueValidationListener {
   ...
   */
  void validateCustomKeyedValues(Change change, ImmutableMap<String, String> toAdd, ImmutableSet<String> toRemove)
