...
public abstract class Verifier {
   ...
   *
   * <p>The UUID is a SHA-1 that is unique across all verifiers.
   *
   * @return UUID
   */
  ...
  /**
   * Returns the repository to which the verifier applies.
   *
   * <p>The repository is the exact name of a repository (no prefix, no regexp).
   *
   * @return the repository to which the verifier applies
   */
  ...
  /**
   * Returns the timestamp of when the verifier was last updated.
   *
