...
public abstract class VerifierUpdate {
  ...
  /**
   * Defines the new URL of the verifier. If not specified, the URL remains unchanged.
   *
  ...
  /**
   * Defines the new repository for which the verifier applies. If not specified, the repository
   * remains unchanged.
   */
   ...
   *
   * <p>If this {@code VerifierUpdate} is passed next to a {@link VerifierCreation} during a
