...
public class NoteDbVerifiersUpdateFactory implements VerifiersUpdateFactory {
  private final Provider<NoteDbVerifiersUpdate.Factory> verifiersUpdateFactoryImplProvider;

  @Inject
  NoteDbVerifiersUpdateFactory(
      Provider<NoteDbVerifiersUpdate.Factory> verifiersUpdateFactoryImplProvider) {
    this.verifiersUpdateFactoryImplProvider = verifiersUpdateFactoryImplProvider;
  }
   ...
   */
  @Override
  public VerifiersUpdate create(@Nullable IdentifiedUser currentUser) {
    return verifiersUpdateFactoryImplProvider.get().create(currentUser);
  }
}
