...
public class VerifierConfig extends VersionedMetaData {
  ...
  private VerifierConfig(String verifierUuid) {
    checkState(VerifierUUID.isUuid(verifierUuid), "invalid verifier UUID");
  ...
  private static String createCommitMessage(
    ...
    Optional<String> newVerifierName =
        verifierUpdate.isPresent() ? verifierUpdate.get().getName() : Optional.empty();
