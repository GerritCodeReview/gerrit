  ...
  public void addChange(
      ...
      @SuppressWarnings(
              "unused") /* Issue 325821304: the useIndex parameter was introduced back in Gerrit
                         * v2.13
                         * when ReviewDb was around and the changeFinder was purely relying on Lucene.
                         * Fast-forward to v3.7 and the situation is exactly the opposite: changeFinder uses
                         * Lucene or NoteDb depending on the format of the change id.
                         * TODO: The useIndex is effectively useless right now, but the method signature needs to
                         * be preserved in a stable (almost EOL) release like v3.7.
                         * The method signature can be amended the parameter removed once this change  is merged
                         * up to master. */
          boolean useIndex)
      throws UnloggedFailure, PermissionBackendException {
