...
final class DispatchCommand extends BaseCommand {
  ...
  private final DynamicSet<SshExecuteCommandInterceptor> commandFilters;
  ...
  DispatchCommand(
      ...
      DynamicSet<SshExecuteCommandInterceptor> commandFilters) {
  ...
  public void start(Environment env) throws IOException {
    try {
      ...
      for (SshExecuteCommandInterceptor filter : commandFilters) {
