...
class NoShell implements ShellFactory {
  ...
  static class SendMessage implements AsyncCommand, SessionAware {
    ...
    public void setInputStream(InputStream in) {
      // When AsyncCommand is implemented, the usual blocking input stream isn't set.
    }

    @Override
    public void setOutputStream(OutputStream out) {
      // When AsyncCommand is implemented, the usual blocking output stream isn't set.
    }

    @Override
    public void setErrorStream(OutputStream err) {
      // When AsyncCommand is implemented, the usual blocking error stream isn't set.
    }
