...
public class SshLogJsonLayout extends Layout {
  ...
  public String format(LoggingEvent event) {
    ...
    kvMap.put("session", (String) event.getMDC(P_SESSION));
    kvMap.put("thread", event.getThreadName());
    kvMap.put("user", (String) event.getMDC(P_USER_NAME));
    kvMap.put("account_id", (String) event.getMDC(P_ACCOUNT_ID));
    kvMap.put("message", (String) event.getMessage());
    kvMap.put("wait_time", (String) event.getMDC(P_WAIT));
    kvMap.put("exec_time", (String) event.getMDC(P_EXEC));
    kvMap.put("mdc_message", (String) event.getMDC(P_MESSAGE));
    kvMap.put("status", (String) event.getMDC(P_STATUS));
    kvMap.put("agent", (String) event.getMDC(P_AGENT));
