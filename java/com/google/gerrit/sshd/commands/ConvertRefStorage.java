...
@CommandMetaData(
    ...
    description = "Convert ref storage to reftable",
...
public class ConvertRefStorage extends SshCommand {
  ...
  @Option(
      name = "--format",
      usage = "format to convert to (reftable or refdir) (default: reftable)")
  private FormatOption format = FormatOption.reftable;
  ...
  public void run() throws Exception {
    ...
    try (Repository repo = repoManager.openRepository(projectName)) {
      ((FileRepository) repo).convertRefStorage(format.name(), writeLogs, backup);
