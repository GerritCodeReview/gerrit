...
public class ExternalIdCaseSensitivityMigrationCommand extends SshCommand {
  ...
  public void run() throws UnloggedFailure, Failure, Exception {
    ...
    stdout.println("External ids case insensitivity migration started. To check if it's completed look for \"External IDs migration completed!\" message in the Gerrit server logs");
  }
}
