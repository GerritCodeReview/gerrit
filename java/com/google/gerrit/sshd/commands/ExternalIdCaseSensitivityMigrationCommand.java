...
@CommandMetaData(
    name = "start-externalids-case-insensitivity-migration",
    description = "Start the online external ids case insensitivity migration")
public class ExternalIdCaseSensitivityMigrationCommand extends SshCommand {
  ...
  public void run() throws UnloggedFailure, Failure, Exception {
    ...
    stdout.println("External ids case insensitivity migration started");
  }
}
