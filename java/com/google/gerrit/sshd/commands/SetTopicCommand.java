...
public class SetTopicCommand extends SshCommand {
  ...
  @Argument(index = 0, required = true, metaVar = "{TOPIC}", usage = "topic to be set")
  ...
  public void run() throws Exception {
    ...
    try (BatchUpdate u = updateFactory.create(change.getProject(), user, TimeUtil.nowTs())) {
