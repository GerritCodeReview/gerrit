...
import com.google.gerrit.server.config.endpoint.GetSummary;
import com.google.gerrit.server.config.endpoint.GetSummary.JvmSummaryInfo;
import com.google.gerrit.server.config.endpoint.GetSummary.MemSummaryInfo;
import com.google.gerrit.server.config.endpoint.GetSummary.SummaryInfo;
import com.google.gerrit.server.config.endpoint.GetSummary.TaskSummaryInfo;
import com.google.gerrit.server.config.endpoint.GetSummary.ThreadSummaryInfo;
import com.google.gerrit.server.config.endpoint.ListCaches;
import com.google.gerrit.server.config.endpoint.ListCaches.CacheInfo;
import com.google.gerrit.server.config.endpoint.ListCaches.CacheType;
