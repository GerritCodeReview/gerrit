...
public class ConfigSuite extends Suite {
   ...
   * configuration.
   *
   * Works similar to {@link org.junit.AfterClass}, but a method can be executed multiple times if
   * a test class provides multiple configs.
   */
   ...
   * configuration.
   *
   * Works similar to {@link org.junit.BeforeClass}, but a method can be executed multiple times if
   * a test class provides multiple configs.
   */
  @Retention(RetentionPolicy.RUNTIME)
  @Target(ElementType.METHOD)
   ...
   *
   * Works similar to {@link org.junit.ClassRule}, but Statement evaluates multiple time - ones
