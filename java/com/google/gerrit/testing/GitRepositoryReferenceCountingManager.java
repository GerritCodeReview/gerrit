...
public class GitRepositoryReferenceCountingManager implements GitRepositoryManager {
  ...
  public class RepositoryTracking extends DelegateRepository {
    ...
    public String toString() {
      return "JGit Repository object "
          ...
          + "See below the tracking information of when the Repository was created, referenced"
          + " and\n"
          + "closed throughout the test. Look carefully at the open/close or incrementOpen/close\n"
          + "pairs for all the AutoCloseable objects (either Repository or one of its wrappers,"
          + " like\n"
          + "RepoView or RepoRefCache) that is not managed properly inside a try-with-resource\n"
          + "enclosure.\n"
          + "------------\n"
          + "  opened from "
  ...
  public Set<RepositoryTracking> openRepositories() {
    return openRepositories == null ? Collections.emptySet() : openRepositories;
  }
