...
public class InMemoryRepositoryManager implements GitRepositoryManager {
  ...
  public static class Repo extends InMemoryRepository {
    ...
    private static class RefUpdateContextValidator {
      public static final RefUpdateContextValidator INSTANCE = crateRefUpdateContextValidator();

      private static RefUpdateContextValidator crateRefUpdateContextValidator() {
        return new RefUpdateContextValidator()
      ...
      Optional<ImmutableList<RefUpdateType>> getAllowedRefUpdateTypes(String refName) {
