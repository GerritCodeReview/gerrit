        ...
        public BatchRefUpdate newBatchUpdate() {
          ...
          return new DfsReftableBatchRefUpdate(this, odb) {
            ...
            private void validateRefUpdateContext(ReceiveCommand cmd) {
              if (RefUpdateContext.hasOpen(TEST_SETUP) || RefUpdateContext.hasOpen(OFFLINE_OPERATION)) {
...
//              }
              ...
              if(RefNames.isRefsEdit(refName) && (RefUpdateContext.hasOpen(CHANGE_EDIT) || RefUpdateContext.hasOpen(CHANGE_MODIFICATION))) {
                return;
              }
              ...
              if (RefNames.isRefsUsers(cmd.getRefName()) && !RefNames.isRefsEdit(refName) && RefUpdateContext.hasOpen(VERSIONED_META_DATA_CHANGE)) {
                return;
              }
              ...
              if (RefNames.isExternalIdRef(cmd.getRefName())
                  && RefUpdateContext.hasOpen(VERSIONED_META_DATA_CHANGE)) {
                return;
              }
