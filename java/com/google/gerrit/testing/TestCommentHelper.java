...
public class TestCommentHelper {
  ...
  public void addComment(Change.Id targetChangeId, CommentInput commentInput) throws Exception {
    addComment(targetChangeId, commentInput, "comment test");
  }
  ...
  public void addComment(Change.Id targetChangeId, CommentInput commentInput, String message)
      throws Exception {
    ReviewInput reviewInput = createReviewInput(commentInput, message);
    gApi.changes().id(targetChangeId.get()).current().review(reviewInput);
  }
