 ...
 * connection has been established. Otherwise SSL/TLS negotiation will only occur if if the user
 * explicitly calls execTLS() and the server accepts the command. Examples:
 *
 * <p>
 *
 * <ul>
