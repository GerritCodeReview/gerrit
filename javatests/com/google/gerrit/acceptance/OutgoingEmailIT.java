...
public class OutgoingEmailIT extends AbstractDaemonTest {
  ...
  @GerritConfig(
      name = "commentlink.buganizer.match",
      value = "\\bb([/:])(\\d+(?:#comment\\d+)?)\\b")
  @GerritConfig(name = "commentlink.buganizer.link", value = "http://b/$2")
  public void htmlChangeEmailContainsCommentLinks() throws Exception {
    ...
    assertThat(message.htmlBody()).contains("<a href=\"http://b/12345\">b/12345</a>");
  }
}
