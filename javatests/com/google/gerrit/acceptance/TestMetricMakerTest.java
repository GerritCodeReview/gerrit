...
public class TestMetricMakerTest {
  ...
  public void counter1_booleanField() throws Exception {
    ...
    assertThat(testMetricMaker.getCount(counterName, /* field1Value= */ true)).isEqualTo(0);
    assertThat(testMetricMaker.getCount(counterName, /* field1Value= */ false)).isEqualTo(0);

    counter.increment(/* field1= */ true);
    assertThat(testMetricMaker.getCount(counterName, /* field1Value= */ true)).isEqualTo(1);
    assertThat(testMetricMaker.getCount(counterName, /* field1Value= */ false)).isEqualTo(0);

    counter.incrementBy(/* field1= */ true, /* value= */ 3);
    assertThat(testMetricMaker.getCount(counterName, /* field1Value= */ true)).isEqualTo(4);
    assertThat(testMetricMaker.getCount(counterName, /* field1Value= */ false)).isEqualTo(0);

    counter.increment(/* field1= */ false);
    assertThat(testMetricMaker.getCount(counterName, /* field1Value= */ true)).isEqualTo(4);
    assertThat(testMetricMaker.getCount(counterName, /* field1Value= */ false)).isEqualTo(1);

    counter.incrementBy(/* field1= */ false, /* value= */ 4);
    assertThat(testMetricMaker.getCount(counterName, /* field1Value= */ true)).isEqualTo(4);
    assertThat(testMetricMaker.getCount(counterName, /* field1Value= */ false)).isEqualTo(5);
  ...
  public void counter1_stringField() throws Exception {
    ...
    assertThat(testMetricMaker.getCount(counterName, /* field1Value= */ "foo")).isEqualTo(0);
    assertThat(testMetricMaker.getCount(counterName, /* field1Value= */ "bar")).isEqualTo(0);

    counter.increment(/* field1= */ "foo");
    assertThat(testMetricMaker.getCount(counterName, /* field1Value= */ "foo")).isEqualTo(1);
    assertThat(testMetricMaker.getCount(counterName, /* field1Value= */ "bar")).isEqualTo(0);

    counter.incrementBy(/* field1= */ "foo", /* value= */ 3);
    assertThat(testMetricMaker.getCount(counterName, /* field1Value= */ "foo")).isEqualTo(4);
    assertThat(testMetricMaker.getCount(counterName, /* field1Value= */ "bar")).isEqualTo(0);

    counter.increment(/* field1= */ "bar");
    assertThat(testMetricMaker.getCount(counterName, /* field1Value= */ "foo")).isEqualTo(4);
    assertThat(testMetricMaker.getCount(counterName, /* field1Value= */ "bar")).isEqualTo(1);

    counter.incrementBy(/* field1= */ "bar", /* value= */ 4);
    assertThat(testMetricMaker.getCount(counterName, /* field1Value= */ "foo")).isEqualTo(4);
    assertThat(testMetricMaker.getCount(counterName, /* field1Value= */ "bar")).isEqualTo(5);
  ...
  public void counter2() throws Exception {
    ...
    assertThat(
            testMetricMaker.getCount(
                counterName, /* field1Value= */ true, /* field2Value= */ "foo"))
        .isEqualTo(0);
    assertThat(
            testMetricMaker.getCount(
                counterName, /* field1Value= */ false, /* field2Value= */ "foo"))
        .isEqualTo(0);
    ...
    assertThat(
            testMetricMaker.getCount(
                counterName, /* field1Value= */ true, /* field2Value= */ "bar"))
        .isEqualTo(1);
