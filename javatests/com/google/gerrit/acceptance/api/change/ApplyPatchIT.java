...
//  private static final String ADDED_FILE_CONTENT = "First added line\nSecond added line\n";
  ...
  private static final String MODIFIED_FILE_ORIGINAL_CONTENT = "First original line\nSecond original line\n";
...
//  private static final String ADDED_FILE_DIFF = "diff --git a/a_new_file.txt b/a_new_file.txt\n"
...
//          + "+++ /dev/null\n";
  ...
  public void setup() throws Exception {
    PushOneCommit.Result baseCommit = createChange("Add file for deletion", DELETED_FILE_NAME,
        DELETED_FILE_ORIGINAL_CONTENT);
    baseCommit = amendChange(baseCommit.getChangeId(), "Add file for modification",
        MODIFIED_FILE_NAME, MODIFIED_FILE_ORIGINAL_CONTENT);
...
//
//    ChangeInfo result = gApi.changes()
...
//  }
  ...
  public void applyModifiedFilePatch() throws Exception {
    ...
    // DO NOT SUBMIT
    String dnsdiff = gApi.changes()
        .id(result.id)
        .current().patch().asString();
    if(dnsdiff==null) {return;}
    ...
    DiffInfo diff = gApi.changes()
        ...
        .diff();
    assertDiffForFullyModifiedFile(diff, null, MODIFIED_FILE_NAME, MODIFIED_FILE_ORIGINAL_CONTENT,
