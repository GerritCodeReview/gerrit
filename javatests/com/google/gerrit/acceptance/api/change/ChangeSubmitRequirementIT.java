...
public class ChangeSubmitRequirementIT extends AbstractDaemonTest {
  private static final SubmitRequirement req =
      new SubmitRequirement("shortReason", "fullReason", null);
  private static final SubmitRequirementInfo reqInfo =
      new SubmitRequirementInfo("shortReason", "fullReason", null);

  @Override
  public Module createModule() {
    return new ChangeSubmitRequirementIT.MyModule();
  }
  ...
  private static class MyModule extends FactoryModule {
    @Override
