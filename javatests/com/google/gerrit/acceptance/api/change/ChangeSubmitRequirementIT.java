...
public class ChangeSubmitRequirementIT extends AbstractDaemonTest {
  private static final SubmitRuleRequirement req =
      SubmitRuleRequirement.builder()
          .setType("custom_rule")
          .setFallbackText("Fallback text")
          .build();
  private static final SubmitRuleRequirementInfo reqInfo =
      new SubmitRuleRequirementInfo("NOT_READY", "Fallback text", "custom_rule");
