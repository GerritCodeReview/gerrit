...
public class PostReviewIT extends AbstractDaemonTest {
  ...
  public void restrictNumberOfUpdates_exceedLimit() throws Exception {
    ...
    assertThat(exception)
        .hasMessageThat()
        .contains(
            "Change 1 may not exceed 1 updates. It may still be abandoned, submitted and you can add/remove reviewers to/from the attention-set. To continue working on this change, recreate it with a new Change-Id, then abandon this one.");
  }
