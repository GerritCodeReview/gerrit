  ...
  public void validateCommentsInInput_commentRejected() throws Exception {
    ...
    RestApiException restApiException =
        assertThrows(
            ...
            () -> gApi.changes().id(r.getChangeId()).current().review(input));
    assertThat(restApiException.getCause().getCause())
        .isInstanceOf(CommentsRejectedException.class);
    assertThat(
            Iterables.getOnlyElement(
                    ((CommentsRejectedException) restApiException.getCause().getCause())
  ...
  public void restApiErrorCode() throws Exception {
    ...
    RestResponse response =
        userRestSession.post(
            ...
            input);
    response.assertStatus(SC_FORBIDDEN);
  }
