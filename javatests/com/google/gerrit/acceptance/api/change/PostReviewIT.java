        ...
        gApi.changes()
            ...
            .review(
                ReviewInput.create()
                    ...
                    .reviewer(user2.email(), ReviewerState.REMOVED, true));

    assertThat(
            reviewResult.reviewers.values().stream()
                .map(a -> Iterables.getOnlyElement(a.removed).name)
        ...
        assertThrows(
            ...
            () ->
                gApi.changes()
                    ...
                    .current()
                    .review(
                        ReviewInput.create().reviewer(user.email(), ReviewerState.REMOVED, true)));
