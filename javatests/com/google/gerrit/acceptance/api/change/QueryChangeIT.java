...
public class QueryChangeIT extends AbstractDaemonTest {
  ...
  public void withPagedResults() throws Exception {
    ...
    createChange(testRepo, "refs/for/master").getChange().getId().get();
    createChange(testRepo, "refs/for/master").getChange().getId().get();
    int changeId3 = createChange(testRepo, "refs/for/master").getChange().getId().get();
    int changeId4 = createChange(testRepo, "refs/for/master").getChange().getId().get();
    ...
    createChange(hiddenRepo, "refs/for/master");
    createChange(hiddenRepo, "refs/for/master");
