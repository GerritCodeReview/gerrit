...
public class QueryChangesIT extends AbstractDaemonTest {
  ...
  @Test
  public void skipVisibilityNonAdminRejected() throws Exception {
  ...
  @Test
  @SuppressWarnings("unchecked")
  public void skipVisibilityAdmin() throws Exception {
    createChange().getChangeId();
  ...
  @Test
  @SuppressWarnings("unchecked")
  public void skipVisibilityPrivateChange() throws Exception {
