...
public class RebaseIT {
  ...
  public static class RebaseChain extends Base {
    ...
    private void verifyRebaseChainResponse(
      ...
      assertThat(info.rebasedChanges)
          .comparingElementsUsing(changeId())
    ...
    private static Correspondence<ChangeInfo, Integer> changeId() {
      return NullAwareCorrespondence.transforming(info -> info._number, "changeId");
    }
  }
}
