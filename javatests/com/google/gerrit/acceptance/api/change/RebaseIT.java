...
@Suite.SuiteClasses({
  ...
  RebaseIT.RebaseChainViaRevisionApi.class, //
  RebaseIT.RebaseChainViaChangeApi.class, //
})
public class RebaseIT {
  public abstract static class Base extends AbstractDaemonTest {
    ...
    protected void verifyRebaseForChange(
        Change.Id changeId, String baseCommit, boolean shouldHaveApproval) throws RestApiException {
      ChangeInfo info =
  ...
  public static class Rebase extends Base {
    @Test
  ...
  public static class RebaseChain extends Base {
    @Test
    public void testRebaseChain() throws Exception {
      ...
      ResourceConflictException c3thrown =
          assertThrows(ResourceConflictException.class, () -> rebaseCall.call(r3.getChangeId()));
  ...
  public static class RebaseChainViaRevisionApi extends RebaseChain {
    @Before
    public void setUp() throws Exception {
      init(
          id -> gApi.changes().id(id).current().rebaseChain(),
          (id, in) -> gApi.changes().id(id).current().rebaseChain(in));
    }
  }

  public static class RebaseChainViaChangeApi extends RebaseChain {
    @Before
    public void setUp() throws Exception {
      init(
          id -> gApi.changes().id(id).rebaseChain(),
          (id, in) -> gApi.changes().id(id).rebaseChain(in));
    }
  }
}
