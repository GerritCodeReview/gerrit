...
public class RevertIT extends AbstractDaemonTest {
  ...
  public void revertSubmissionWithBugAndIssueFooters() throws Exception {
    System.out.println("revertSubmissionWithBugAndIssueFooters\n");
    ...
    String commitMessage1 = gApi.changes().id(r1.getChangeId()).current().commit(false).message;
    System.out.println("commitMessage1: " + commitMessage1);
    ...
    commitMessage1 = gApi.changes().id(revert1.id).current().commit(false).message;
    System.out.println("commitMessage1: " + commitMessage1);
