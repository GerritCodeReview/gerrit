...
public class RevertIT extends AbstractDaemonTest {
  ...
  @Test
  public void revertChangeWithWipByDefault() throws Exception {
    ConfigInput configInput = new ConfigInput();
    configInput.workInProgressByDefault = InheritableBoolean.TRUE;
  ...
  @Test
  public void revertChangeOverrideWipByDefault() throws Exception {
    ConfigInput configInput = new ConfigInput();
    configInput.workInProgressByDefault = InheritableBoolean.TRUE;
    gApi.projects().name(project.get()).config(configInput);
