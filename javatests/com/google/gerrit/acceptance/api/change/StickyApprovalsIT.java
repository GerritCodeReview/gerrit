...
public class StickyApprovalsIT extends AbstractDaemonTest {
  ...
  public void notStickyWithCopyAllScoresIfListOfFilesDidNotChangeWhenFileIsModifiedDueToSquash()
    ...
    vote(admin, changeId2.toString(), 2, 1);
    ...
    //
    // Actual:
    // The code review vote is copied because file a.txt is detected as modified due to rebase and
    // thus filtered out so that the list of files did not change.
