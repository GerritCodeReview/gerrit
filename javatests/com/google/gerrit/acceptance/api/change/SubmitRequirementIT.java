...
public class SubmitRequirementIT extends AbstractDaemonTest {
  ...
  public void checkSubmitRequirement_fromRefsConfigChange_satisfied() throws Exception {
    ...
    SubmitRequirementResultInfo info =
        gApi.changes()
            ...
            .srName("Foo")
            .refsConfigChangeNumber(configResult.getChange().getId().get())
            .get();
        ...
        assertThrows(
            ...
            () ->
                gApi.changes()
                    ...
                    .checkSubmitRequirementRequest()
                    .srName("Foo")
                    .refsConfigChangeNumber(r.getChange().getId().get())
                    .get());
    assertThat(thrown)
        .hasMessageThat()
        .isEqualTo(
  ...
  public void checkSubmitRequirement_notAllowedFromNonExistingChange() throws Exception {
    int invalidChangeNumber = 2134789;
    PushOneCommit.Result r = createChange();
    String changeId = r.getChangeId();
    Exception thrown =
        assertThrows(
            ...
            () ->
                gApi.changes()
                    ...
                    .checkSubmitRequirementRequest()
                    .srName("Foo")
                    .refsConfigChangeNumber(invalidChangeNumber)
                    .get());
    assertThat(thrown)
        .hasMessageThat()
        .isEqualTo(String.format("Change '%d' does not exist", invalidChangeNumber));
  }
