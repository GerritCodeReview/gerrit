...
public class SubmitRequirementPredicateIT extends AbstractDaemonTest {
  ...
  public void label_requireVoteFromHumanReviewers() throws Exception {
    ...
    // query changes where all reviewers have a vote <=, >=, < or >
    assertRequirement(
        "label:Code-Review<=2,users=human_reviewers",
        ImmutableList.of(
            changeApprovedByAllReviewers,
    ...
    // query changes where all reviewers have any (non-zero) vote
    assertRequirement(
    ...
    addReviewer(project, changeApprovedByAllReviewers, "email-without-account@example.com");
    addReviewer(project, changeNoVotesByReviewers, "email-without-account@example.com");
    assertRequirement(
        "label:Code-Review=MAX,users=human_reviewers",
        ImmutableList.of(),
        ImmutableList.of(
