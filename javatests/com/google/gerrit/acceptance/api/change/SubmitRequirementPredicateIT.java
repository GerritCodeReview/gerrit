...
public class SubmitRequirementPredicateIT extends AbstractDaemonTest {
  ...
  @Test
  public void hasSubmoduleUpdate_againstParent1_withSubmoduleChangeInParent2_matches()
      throws Exception {
  ...
  @Test
  public void hasSubmoduleUpdate_againstParent1_withSubmoduleChangeInParent1_doesNotMatch()
      throws Exception {
    ObjectId initial = repo().exactRef(HEAD).getLeaf().getObjectId();
  ...
  @Test
  public void hasSubmoduleUpdate_againstParent2_withSubmoduleChangeInParent1_matches()
      throws Exception {
    ObjectId initial = repo().exactRef(HEAD).getLeaf().getObjectId();
    PushOneCommit.Result r1 = createGitSubmoduleCommit("refs/for/master");
    testRepo.reset(initial);
  ...
  @Test
  public void hasSubmoduleUpdate_againstParent2_withSubmoduleChangeInParent2_doesNotMatch()
      throws Exception {
    ObjectId initial = repo().exactRef(HEAD).getLeaf().getObjectId();
    PushOneCommit.Result r1 = createNormalCommit("refs/for/master", "file1");
    testRepo.reset(initial);
  ...
  @Test
  public void hasSubmoduleUpdate_againstDefaultParent_withSubmoduleChangeInParent1_doesNotMatch()
      throws Exception {
    ObjectId initial = repo().exactRef(HEAD).getLeaf().getObjectId();
    PushOneCommit.Result r1 = createGitSubmoduleCommit("refs/for/master");
    testRepo.reset(initial);
  ...
  @Test
  public void hasSubmoduleUpdate_againstDefaultParent_withSubmoduleChangeInParent2_doesNotMatch()
      throws Exception {
    ObjectId initial = repo().exactRef(HEAD).getLeaf().getObjectId();
    PushOneCommit.Result r1 = createNormalCommit("refs/for/master", "file1");
    testRepo.reset(initial);
  ...
  @Test
  public void hasSubmoduleUpdate_againstParent1_withoutSubmoduleChange_doesNotMatch()
      throws Exception {
    ObjectId initial = repo().exactRef(HEAD).getLeaf().getObjectId();
    PushOneCommit.Result r1 = createNormalCommit("refs/for/master", "file1");
    testRepo.reset(initial);
  ...
  @Test
  public void hasSubmoduleUpdate_againstParent2_withoutSubmoduleChange_doesNotMatch()
      throws Exception {
    ObjectId initial = repo().exactRef(HEAD).getLeaf().getObjectId();
    PushOneCommit.Result r1 = createNormalCommit("refs/for/master", "file1");
    testRepo.reset(initial);
  ...
  @Test
  public void hasSubmoduleUpdate_againstDefaultParent_withoutSubmoduleChange_doesNotMatch()
      throws Exception {
    ObjectId initial = repo().exactRef(HEAD).getLeaf().getObjectId();
    PushOneCommit.Result r1 = createNormalCommit("refs/for/master", "file1");
    testRepo.reset(initial);
  ...
  @Test
  public void
      hasSubmoduleUpdate_withBaseParamGreaterThanParentCount_withSubmoduleChangeInParent2_doesNotMatch()
          throws Exception {
    ObjectId initial = repo().exactRef(HEAD).getLeaf().getObjectId();
    PushOneCommit.Result r1 = createNormalCommit("refs/for/master", "file1");
    testRepo.reset(initial);
  ...
  @Test
  public void hasSubmoduleUpdate_withWrongBaseArg_throws() {
    assertError(
  ...
  @Test
  public void hasSubmoduleUpdate_withWrongNumberOfArguments_throws() {
    assertError(
  ...
  @Test
  public void hasSubmoduleUpdate_withMalformedBaseParameter_throws() {
    assertError(
  ...
  protected PushOneCommit.Result createMergeCommitChange(
