...
package com.google.gerrit.acceptance.api.menus;
...
@TestPlugin(
    name = "test-topmenus",
    sysModule = "com.google.gerrit.acceptance.api.menus.TopMenusIT$Module")
public class TopMenusIT extends LightweightPluginDaemonTest {
  ...
  @Test
  public void topMenuShouldReturnOneEntry() {
    List<MenuEntry> topMenuItems = gApi.topMenus().list();
