...
public class CommitIT extends AbstractDaemonTest {
  ...
  public void cherryPickWithAllowConflicts() throws Exception {
    ...
    // want to validate the fields of the returned ChangeInfo and
    ...
    // doesn't have transient fields like 'containsGitConflicts' set. Since we want to verify the
    // transient fields, we use REST instead.
