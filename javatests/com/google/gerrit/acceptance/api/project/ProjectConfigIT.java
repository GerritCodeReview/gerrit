...
public class ProjectConfigIT extends AbstractDaemonTest {
  ...
  @GerritConfig(
      ...
      value = "receive.rejectImplicitMerges=enforced")
  public void configureEnforcedAsDefaultForBooleanProjectConfig() throws Exception {
    assertThat(
            projectCache
                .get(project)
                .orElseThrow(illegalState(project))
    ...
    // enforced cannot be overridden in the project
    try (ProjectConfigUpdate u = updateProject(project)) {
      u.getConfig()
          .updateProject(
              b ->
