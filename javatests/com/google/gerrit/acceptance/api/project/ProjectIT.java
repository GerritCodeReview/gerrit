...
public class ProjectIT extends AbstractDaemonTest {
  ...
  private void assertCommentLinks(ConfigInfo actual, Map<String, CommentLinkInfo> expected) {
    assertThat(actual.commentlinks).isNotNull();
    assertThat(actual.commentlinks).containsExactlyEntriesIn(expected);
  }

  private void addCommentLink(ConfigInput input, String name, String match, String link) {
    ...
    if (input.commentLinks == null) {
      input.commentLinks = new HashMap<>();
    }
    input.commentLinks.put(name, commentLinkInput);
  }
