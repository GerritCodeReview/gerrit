...
public class ProjectIT extends AbstractDaemonTest {
  ...
  public void descriptionChangeCausesRefUpdate() throws Exception {
    RevCommit initialHead = this.projectOperations.project(project).getHead(RefNames.REFS_CONFIG);
    ...
    RevCommit updatedHead = this.projectOperations.project(project).getHead(RefNames.REFS_CONFIG);
  ...
  protected RevCommit getRemoteHead(String project, String branch) throws Exception {
    return ProjectIT.this.projectOperations.project(Project.nameKey(project)).getHead(branch);
  }
