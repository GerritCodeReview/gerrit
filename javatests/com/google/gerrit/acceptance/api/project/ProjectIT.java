...
public class ProjectIT extends AbstractDaemonTest {
  ...
  public void commitsIncludedInRefsOpenChange() throws Exception {
    ...
    testRepo.reset(baseChange.getCommit());
    PushOneCommit.Result change1 = createChange();
    testRepo.reset(baseChange.getCommit());
    PushOneCommit.Result change2 = createChange();

    Map<String, Collection<String>> refsByCommit =
        getCommitsIncludedInRefs(
  ...
  private Collection<String> getCommitsIncludedInRefs(String commit, List<String> refs)
      throws Exception {
    return getCommitsIncludedInRefs(Lists.newArrayList(commit), refs).get(commit);
  }

  private Map<String, Collection<String>> getCommitsIncludedInRefs(
      List<String> commits, List<String> refs) throws Exception {
