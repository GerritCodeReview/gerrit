...
public class ProjectIT extends AbstractDaemonTest {
  ...
  public void commitsIncludedInRefsOpenChange() throws Exception {
    ...
    assertThat(
        ...
        .isNull();
    assertThat(getCommitIncludedInRefs("foo", Arrays.asList(R_HEADS + "master"))).isNull();
    assertThat(
            getCommitIncludedInRefs(
                "4fa12ab8f257034ec793dacb2ae2752ae2e9f5f8", Arrays.asList(R_HEADS + "master")))
        .isNull();
    assertThat(
  ...
  public void commitsIncludedInRefsMergedChange() throws Exception {
    ...
    assertThat(
            getCommitIncludedInRefs(
                ...
                Arrays.asList(R_HEADS + "master", R_HEADS + "test-branch-1", R_HEADS + "foo")))
        .containsExactly(R_HEADS + "master");
  ...
  @Test
  public void commitsIncludedInRefsMergedChange_nonVisibleBranchRefs() throws Exception {
  ...
  @Test
  public void commitsIncludedInRefsMergedChange_nonVisibleTagRefs() throws Exception {
