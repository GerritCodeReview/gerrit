...
public class ApplyProvidedFixIT extends AbstractDaemonTest {
  ...
  @Test
  public void fixRestAPItestForASimpleFix() throws Exception {
    ApplyProvidedFixInput applyProvidedFixInput =
        createApplyProvidedFixInput(FILE_NAME, "Modified content", 3, 1, 3, 3);
    RestResponse resp =
  ...
  @Test
  public void fixesOnSameFileCanBeApplied() throws Exception {
    FixReplacementInfo fixReplacementInfo1 = new FixReplacementInfo();
    fixReplacementInfo1.path = FILE_NAME;
    fixReplacementInfo1.range = createRange(2, 0, 3, 0);
    fixReplacementInfo1.replacement = "First modification\n";
  ...
  @Test
  public void fixRestAPIcallWithoutAddPatchSetPermissionCannotBeApplied() throws Exception {
    ApplyProvidedFixInput applyProvidedFixInput =
        createApplyProvidedFixInput(FILE_NAME, "Modified content", 3, 1, 3, 3);
  ...
  @Test
  public void fixOnCurrentPatchSetWithExistingChangeEditCanBeApplied() throws Exception {
    FixReplacementInfo fixReplacementInfo1 = new FixReplacementInfo();
    fixReplacementInfo1.path = FILE_NAME;
    fixReplacementInfo1.range = createRange(2, 0, 3, 0);
    fixReplacementInfo1.replacement = "First modification\n";
  ...
  @Test
  public void fixOnPreviousPatchSetCannotBeApplied() throws Exception {
  ...
  @Test
  public void twoFixesNonOverlappingOnCommitMessageCanBeAppliedSubsequently() throws Exception {
    // Set a dedicated commit message.
    String footer = "\nChange-Id: " + changeId + "\n";
    String originalCommitMessage =
        "Line 1 of commit message\nLine 2 of commit message\nLine 3 of commit message\n" + footer;
  ...
  @Test
  public void fixingTwiceIsIdempotent() throws Exception {
    ApplyProvidedFixInput applyProvidedFixInput =
        createApplyProvidedFixInput(FILE_NAME, "Modified content", 3, 1, 3, 3);
    gApi.changes().id(changeId).current().applyFix(applyProvidedFixInput);
  ...
  @Test
  public void fixReturnsEditInfoForCreatedChangeEdit() throws Exception {
    ApplyProvidedFixInput applyProvidedFixInput =
        createApplyProvidedFixInput(FILE_NAME, "Modified content", 3, 1, 3, 3);
  ...
  @Test
  public void fixCreatedChangeEditIsBasedOnCurrentPatchSet() throws Exception {
  ...
  @Test
  public void fixRestCallWithDifferentUserTheUserBecomesUploader() throws Exception {
    ApplyProvidedFixInput applyProvidedFixInput =
        createApplyProvidedFixInput(FILE_NAME, "Modified content", 3, 1, 3, 3);
