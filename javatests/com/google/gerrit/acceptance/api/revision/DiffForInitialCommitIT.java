...
public class DiffForInitialCommitIT extends AbstractDaemonTest {
  ...
  public void getModifiedFilesForInitialCommit() throws Exception {
    try (Registration registration = extensionRegistry.newRegistration().add(new CommitValidationListener() {
      @Override
      public List<CommitValidationMessage> onCommitReceived(CommitReceivedEvent receiveEvent)
          throws CommitValidationException {
        try {
          diffOperations.listModifiedFilesAgainstParent(project, receiveEvent.commit, null);
