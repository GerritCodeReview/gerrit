...
public class PortedCommentsIT extends AbstractDaemonTest {
  ...
  public void portedCommentsCanBeRequestedForSpecificFilePath() throws Exception {
    ...
    List<CommentInfo> portedComments = getPortedComments(patchset2Id, "file_1.txt");
    assertThatList(portedComments).onlyElement().uuid().isEqualTo(comment1Uuid);

    portedComments = getPortedComments(patchset2Id, "file_2.txt");
  ...
  public void portedCommentsForSpecificFilePathCannotHandleRenames() throws Exception {
    ...
    List<CommentInfo> portedComments = getPortedComments(patchset2Id, "newFileName");
  ...
  private List<CommentInfo> getPortedComments(PatchSet.Id patchsetId, String filePath)
      throws RestApiException {
    return gApi.changes()
        .id(patchsetId.changeId().get())
        .revision(patchsetId.get())
