...
public class PreviewProvidedFixIT extends AbstractDaemonTest {
  ...
  @Test
  public void previewProvidedFixInputNullReturnsBadRequestException() throws Exception {
  ...
  @Test
  public void previewProvidedFixInputFixReplacementInfosNullReturnsBadRequestException()
      throws Exception {
    ApplyProvidedFixInput applyProvidedFixInput = new ApplyProvidedFixInput();
    BadRequestException thrown =
        assertThrows(
