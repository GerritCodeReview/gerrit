...
public class RobotCommentsIT extends AbstractDaemonTest {
  ...
  public void directFixOnPreviousPatchSetWithExistingChangeEditCanBeApplied() throws Exception {
    ...
    EditInfo editInfo = gApi.changes().id(changeId).revision(previousRevision).applyDirectFix(directFixInput);
  ...
  @Test
  public void directFixContainingSeveralModificationsOfCommitMessageCanBeApplied() throws Exception {
    // Set a dedicated commit message.
    String footer = "\nChange-Id: " + changeId + "\n";
    String originalCommitMessage =
        "Line 1 of commit message\nLine 2 of commit message\nLine 3 of commit message\n" + footer;
    ...
    List<FixReplacementInfo> fixReplacementInfoList = Arrays.asList(fixReplacementInfo1, fixReplacementInfo2);
    DirectFixInput directFixInput = new DirectFixInput();
    directFixInput.fixReplacementInfos = fixReplacementInfoList;
  ...
  @Test
  public void twoConflictingDirectFixesOnCommitMessageCanNotBeAppliedOneAfterTheOther() throws Exception {
    // Set a dedicated commit message.
    String footer = "Change-Id: " + changeId;
    String originalCommitMessage =
        "Line 1 of commit message\nLine 2 of commit message\nLine 3 of commit message\n\n"
  ...
  @Test
  public void applyingDirectFixOnTopOfChangeEditReturnsEditInfoForUpdatedChangeEdit() throws Exception {
    gApi.changes().id(changeId).edit().create();
