...
public class ChangeEditIT extends AbstractDaemonTest {
  ...
  public void updateCommitterRest() throws Exception {
    ...
    in.email = "test.rest@example.com";
    ...
    ChangeInfo info =
        get(changeId, ListChangesOption.CURRENT_COMMIT, ListChangesOption.CURRENT_REVISION);
    GitPerson committer = info.revisions.get(info.currentRevision).commit.committer;
    assertThat(committer.email).isEqualTo("test.rest@example.com");
  }
    ...
    assertThrows(
        ...
        () ->
            gApi.changes()
                .id(changeId)
                .edit()
                .modifyIdentity("Test", "other@example.com", ChangeEditIdentityType.COMMITTER));
  }
  ...
  public void updateAuthorRest() throws Exception {
    ...
    ChangeInfo info =
        get(changeId, ListChangesOption.CURRENT_COMMIT, ListChangesOption.CURRENT_REVISION);
    GitPerson author = info.revisions.get(info.currentRevision).commit.author;
    assertThat(author.email).isEqualTo("test.rest@example.com");
  }
    ...
    assertThrows(
        ...
        () ->
            gApi.changes()
                .id(changeId)
                .edit()
                .modifyIdentity("Test", "other@example.com", ChangeEditIdentityType.AUTHOR));
  }
