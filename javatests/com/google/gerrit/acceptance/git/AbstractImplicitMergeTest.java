...
public abstract class AbstractImplicitMergeTest extends AbstractDaemonTest {
  ...
  PushOneCommit.Result createApprovedChange(String targetBranch, RevCommit... parents)
      throws Exception {
  ...
  PushOneCommit.Result createApprovedChange(String targetBranch, PushOneCommit.Result... parents)
      throws Exception {
  ...
  PushOneCommit.Result pushTo(String ref, ImmutableMap<String, String> files, RevCommit... parents)
      throws Exception {
   ...
   */
  RevCommit createChangeWithoutPush(
  ...
  void setRejectImplicitMerges() throws Exception {
    setRejectImplicitMerges(/*reject=*/ true);
  }

  void setRejectImplicitMerges(boolean reject) throws Exception {
  ...
  void setSubmitType(SubmitType submitType) throws Exception {
    try (ProjectConfigUpdate u = updateProject(project)) {
  ...
  PushOneCommit.Result push(String ref, String subject, String fileName, String content)
      throws Exception {
