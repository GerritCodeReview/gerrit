...
public class ImplicitMergeOnSubmitCheckIT extends AbstractDaemonTest {
  ...
  public void setUp() throws Exception {
    ...
    //    RevCommit masterBranchTip = pushTo("refs/heads/master", ImmutableMap.of("master-content",
    // "master-first-line\n"), base).getCommit();
    //    RevCommit stableBranchTip = pushTo("refs/heads/stable", ImmutableMap.of("stable-content",
    // "stable-first-line\n"), base).getCommit();
