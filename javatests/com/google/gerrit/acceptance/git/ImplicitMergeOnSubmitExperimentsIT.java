 ...
 *
 * <p>The changes forms the following tree:
 *
 * <pre>
 ...
 * </pre>
 *
 * <p>Here change[1] is an expicit merge and can be submitted to stable. The change[0] if submitted
 * alone implicitly merges master into a stable branch.
 */
public class ImplicitMergeOnSubmitExperimentsIT extends AbstractImplicitMergeOnSubmit {
  @Override
