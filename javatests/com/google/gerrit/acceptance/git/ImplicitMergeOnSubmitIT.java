 ...
 * ImplicitMergeOnSubmitCherryPickIT} contains tests for the cherry pick startegy.
 */
public class ImplicitMergeOnSubmitIT extends AbstractImplicitMergeTest {
  ...
  public void twoChainOfChangesSameTopic_oneChainImplicitMerge_rejectedOnSubmit() throws Exception {
    ...
    // The resourcePrefix is unique per test.
    gApi.changes().id(c1.getChangeId()).topic(resourcePrefix + "topic");
    gApi.changes().id(c2.getChangeId()).topic(resourcePrefix + "topic");
    gApi.changes().id(c3.getChangeId()).topic(resourcePrefix + "topic");
    gApi.changes().id(implicitMerge.getChangeId()).topic(resourcePrefix + "topic");
    gApi.changes().id(im1.getChangeId()).topic(resourcePrefix + "topic");
    gApi.changes().id(im2.getChangeId()).topic(resourcePrefix + "topic");

    assertSubmitRejectedWithImplicitMerge(c1.getChangeId());
  }

  @Test
  public void twoChainOfChangesDifferentBranchesSameTopic_noImplicitMerge_canSubmit()
      throws Exception {
    cfg.setBoolean("change", null, "submitWholeTopic", true);
    ...
    // several tests gerrit tries to submit all changes, including changes from other tests.
    // The resourcePrefix is unique per test.
    gApi.changes().id(chain1change1.getChangeId()).topic(resourcePrefix + "topic");
    gApi.changes().id(chain1change2.getChangeId()).topic(resourcePrefix + "topic");
    gApi.changes().id(chain1change3.getChangeId()).topic(resourcePrefix + "topic");
    gApi.changes().id(chain2change1.getChangeId()).topic(resourcePrefix + "topic");
    gApi.changes().id(chain2change2.getChangeId()).topic(resourcePrefix + "topic");
    gApi.changes().id(chain2change3.getChangeId()).topic(resourcePrefix + "topic");
  ...
  @Test
  public void
      twoChainOfChangesDifferentBranchesSameTopicNotOnTopOfBranch_noImplicitMerge_canSubmit()
          throws Exception {
    // Add one more commit to master branch.
    pushTo("refs/heads/master", ImmutableMap.of(), masterTip);
    cfg.setBoolean("change", null, "submitWholeTopic", true);
  ...
  public void twoChainOfChangesEndsWithExplicitMergeSameTopicNotTipOfBranches_canBeSubmitted()
    ...
    // several tests gerrit tries to submit all changes, including changes from other tests.
    // The resourcePrefix is unique per test.
    gApi.changes().id(implicitMerge1.getChangeId()).topic(resourcePrefix + "topic");
    gApi.changes().id(changeInChain1.getChangeId()).topic(resourcePrefix + "topic");
    gApi.changes().id(explicitMerge1.getChangeId()).topic(resourcePrefix + "topic");
    gApi.changes().id(implicitMerge2.getChangeId()).topic(resourcePrefix + "topic");
    gApi.changes().id(changeInChain2.getChangeId()).topic(resourcePrefix + "topic");
    gApi.changes().id(explicitMerge2.getChangeId()).topic(resourcePrefix + "topic");
