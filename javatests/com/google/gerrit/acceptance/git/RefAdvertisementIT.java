...
public class RefAdvertisementIT extends AbstractDaemonTest {
  ...
  private void setUpChanges() throws Exception {
    ...
    try (Repository repo = repoManager.openRepository(project)) {
      ...
      RefUpdateContext.testSetup(() -> assertThat(mtu.update()).isEqualTo(RefUpdate.Result.NEW));
      ...
      RefUpdateContext.testSetup(() -> assertThat(btu.update()).isEqualTo(RefUpdate.Result.NEW));
      ...
      RefUpdateContext.testSetup(() -> assertThat(ttu.update()).isEqualTo(RefUpdate.Result.NEW));
    }
  }
  ...
  public void uploadPackBranchRewindMakeTagUnreachableInVisible() throws Exception {
    ...
    try (Repository repo = repoManager.openRepository(project)) {
      ...
      RefUpdateContext.testSetup(() -> assertThat(btu1.update()).isEqualTo(RefUpdate.Result.NEW));
      ...
      RefUpdateContext.testSetup(
          () -> assertThat(btu2.update()).isEqualTo(RefUpdate.Result.FORCED));
    }
  ...
  public void uploadPackTagUpdatedReachableVisible() throws Exception {
    ...
    try (Repository repo = repoManager.openRepository(project)) {
      ...
      RefUpdateContext.testSetup(() -> assertThat(btu.update()).isEqualTo(RefUpdate.Result.FORCED));
    }
