...
public class ChangeExternalIdCaseSensitivityIT extends StandaloneSiteTest {
  ...
  private static final boolean CASE_SENSITIVE_TRIAL_MODE = false;
  ...
  public void externalIdNoteNameIsMigratedToCaseInsensitive() throws Exception {
    prepareExternalIdNotes(CASE_SENSITIVE, CASE_SENSITIVE_TRIAL_MODE);
    ...
    assertExternalIdNotes(CASE_INSENSITIVE, CASE_SENSITIVE_TRIAL_MODE);
  }

  @Test
  public void externalIdNoteNameIsMigratedToCaseSensitive() throws Exception {
    prepareExternalIdNotes(CASE_INSENSITIVE, CASE_SENSITIVE_TRIAL_MODE);
    ...
    assertExternalIdNotes(CASE_SENSITIVE, CASE_SENSITIVE_TRIAL_MODE);
  }
