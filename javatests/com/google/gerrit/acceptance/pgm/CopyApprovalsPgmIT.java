...
public class CopyApprovalsPgmIT extends StandaloneSiteTest {
  ...
  public void programFinishesNormally() throws Exception {
    // This test checks that we are able to set up the injector for the program.
    // The actual migration logic is tested elsewhere.
    Project.NameKey project = Project.nameKey("copy-approvals-test");
