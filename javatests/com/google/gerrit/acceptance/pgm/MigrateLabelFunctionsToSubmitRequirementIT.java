...
public class MigrateLabelFunctionsToSubmitRequirementIT extends AbstractDaemonTest {
  ...
  /**
   * This test is implemented for completeness. It's the responsibility of the caller of {@link
   * MigrateLabelFunctionsToSubmitRequirement} to skip the migration if at least one project has
   * prolog rules.
   */
  @Test
  @Ignore
  ...
  @Test
  public void migrationDoesNotCreateANewSubmitRequirement_ifSRAlreadyExists() throws Exception {
    createLabel("Foo", "MaxWithBlock", /* ignoreSelfApproval= */ false);
    createSubmitRequirement("Foo", "owner:" + admin.email(), /* canOverride= */ true);
    assertExistentSr(
        /* srName */ "Foo",
        /* applicabilityExpression= */ null,
        /* submittabilityExpression= */ "owner:" + admin.email(),
        /* canOverride= */ true);
