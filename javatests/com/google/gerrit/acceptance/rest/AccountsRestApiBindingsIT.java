...
public class AccountsRestApiBindingsIT extends AbstractRestApiBindingsTest {
  ...
  public void accountEndpoints() throws Exception {
    for (RestCall restCall : ACCOUNT_ENDPOINTS) {
      execute(restCall, "self");
    }
  }

  @Test
  public void emailEndpoints() throws Exception {
    for (RestCall restCall : EMAIL_ENDPOINTS) {
      execute(restCall, "self", admin.email);
    }
  }
  ...
  public void sshKeyEndpoints() throws Exception {
    ...
    for (RestCall restCall : SSH_KEY_ENDPOINTS) {
      execute(restCall, "self", sshKeySeq);
    }
  }
  ...
  public void starEndpoints() throws Exception {
    ...
    for (RestCall restCall : STAR_ENDPOINTS) {
      execute(restCall, "self", changeId);
    }
  }
}
