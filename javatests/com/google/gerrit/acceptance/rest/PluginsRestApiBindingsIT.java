...
public class PluginsRestApiBindingsIT extends AbstractRestApiBindingsTest {
  ...
  private static final ImmutableList<RestCall> PLUGIN_ENDPOINTS =
      ImmutableList.of(
          ...
          // TODO(ekempin): GET /plugins/<id>/status is not working, find out why
  ...
  public void testPluginEndpoints() throws Exception {
    String pluginName = "my-plugin";
    installPlugin(pluginName);

    for (RestCall restCall : PLUGIN_ENDPOINTS) {
      execute(restCall, pluginName);
    }
  }
