...
public class ProjectsRestApiBindingsIT extends AbstractRestApiBindingsTest {
  ...
  public void projectEndpoints() throws Exception {
    for (RestCall restCall : PROJECT_ENDPOINTS) {
      execute(restCall, project.get());
    }
  }
  ...
  public void childProjectEndpoints() throws Exception {
    ...
    for (RestCall restCall : CHILD_PROJECT_ENDPOINTS) {
      execute(restCall, project.get(), childProject.get());
    }
  }

  @Test
  public void branchEndpoints() throws Exception {
    for (RestCall restCall : BRANCH_ENDPOINTS) {
      execute(restCall, project.get(), "master");
    }
  }
  ...
  public void branchFileEndpoints() throws Exception {
    ...
    for (RestCall restCall : BRANCH_FILE_ENDPOINTS) {
      execute(restCall, project.get(), "master", FILENAME);
    }
  }
  ...
  public void dashboardEndpoints() throws Exception {
    ...
    for (RestCall restCall : DASHBOARD_ENDPOINTS) {
      execute(restCall, project.get(), DEFAULT_DASHBOARD_NAME);
    }
  }
  ...
  public void tagEndpoints() throws Exception {
    ...
    for (RestCall restCall : TAG_ENDPOINTS) {
      execute(restCall, project.get(), tag);
    }
  }
  ...
  public void commitEndpoints() throws Exception {
    ...
    for (RestCall restCall : COMMIT_ENDPOINTS) {
      execute(restCall, project.get(), commit);
    }
  }
  ...
  public void commitFileEndpoints() throws Exception {
    ...
    for (RestCall restCall : COMMIT_FILE_ENDPOINTS) {
      execute(restCall, project.get(), commit, FILENAME);
    }
  }
