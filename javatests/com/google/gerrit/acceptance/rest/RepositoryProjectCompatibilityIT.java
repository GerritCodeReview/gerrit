...
public class RepositoryProjectCompatibilityIT extends AbstractDaemonTest {
  ...
  @Test
  @GerritConfig(name = "rest.repositoryProjectCompatibility", value = "PROJECT_AND_REPOSITORY")
  public void getOnRepositoriesRootCollection_compatibility_succeeds() throws Exception {
  ...
  @Test
  @GerritConfig(name = "rest.repositoryProjectCompatibility", value = "PROJECT_AND_REPOSITORY")
  public void getOnProjectsRootCollection_compatibility_succeeds() throws Exception {
    RestResponse r = adminRestSession.get("/projects/" + project.get());
    r.assertOK();
  }

  @Test
  public void getOnRepositoriesRootCollection_noCompatibility_succeeds() throws Exception {
    RestResponse r = adminRestSession.get("/repositories/" + project.get());
    r.assertNotFound();
  }

  @Test
  public void getOnProjectsRootCollection_noCompatibility_succeeds() throws Exception {
    RestResponse r = adminRestSession.get("/projects/" + project.get());
    r.assertOK();
  }
