...
public class ImpersonationIT extends AbstractDaemonTest {
  ...
  @CanIgnoreReturnValue
  private ChangeData testSubmitWithRunAs(Project.NameKey project, TestAccount impersonatedUser)
      throws Exception {
    // Real updater of the change. Must be admin unless we create a new session for the other
    // selected user below.
    TestAccount realUser = admin;
    allowRunAs();
  ...
  public void submitWithRunAs_mergeAlways() throws Exception {
    ...
    testSubmitWithRunAs(project, impersonatedUser);
  ...
  public void submitWithRunAs_rebaseAlways() throws Exception {
    ...
    ChangeData cd = testSubmitWithRunAs(project, impersonatedUser);
