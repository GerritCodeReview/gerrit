...
public class PluginProvidedRootRestApiBindingsIT extends AbstractDaemonTest {
  ...
  /** Resource to bind a root collection. */
  ...
  private static final ImmutableSet<RestCall> TEST_CALLS =
      ImmutableSet.of(
          RestCall.get("/test-collection/"),
          RestCall.get("/test-collection/1/detail"),
          RestCall.post("/test-collection/"),
          RestCall.post("/test-collection/1/update"));
