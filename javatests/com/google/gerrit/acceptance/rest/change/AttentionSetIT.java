...
public class AttentionSetIT extends AbstractDaemonTest {
  ...
  public void abandonRemovesUsers() throws Exception {
    ...
    assertThat(userUpdate).hasOperation().isEqualTo(AttentionSetUpdate.Operation.REMOVE);
    assertThat(userUpdate).hasReason().isEqualTo("Change was abandoned");
    ...
    assertThat(adminUpdate).hasOperation().isEqualTo(AttentionSetUpdate.Operation.REMOVE);
    assertThat(adminUpdate).hasReason().isEqualTo("Change was abandoned");
  }
  ...
  public void workInProgressRemovesUsers() throws Exception {
    ...
    assertThat(attentionSet).hasOperation().isEqualTo(AttentionSetUpdate.Operation.REMOVE);
    assertThat(attentionSet).hasReason().isEqualTo("Change was marked work in progress");
  }
  ...
  public void submitRemovesUsersForAllSubmittedChanges() throws Exception {
    ...
    assertThat(attentionSet).hasAccountIdThat().isEqualTo(user.id());
    assertThat(attentionSet).hasOperation().isEqualTo(AttentionSetUpdate.Operation.REMOVE);
    assertThat(attentionSet).hasReason().isEqualTo("Change was submitted");
  ...
  public void addedReviewersAreAddedToAttentionSetOnMergedChanges() throws Exception {
    ...
    assertThat(attentionSet).hasAccountIdThat().isEqualTo(user.id());
    assertThat(attentionSet).hasOperation().isEqualTo(AttentionSetUpdate.Operation.ADD);
    assertThat(attentionSet).hasReason().isEqualTo("Reviewer was added");
  }
  ...
  public void reviewersAddedAndRemovedFromAttentionSet() throws Exception {
    ...
    assertThat(attentionSet).hasAccountIdThat().isEqualTo(user.id());
    assertThat(attentionSet).hasOperation().isEqualTo(AttentionSetUpdate.Operation.REMOVE);
    assertThat(attentionSet).hasReason().isEqualTo("Reviewer was removed");
  }
  ...
  public void robotReadyForReviewAddsAllReviewersToAttentionSet() throws Exception {
    ...
    assertThat(attentionSet).hasAccountIdThat().isEqualTo(user.id());
    assertThat(attentionSet).hasOperation().isEqualTo(AttentionSetUpdate.Operation.ADD);
    assertThat(attentionSet).hasReason().isEqualTo("Change was marked ready for review");
  }
  ...
  public void reviewersAreNotAddedForNoReasonBecauseOfAnUpdate() throws Exception {
    ...
    assertThat(attentionSet).hasAccountIdThat().isEqualTo(user.id());
    assertThat(attentionSet).hasOperation().isEqualTo(AttentionSetUpdate.Operation.REMOVE);
    assertThat(attentionSet).hasReason().isEqualTo("removed");
  }
  ...
  public void reviewAddsManuallyAddedUserToAttentionSet() throws Exception {
    ...
    assertThat(attentionSet).hasAccountIdThat().isEqualTo(user.id());
    assertThat(attentionSet).hasOperation().isEqualTo(AttentionSetUpdate.Operation.ADD);
    assertThat(attentionSet).hasReason().isEqualTo("reason");
  ...
  public void reviewRemovesUserFromAttentionSet() throws Exception {
    ...
    assertThat(attentionSet).hasOperation().isEqualTo(AttentionSetUpdate.Operation.REMOVE);
    assertThat(attentionSet).hasReason().isEqualTo("removed on reply");
  }
  ...
  public void repliesAddsOwner() throws Exception {
    ...
    assertThat(attentionSet).hasAccountIdThat().isEqualTo(admin.id());
    assertThat(attentionSet).hasOperation().isEqualTo(AttentionSetUpdate.Operation.ADD);
    assertThat(attentionSet).hasReason().isEqualTo("Someone else replied on the change");
  }
  ...
  public void reviewAddsAllUsersInCommentThread() throws Exception {
    ...
    assertThat(attentionSet).hasAccountIdThat().isEqualTo(user.id());
    assertThat(attentionSet).hasOperation().isEqualTo(AttentionSetUpdate.Operation.ADD);
    assertThat(attentionSet).hasReason().isEqualTo("Someone else replied on a comment you posted");
  ...
  public void robotReviewWithNegativeLabelAddsOwner() throws Exception {
    ...
    assertThat(attentionSet).hasAccountIdThat().isEqualTo(admin.id());
    assertThat(attentionSet).hasOperation().isEqualTo(AttentionSetUpdate.Operation.ADD);
    assertThat(attentionSet).hasReason().isEqualTo("A robot voted negatively on a label");
  }
  ...
  public void robotCommentAddsOwner() throws Exception {
    ...
    assertThat(attentionSet).hasAccountIdThat().isEqualTo(admin.id());
    assertThat(attentionSet).hasOperation().isEqualTo(AttentionSetUpdate.Operation.ADD);
    assertThat(attentionSet).hasReason().isEqualTo("A robot comment was added");
  }
