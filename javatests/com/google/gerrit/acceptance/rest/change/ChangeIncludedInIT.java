...
public class ChangeIncludedInIT extends AbstractDaemonTest {
  ...
  @Test
  public void externalIncludedInReceivesArgumentsInTheCorrectParameters() throws Exception {
    String changeId = baseTestCase();
    ...
    assertThat(externalIncludedIn.capturedChangeNumber).isEqualTo(changeInfo._number);
