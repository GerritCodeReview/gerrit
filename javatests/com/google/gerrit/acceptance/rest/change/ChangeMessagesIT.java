...
public class ChangeMessagesIT extends AbstractDaemonTest {
  ...
  public void listChangeMessages() throws Exception {
    ...
    List<ChangeMessageInfo> messages2 = new ArrayList<>(change(change).get().messages);
  ...
  private void deleteOneChangeMessage(
    ...
    assertThat(changes.stream().map(c -> c._number).collect(toSet()))
        .contains(change.getPatchSetId().changeId().get());
  ...
  private void assertMetaCommitsAfterDeletion(
    ...
    List<RevCommit> commitsAfterDeletion =
        getChangeMetaCommitsInReverseOrder(change.getChange().getId());
