...
public class ChangeMessagesIT extends AbstractDaemonTest {
  ...
  public void deleteCannotBeAppliedWithEmptyChangeMessageUuid() throws Exception {
    ...
    exception.expectMessage("change message id is required");
  ...
  public void deleteCannotBeAppliedWithNonExistingChangeMessageUuid() throws Exception {
    ...
    input.id = "8473b95934b5732ac55d26311a706c9c2bde9941";
    input.reason = "spam";

    exception.expect(ResourceNotFoundException.class);
    exception.expectMessage(String.format("change message %s not found", input.id));
  ...
  private void deleteOneChangeMessage(
    ...
    DeleteChangeMessageInput input =
        new DeleteChangeMessageInput(messagesBefore.get(deletedMessageIndex).id, reason);
    ChangeMessageInfo info = gApi.changes().id(changeNum).deleteChangeMessage(input);
  ...
  private List<ChangeMessageInfo> getAllChangeMessages(int changeNum) throws Exception {
