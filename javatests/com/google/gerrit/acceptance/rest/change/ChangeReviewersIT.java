...
// This test creates a new user which doesn't go well with other tests that assume there are only
// two users, hence it is sandboxed.
@Sandboxed
public class ChangeReviewersIT extends AbstractDaemonTest {
  ...
  public void removeReviewerWithoutVoteWithPermissionSucceeds() throws Exception {
    ...
    deny(project, RefNames.REFS + "*", Permission.REMOVE_REVIEWER, REGISTERED_USERS);
  }
