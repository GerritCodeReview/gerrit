...
public class ConfigChangeIT extends AbstractDaemonTest {
  ...
  public void addNotifyConfigForEmail() throws Exception {
    ...
    input.notifyConfigUpdates.notifyConfigsAdditions = new ArrayList<>();
    ...
    input.notifyConfigUpdates.notifyConfigsAdditions.add(notifyConfigInput);
  ...
  public void notifySectionErasingNotifyConfigs() throws Exception {
    ...
    input.notifyConfigUpdates.notifyConfigsAdditions.add(notifyConfigInput);
    input.notifyConfigUpdates.notifyConfigsAdditions.add(notifyConfigInput2);
    gApi.projects().name(project.get()).config(input);
    input.notifyConfigUpdates.notifyConfigsAdditions = null;
    input.notifyConfigUpdates.notifyConfigsRemovals = Arrays.asList("example1");
  ...
  public void notifySectionsNameMustBeValid() {
    ...
    input.notifyConfigUpdates.notifyConfigsAdditions.clear();
  ...
  public void notifySectionCantDeleteNonExisting() throws Exception {
    ConfigInput input = new ConfigInput();
    input.notifyConfigUpdates = new NotifyConfigUpdates();
    input.notifyConfigUpdates.notifyConfigsRemovals = new ArrayList<>();
    input.notifyConfigUpdates.notifyConfigsRemovals.add("non_existing");
    BadRequestException thrown =
        assertThrows(
            BadRequestException.class, () -> gApi.projects().name(project.get()).config(input));
