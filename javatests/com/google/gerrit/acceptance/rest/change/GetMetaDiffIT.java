...
public class GetMetaDiffIT extends AbstractDaemonTest {
  ...
  private static final String UNSAVED_REV_ID = "2fd4e1c67a2d28fced849ee1bb76e7391b93eb12";
  ...
  @Test
  public void metaDiffInvalidOldSha1UsesDefault() throws Exception {
    PushOneCommit.Result ch = createChange();
    ...
    ChangeInfoDifference difference =
        gApi.changes().id(ch.getChangeId()).metaDiff("invalid", info.metaRevId);
