...
public class GetMetaDiffIT extends AbstractDaemonTest {
  ...
  public void metaDiffReturnsSuccessful() throws Exception {
    ...
    RestResponse resp =
        adminRestSession.get(
            "/changes/" + ch.getChangeId() + "/metaDiff/?meta=" + info.metaRevId);
  ...
  public void metaDiffNoOldMetaGivenUsesLastPatchSet() throws Exception {
    ...
    ChangeInfoDifference difference = chApi.metaDiff(newInfo.metaRevId);
  ...
  public void metaDiffNoNewMetaGivenUsesCurrentPatchSet() throws Exception {
    ...
    ChangeInfoDifference difference = chApi.metaDiffWithOld(oldInfo.metaRevId);
