...
public class LegacyProjectFieldIT extends AbstractDaemonTest {
  @Test
  ...
  @Test
  public void inboundLegacy() throws Exception {
    JsonObject obj = new JsonObject();
    obj.addProperty("subject", "Test");
    obj.addProperty("project", project.get());
    obj.addProperty("branch", "master");
    RestResponse r = adminRestSession.post("/changes/", obj);
    r.assertCreated();
  ...
  @Test
  public void inboundNew() throws Exception {
    JsonObject obj = new JsonObject();
    obj.addProperty("subject", "Test");
    obj.addProperty("repository", project.get());
    obj.addProperty("branch", "master");
    RestResponse r = adminRestSession.post("/changes/", obj);
    r.assertCreated();
