...
public class SubmitAddApprovalsIT extends AbstractDaemonTest {
  @Inject private ProjectOperations projectOperations;

  @Test
  @TestProjectInput(submitType = SubmitType.CHERRY_PICK)
  @GerritConfig(name = "change.addApprovalsToCommitMessage", value = "false")
  ...
  @Test
  @TestProjectInput(submitType = SubmitType.CHERRY_PICK)
  @GerritConfig(name = "change.addApprovalsToCommitMessage", value = "true")
