...
public class SubmitByMergeIfNecessaryIT extends AbstractSubmitByMerge {
  ...
  public void submitWithFastForward() throws Throwable {
    RevCommit initialHead = this.projectOperations.project(project).getHead("master");
    PushOneCommit.Result change = createChange();
    submit(change.getChangeId());
    RevCommit updatedHead = this.projectOperations.project(project).getHead("master");
  ...
  public void submitChangesAcrossRepos() throws Throwable {
    ...
    RevCommit initialHead2 = this.projectOperations.project(p2).getHead("master");
    RevCommit initialHead3 = this.projectOperations.project(p3).getHead("master");
  ...
  public void submitChangesAcrossReposBlocked() throws Throwable {
    ...
    RevCommit initialHead1 = this.projectOperations.project(p1).getHead("master");
    RevCommit initialHead2 = this.projectOperations.project(p2).getHead("master");
    RevCommit initialHead3 = this.projectOperations.project(p3).getHead("master");
  ...
  public void submitWithMergedAncestorsOnOtherBranch() throws Throwable {
    ...
    RevCommit headAfterFirstSubmit = this.projectOperations.project(project).getHead("master");
  ...
  public void submitWithOpenAncestorsOnOtherBranch() throws Throwable {
    ...
    Project.NameKey p3 = projectOperations.newProject().create();
    TestRepository<?> repo3 = cloneProject(p3);
    RevCommit repo3Head = this.projectOperations.project(p3).getHead("master");
  ...
  public void gerritWorkflow() throws Throwable {
    ...
    RevCommit stable = this.projectOperations.project(project).getHead("stable");
    RevCommit master = this.projectOperations.project(project).getHead("master");
