...
public class SubmitWithDeletedUserIT extends AbstractSubmit {
  ...
  @Test
  public void submitWithApprovalFromDeletedUserSucceedsIfExperimentDisabled() throws Throwable {
    // Create a new user
    TestAccount user2 = accountCreator.create("user2", "user2@example.com", "User 2", null);
  ...
  private void deleteAccount(Account.Id id) throws Exception {
    try (RefUpdateContext ctx = RefUpdateContext.open(RefUpdateContext.RefUpdateType.ACCOUNTS_UPDATE)) {
