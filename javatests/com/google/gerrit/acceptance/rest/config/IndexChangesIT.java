...
public class IndexChangesIT extends AbstractDaemonTest {
  ...
  public void deleteMissingChangesFromIndex() throws Exception {
    ...
    assertThat(
            idx.get(changeId1, IndexedChangeQuery.createOptions(indexConfig, 0, 1, ImmutableSet.of())))
        .isPresent();
    assertThat(
            idx.get(changeId2, IndexedChangeQuery.createOptions(indexConfig, 0, 1, ImmutableSet.of())))
        .isPresent();
    ...
    in.changes =
        ImmutableSet.of(
            String.valueOf(changeId1.get()), project.get() + "~" + changeId2.get());
