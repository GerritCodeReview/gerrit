...
public class AccessIT extends AbstractDaemonTest {
  ...
  public void webLinks() throws Exception {
    WebLinkInfo expected = new WebLinkInfo("foo", "imageUrl", "url");

    // NOSUBMIT - RevisionIT#commit does this, but doesn't seem to be working here.
    ...
    try {
      ...
      assertThat(info.configWebLinks).isNotEmpty();
    } finally {
      handle.remove();
    }
  }
