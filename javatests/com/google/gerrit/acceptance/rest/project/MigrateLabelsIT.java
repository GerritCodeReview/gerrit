...
public class MigrateLabelsIT extends AbstractDaemonTest {
  ...
  public void migrateLabelsReviewEndpoint_createsReviewChange() throws Exception {
    ...
    assertThat(info.change.subject)
        .isEqualTo(MigrateLabelFunctionsToSubmitRequirement.COMMIT_MSG);
  ...
  private void assertSubmitRequirement(
      ...
      throws Exception {
    SubmitRequirementInfo info = gApi.projects().name(project.get()).submitRequirement(srName).get();
