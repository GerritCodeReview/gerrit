...
public class ServiceUserClassifierIT extends AbstractDaemonTest {
  ...
  @Test
  public void cyclicSubgroupsThrowsIllegalStateException() throws Exception {
    TestAccount user = accountCreator.create();
    ...
    IllegalStateException thrown =
        assertThrows(
            IllegalStateException.class, () -> serviceUserClassifier.isServiceUser(user.id()));
    assertThat(thrown).hasMessageThat().contains("cyclic subgroups detected");
  }
