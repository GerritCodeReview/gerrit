...
public class ApprovalCopierIT extends AbstractDaemonTest {
  ...
  @GerritConfig(name = "change.codeReviewLabelCopyRestriction", value = "changekind:REWORK")
  ...
  @GerritConfig(
      name = "experiments.enabled",
      values = {ExperimentFeaturesConstants.ENABLE_CENTRAL_OVERRIDE_FOR_CODE_REVIEW_COPY_CONDITION})
  @GerritConfig(name = "change.codeReviewLabelCopyEnforcement", value = "is:NEGATIVE")
