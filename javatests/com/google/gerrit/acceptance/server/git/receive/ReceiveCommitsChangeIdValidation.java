...
public class ReceiveCommitsChangeIdValidation extends AbstractDaemonTest {

  @Test
  public void disallowEditingChangeIdAcrossPatchSets() throws Exception {
    // Create the parent.
    RevCommit parent =
    ...
    // The Change PS2 is rejected because the Change-Id is invalid
    pushFactory
        .create(
            admin.newIdent(),
            testRepo,
