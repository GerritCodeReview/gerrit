...
public class LuceneChangeIndexerIT extends AbstractDaemonTest {
  ...
  @Test
  @GerritConfig(name = "index.skipExistingDocuments", value = "false")
  public void testReindexWithoutSkip() throws Exception {
  ...
  @Test
  @GerritConfig(name = "index.skipExistingDocuments", value = "true")
  public void testReindexWithSkip() throws Exception {
    ChangeIndexedCounter changeIndexedCounter = new ChangeIndexedCounter();
    try (Registration registration =
        extensionRegistry.newRegistration().add(changeIndexedCounter)) {
      createChange();
  ...
  private void createIndexWithStaleChangeAndReindex(ChangeIndexedCounter changeIndexedCounter)
    ...
    Multimap<NameKey, RefState> refStates =
