...
public class MailProcessorIT extends AbstractMailIT {
  ...
  public void parseAndPersistChangeMessage() throws Exception {
    ...
    String txt =
        newPlaintextBody(getChangeUrl(changeInfo) + "/1", "Test Message", null, null);
  ...
  public void parseAndPersistFileComment() throws Exception {
    ...
    String txt =
        newPlaintextBody(
            getChangeUrl(changeInfo) + "/1", null, null, "Some Comment on File 1");
    b.textContent(txt + textFooterForChange(changeInfo._number, ts));
  ...
  public void limitNumberOfComments() throws Exception {
    ...
    String txt =
        newPlaintextBody(
            ...
            "2) reply to comment\n",
            "3) file comment\n"
        ); // not supported together with 2) ö duplicate this
