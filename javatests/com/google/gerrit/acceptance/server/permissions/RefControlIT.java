...
public class RefControlIT extends AbstractDaemonTest {
  ...
  // ---------------------------------------------------------------------------
  // Doc: ${username} dynamic reference — user-specific sandboxes
  // Each user can read only their own namespace.
  // ---------------------------------------------------------------------------
  ...
  // ---------------------------------------------------------------------------
  // Doc: inheritance — child-project ALLOW overrides a narrower parent ALLOW
  // (project owners apply permissions specific to their project, overwriting
  //  the site defaults specified in All-Projects)
  // ---------------------------------------------------------------------------
  ...
  // ---------------------------------------------------------------------------
  // Doc: Exclusive flag stops the upward search; only the exclusive group can
  // read the matched refs — other groups lose inherited access.
  // ---------------------------------------------------------------------------
