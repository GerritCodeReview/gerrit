...
public class ListSubmitRequirementTemplatesIT extends AbstractDaemonTest {
  ...
  public void parentReadBlockAlsoBlocksChildConfigRead() throws Exception {
    ...
    Project.NameKey parent = projectOperations.newProject().name(name("parent")).parent(grandparent).create();
    Project.NameKey child = projectOperations.newProject().name(name("child")).parent(parent).create();
  ...
  private Response<List<SubmitRequirementInfo>>
  listSubmitRequirementTemplates(Project.NameKey projectName) throws Exception {
