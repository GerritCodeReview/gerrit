...
public class ProjectWatchIT extends AbstractDaemonTest {
  ...
  public void newPatchSetsNotifyConfig() throws Exception {
    ...
    PushOneCommit.Result r =
        pushFactory
            .create(db, admin.newIdent(), testRepo, "original subject", "a", "a1")
            .to("refs/for/master");
    r.assertOkStatus();
    ...
    r =
        pushFactory
            .create(
                db, admin.newIdent(), testRepo, "super sekret subject", "a", "a2", r.getChangeId())
            .to("refs/for/master");
    r.assertOkStatus();

    r =
        pushFactory
            .create(db, admin.newIdent(), testRepo, "back to original subject", "a", "a3")
            .to("refs/for/master");
    r.assertOkStatus();
  ...
  public void noNotificationForPrivateChangesForWatchersInNotifyConfig() throws Exception {
    ...
    PushOneCommit.Result r =
        pushFactory
            .create(db, admin.newIdent(), testRepo, "private change", "a", "a1")
  ...
  public void noNotificationForChangeThatIsTurnedPrivateForWatchersInNotifyConfig()
    ...
    PushOneCommit.Result r =
        pushFactory
            .create(db, admin.newIdent(), testRepo, "subject", "a", "a1")
            .to("refs/for/master");
    r.assertOkStatus();
    ...
    r =
        pushFactory
            .create(db, admin.newIdent(), testRepo, "subject", "a", "a2", r.getChangeId())
            .to("refs/for/master%private");
    r.assertOkStatus();
  ...
  public void noNotificationForWipChangesForWatchersInNotifyConfig() throws Exception {
    ...
    PushOneCommit.Result r =
        pushFactory
            .create(db, admin.newIdent(), testRepo, "wip change", "a", "a1")
  ...
  public void watchProject() throws Exception {
    ...
    PushOneCommit.Result r =
        pushFactory
            .create(db, admin.newIdent(), watchedRepo, "TRIGGER", "a", "a1")
            .to("refs/for/master");
    r.assertOkStatus();
    ...
    r =
        pushFactory
            .create(db, admin.newIdent(), notWatchedRepo, "DONT_TRIGGER", "a", "a1")
            .to("refs/for/master");
    r.assertOkStatus();
  ...
  public void watchFile() throws Exception {
    ...
    PushOneCommit.Result r =
        pushFactory
            .create(db, admin.newIdent(), watchedRepo, "TRIGGER", "a.txt", "a1")
            .to("refs/for/master");
    r.assertOkStatus();
    ...
    r =
        pushFactory
            .create(db, admin.newIdent(), watchedRepo, "TRIGGER_USER2", "b.txt", "b1")
            .to("refs/for/master");
    r.assertOkStatus();
  ...
  public void watchKeyword() throws Exception {
    ...
    PushOneCommit.Result r =
        pushFactory
            .create(db, admin.newIdent(), watchedRepo, "Document multimaster setup", "a.txt", "a1")
            .to("refs/for/master");
    r.assertOkStatus();
    ...
    r =
        pushFactory
            .create(
                db, admin.newIdent(), watchedRepo, "Cleanup cache implementation", "b.txt", "b1")
            .to("refs/for/master");
    r.assertOkStatus();
  ...
  public void watchAllProjects() throws Exception {
    ...
    PushOneCommit.Result r =
        pushFactory
            .create(db, admin.newIdent(), anyRepo, "TRIGGER", "a", "a1")
            .to("refs/for/master");
    r.assertOkStatus();
  ...
  public void watchFileAllProjects() throws Exception {
    ...
    PushOneCommit.Result r =
        pushFactory
            .create(db, admin.newIdent(), anyRepo, "TRIGGER", "a.txt", "a1")
            .to("refs/for/master");
    r.assertOkStatus();
    ...
    r =
        pushFactory
            .create(db, admin.newIdent(), anyRepo, "TRIGGER_USER2", "b.txt", "b1")
            .to("refs/for/master");
    r.assertOkStatus();
  ...
  public void watchKeywordAllProjects() throws Exception {
    ...
    PushOneCommit.Result r =
        pushFactory
            .create(db, admin.newIdent(), anyRepo, "Document multimaster setup", "a.txt", "a1")
            .to("refs/for/master");
    r.assertOkStatus();
    ...
    r =
        pushFactory
            .create(db, admin.newIdent(), anyRepo, "Cleanup cache implementation", "b.txt", "b1")
            .to("refs/for/master");
    r.assertOkStatus();
  ...
  public void watchProjectNoNotificationForIgnoredChange() throws Exception {
    ...
    PushOneCommit.Result r =
        pushFactory
            .create(db, admin.newIdent(), watchedRepo, "ignored change", "a", "a1")
            .to("refs/for/master");
    r.assertOkStatus();
  ...
  public void watchProjectNoNotificationForPrivateChange() throws Exception {
    ...
    PushOneCommit.Result r =
        pushFactory
            .create(db, admin.newIdent(), watchedRepo, "private change", "a", "a1")
            .to("refs/for/master%private");
    r.assertOkStatus();
