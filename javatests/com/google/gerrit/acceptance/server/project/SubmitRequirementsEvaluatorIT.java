...
public class SubmitRequirementsEvaluatorIT extends AbstractDaemonTest {
  ...
  public void submitRequirementThrowsException_whenOperatorIsMissingInExpression() {
    SubmitRequirementExpression exp =
        SubmitRequirementExpression.create(":\"'^.*\\.txt',withDiffContaining='line 2'\"");

    assertThrows(QueryParseException.class, () -> evaluator.validateExpression(exp));
  }

  @Test
  public void submitRequirementThrowsException_whenOperatorValueIsMissingInExpression() {
    SubmitRequirementExpression exp = SubmitRequirementExpression.create("Label:");
