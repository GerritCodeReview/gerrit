...
public class SubmitRequirementsEvaluatorIT extends AbstractDaemonTest {
  ...
  @Test
  public void byCommitEdits_escapeSingleQuotes() throws Exception {
    Change.Id parent = changeOperations.newChange().file(FILE_NAME).content(CONTENT).create();
    Change.Id childId =
        changeOperations
            .newChange()
  ...
  @Test
  public void byCommitEdits_doubleEscapeSingleQuote() throws Exception {
    Change.Id parent = changeOperations.newChange().file(FILE_NAME).content(CONTENT).create();
    Change.Id childId =
        changeOperations
            .newChange()
  ...
  @Test
  public void byCommitEdits_escapeDoubleQuotes() throws Exception {
    Change.Id parent = changeOperations.newChange().file(FILE_NAME).content(CONTENT).create();
    Change.Id childId =
        changeOperations
            .newChange()
  ...
  @Test
  public void byCommitEdits_invalidSyntax() throws Exception {
    Change.Id parent = changeOperations.newChange().file(FILE_NAME).content(CONTENT).create();
    Change.Id childId =
        changeOperations
            .newChange()
    ...
    assertThat(srResult.errorMessage().get())
        .isEqualTo(
            "Argument for the 'commitEdits' operator should be in the form of commitedits:\"'fileRegex',content='contentRegex'\".");
  }

  @Test
  public void byCommitEdits_invalidFilePattern() throws Exception {
    SubmitRequirementExpression exp =
        SubmitRequirementExpression.create("commitedits:\"'*',content='content'\"");
  ...
  @Test
  public void byCommitEdits_invalidContentPattern() throws Exception {
    SubmitRequirementExpression exp =
        SubmitRequirementExpression.create("commitedits:\"'fileName\\.txt',content='*'\"");
