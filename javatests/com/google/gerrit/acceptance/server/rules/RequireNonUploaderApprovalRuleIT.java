...
import com.google.gerrit.server.rules.RequireNonUploaderApprovalRule;
...
@NoHttpd
public class RequireNonUploaderApprovalRuleIT extends AbstractDaemonTest {
  private static final String FILENAME = "my.file";
  @Inject private RequireNonUploaderApprovalRule rule;
  ...
  private void enableRule(String labelName, boolean newState) throws Exception {
    try (ProjectConfigUpdate u = updateProject(project)) {
      ...
      localLabelSections.get(labelName).setIgnoreUploaderSelfApproval(newState);
      u.save();
    }
  }
}
