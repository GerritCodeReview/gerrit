...
public class TaskListenerIT extends AbstractDaemonTest {
   ...
   * called, the call() method will block until another thread calls the complete() method.
   */
  public static class LatchedMethod<T> {
     ...
     */
    public void awaitAndAssertCalled() {
    ...
    public void setAndComplete(T val) {
      set(val);
      complete();
    }

    public void assertAwaitAndSetAndComplete(T val) {
      awaitAndAssertCalled();
      set(val);
      complete();
    }
  ...
  public void onStartThenRunThenOnStopAreCalled() throws Exception {
    ...
    listener.onStart.awaitAndAssertCalled();
    ...
    listener.onStop.awaitAndAssertCalled();
    assertQueueSize(size);
