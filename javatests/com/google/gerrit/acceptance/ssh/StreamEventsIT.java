...
public class StreamEventsIT extends AbstractDaemonTest {
  ...
  public void batchRefsUpdatedShowSeparatelyInStreamEvents() throws Exception {
    ...
    List<String> streamEvents = pollEventsContaining("ref-updated");

    assertThat(streamEvents.stream().filter(ev -> ev.contains(refNamePrefix))).hasSize(2);
  }
  ...
  public void draftCommentRefsDeletionShowInStreamEventsUponPublishing() throws Exception {
    ...
    List<String> eventsReceived = pollEvents(3 /* ref-update draft-comments; ref-update change meta; comment-added */);
