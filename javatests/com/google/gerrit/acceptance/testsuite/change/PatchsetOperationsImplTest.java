...
public class PatchsetOperationsImplTest extends AbstractDaemonTest {
  ...
  public void robotCommentCanBeCreatedOnNonExistingSecondParentCommit() throws Exception {
    ...
    // error
    // handling or resilience of an endpoint) and hence we need to allow such invalid robot comments
    // in
    // the test API.
    CommentInfo comment = getRobotCommentFromServerInCurrentPatchset(changeId, commentUuid);
    assertThat(comment).side().isEqualTo(Side.PARENT);
  ...
  public void robotCommentIsCreatedWithFixSuggestion() throws Exception {
    Change.Id changeId = changeOperations.newChange().create();
    TestFixSuggestionCreation.TestFixReplacementCreation testFixReplacementCreation =
        TestFixSuggestionCreation.TestFixReplacementCreation.builder()
            .path("path")
            ...
            .range(
                TestRange.builder()
                    ...
                    .build())
            .build();
    TestFixSuggestionCreation testFixSuggestionCreation =
        TestFixSuggestionCreation.builder()
            .setDescription("description")
            .addFixReplacement(testFixReplacementCreation)
            .build();
    ...
    String commentUuid =
        changeOperations
            ...
            .currentPatchset()
            .newRobotComment()
            .addFixSuggestion(testFixSuggestionCreation)
            .create();
