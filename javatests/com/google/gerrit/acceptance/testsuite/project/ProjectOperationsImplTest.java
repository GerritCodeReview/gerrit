...
public class ProjectOperationsImplTest extends AbstractDaemonTest {
  ...
  public void createWithOwners() throws Exception {
    ...
    Project.NameKey key = projectOperations.newProject().owners(ImmutableList.of(uuid)).create();
    this.assertPermissions(key, groupRef(uuid), "refs/*", false, Permission.OWNER);
  }
