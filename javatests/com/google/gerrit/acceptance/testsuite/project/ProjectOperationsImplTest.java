...
public class ProjectOperationsImplTest extends AbstractDaemonTest {
  ...
  public void addAllowLabelRemovalPermission() throws Exception {
    ...
    projectOperations
        .project(key)
        .forUpdate()
        .add(allowLabelRemoval("Code-Review").ref("refs/foo").group(REGISTERED_USERS))
        .update();
    ...
    assertThat(config)
        .subsectionValues("access", "refs/foo")
        .containsExactly("RemoveLabelAs-Code-Review", "group global:Registered-Users");
  }
  ...
  public void addBlockLabelRemovalPermission() throws Exception {
    ...
    projectOperations
        .project(key)
        .forUpdate()
        .add(blockLabelRemoval("Code-Review").ref("refs/foo").group(REGISTERED_USERS))
        .update();
    ...
    assertThat(config)
        .subsectionValues("access", "refs/foo")
        .containsExactly("RemoveLabelAs-Code-Review", "block group global:Registered-Users");
  }
  ...
  public void addAllowExclusiveLabelRemovalPermission() throws Exception {
    ...
    assertThat(config)
        .subsectionValues("access", "refs/foo")
        .containsExactly(
            "RemoveLabelAs-Code-Review", "group global:Registered-Users",
            "exclusiveGroupPermissions", "RemoveLabelAs-Code-Review");
  ...
  public void removeLabelRemovalPermission() throws Exception {
    ...
    projectOperations
        ...
        .forUpdate()
        .add(allowLabelRemoval("Code-Review").ref("refs/foo").group(REGISTERED_USERS))
        .add(allowLabelRemoval("Code-Review").ref("refs/foo").group(PROJECT_OWNERS))
        .update();
    assertThat(projectOperations.project(key).getConfig())
        .subsectionValues("access", "refs/foo")
        .containsExactly(
            "RemoveLabelAs-Code-Review", "group global:Registered-Users",
            "RemoveLabelAs-Code-Review", "group global:Project-Owners");
    ...
    assertThat(projectOperations.project(key).getConfig())
        .subsectionValues("access", "refs/foo")
        .containsExactly("RemoveLabelAs-Code-Review", "group global:Project-Owners");
  }
