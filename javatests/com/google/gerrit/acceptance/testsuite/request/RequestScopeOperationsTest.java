...
public class RequestScopeOperationsTest extends AbstractDaemonTest {
  ...
  public void setApiUserToExistingUserById() throws Exception {
    assertThat(getApiUser()).isEqualTo(admin.getId());
    ...
    assertThat(getApiUser()).isEqualTo(user.getId());
  }
  ...
  public void setApiUserToExistingUserByTestAccount() throws Exception {
    ...
    assertThat(oldCtx.getUser().getAccountId()).isEqualTo(admin.getId());
    assertThat(getApiUser()).isEqualTo(testAccount.accountId());
  }
  ...
  private Account.Id getApiUser() throws Exception {
    return new Account.Id(gApi.accounts().self().get()._accountId);
  }
}
