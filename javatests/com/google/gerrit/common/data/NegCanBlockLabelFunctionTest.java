...
public class NegCanBlockLabelFunctionTest {
  ...
  public NegCanBlockLabelFunctionTest(List<PatchSetApproval> approvals,
      SubmitRecord.Label.Status expected) {
  ...
  @Test
  public void test() {
    SubmitRecord.Label myLabel = LabelFunction.NEG_CAN_BLOCK.check(VERIFIED_LABEL,
        fApprovals);
