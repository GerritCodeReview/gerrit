...
public class ParameterizedStringTest {
  ...
  public void emptyString() {
    ...
    assertThat(p.getPattern()).isEqualTo("");
    assertThat(p.getRawPattern()).isEqualTo("");
    assertThat(p.getParameterNames().isEmpty()).isTrue();

    Map<String, String> a = new HashMap<>();
    assertThat(p.bind(a)).isNotNull();
    assertThat(p.bind(a)).hasLength(0);
    assertThat(p.replace(a)).isEqualTo("");
  }
  ...
  public void replace4() {
    ...
    Map<String, String> a = new HashMap<>();
    assertThat(p.bind(a)).asList().isNotNull();
    assertThat(p.bind(a)).hasLength(1);
    assertThat(p.bind(a)[0]).isEqualTo("");
  ...
  public void replaceSubmitTooltipWithoutVariables() {
    ...
    Map<String, String> params =
        ImmutableMap.of(
            "patchSet", "42",
            "branch", "foo");
    assertThat(p.bind(params)).hasLength(0);
