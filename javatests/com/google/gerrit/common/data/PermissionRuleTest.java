...
public class PermissionRuleTest {
  ...
  public void setup() {
    ...
    this.permissionRule = PermissionRule.builder(groupReference).build();
  }
  ...
  public void getAndSetAction() {
    ...
    assertThat(permissionRule.toBuilder().setAction(Action.DENY).build().getAction())
  ...
  public void cannotSetActionToNull() {
    assertThrows(
        NullPointerException.class, () -> permissionRule.toBuilder().setAction(null).build());
  }
  ...
  public void setDeny() {
    ...
    assertThat(permissionRule.toBuilder().setDeny().build().isDeny()).isTrue();
  }
  ...
  public void setBlock() {
    ...
    assertThat(permissionRule.toBuilder().setBlock().build().isBlock()).isTrue();
  }

  @Test
  public void setForce() {
    assertThat(permissionRule.getForce()).isFalse();
    assertThat(permissionRule.toBuilder().setForce(true).build().getForce()).isTrue();
    assertThat(permissionRule.toBuilder().setForce(false).build().getForce()).isFalse();
  }

  @Test
  public void setMin() {
    assertThat(permissionRule.getMin()).isEqualTo(0);
    assertThat(permissionRule.toBuilder().setMin(-2).build().getMin()).isEqualTo(-2);
    assertThat(permissionRule.toBuilder().setMin(2).build().getMin()).isEqualTo(2);
  }
  ...
  public void setMax() {
    ...
    assertThat(permissionRule.toBuilder().setMax(2).build().getMax()).isEqualTo(2);
    assertThat(permissionRule.toBuilder().setMax(-2).build().getMax()).isEqualTo(-2);
  }
  ...
  public void setRange() {
    ...
    PermissionRule rule = permissionRule.toBuilder().setRange(-2, 2).build();
    assertThat(rule.getMin()).isEqualTo(-2);
    assertThat(rule.getMax()).isEqualTo(2);

    rule = permissionRule.toBuilder().setRange(2, -2).build();
    assertThat(rule.getMin()).isEqualTo(-2);
    assertThat(rule.getMax()).isEqualTo(2);

    rule = permissionRule.toBuilder().setRange(1, 1).build();
    assertThat(rule.getMin()).isEqualTo(1);
    assertThat(rule.getMax()).isEqualTo(1);
  }

  @Test
  public void hasRange() {
    assertThat(permissionRule.hasRange()).isFalse();
    assertThat(permissionRule.toBuilder().setMin(-1).build().hasRange()).isTrue();
    assertThat(permissionRule.toBuilder().setMax(1).build().hasRange()).isTrue();
  }
  ...
  public void setGroup() {
    ...
    assertThat(permissionRule.getGroup()).isEqualTo(groupReference);
    assertThat(permissionRule.toBuilder().setGroup(groupReference2).build().getGroup())
        .isEqualTo(groupReference2);
  }
