...
public class SubmitRecordTest {
  ...
  private static final SubmitRecord OK_RECORD = new SubmitRecord();
  private static final SubmitRecord NOT_READY_RECORD = new SubmitRecord();

  static {
    OK_RECORD.status = Status.OK;
    NOT_READY_RECORD.status = Status.NOT_READY;
  }
