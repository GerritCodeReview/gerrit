...
public final class ChangeInfoDifferTest {
  ...
  private static AccountInfo createAccountInfoWithEmails(String name, String... emails) {
    AccountInfo accountInfo = new AccountInfo();
    accountInfo.name = name;
    accountInfo.secondaryEmails = ImmutableList.copyOf(emails);
    return accountInfo;
  }
  ...
  private static ChangeInfo createChangeInfoWithReviewers(AccountInfo... reviewers) {
    ChangeInfo changeInfo = new ChangeInfo();
    changeInfo.removableReviewers = ImmutableList.copyOf(reviewers);
    return changeInfo;
  }
