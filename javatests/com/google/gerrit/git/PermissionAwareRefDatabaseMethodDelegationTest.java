...
public class PermissionAwareRefDatabaseMethodDelegationTest {
  ...
  public PermissionAwareRefDatabaseMethodDelegationTest(
      Method repositoryMethod, String repositoryMethodName) {
  ...
  public void isDelegated() throws Exception {
    assertMethodIsDelegated(
        repositoryMethod,
        permissionAwareRefDb,
        refDb,
        new Object[] {repository, forProject},
