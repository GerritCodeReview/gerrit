...
public class PermissionAwareRepositoryTest extends EasyMockSupport {
	...
	private final Set<String> methodsWithSpecificTest = ImmutableSet.of(
	...
	public void permissionAwareRepositoryShouldNotDelegateGetRefDatabase( ) {	
		...
		assertThat(permissionAwareRepository.getRefDatabase()).isInstanceOf(PermissionAwareReadOnlyRefDatabase.class);
	...
	protected PermissionAwareRepository buildPermissionAwareRepo() {
		...
		PermissionAwareRepository permissionAwareRepository = new PermissionAwareRepository(repository, forProject);
	...
	protected PermissionAwareDfsRepository buildPermissionAwareDfsRepo() {
		...
		PermissionAwareDfsRepository permissionAwareRepository = new PermissionAwareDfsRepository((DfsRepository)repository, forProject);
