...
public class AllowRenderInFrameFilterTest {
  ...
  @Test
  public void shouldSkipHeaderWhenCanRenderInFrameIsTrue() throws IOException, ServletException {
  ...
  @Test
  public void shouldSkipHeaderWhenCanRenderInFrameIsTrueAndXFormOptionIsDENY()
      throws IOException, ServletException {
    when(cfg.getBoolean("gerrit", "canLoadInIFrame", false)).thenReturn(true);
    when(cfg.getString("gerrit", null, "xframeOption"))
        .thenReturn(AllowRenderInFrameFilter.X_FRAME_OPTIONS.ALLOW.name());
  ...
  @Test
  public void shouldSkipHeaderWhenUnknownXFormOptionValue() throws IOException, ServletException {
    when(cfg.getBoolean("gerrit", "canLoadInIFrame", false)).thenReturn(true);
