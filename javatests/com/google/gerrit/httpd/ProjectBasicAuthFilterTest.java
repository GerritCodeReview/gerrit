...
public class ProjectBasicAuthFilterTest {
  ...
  @Mock private AuthTokenCacheImpl tokenCache;
  ...
  public void setUp() throws Exception {
    ...
    tokenVerifier = new AuthTokenVerifier(tokenCache);
    ...
    doReturn(
            List.of(
                new AuthTokenCacheEntry(
                    AUTH_ACCOUNT_ID, AuthToken.createWithPlainToken("token", AUTH_PASSWORD))))
        .when(tokenCache)
        .get(AUTH_ACCOUNT_ID);
  }
