...
public class ProjectBasicAuthFilterTest {
  ...
  public void setUp() throws Exception {
    ...
    doReturn(java.util.Optional.of(accountState)).when(accountCache).getByUsername(AUTH_USER);
  ...
  public void shouldNotReauthenticateIfAlreadySignedIn() throws Exception {
    req.addHeader(
        "Authorization",
        "Basic " + B64_ENC.encodeToString((AUTH_USER + ":" + AUTH_PASSWORD).getBytes(StandardCharsets.UTF_8)));
    res.setStatus(HttpServletResponse.SC_OK);
