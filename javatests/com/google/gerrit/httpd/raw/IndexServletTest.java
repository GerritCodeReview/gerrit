...
public class IndexServletTest {
  ...
  public void renderTemplate() throws Exception {
    ...
    String disabledDefault = ExperimentFeaturesConstants.DEFAULT_ENABLED_FEATURES.asList().get(0);
    ...
    ExperimentFeatures experimentFeatures = new ExperimentFeaturesImpl(serverConfig);
