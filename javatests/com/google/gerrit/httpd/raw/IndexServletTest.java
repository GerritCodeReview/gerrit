...
public class IndexServletTest {
  ...
  public void renderTemplate() throws Exception {
    ...
    com.google.common.cache.Cache<String, com.google.gerrit.server.config.ServerConfigCacheImpl.ServerConfigData> serverConfigCache =
        com.google.common.cache.CacheBuilder.newBuilder().build();
    IndexServlet servlet =
        new IndexServlet(
            testCanonicalUrl, testCdnPath, testFaviconURL, gerritApi, experimentFeatures, serverConfigCache);
