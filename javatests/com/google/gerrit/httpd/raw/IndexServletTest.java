...
public class IndexServletTest {
  ...
  public void renderTemplate() throws Exception {
    ...
    String disabledDefault = ExperimentFeatures.DEFAULT_ENABLED_FEATURES.asList().get(0);
    ...
    ExperimentFeatures experimentFeatures = new ExperimentFeatures(serverConfig);
    ...
    String enabledDefaults =
        ExperimentFeatures.DEFAULT_ENABLED_FEATURES.stream()
