...
public class OpenSearchServletTest {
  ...
  public void pathAndInstanceName() throws URISyntaxException {
    SoyMapData data =
        OpenSearchServlet.getTemplateData(
            "http://example.com/gerrit", "InstanceName");
    assertThat(data.getSingle("canonicalPath").stringValue()).isEqualTo("http://example.com/gerrit");
