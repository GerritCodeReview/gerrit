...
public class SchemaUtilTest {
  ...
  private static final StoredSchemaField<String, String> TEST_FIELD =
      StoredSchemaField.<String>stringBuilder("TestId").build(a -> a);

  private static final StoredSchemaField<String, String> TEST_FIELD_DUPLICATE_NAME =
      StoredSchemaField.<String>stringBuilder(TEST_DEF.getName()).build(a -> a);

  private static final StoredSchemaField.StoredSearchSpec TEST_FIELD_SPEC =
    ...
    assertThrows(
        ...
        () ->
            new Schema.Builder<String>()
                .version(0)
                .addStoredSchemaFields(TEST_FIELD)
  ...
  public void addFieldDefWithDuplicateFieldName_disallowed() {
    assertThrows(
        ...
        () ->
            new Schema.Builder<String>()
                .version(0)
                .addStoredSchemaFields(TEST_FIELD_DUPLICATE_NAME)
                .add(TEST_DEF)
                .build());
  }
