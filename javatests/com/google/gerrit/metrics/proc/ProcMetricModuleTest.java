        ...
        Guice.createInjector(
            new AbstractModule() {
              ...
              protected void configure() {
                MetricsReservoirConfig configMock = mock(MetricsReservoirConfig.class);
                bind(MetricsReservoirConfig.class).toInstance(configMock);
                install(new DropWizardMetricMaker.ApiModule());
              }
            });
