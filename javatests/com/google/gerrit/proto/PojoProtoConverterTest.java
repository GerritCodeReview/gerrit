...
public class PojoProtoConverterTest {
  ...
  public void addAll() throws Exception {
    PojoProtoConverter.INSTANCE.addAllTypes();
  }
  ...
  public void inheritance() throws Exception {
    ApprovalInfo ainf = new ApprovalInfo();
    ainf.tag = "tag";
    ainf._accountId = 123;
    ainf.email = "a@b";

    Rest.ApprovalInfo.Builder want = Rest.ApprovalInfo.newBuilder().setTag("tag");
    want.getAccountInfoBuilder().setAccountId(123).setEmail("a@b");

    Rest.ApprovalInfo got = (Rest.ApprovalInfo) PojoProtoConverter.toProtoMessage(ainf);
    assertThat(got).isEqualTo(want.build());
