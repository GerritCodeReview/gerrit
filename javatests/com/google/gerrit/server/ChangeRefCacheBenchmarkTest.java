...
public class ChangeRefCacheBenchmarkTest extends GerritBaseTests {
  ...
  public void benchmark() throws Exception {
    ...
    Dumper.dumpHeap("/usr/local/google/home/hiesel/local-heap.bin", true);
    Dumper.dumpHeap("/usr/local/google/home/hiesel/local-heap-non-live.bin", false);
