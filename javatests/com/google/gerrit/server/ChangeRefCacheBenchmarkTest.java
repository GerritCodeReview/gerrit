...
public class ChangeRefCacheBenchmarkTest extends GerritBaseTests {
  ...
  public void benchmark() throws Exception {
    ...
    ChangeRefKeyProto key = ChangeRefKeyProto.newBuilder()
        .setChangeId(12345)
        .setRepoKey("chromium/chromium/src/nested/repo")
        .build();
    ChangeRefStateProto value = ChangeRefStateProto.newBuilder()
  ...
  private static long deserialize(ChangeRefKeyProto key, ChangeRefStateProto value, int numObjects) throws Exception {
