...
import static com.google.gerrit.server.account.AuthTokenExpiryNotificationConfig.AUTH_SECTION;
import static com.google.gerrit.server.account.AuthTokenExpiryNotificationConfig.TOKEN_EXPIRY_NOTIFY;
import static com.google.gerrit.server.account.AuthTokenExpiryNotificationConfig.TOKEN_EXPIRY_NOTIFY_DAYS_BEFORE;
import static com.google.gerrit.server.account.AuthTokenExpiryNotificationConfig.TOKEN_EXPIRY_SUBSECTION;
...
public class AuthTokenExpiryNotificationConfigTest {
  ...
  public void readsNotificationDaysFromConfig() {
    ...
    config.setStringList(
        AUTH_SECTION,
        TOKEN_EXPIRY_SUBSECTION,
        TOKEN_EXPIRY_NOTIFY_DAYS_BEFORE,
        List.of("5", "10", "15"));
    AuthTokenExpiryNotificationConfig notificationConfig =
        new AuthTokenExpiryNotificationConfig(config);
  ...
  public void featureCanBeDisabled() {
    Config config = new Config();
    config.setBoolean(AUTH_SECTION, TOKEN_EXPIRY_SUBSECTION, TOKEN_EXPIRY_NOTIFY, false);
    AuthTokenExpiryNotificationConfig notificationConfig =
        new AuthTokenExpiryNotificationConfig(config);
