...
public class EncryptionConfigTest {
  ...
  public void testHashAlgorithmDefault() throws Exception {
    expect(gerritConfig.getString(SECTION, null, "hashAlgorithm")).andReturn(HASH_ALGORITHM);
    replay(gerritConfig);
    encryptionCfg = new EncryptionConfig(gerritConfig);
    assertThat(encryptionCfg.hashAlgorithm()).isEqualTo(HASH_ALGORITHM);
  }

  @Test
  public void testTransformationDefault() throws Exception {
    expect(gerritConfig.getString(SECTION, null, "transformation")).andReturn(TRANSFORMATION);
    replay(gerritConfig);
    encryptionCfg = new EncryptionConfig(gerritConfig);
    assertThat(encryptionCfg.transformation()).isEqualTo(TRANSFORMATION);
  }

  @Test
  public void testIterationsDefault() throws Exception {
    expect(gerritConfig.getInt(SECTION, "iterations", ITERATION_COUNT)).andReturn(ITERATION_COUNT);
    replay(gerritConfig);
    encryptionCfg = new EncryptionConfig(gerritConfig);
    assertThat(encryptionCfg.iterations()).isEqualTo(ITERATION_COUNT);
  }

  @Test
  public void testKeyLength() throws Exception {
    expect(gerritConfig.getInt(SECTION, "keyLength", KEY_LENGTH)).andReturn(256);
    replay(gerritConfig);
    encryptionCfg = new EncryptionConfig(gerritConfig);
    assertThat(encryptionCfg.keyLength()).isEqualTo(256);
  }
  ...
  public void testHashAlgorithm() throws Exception {
    expect(gerritConfig.getString(SECTION, null, "hashAlgorithm")).andReturn("testHash");
    replay(gerritConfig);
    encryptionCfg = new EncryptionConfig(gerritConfig);
    assertThat(encryptionCfg.hashAlgorithm()).isEqualTo("testHash");
  }

  @Test
  public void testTransformation() throws Exception {
    expect(gerritConfig.getString(SECTION, null, "transformation")).andReturn("testtransformation");
    replay(gerritConfig);
    encryptionCfg = new EncryptionConfig(gerritConfig);
    assertThat(encryptionCfg.transformation()).isEqualTo("testtransformation");
  }

  @Test
  public void testIterations() throws Exception {
    expect(gerritConfig.getInt(SECTION, "iterations", ITERATION_COUNT)).andReturn(2000);
    replay(gerritConfig);
    encryptionCfg = new EncryptionConfig(gerritConfig);
    assertThat(encryptionCfg.iterations()).isEqualTo(2000);
  }
}
