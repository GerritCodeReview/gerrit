...
public final class OAuthTokenCacheTest {
  ...
  public void serializeAndDeserializeBackAccountId() {
    final OAuthTokenCache.AccountIdSerializer serializer = OAuthTokenCache.AccountIdSerializer.INSTANCE;
  ...
  public void accountIdSerializerIsNotAnAnonymousClass() {
    assertThat(OAuthTokenCache.AccountIdSerializer.INSTANCE.getClass().getSimpleName()).isNotEmpty();
  }
