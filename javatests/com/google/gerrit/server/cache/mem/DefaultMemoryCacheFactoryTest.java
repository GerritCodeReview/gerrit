...
public class DefaultMemoryCacheFactoryTest {
  ...
  public void setUp() {
    ...
    memoryCacheFactory =
        new DefaultMemoryCacheFactory(
            memoryCacheConfig, new ForwardingRemovalListenerFactoryTest());
  ...
  private static class ForwardingRemovalListenerFactoryTest
      implements ForwardingRemovalListener.Factory {

    @SuppressWarnings("unchecked")
    @Override
    public ForwardingRemovalListener<Integer, Integer> create(String cacheName) {
      return createMockBuilder(ForwardingRemovalListener.class).createMock();
    }
  }
}
