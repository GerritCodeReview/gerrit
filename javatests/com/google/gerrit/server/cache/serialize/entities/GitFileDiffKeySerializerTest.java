...
public class GitFileDiffKeySerializerTest {
  ...
  public void roundTrip() {
    GitFileDiffCacheImpl.Key key =
        GitFileDiffCacheImpl.Key.builder()
    ...
    byte[] serialized = GitFileDiffCacheImpl.Key.Serializer.INSTANCE.serialize(key);

    assertThat(GitFileDiffCacheImpl.Key.Serializer.INSTANCE.deserialize(serialized)).isEqualTo(key);
  }
}
