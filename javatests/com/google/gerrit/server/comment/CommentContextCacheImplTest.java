...
public class CommentContextCacheImplTest {
  ...
  public void getAll_deduplicatesInputKeys() {
    ...
    CommentContext ctx1 =
        CommentContext.create(ImmutableMap.of(10, "line 10"), "text/x-java");
    CommentContext ctx2 =
        CommentContext.create(ImmutableMap.of(20, "line 20"), "text/x-java");
  ...
  public void get_singleKey() {
    ...
    CommentContext ctx =
        CommentContext.create(ImmutableMap.of(5, "code line"), "text/x-java");
