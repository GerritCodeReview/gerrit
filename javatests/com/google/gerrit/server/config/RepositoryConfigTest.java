...
public class RepositoryConfigTest {
  ...
  public void defaultConfigForSpecificFilter() {
    configureDefaultConfig(
        "someProject", "receive.rejectImplicitMerges", DefaultBooleanProjectConfig.Value.ENFORCED);
    assertThat(
            repoCfg.getDefault(
                Project.nameKey("someProject"), BooleanProjectConfig.REJECT_IMPLICIT_MERGES))
        .isEqualTo(DefaultBooleanProjectConfig.Value.ENFORCED);
    assertThat(
            repoCfg.getDefault(
  ...
  public void defaultConfigForStartWithFilter() {
    configureDefaultConfig(
        ...
        DefaultBooleanProjectConfig.Value.ENFORCED);
    configureDefaultConfig(
