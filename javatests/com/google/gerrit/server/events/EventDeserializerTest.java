...
public class EventDeserializerTest extends GerritBaseTests {
  ...
  public void patchSetCreatedEvent() {
    ...
    PatchSetCreatedEvent e = (PatchSetCreatedEvent) gsonDeserializer.fromJson(gsonSerializer.toJson(orig), Event.class);
  ...
  public void assigneeChangedEvent() {
    ...
    AssigneeChangedEvent e = (AssigneeChangedEvent) gsonDeserializer.fromJson(gsonSerializer.toJson(orig), Event.class);
  ...
  public void changeDeletedEvent() {
    ...
    ChangeDeletedEvent e = (ChangeDeletedEvent) gsonDeserializer.fromJson(gsonSerializer.toJson(orig), Event.class);
  ...
  public void hashtagsChangedEvent() {
    ...
    HashtagsChangedEvent e = (HashtagsChangedEvent) gsonDeserializer.fromJson(gsonSerializer.toJson(orig), Event.class);
  ...
  public void changeAbandonedEvent() {
    ...
    ChangeAbandonedEvent e = (ChangeAbandonedEvent) gsonDeserializer.fromJson(gsonSerializer.toJson(orig), Event.class);
  ...
  public void changeMergedEvent() {
    ...
    ChangeMergedEvent e = (ChangeMergedEvent) gsonDeserializer.fromJson(gsonSerializer.toJson(orig), Event.class);
  ...
  public void changeRestoredEvent() {
    ...
    ChangeRestoredEvent e = (ChangeRestoredEvent) gsonDeserializer.fromJson(gsonSerializer.toJson(orig), Event.class);
  ...
  public void commentAddedEvent() {
    ...
    CommentAddedEvent e = (CommentAddedEvent) gsonDeserializer.fromJson(gsonSerializer.toJson(orig), Event.class);
  ...
  public void privateStateChangedEvent() {
    ...
    PrivateStateChangedEvent e = (PrivateStateChangedEvent) gsonDeserializer.fromJson(gsonSerializer.toJson(orig),
        Event.class);
  ...
  public void reviewerAddedEvent() {
    ...
    ReviewerAddedEvent e = (ReviewerAddedEvent) gsonDeserializer.fromJson(gsonSerializer.toJson(orig), Event.class);
  ...
  public void reviewerDeletedEvent() {
    ...
    ReviewerDeletedEvent e = (ReviewerDeletedEvent) gsonDeserializer.fromJson(gsonSerializer.toJson(orig), Event.class);
  ...
  public void voteDeletedEvent() {
    ...
    VoteDeletedEvent e = (VoteDeletedEvent) gsonDeserializer.fromJson(gsonSerializer.toJson(orig), Event.class);
  ...
  public void workinProgressStateChangedEvent() {
    ...
    WorkInProgressStateChangedEvent e = (WorkInProgressStateChangedEvent) gsonDeserializer
        .fromJson(gsonSerializer.toJson(orig), Event.class);
  ...
  public void topicChangedEvent() {
    ...
    TopicChangedEvent e = (TopicChangedEvent) gsonDeserializer.fromJson(gsonSerializer.toJson(orig), Event.class);
  ...
  private Change newChange(String changeKey) {
    Change change = new Change(Change.key(changeKey), Change.id(1000), Account.id(1000),
        Branch.nameKey(Project.nameKey("myproject"), "mybranch"), new Timestamp(System.currentTimeMillis()));
    return change;
  }
  ...
  private void assertSameChangeEvent(ChangeEvent current, ChangeEvent expected) {
    ...
    assertSameChange(current.change.get(), expected.change.get());
  }

  private void assertSameChange(ChangeAttribute current, ChangeAttribute expected) {
    assertThat(current.project).isEqualTo(expected.project);
