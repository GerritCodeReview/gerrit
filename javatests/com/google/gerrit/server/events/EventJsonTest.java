...
public class EventJsonTest extends GerritBaseTests {
  ...
  public void refUpdatedEvent() {
    ...
    assertThatJsonMap(event)
        .containsExactly(
            "submitter",
            ImmutableMap.of("email", "some.user@domain.com"),
            "refUpdate",
            ImmutableMap.of("refName", "refs/heads/master"),
            "type",
            "ref-updated",
            "eventCreatedOn",
            1.2543444E9);
  ...
  public void patchSetCreatedEvent() {
    ...
    assertThatJsonMap(event)
        .containsExactly(
            "uploader",
            ImmutableMap.of(
                "name", "uploader", "email", "uploader@somewhere.com", "username", "uploader"),
            "change",
            ...
            "refs/heads/mybranch",
            "changeKey",
            ImmutableMap.of("id", "Ideadbeefdeadbeefdeadbeefdeadbeefdeadbeef"),
            "type",
            "patchset-created",
            "eventCreatedOn",
            1.254344401E9);
  ...
  public void assigneeChangedEvent() {
    ...
    assertThatJsonMap(event)
        .containsExactly(
            "changer",
            ImmutableMap.of(
                "name", "changer", "email", "changer@somewhere.com", "username", "changer"),
            "oldAssignee",
            ImmutableMap.of(
                "name",
                "oldAssignee",
                "email",
                "oldAssignee@somewhere.com",
                "username",
                "oldAssignee"),
            "change",
            ImmutableMap.builder()
  ...
  public void hashtagsChangedEvent() {
    ...
    assertThatJsonMap(event)
        .containsExactly(
            "editor",
            ImmutableMap.of(
                "name", "editor", "email", "editor@somewhere.com", "username", "editor"),
            "added",
            ImmutableList.of("added"),
            "removed",
            ImmutableList.of("removed"),
            "hashtags",
            ImmutableList.of("hashtags"),
            "change",
            ImmutableMap.builder()
                .put("project", "myproject")
                .put("branch", "mybranch")
  ...
  public void changeAbandonedEvent() {
    ...
    assertThatJsonMap(event)
        .containsExactly(
            "abandoner",
            ImmutableMap.of(
                "name", "abandoner", "email", "abandoner@somewhere.com", "username", "abandoner"),
            "reason",
            "some reason",
            "change",
            ImmutableMap.builder()
  ...
  private MapSubject assertThatJsonMap(Object src) {
    ...
    Map<Object, Object> map =
        deserializeGson.fromJson(
            serializeGson.toJson(src), new TypeToken<Map<Object, Object>>() {}.getType());
