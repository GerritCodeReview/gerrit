...
public class EventTest {
  ...
  public void eventsWithSameClassAndBaseFieldsAreEqual() {
    Event event = newTestEvent(1000L, INSTANCE_ID);
    Event sameEvent = newTestEvent(1000L, INSTANCE_ID);
  ...
  public void eventsWithDifferentEventCreatedOnAreNotEqual() {
    Event event = newTestEvent(1000L, INSTANCE_ID);
    Event eventWithDifferentTimestamp = newTestEvent(1001L, INSTANCE_ID);
  ...
  public void eventsWithDifferentInstanceIdAreNotEqual() {
    Event event = newTestEvent(1000L, INSTANCE_ID);
    Event eventWithDifferentInstanceId = newTestEvent(1000L, "other-instance-id");
