...
public class FixCalculatorTest {
  private static final String emptySrc = "";
  private static final String oneLineSrcNoEOL = "First line";
  private static final String oneLineSrcHasEOL = "First line\n";
  private static final String multiLineSrcNoEOL = "First line\nSecond line\nThird line";
  private static final String multiLineSrcHasEol = "First line\nSecond line\nThird line\n";

  private static final String emptyReplacement = "";
  private static final String oneLineReplacementNoEOL = "ABC";
  private static final String oneLineReplacementHasEOL = "ABC\n";
  private static final String multiLineReplacementNoEol = "ABC\nDEFG\nHK";
  private static final String multiLineReplacementEol = "ABC\nDEFG\nHK\n";
  private static final String replacementStartsWithEOL = "\nABC\nDEFG\nHK\n";

  public static FixResult calculateFixSingleReplacement(String content, int startLine, int startChar, int endLine, int endChar, String replacement) throws ResourceConflictException {
    FixReplacement fixReplacement = new FixReplacement("AnyPath", new Range(startLine, startChar, endLine, endChar), replacement);
    return FixCalculator.calculateFix(new Text(content.getBytes(UTF_8)), ImmutableList.of(fixReplacement));
  }
  @Test
