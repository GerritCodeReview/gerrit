...
public class OneLineContentNoEOLTest {
  ...
  public void insertSingleLineNoEOLAtStart() throws Exception {
    FixResult fixResult = FixCalculatorTest.calculateFixSingleReplacement("First line", 1, 0, 1, 0, "Abc");
  ...
  public void insertSingleLineNoEOLInTheMiddle() throws Exception {
    FixResult fixResult = FixCalculatorTest.calculateFixSingleReplacement("First line", 1, 5, 1, 5, "Abc");
  ...
  public void insertSingleLineNoEOLAtEnd() throws Exception {
    FixResult fixResult = FixCalculatorTest.calculateFixSingleReplacement("First line", 1, 10, 1, 10, "Abc");
    assertThat(fixResult).text().isEqualTo("First lineAbc");
    assertThat(fixResult).edits().onlyElement()
        .isReplace(0, 1,  0, 1)
        .hasInternalEdits()
        .onlyElement().isInsert(10, 10, 3);
  }
  ...
  public void insertMultilineLineWithEOLAtEnd() throws Exception {
    ...
    assertThat(fixResult).edits().onlyElement()
        .isReplace(0, 1,  0, 2)
        .hasInternalEdits()
        .onlyElement().isInsert(10, 10, 10);
  }

  @Test
  public void replaceWithSingleLineNoEOLAtStart() throws Exception {
    FixResult fixResult = FixCalculatorTest.calculateFixSingleReplacement("First line", 1, 0, 1, 2, "Abc");
  ...
  public void replaceWithSingleLineNoEOLInTheMiddle() throws Exception {
    FixResult fixResult = FixCalculatorTest.calculateFixSingleReplacement("First line", 1, 3, 1, 5, "Abc");
  ...
  public void replaceWithSingleLineNoEOLAtEnd() throws Exception {
    FixResult fixResult = FixCalculatorTest.calculateFixSingleReplacement("First line", 1, 8, 1, 10, "Abc");
    assertThat(fixResult).text().isEqualTo("First liAbc");
    assertThat(fixResult).edits().onlyElement()
        .isReplace(0, 1,  0, 1)
        .hasInternalEdits()
        .onlyElement().isReplace(8, 2, 8, 3);
  }
  ...
  public void replaceMultilineLineWithEOLAtEnd() throws Exception {
    ...
    assertThat(fixResult).edits().onlyElement()
        .isReplace(0, 1,  0, 2)
        .hasInternalEdits()
        .onlyElement().isReplace(8, 2, 8, 10);
  }
  ...
  public void replaceMultilineLineNoEOLAtEnd() throws Exception {
    ...
    assertThat(fixResult).edits().onlyElement()
        .isReplace(0, 1,  0, 2)
        .hasInternalEdits()
        .onlyElement().isReplace(8, 2, 8, 9);
  }

  @Test
  public void replaceWholeContent() throws Exception {
    FixResult fixResult = FixCalculatorTest.calculateFixSingleReplacement("First line", 1, 0, 1, 10, "Abc");
    assertThat(fixResult).text().isEqualTo("Abc");
    assertThat(fixResult).edits().onlyElement()
        .isReplace(0, 1,  0, 1)
        .hasInternalEdits()
        .onlyElement().isReplace(0, 10, 0, 3);
  }

  @Test
  public void deleteWholeContent() throws Exception {
    FixResult fixResult = FixCalculatorTest.calculateFixSingleReplacement("First line", 1, 0, 1, 10, "");
    assertThat(fixResult).text().isEqualTo("");
    assertThat(fixResult).edits().onlyElement()
        .isDelete(0, 1, 0)
        .hasInternalEdits()
        .onlyElement().isDelete(0, 10, 0);
  }

  @Test
  public void deleteAtStart() throws Exception {
    FixResult fixResult = FixCalculatorTest.calculateFixSingleReplacement("First line", 1, 0, 1, 4, "");
  ...
  public void deleteInTheMidle() throws Exception {
    FixResult fixResult = FixCalculatorTest.calculateFixSingleReplacement("First line", 1, 5, 1, 8, "");
  ...
  public void deleteAtEnd() throws Exception {
    FixResult fixResult = FixCalculatorTest.calculateFixSingleReplacement("First line", 1, 7, 1, 10, "");
    assertThat(fixResult).text().isEqualTo("First l");
    assertThat(fixResult).edits().onlyElement()
        .isReplace(0, 1,  0, 1)
        .hasInternalEdits()
        .onlyElement().isDelete(7, 3, 7);
  }
}
