...
public class DeleteZombieCommentsRefsTest {
  ...
  public void cleanZombieDrafts() throws Exception {
    ...
    ObjectId tree1 = createTree(usersRepo, rw.lookupBlob(file1), "file1.txt");
    ObjectId tree2 = createTree(usersRepo, rw.lookupBlob(file2), "file2.txt");
    ObjectId tree3 = createTree(usersRepo, rw.lookupBlob(file3), "file3.txt");
    ...
    Ref ref1 = createRef(usersRepo, commit2, "refs/draft-comments/01/1/1000001");
    Ref ref2 = createRef(usersRepo, commit4, "refs/draft-comments/01/1/1000002");
    ...
    assertThat(usersRepo.exactRef("refs/draft-comments/01/1/1000001").getObjectId())
        .isEqualTo(commit2);
    assertThat(usersRepo.exactRef("refs/draft-comments/01/1/1000002")).isNull();
