...
import com.google.gerrit.server.git.TagSet.Dag;
import com.google.gerrit.server.git.TagSet.Node;
...
public class TagSetTest {
  ...
  public void roundTripToProto() {
    ...
    Node ic3 = new Node(ObjectId.fromString("0000000000000000000000000000000000000003"),
        decorations(tag1));
    dag.setInitialCommit(ic3);

    String tag2 = "refs/tags/tag2";
    String branch2 = "refs/heads/branch2";
    Node ic4 = new Node(ObjectId.fromString("0000000000000000000000000000000000000004"), decorations(tag2, branch2));
  ...
  public <V> void dagFields() {
    assertThatSerializedClass(Dag.class)
...
// Not true that <{decorated=java.util.Set<com.google.gerrit.server.git.TagSet$Node>, directory=V[][], size=int, grow=int, bits=int, mask=int}> contains exactly <{decorated=java.util.Set<com.google.gerrit.server.git.TagSet$Node>, directory=V[][], size=int, grow=int, bits=int, mask=int}>. It has the following entries with matching keys but different values: {directory=(expected V[][] (com.google.inject.internal.MoreTypes$GenericArrayTypeImpl) but got V[][] (sun.reflect.generics.reflectiveObjects.GenericArrayTypeImpl))}
// serializedClass was: class com.google.gerrit.server.git.TagSet$Dag
