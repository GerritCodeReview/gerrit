...
public class VersionedMetaDataTest {
  ...
  public void sharedBatchRefUpdate() throws Exception {
    ...
    assertMyMetaData(d1.getRefName(), 3, "Increment conf.value by 1", "Increment conf.value by 2");
    assertMyMetaData(d2.getRefName(), 3, "Increment conf.value by 2", "Increment conf.value by 1");
  }

  private MyMetaData load(int expectedValue) throws Exception {
    return load("refs/meta/config", expectedValue);
  }
