...
public class AbstractGroupTest extends GerritBaseTests {
  ...
  protected Timestamp getTipTimestamp(Repository repo, AccountGroup.UUID uuid) throws Exception {
  ...
  protected void assertTipCommit(Repository repo, AccountGroup.UUID uuid, String expectedMessage)
      throws Exception {
    ImmutableList<CommitInfo> commits = GroupTestUtil.log(repo, RefNames.refsGroups(uuid));
    assertCommit(
