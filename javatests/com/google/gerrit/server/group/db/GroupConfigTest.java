...
public class GroupConfigTest {
  ...
  public void commitMessageOfNewGroupWithMembersContainsFooters() throws Exception {
    ...
    AuditLogFormatter auditLogFormatter =
        createAuditLogFormatter(accounts, ImmutableSet.of(), "server-id");
  ...
  public void commitMessageOfNewGroupWithSubgroupsContainsFooters() throws Exception {
    ...
    AuditLogFormatter auditLogFormatter =
        createAuditLogFormatter(ImmutableSet.of(), groups, "serverId");
  ...
  public void commitMessageOfMemberAdditionContainsFooters() throws Exception {
    ...
    AuditLogFormatter auditLogFormatter =
        createAuditLogFormatter(accounts, ImmutableSet.of(), "GerritServer1");
  ...
  private static AuditLogFormatter createAuditLogFormatter(
      ImmutableSet<Account> accounts,
      ImmutableSet<GroupDescription.Basic> groups,
      String serverId) {
    return new AuditLogFormatter(
        id -> accounts.stream().filter(account -> account.getId().equals(id)).findAny(),
        uuid -> groups.stream().filter(group -> group.getGroupUUID().equals(uuid)).findAny(),
        serverId);
  }
