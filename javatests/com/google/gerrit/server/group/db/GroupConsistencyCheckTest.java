...
public class GroupConsistencyCheckTest extends GerritBaseTests {
  ...
  public void duplicateUUIDs() throws Exception {
    ...
    ConsistencyProblemInfo exp1 =
        new ConsistencyProblemInfo(
            Status.WARNING, "shared group UUID 'uuid-1' between groups: g-1, g-3, g-5");
    ConsistencyProblemInfo exp2 =
        new ConsistencyProblemInfo(
            Status.WARNING, "shared group UUID 'uuid-2' between groups: g-2, g-4");

    List<ConsistencyProblemInfo> problems =
        GroupsConsistencyChecker.checkGroupNameNotesConsistency(byUUID, ImmutableListMultimap.of());
  ...
  public void duplicateNames() throws Exception {
    ...
    ConsistencyProblemInfo exp1 =
        new ConsistencyProblemInfo(
            Status.WARNING, "shared group name 'g-1' between groups: uuid-1, uuid-3, uuid-4");
    ConsistencyProblemInfo exp2 =
        new ConsistencyProblemInfo(
            Status.WARNING, "shared group name 'g-2' between groups: uuid-2, uuid-5");

    List<ConsistencyProblemInfo> problems =
        GroupsConsistencyChecker.checkGroupNameNotesConsistency(ImmutableListMultimap.of(), byName);
    assertThat(problems).containsExactly(exp1, exp2);
  }
}
