...
public class GroupRebuilderTest extends GerritBaseTests {
  ...
  private void assertOwner(AccountGroup g, GroupReference expected) throws Exception {
    ...
    GroupReference actual = rule.getGroup();

    // Manual assertions since GroupReference#equals only compares ID.
