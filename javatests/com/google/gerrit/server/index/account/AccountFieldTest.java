...
public class AccountFieldTest {
  ...
  public void externalIdStateFieldValues() throws Exception {
    ...
    ExternalId extId1 =
        ExternalId.create(
            ExternalId.Key.create(ExternalId.SCHEME_MAILTO, "foo.bar@example.com", false, false),
            id,
            "foo.bar@example.com",
            null,
    ...
    ExternalId extId2 =
        ExternalId.create(
            ExternalId.Key.create(ExternalId.SCHEME_USERNAME, "foo", false, false),
            id,
            null,
            "secret",
    ...
    ExternalId extId3 =
        ExternalId.create(
            ExternalId.Key.create(ExternalId.SCHEME_USERNAME, "Bar", true, false),
            id,
            null,
            "secret",
