...
public class ChangeFieldTest {
  ...
  @Test
  public void metRequirementField() {
    ...
    assertThat(ChangeField.MET_REQUIREMENT_FIELD.get(cd)).containsExactly("code-review");
    assertThat(ChangeField.UNMET_REQUIREMENT_FIELD.get(cd)).containsExactly("verified");
    assertThat(ChangeField.SUBMIT_REQUIREMENT_FIELD.get(cd))
        .containsExactly("code-review=satisfied", "verified=unsatisfied");
