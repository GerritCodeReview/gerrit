...
public class ChangeIndexRewriterTest {
  ...
  @Test
  public void noneChildInAndInsideOrStaysIndexPushable() throws Exception {
    // An AND with a none() child short-circuits to none(). When that AND is nested inside an OR,
    // the none() must remain an index-pushable ChangeDataSource so the OR folds into an OrSource.
