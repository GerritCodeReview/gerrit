    ...
    try (PerformanceLogContext traceContext =
      ...
      Timer1<Integer> timer1 =
          metricMaker.newTimer(
              ...
              Field.ofInteger(
                      (metadataBuilder, fieldValue) -> metadataBuilder.accountId(fieldValue))
                  .name("account")
                  .build());
      ...
      Timer2<Integer, Integer> timer2 =
          metricMaker.newTimer(
              ...
              Field.ofInteger(
                  ...
                  .name("account")
                  .build(),
              Field.ofInteger((metadataBuilder, fieldValue) -> metadataBuilder.changeId(fieldValue))
                  .name("change")
                  .build());
      ...
      Timer2<String, String> timer2 =
          metricMaker.newTimer(
              ...
              Field.ofString(
                  ...
                  .build(),
              Field.ofString(
                      (metadataBuilder, fieldValue) -> metadataBuilder.branchName(fieldValue))
                  .name("branch")
                  .build());
      ...
      Timer3<String, String, String> timer3 =
          metricMaker.newTimer(
              ...
              Field.ofString(
                  ...
                  .name("branch")
                  .build(),
              Field.ofString((metadataBuilder, fieldValue) -> metadataBuilder.revision(fieldValue))
                  .name("revision")
                  .build());
  ...
  public void timerMetricsOutsidePerformanceLogContextDoNotCreatePerformanceLog() {
    ...
    Timer1<Integer> timer1 =
        metricMaker.newTimer(
            "test2/latency",
            new Description("Latency metric for testing"),
            Field.ofInteger((metadataBuilder, fieldValue) -> metadataBuilder.accountId(fieldValue))
                .name("account")
                .build());
    timer1.start(1000000).close();
    ...
    Timer3<Integer, Integer, String> timer3 =
        metricMaker.newTimer(
            ...
            Field.ofInteger((metadataBuilder, fieldValue) -> metadataBuilder.changeId(fieldValue))
                .name("change")
                .build(),
            Field.ofString((metadataBuilder, fieldValue) -> metadataBuilder.projectName(fieldValue))
                .name("project")
                .build());
