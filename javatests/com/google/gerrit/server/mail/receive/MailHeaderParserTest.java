...
public class MailHeaderParserTest {
  ...
  public void parseMetadataFromHeader() {
    ...
    b.addAdditionalHeader(
        MailHeader.TIMESTAMP.fieldWithDelimiter() + "Tue, 25 Oct 2016 02:11:35 -0700");
  ...
  public void parseMetadataFromText() {
    ...
    stringBuilder.append(
        MailHeader.TIMESTAMP.withDelimiter() + "Tue, 25 Oct 2016 02:11:35 -0700\r\n");
  ...
  public void parseMetadataFromHTML() {
    ...
    stringBuilder.append(
        "<div>"
            + MailHeader.TIMESTAMP.withDelimiter()
