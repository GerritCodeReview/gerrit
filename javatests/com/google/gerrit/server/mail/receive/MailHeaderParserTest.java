...
public class MailHeaderParserTest {
  ...
  public void parseMetadataFromText() {
    ...
    stringBuilder.append(MailHeader.COMMENT_DATE.withDelimiter())
  ...
  public void parseMetadataFromHTML() {
    ...
    StringBuilder stringBuilder = new StringBuilder();
    stringBuilder.append("<div id\"someid\">").append(MailHeader.CHANGE_NUMBER.withDelimiter())
        .append("123</div>");
    stringBuilder.append("<div>").append(MailHeader.PATCH_SET.withDelimiter()).append("1</div>");
    stringBuilder.append("<div>").append(MailHeader.MESSAGE_TYPE.withDelimiter())
        .append("comment</div>");
    stringBuilder.append("<div>").append(MailHeader.COMMENT_DATE.withDelimiter())
        .append("Tue, 25 Oct 2016 02:11:35 -0700").append("</div>");
