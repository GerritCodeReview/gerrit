...
import com.google.gerrit.plugins.checks.email.ChecksMailSoyTemplateProvider;
...
public class MailSoySauceProviderTest {
  ...
  @Test
  public void checksPluginSoyCompilation() {
    set.add("checks", new ChecksMailSoyTemplateProvider());
