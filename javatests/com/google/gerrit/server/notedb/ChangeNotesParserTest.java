  ...
  public void parseApprovalNoUUIDUserWithComma() throws Exception {
    assertParseSucceeds(
        "Update change\n"
            ...
            + "Change-id: I577fb248e474018276351785930358ec0450e9f7\n"
            + "Patch-set: 1\n"
            + "Label: Label1=+1 Gerrit User 1 (company_name, department) <1@gerrit>\n"
            + "Subject: This is a test change\n");
  }
  ...
  public void parseCopiedApprovalNoUUIDUserWithComma() throws Exception {
    assertParseSucceeds(
        "Update change\n"
            ...
            + "Change-id: I577fb248e474018276351785930358ec0450e9f7\n"
            + "Patch-set: 1\n"
            + "Copied-Label: Label1=+1 Gerrit User 1 (company_name, department) <1@gerrit>\n"
            + "Copied-Label: Label2=+1 Gerrit User 1 (company_name, department) <1@gerrit>,Gerrit User 2 (company_name, department) <2@gerrit>\n"
            + "Subject: This is a test change\n");
  }
