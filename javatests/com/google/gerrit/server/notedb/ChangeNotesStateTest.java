...
public class ChangeNotesStateTest {
  ...
  public void serializeNullTopic() throws Exception {
    ChangeNotesState state = newBuilder().build();
    assertThat(state.columns().topic()).isNull();
    assertRoundTrip(
        state,
        ChangeNotesStateProto.newBuilder()
            .setMetaId(SHA_BYTES)
  ...
  public void serializeEmptyTopic() throws Exception {
    ...
    assertThat(state.columns().topic()).isNotNull();
    assertRoundTrip(
        state,
        ChangeNotesStateProto.newBuilder()
            .setMetaId(SHA_BYTES)
  ...
  public void serializeStatus() throws Exception {
    assertRoundTrip(
        ...
        ChangeNotesStateProto.newBuilder()
            .setMetaId(SHA_BYTES)
            .setChangeId(ID.get())
            .setColumns(colsProto.toBuilder().setStatus('M').setHasStatus(true))
            .build());
  }
  ...
  public void serializeIsWorkInProgress() throws Exception {
    assertRoundTrip(
        newBuilder().columns(cols.toBuilder().isWorkInProgress(true).build()).build(),
        ChangeNotesStateProto.newBuilder()
            .setMetaId(SHA_BYTES)
            .setChangeId(ID.get())
            .setColumns(colsProto.toBuilder().setIsWorkInProgress(true))
            .build());
  }
  ...
  public void serializeHasReviewStarted() throws Exception {
    assertRoundTrip(
        newBuilder().columns(cols.toBuilder().hasReviewStarted(true).build()).build(),
        ChangeNotesStateProto.newBuilder()
            .setMetaId(SHA_BYTES)
            .setChangeId(ID.get())
            .setColumns(colsProto.toBuilder().setHasReviewStarted(true))
            .build());
  }
  ...
  public void serializeApprovals() throws Exception {
    PatchSetApproval a1 =
        new PatchSetApproval(
            ...
            (short) 1,
            TimeUtil.nowTs());
    ByteString a1Bytes = Serializer.encodeToByteString(APPROVAL_CODEC, a1);
    ...
    PatchSetApproval a2 =
        new PatchSetApproval(
            ...
            (short) -1,
            TimeUtil.nowTs());
    ByteString a2Bytes = Serializer.encodeToByteString(APPROVAL_CODEC, a2);
            ...
            .reviewers(
                ReviewerSet.fromTable(
                    ImmutableTable.<ReviewerStateInternal, Account.Id, Timestamp>builder()
                        .put(ReviewerStateInternal.CC, new Account.Id(2001), TimeUtil.nowTs())
                        .put(ReviewerStateInternal.REVIEWER, new Account.Id(2002), TimeUtil.nowTs())
                        .build()))
            .build(),
        ChangeNotesStateProto.newBuilder()
            .setMetaId(SHA_BYTES)
            ...
            .addReviewer(
                ReviewerSetEntryProto.newBuilder()
                    .setState("CC")
                    .setAccountId(2001)
                    .setTimestamp(1254344402000L))
            .addReviewer(
                ReviewerSetEntryProto.newBuilder()
                    .setState("REVIEWER")
                    .setAccountId(2002)
                    .setTimestamp(1254344403000L))
            .build());
  }
        ...
        ChangeNotesStateProto.newBuilder()
            ...
            .addReviewerUpdate(
                ReviewerStatusUpdateProto.newBuilder()
                    .setDate(1254344402000L)
                    .setUpdatedBy(1000)
                    .setReviewer(2002)
                    .setState("CC"))
            .addReviewerUpdate(
                ReviewerStatusUpdateProto.newBuilder()
                    .setDate(1254344403000L)
                    .setUpdatedBy(1000)
                    .setReviewer(2001)
                    .setState("REVIEWER"))
            .build());
  ...
  public void serializeChangeMessages() throws Exception {
    ...
    ByteString m1Bytes = Serializer.encodeToByteString(MESSAGE_CODEC, m1);
    ...
    ByteString m2Bytes = Serializer.encodeToByteString(MESSAGE_CODEC, m2);
  ...
  public void serializeReadOnlyUntil() throws Exception {
    assertRoundTrip(
        newBuilder().readOnlyUntil(TimeUtil.nowTs()).build(),
        ChangeNotesStateProto.newBuilder()
            .setMetaId(SHA_BYTES)
            .setChangeId(ID.get())
            .setColumns(colsProto)
            .setReadOnlyUntil(1254344402000L)
  ...
  public void changeNotesStateMethods() throws Exception {
    CacheSerializerTestUtil.testExpectedAutoValueMethods(
  ...
  public void changeColumnsMethods() throws Exception {
    CacheSerializerTestUtil.testExpectedAutoValueMethods(
        ...
        ImmutableMap.<String, Type>builder()
            ...
            .put("isWorkInProgress", boolean.class)
            .put("hasReviewStarted", boolean.class)
  ...
  public void changeMessageFields() throws Exception {
    CacheSerializerTestUtil.testExpectedFields(
        ChangeMessage.Key.class,
        ImmutableMap.of("changeId", Change.Id.class, "uuid", String.class));
    CacheSerializerTestUtil.testExpectedFields(
        ChangeMessage.class,
        ImmutableMap.<String, Type>builder()
  ...
  public void commentFields() throws Exception {
    CacheSerializerTestUtil.testExpectedFields(
        Comment.Key.class,
        ImmutableMap.of("uuid", String.class, "filename", String.class, "patchSetId", int.class));
    CacheSerializerTestUtil.testExpectedFields(
        Comment.Identity.class, ImmutableMap.of("id", int.class));
    CacheSerializerTestUtil.testExpectedFields(
        Comment.Range.class,
        ImmutableMap.of(
            "startLine", int.class,
  ...
  private static void assertRoundTrip(ChangeNotesState state, ChangeNotesStateProto expectedProto)
      throws Exception {
    ChangeNotesStateProto actualProto = toProto(state);
    assertThat(actualProto).isEqualTo(expectedProto);
    assertThat(Serializer.INSTANCE.deserialize(Serializer.INSTANCE.serialize(state)))
        .isEqualTo(state);
  }
