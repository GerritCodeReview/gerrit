            ...
            .assigneeUpdates(
                ImmutableList.of(
                    AssigneeStatusUpdate.create(
                        new Timestamp(1212L), Account.id(1000), null, Account.id(2001)),
                    AssigneeStatusUpdate.create(
                        new Timestamp(3434L), Account.id(1000), Account.id(2001), null)))
            .build(),
        ChangeNotesStateProto.newBuilder()
            .setMetaId(SHA_BYTES)
            .setChangeId(ID.get())
    ...
    assertThatSerializedClass(AssigneeStatusUpdate.class)
        .hasAutoValueMethods(
            ImmutableMap.of(
                "date", Timestamp.class,
                "updatedBy", Account.Id.class,
                "pastAssignee", Account.Id.class,
                "currentAssignee", Account.Id.class));
  }
