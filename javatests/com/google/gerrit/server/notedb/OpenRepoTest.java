...
public class OpenRepoTest extends AbstractChangeNotesTest {
  ...
  private final Optional<Integer> MAX_UPDATES = Optional.of(1);
  ...
  public void throwExceptionWhenExceedingMaxUpdatesLimit() throws Exception {
    ...
    OpenRepo openRepo = new OpenRepo(
        repo,
        rw,
        null,
        fakeChainedReceiveCommands,
    false);
    ...
    ListMultimap <String, ChangeUpdate> changeUpdates = new ImmutableListMultimap.Builder<String, ChangeUpdate>()
        .put("one", update)
        .build();

    openRepo.addUpdates(changeUpdates, MAX_UPDATES, MAX_PATCH_SETS);
  }
  ...
  public void attentionSetUpdateShouldNotContributeToOperationsCount() throws Exception {
    ...
    ListMultimap <String, ChangeUpdate> changeUpdates1 = new ImmutableListMultimap.Builder<String, ChangeUpdate>()
        .put("one", update1)
        .build();

    openRepo.addUpdates(changeUpdates1, MAX_UPDATES, MAX_PATCH_SETS);
    ...
    ListMultimap <String, ChangeUpdate> changeUpdates2 = new ImmutableListMultimap.Builder<String, ChangeUpdate>()
        .put("one", update2)
        .build();

    openRepo.addUpdates(changeUpdates2, MAX_UPDATES, MAX_PATCH_SETS);
