...
import static com.google.gerrit.server.notedb.schema.NoteDbSchemaUpdater.requiredUpgrades;
...
public class NoteDbSchemaUpdaterTest {
  ...
  private static class TestUpdate {
    ...
    TestUpdate(Optional<Integer> initialVersion) throws Exception {
      ...
      NoteDbSchemaVersionManager versionManager =
          new NoteDbSchemaVersionManager(
              allProjectsName, repoManager, GitReferenceUpdated.DISABLED);
      updater =
  ...
  public void bootstrapUpdate() throws Exception {
    ...
    assertThat(u.update())
        .containsExactly(
            "Upgrading schema to 10 ...", "body of 10", "Upgrading schema to 11 ...", "BODY OF 11")
        .inOrder();
  ...
  public void updateOneVersion() throws Exception {
    ...
    assertThat(u.update()).containsExactly("Upgrading schema to 11 ...", "BODY OF 11").inOrder();
    assertThat(u.readVersion()).hasValue(11);
  }
