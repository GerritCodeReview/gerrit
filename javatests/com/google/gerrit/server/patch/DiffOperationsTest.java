...
public class DiffOperationsTest {
  ...
  public void gitattributesDiffOverride() throws Exception {
    ...
    ObjectId oldCommitId1 = createCommit(repo, null, ImmutableList.of(
        new FileEntity(jsonFile, "{}")
    ));
    ObjectId newCommitId1 = createCommit(repo, oldCommitId1, ImmutableList.of(
        new FileEntity(jsonFile, "{\"foo\": \"bar\"}")
    ));
    FileDiffOutput diffOutput1 = diffOperations.getModifiedFileAgainstParent(
    ...
    ObjectId oldCommitId2 = createCommit(repo, null, ImmutableList.of(
        new FileEntity(".gitattributes", jsonFile + " -diff"),
        new FileEntity(jsonFile, "{}")
    ));
    ObjectId newCommitId2 = createCommit(repo, oldCommitId2, ImmutableList.of(
        new FileEntity(".gitattributes", jsonFile + " -diff"),
        new FileEntity(jsonFile, "{\"foo\": \"bar\"}")
    ));
    FileDiffOutput diffOutput2 = diffOperations.getModifiedFileAgainstParent(
    ...
    ObjectId oldCommitId3 = createCommit(repo, null, ImmutableList.of(
        new FileEntity(".gitattributes", jsonFile + " binary"),
        new FileEntity(jsonFile, "{}")
    ));
    ObjectId newCommitId3 = createCommit(repo, oldCommitId3, ImmutableList.of(
        new FileEntity(".gitattributes", jsonFile + " binary"),
        new FileEntity(jsonFile, "{\"foo\": \"bar\"}")
    ));
    FileDiffOutput diffOutput3 = diffOperations.getModifiedFileAgainstParent(
