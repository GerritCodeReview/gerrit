...
public class GerritServerFlavourTest {
  ...
  @Test
  public void ee8RejectsEe11Plugin() {
    InvalidPluginException e =
        assertThrows(
            InvalidPluginException.class,
            () -> GerritServerFlavour.checkPluginFlavour("foo", "ee11", GerritServerFlavour.EE8));
    assertThat(e).hasMessageThat().contains("Plugin 'foo' is built for flavour 'ee11'");
    assertThat(e).hasMessageThat().contains("this Gerrit instance is 'ee8'");
    assertThat(e).hasMessageThat().contains("dev-plugins.html");
  }

  // --- EE11 Gerrit: strict, requires an explicit Gerrit-Flavour: ee11 ---

  @Test
  public void ee11AcceptsEe11Plugin() throws Exception {
    GerritServerFlavour.checkPluginFlavour("foo", "ee11", GerritServerFlavour.EE11);
  }

  @Test
  public void ee11RejectsUnmarkedPlugin() {
    InvalidPluginException e =
        assertThrows(
            InvalidPluginException.class,
            () -> GerritServerFlavour.checkPluginFlavour("foo", null, GerritServerFlavour.EE11));
    assertThat(e).hasMessageThat().contains("Plugin 'foo' is built for flavour 'ee8'");
    assertThat(e).hasMessageThat().contains("this Gerrit instance is 'ee11'");
  }

  @Test
  public void ee11RejectsEe8Plugin() {
    assertThrows(
        InvalidPluginException.class,
        () -> GerritServerFlavour.checkPluginFlavour("foo", "ee8", GerritServerFlavour.EE11));
  }
  ...
  @Test
  public void anyLoadsUnderEe11() throws Exception {
    GerritServerFlavour.checkPluginFlavour("foo", "any", GerritServerFlavour.EE11);
  }
  ...
  public void markerValuesMatchEnum() {
    ...
    assertThat(GerritServerFlavour.EE11.marker()).isEqualTo("ee11");
  ...
  public void unknownMarkerIsRejected() {
    InvalidPluginException e =
        assertThrows(
            InvalidPluginException.class,
            () -> GerritServerFlavour.checkPluginFlavour("foo", "ee12", GerritServerFlavour.EE11));
    assertThat(e).hasMessageThat().contains("unknown Gerrit-Flavour 'ee12'");
  }
}
