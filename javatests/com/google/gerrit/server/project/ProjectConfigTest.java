...
public class ProjectConfigTest extends GerritBaseTests {
  ...
  public void readConfig() throws Exception {
    ...
    assertThat(ca.getMatchProjects().get(0).toString()).isEqualTo("^/ourproject");
    assertThat(ca.getMatchProjects().get(1).toString()).isEqualTo("^/ourotherproject");
    assertThat(ca.getMatchProjects().get(2).toString()).isEqualTo("^/someotherroot/ourproject");
    assertThat(ca.getExcludeProjects()).hasSize(4);
    assertThat(ca.getExcludeProjects().get(0).toString()).isEqualTo("^/theirproject");
    assertThat(ca.getExcludeProjects().get(1).toString()).isEqualTo("^/theirotherproject");
    assertThat(ca.getExcludeProjects().get(2).toString())
        .isEqualTo("^/someotherroot/theirproject");
    assertThat(ca.getExcludeProjects().get(3).toString())
        .isEqualTo("^/someotherroot/theirotherproject");
  ...
  public void editConfig() throws Exception {
    ...
    ca.setExcludeProjects(Collections.singletonList(Pattern.compile("^/theirproject")));
