...
public class CachedServerConfigTest {
  ...
  @Test
  public void getInfo_cachesAndExpires() throws Exception {
    ...
    ServerInfo thirdLoad = cachedServerConfig.getInfo(); // After expiration
  ...
  @Test
  @SuppressWarnings("unchecked")
  public void getVersion_cachesAndExpires() throws Exception {
  ...
  @Test
  public void getTopMenus_cachesAndExpires() throws Exception {
