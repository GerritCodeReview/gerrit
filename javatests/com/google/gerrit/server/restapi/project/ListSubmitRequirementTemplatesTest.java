...
public class ListSubmitRequirementTemplatesTest {
  ...
  public void skipUnreadableParentProject() throws Exception {
    ...
    PermissionBackend.ForProject currentPermissions =
    ...
    ProjectState parentProjectState =
        currentProjectState.treeInOrder().iterator().next();

    PermissionBackend.ForProject parentPermissions =
        mock(PermissionBackend.ForProject.class);
  ...
  @Test
  public void returnsCurrentProjectTemplatesWhenParentIsUnreadable()
      throws Exception {
    SubmitRequirement parentTemplate =
        SubmitRequirement.builder()
            .setName("Parent-Template")
