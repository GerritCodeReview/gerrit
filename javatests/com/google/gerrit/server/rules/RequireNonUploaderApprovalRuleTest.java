...
public class RequireNonUploaderApprovalRuleTest {
  ...
  public void filtersByLabel() {
    ...
    Collection<PatchSetApproval> filteredApprovals =
        RequireNonUploaderApprovalRule.getNonUploaderApprovalsForLabel(
            ImmutableList.of(approvalVerified, approvalCr), codeReview, USER2);
  ...
  public void filtersVotesFromUser() {
    ...
    Collection<PatchSetApproval> filteredApprovals =
        RequireNonUploaderApprovalRule.getNonUploaderApprovalsForLabel(approvals, VERIFIED, USER1);
