...
public class AllProjectsCreatorTest extends GerritBaseTests {
  ...
  public void createDefaultAllProjectsConfig() throws Exception {
    ...
    AllProjectsInput allProjectsInput =
        AllProjectsInput.builderWithDefaults()
  ...
  private String getDefaultAllProjectsWithAllDefaultSections() {
    return String.join(
        "\n",
  ...
  public void createAllProjectsWithNewCodeReviewLabel() throws Exception {
    ...
    AllProjectsInput allProjectsInput =
        AllProjectsInput.builderWithDefaults().codeReviewLabel(TEST_LABEL).build();
    allProjectsCreator.create(allProjectsInput);
  ...
  @Test
  public void createAllProjectsWithAdditionalLabels() throws Exception {
    Config expectedLabelConfig = new Config();
    expectedLabelConfig.fromText(
        TEST_LABEL_STRING + "\n" + String.join("\n", DEFAULT_ALL_PROJECTS_LABEL_SECTION));

    AllProjectsInput allProjectsInput =
        AllProjectsInput.builderWithDefaults()
            .additionalLabelType(ImmutableList.of(TEST_LABEL))
            .build();
    allProjectsCreator.create(allProjectsInput);
  ...
  public void createAllProjectsWithProjectDescription() throws Exception {
    ...
    AllProjectsInput allProjectsInput =
        AllProjectsInput.builderWithDefaults().projectDescription(testDescription).build();
    allProjectsCreator.create(allProjectsInput);
  ...
  private Config readAllProjectsConfig() throws IOException, ConfigInvalidException {
    try (Repository repo = repoManager.openRepository(allProjectsName);
      ...
      return new BlobBasedConfig(null, repo, commit.getTree(), "project.config");
    }
  }
