...
public class AllProjectsCreatorTest extends GerritBaseTests {
  ...
  @Inject
  private AllProjectsCreator allProjectsCreator;
  ...
  private static String getDefaultAllProjectsWithAllDefaultSections() {
    return Streams.stream(Iterables.concat(DEFAULT_ALL_PROJECTS_PROJECT_SECTION,
        ...
        DEFAULT_ALL_PROJECTS_LABEL_SECTION)).collect(Collectors.joining("\n"));
  }
