...
public class Schema_166_to_167_WithGroupsInNoteDbTest {
  ...
  public void unwrapDb() {
    // We must unwrap the ReviewDb to remove DisallowReadFromGroupsReviewDbWrapper,
    // otherwise we can't read groups from ReviewDb.
    db = ReviewDbWrapper.unwrapReviewDb(db);
  }
