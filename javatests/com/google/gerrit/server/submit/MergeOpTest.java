...
public class MergeOpTest {
  ...
  public void submitAsPermissionDenied() throws Exception {
    when(forChange.test(EnumSet.of(ChangePermission.READ, ChangePermission.SUBMIT)))
    ...
    assertThat(problems.get(0).getProblem()).contains("Insufficient permission to submit change");
  }
