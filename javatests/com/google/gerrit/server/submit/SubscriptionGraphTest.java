...
public class SubscriptionGraphTest {
  ...
  public void oneSuperprojectOneSubmodule() throws Exception {
    SubscriptionGraph.Factory factory = new DefaultFactory(mockGitModulesFactory);
    SubscriptionGraph subscriptionGraph =
        factory.compute(ImmutableSet.of(SUB_BRANCH), mockProjectCache, mergeOpRepoManager);
