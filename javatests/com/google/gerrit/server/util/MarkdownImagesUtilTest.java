...
public class MarkdownImagesUtilTest {
  ...
  private static final String IMAGE_DATA = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mP8z8BQDwAEhQGAhKmMIQAAAABJRU5ErkJggg==";
  ...
  public void stripImages_featureEnabled() {
    ...
    assertThat(util.stripImages("Hello " + MARKDOWN_IMAGE + " world"))
