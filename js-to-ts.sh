...
rulesdir=${rootdir}/tools/js/eslint-rules

echo "Fixing files: Step 1:"
node ${rootdir}/node_modules/eslint/bin/eslint.js ${allTsFiles[@]} --fix --rulesdir $rulesdir

echo "Fixing files: Step 2:"
node ${rootdir}/node_modules/eslint/bin/eslint.js ${allTsFiles[@]} --fix --rulesdir $rulesdir --rule "polymer-element:2"
