...
c;a:{var e=a.className+" ";e+=a.parentNode?a.parentNode.className:"";if(c=P.exec(e))c=z(c[1])?c[1]:"no-highlight";else{e=e.split(/\s+/);c=0;for(b=e.length;c<b;c++){var d=e[c];if(K.test(d)||z(d)){c=d;break a}}c=void 0}}if(!K.test(c)){t.useBR?(d=document.createElementNS("http://www.w3.org/1999/xhtml","div"),d.innerHTML=a.innerHTML.replace(/\n/g,"").replace(/<br[ \/]*>/g,"\n")):d=a;b=d.textContent;e=c?C(c,b,!0):F(b);d=q(d);if(d.length){var l=document.createElementNS("http://www.w3.org/1999/xhtml","div");
l.innerHTML=e.value;e.value=L(d,q(l),b)}e.value=I(e.value);a.innerHTML=e.value;b=a.className;c=c?G[c]:e.language;d=[b.trim()];b.match(/\bhljs\b/)||d.push("hljs");-1===b.indexOf(c)&&d.push(c);c=d.join(" ").trim();a.className=c;a.result={language:e.language,re:e.relevance};e.second_best&&(a.second_best={language:e.second_best.language,re:e.second_best.relevance})}}function u(){if(!u.called){u.called=!0;var a=document.querySelectorAll("pre code");H.forEach.call(a,J)}}function z(a){a=(a||"").toLowerCase();
