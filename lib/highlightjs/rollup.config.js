...
// export default {
module.exports = {
  // external: ['highlight.js', 'highlightjs-epp', 'highlightjs-closure-templates', 'highlightjs-structured-text', 'highlightjs-vue'],
  onwarn: warning => {
  ...
  plugins: [
    nodeResolve({
      customResolveOptions: {
        moduleDirectories: ['external/ui_npm/node_modules']
      }
    }),
    cjs(),
  ]
