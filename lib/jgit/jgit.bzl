...
JGIT_SRC_COMMIT_SHA1 = "8cd07cb8157eec75099cb93c25d6daa9d5e6e0bc"
JGIT_SRC_ARCHIVE_SHA256 = "49d300977bd26384206aeb6aeec11b35c0e9dfcfd5b244e99266a21d9d8e3aa9"
...
def jgit_repos():
    ...
    elif JGIT_SRC_COMMIT_SHA1:
        http_archive(
            name = "jgit",
            strip_prefix = "jgit-" + JGIT_SRC_COMMIT_SHA1,
            sha256 = JGIT_SRC_ARCHIVE_SHA256,
            urls = [
                "https://github.com/eclipse/jgit/archive/" + JGIT_SRC_COMMIT_SHA1 + ".tar.gz",
            ],
        )
        jgit_maven_transitive_deps()
    else:
...
def jgit_dep(name):
    ...
    if LOCAL_JGIT_REPO or JGIT_SRC_COMMIT_SHA1:
        return mapping[name]
    else:
        return name
