...
_JGIT_VERS = "5.4.0.201906121030-r"
...
def jgit_repos():
    if LOCAL_JGIT_REPO:
        ...
        http_archive(
            ...
            sha256 = "76cd64959b81b0aa782a11b73adca6080a8f5561089b2a2e7785490d6021d1ae",
            urls = [
                "https://github.com/eclipse/jgit/archive/v" + _JGIT_VERS + ".tar.gz",
            ],
        )
    jgit_maven_repos()
