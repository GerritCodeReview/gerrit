...
## <a id="no-default-export"></a>No default export
...
## <a id="destructuring-imports-only"></a>Use destructuring imports only

Never use star import (`import * as ... from '...'`) or default import (`import x from '...'`). Instead use destructuring import
statement and specify all required names explicitly (e.g. `import {a,b,c} from '...'`).

**Note:** It is not always possible to use destructuring imports with 3rd-party libraries if a 3rd-party library
