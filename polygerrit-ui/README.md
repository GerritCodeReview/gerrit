...
If you would like to enable headless mode in chrome, which is required when you doin't
have a display, do the following:

```
export BROWSER_OPTIONS=[\'start-maximized\',\'headless\',\'disable-gpu\',\'no-sandbox\']
```
