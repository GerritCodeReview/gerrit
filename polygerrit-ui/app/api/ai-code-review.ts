 ...
 */
import {TextRange} from './diff';
import {ChangeInfo, CommentSide} from './rest-api';
...
export declare interface ChatResponse {
  ...
  /** The citations that were used to generate the response */
  citations: string[];
}
...
export declare interface CreateCommentAction {
  /** The path of the file to create the comment in. */
  path?: string;
  /**
   * The range of the comment. If not set - this is a file-level comment (or
   * a change-level comment if the file is not set).
   */
  range?: TextRange;
  /** The text of the comment. */
  comment_text?: string;
  /** The patchset number to create the comment on. */
  patchset?: number;
  /** The side of the diff to comment on. Defaults to REVISION. */
  side?: CommentSide;
}
...
/**
 * The data sent by the client to the backend. It is stored in spanner and
...
export declare interface ContextItemType {
  /** The id of the context item type. */
  id: string;
  /** The name of the context item type. */
  name: string;
  /** The icon of the context item type. */
  icon: string;
  /**
...
export declare interface AiCodeReviewProvider {
   ...
   */
  getChatConversation?(change: ChangeInfo, conversation_id: string):
