...
export interface ChangeActionsPluginApi {
  ...
  setActionPriority(type: ActionType, key: string, priority: ActionPriority): void;
  ...
  addTapListener(key: string, handler: EventListenerOrEventListenerObject): void;

  removeTapListener(key: string, handler: EventListenerOrEventListenerObject): void;
