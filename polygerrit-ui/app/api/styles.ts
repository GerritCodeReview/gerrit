 ...
 *
 * Plugins that use Lit can cast to CSSResult.
 *
 * Non-Lit plugins can call
 * But in order to also support LitElements we also have to explicitly export
 * CSSResult, because Lit's css`` only accepts constants, not arbitrary strings.
 */

/** Lit plugins can cast this to CSSResult */
