...
export class GrAccessSection extends LitElement {
      ...
      >
        <div id="mainContainer">
          <div class="header">
            <div class="name">
              <h3 class="heading-3">
                ${this._computeSectionName(this.section?.id)}
              </h3>
              <gr-button
                id="editBtn"
                link=""
        ...
        <div id="deletedContainer">
          <span>${this._computeSectionName(this.section?.id)} was deleted</span>
  ...
  _computeSectionName(name?: GitRef) {
  ...
  private isEditEnabled() {
    return this.canUpload || (this.ownerOf && this.ownerOf.indexOf(this.section!.id) >= 0);
  }
