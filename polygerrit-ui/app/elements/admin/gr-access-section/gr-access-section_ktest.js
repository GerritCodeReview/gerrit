...
const testFixtureContainer = document.createElement('test-fixture');
testFixtureContainer.setAttribute('id', 'basic');

// testFixtureContainer.innerHTML = `
...
//     </test-fixture>
// `;
// document.head.appendChild(testFixtureContainer);
