  ...
  suite('interactive tests', () => {
    ...
    suite('Non-global section', () => {
      ...
      test('add permission', async () => {
        ...
        MockInteractions.tap(queryAndAssert<GrButton>(element, '#addBtn'));
        await element.updateComplete;
      ...
      test('remove section', async () => {
        ...
        queryAndAssert<GrButton>(element, '#deleteBtn');
        MockInteractions.tap(queryAndAssert<GrButton>(element, '#deleteBtn'));
        await element.updateComplete;
        ...
        MockInteractions.tap(
          queryAndAssert<GrButton>(element, '#undoRemoveBtn')
        );
        await element.updateComplete;
        assert.isFalse(element.deleted);
        assert.isNotOk(element.section!.value.deleted);
