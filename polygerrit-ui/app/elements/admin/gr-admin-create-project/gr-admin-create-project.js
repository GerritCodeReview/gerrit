    ...
    _CreateProject() {
     // if (!this.project) { return Promise.resolve(); }
      ...
      promises.push(this.$.restAPI.getProjectConfig(this.project).then(
       ...
       this._projectConfig = [];
    //  if (typeof this._projectConfig === 'undefined' && typeof this._projectConfig.parent === 'undefined') {
        this._projectConfig.parent = 'All-Projects';
     // }

   //   if (typeof this._projectConfig === 'undefined' && typeof this._projectConfig.create_empty_commit === 'undefined') {
        this._projectConfig.create_empty_commit = false;
   //   }

    //  if (typeof this._projectConfig === 'undefined' && typeof this._projectConfig.permissions_only === 'undefined') {
