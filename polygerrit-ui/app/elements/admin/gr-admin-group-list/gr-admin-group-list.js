...
(function() {
  ...
  Polymer({
    ...
    _paramsChanged(value) {
      ...
      return this.$.restAPI.getGroups(this._groupsPerPage, this._offset)
          .then(groups => {
            if (!groups) {
              this._groups = [];
              return;
    ...
    _computeNavLink(offset, direction, groupsPerPage) {
    ...
    _handleNextPage() {
      ...
      page.show(this._computeNavLink(
          this._offset, 1, this._groupsPerPage));
    },
