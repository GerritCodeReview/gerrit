...
export class GrAdminGroupList extends LitElement {
        ...
        >
          ...
          <div class="main" slot="main">
            <gr-create-group-dialog
              id="createNewModal"
              @new-group-name=${this.handleHasNewGroupName}
            ></gr-create-group-dialog>
          </div>
        </gr-dialog>
      </gr-overlay>
  ...
  maybeOpenCreateOverlay(params?: AppElementAdminParams) {
    if (params?.openCreateModal) {
      assertIsDefined(this.createOverlay, 'createOverlay should exist');
  ...
  // private but used in test
  handleCreateGroup() {
    assertIsDefined(this.createNewModal, 'createNewModal should exist');
