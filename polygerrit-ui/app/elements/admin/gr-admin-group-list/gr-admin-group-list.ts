...
export class GrAdminGroupList extends LitElement {
  ...
  @state() private newGroupName = false;
        ...
        >
          ...
          <div class="main" slot="main">
            <gr-create-group-dialog
              id="createNewModal"
              @new-group-name=${this.handleNewGroupName}
            ></gr-create-group-dialog>
          </div>
        </gr-dialog>
      </gr-overlay>
  ...
  private handleNewGroupName() {
    this.newGroupName = !!this.createNewModal.name;
  }
}
