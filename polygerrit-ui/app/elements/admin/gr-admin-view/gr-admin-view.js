...
(function() {
  ...
  Polymer({
    ...
    _paramsChanged(params) {
      ...
      this.set('_showGroupAuditLog', isGroupView && params.detail === 'log');
      this.set('_showGroupMembers', isGroupView && params.detail === 'members');

      this.set('_showGroupList', isAdminView &&
          prams.adminView === 'gr-admin-group-list');
