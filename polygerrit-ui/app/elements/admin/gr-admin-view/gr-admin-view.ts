...
export class GrAdminView extends LitElement {
  ...
  private renderGroupMembers() {
    ...
    return html`
      <div class="main breadcrumbs">
        <gr-group-members .groupId=${(this.params as AppElementGroupParams).groupId}></gr-group-members>
      </div>
    `;
  }
  ...
  private renderRepoCommands() {
    ...
    return html`
      <div class="main breadcrumbs">
        <gr-repo-commands .repo=${(this.params as AppElementRepoParams).repo}></gr-repo-commands>
      </div>
    `;
  }
  ...
  private renderRepoDashboards() {
    ...
    return html`
      <div class="main table breadcrumbs">
        <gr-repo-dashboards .repo=${(this.params as AppElementRepoParams).repo}></gr-repo-dashboards>
      </div>
    `;
  }
  ...
  _paramsChanged() {
    ...
    this._showRepoList =
      this.params.view === GerritView.ADMIN && this.params.adminView === 'gr-repo-list';

    this._showPluginList =
      this.params.view === GerritView.ADMIN && this.params.adminView === 'gr-plugin-list';
