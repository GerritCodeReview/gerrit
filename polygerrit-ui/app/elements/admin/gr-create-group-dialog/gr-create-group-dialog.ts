...
export class GrCreateGroupDialog extends LitElement {
  @query('md-outlined-text-field') private input!: HTMLInputElement;
          ...
          <section>
            ...
            <div class="value-flex">
              <span class="value">
                <gr-select
                  id="visibleToAll"
                  .bindValue=${this.visibleToAll}
                  @bind-value-changed=${(e: ValueChangedEvent<boolean>) => {
                    this.visibleToAll = e.detail.value;
                  }}
                >
                  <select>
