...
(function() {
  ...
  Polymer({
    ...
    _loadGroup() {
      ...
      this.$.restAPI.getGroupConfig(this.groupId).then(
          config => {
            ...
            this.fire('name-changed', {name: config.name});
            this._loading = false;
    ...
    _handleSaveName() {
      return this.$.restAPI.saveGroupConfig('name', this.groupId,
    ...
    _handleSaveOwner() {
      return this.$.restAPI.saveGroupConfig('owner', this.groupId,
    ...
    _handleSaveDescription() {
      return this.$.restAPI.saveGroupConfig('description', this.groupId,
    ...
    _handleSaveOptions() {
      return this.$.restAPI.saveGroupConfig('options', this.groupId,
