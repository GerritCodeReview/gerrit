...
(function() {
  ...
  Polymer({
    ...
    _handleNotifyTypeCheckboxChange(e) {
      ...
      this.set(['section', 'notification_types', key], !!checked);
      this.hasUnsavedChanges = true;
    },

    _computeNotificationCheckboxChecked(notificationTypesChanges, key) {
      return !!notificationTypesChanges.base[key];
    },
