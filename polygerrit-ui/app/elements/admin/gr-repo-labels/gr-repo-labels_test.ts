...
suite('gr-repo-labels tests', () => {
  ...
  suite('labels table', () => {
            ...
            <table class="genericList" id="list">
              ...
              <tbody id="labels">
                <tr class="table">
                  ...
                  <td class="values">
                    {" 0":"No score","-1":"I would prefer this is not submitted
                    as is","-2":"This shall not be submitted","+1":"Looks good
                    to me, but someone else must approve","+2":"Looks good to
                    me, approved"}
                  </td>
                </tr>
              </tbody>
            ...
            <table class="genericList" id="list">
              ...
              <tbody id="labels">
                <tr class="table">
                  ...
                  <td class="branches">refs/heads/main</td>
                  <td class="values">
                    {" 0":"No score","-1":"I would prefer this is not submitted as is","-2":"This shall not be submitted","+1":"Looks good to me, but someone else must approve","+2":"Looks good to me, approved"}
                  </td>
                  <td class="actions">
                    <gr-button
                      aria-disabled="false"
                ...
                <div class="gr-form-styles">
                  <div id="form">
                    ...
                    <section>
                      ...
                      <div class="value-flex">
                        <span class="value">
                          <textarea id="branches" rows="4"></textarea>
                        </span>
                      </div>
                    </section>
                    <section>
    ...
    test('open edit dialog', async () => {
      ...
      const valuesTextarea = queryAndAssert<HTMLTextAreaElement>(
        element,
        '#values'
      );
      assert.equal(
