...
class GrRepoPluginConfig extends GestureEventListeners(
  ...
  _pluginConfigOptions!: PluginOption[];
  ...
  _handleArrayChange(e: {detail: PluginConfigOptionsChangedEventDetail}) {
