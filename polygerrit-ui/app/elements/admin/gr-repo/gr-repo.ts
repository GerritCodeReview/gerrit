...
export class GrRepo extends LitElement {
    ...
    return html`
      <div class="main gr-form-styles read-only">
        <div class="info">
          ...
          <hr />
          <div>
            <a href=${this.getWebLink(this.webLinks, this.serverConfig)?.url}
              ><gr-button link ?disabled=${this.getWebLink(this.webLinks, this.serverConfig)?.url}
                >Browse</gr-button
              ></a
  ...
  private getWebLink(weblinks?: WebLinkInfo[], serverConfig?: ServerInfo) {
    return getRepoWeblink(weblinks, serverConfig);
  }
