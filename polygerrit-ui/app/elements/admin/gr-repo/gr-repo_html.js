  ...
  <main class="gr-form-styles read-only">
    ...
    <div id="loadedContent" class$="[[_computeLoadingClass(_loading)]]">
      <div id="downloadContent" class$="[[_computeHideClass(_schemes)]]">
        <h2 id="download" class="font-h2">Download</h2>
        <fieldset>
      ...
      <h2
        id="configurations"
        class$="font-h2 [[_computeHeaderClass(_configChanged)]]"
      >
        Configurations
      </h2>
      <div id="form">
        <fieldset>
          <h3 id="Description" class="font-h3">Description</h3>
          <fieldset>
          ...
          <h3 id="Options" class="font-h3">Repository Options</h3>
          <fieldset id="options">
            <section>
          ...
          <h3 id="Options" class="font-h3">Contributor Agreements</h3>
