...
suite('gr-change-list-bulk-flow tests', () => {
  ...
  test('computeCommonLabels', async () => {
    sinon.stub(element, 'computeLabels').callsFake((change: ChangeInfo) => {
      if (change._number === (1 as NumericChangeId)) {
        return [
          {name: 'a', value: null},
          {name: 'b', value: null},
          {name: 'c', value: null},
      ...
      if (change._number === (2 as NumericChangeId)) {
        return [
          {name: 'b', value: null},
          {name: 'c', value: null},
          {name: 'd', value: null},
      ...
      if (change._number === (3 as NumericChangeId)) {
        return [
          {name: 'c', value: null},
          {name: 'd', value: null},
          {name: 'e', value: null},
