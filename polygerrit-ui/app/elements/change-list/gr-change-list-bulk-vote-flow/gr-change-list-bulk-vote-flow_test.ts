        ...
        <gr-dialog role="dialog">
          <div slot="main">
            <div class="newSubmitRequirements scoresTable">
              ...
              <gr-label-score-row class="access" name="a"> </gr-label-score-row>
              <gr-label-score-row class="access" name="b"> </gr-label-score-row>
              <gr-label-score-row class="access" name="c"> </gr-label-score-row>
            </div>
          </div>
        </gr-dialog>
      </gr-overlay> `);
