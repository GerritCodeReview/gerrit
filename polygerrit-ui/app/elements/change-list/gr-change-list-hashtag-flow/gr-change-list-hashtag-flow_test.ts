        ...
        /* HTML */ `
          ...
          >
            <div slot="dropdown-content">
              <div class="chips">
                <button role="listbox" aria-label="hashtag1" class="chip">
                  hashtag1
                </button>
                <button role="listbox" aria-label="sharedHashtag" class="chip">
                  sharedHashtag
                </button>
                <button role="listbox" aria-label="hashtag2" class="chip">
                  hashtag2
                </button>
              </div>
              <gr-autocomplete
