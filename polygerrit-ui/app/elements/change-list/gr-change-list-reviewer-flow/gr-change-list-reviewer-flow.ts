...
export class GrChangeListReviewerFlow extends LitElement {
  ...
  private renderOverwriteWarnings() {
    return html`
      ${this.renderOverwriteWarning(ReviewerState.REVIEWER)}
      ${this.renderOverwriteWarning(ReviewerState.CC)}
    `;
  }

  private renderOverwriteWarning(currentReviewerState: ReviewerState) {
