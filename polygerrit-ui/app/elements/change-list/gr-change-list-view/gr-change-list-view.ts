...
export interface ViewStateChangeEventDetail {
  value: ChangeListViewState;
}
export type ViewStateChangeEvent = CustomEvent<ViewStateChangeEventDetail>;
...
declare global {
  interface HTMLElementEventMap {
    'view-state-changed': ViewStateChangeEvent;
  }
