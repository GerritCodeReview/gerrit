...
import {ColumnNames, LABELS_COLUMN_KEY, ScrollMode} from '../../../constants/constants';
import {
  getRequirements,
...
export class GrChangeList extends LitElement {
  ...
  private computeVisibleChangeTableColumns() {
    ...
    if (this.loggedInUser && this.preferences) {
      ...
      this.showLabels = rawChangeTable.length === 0 || rawChangeTable.includes(LABELS_COLUMN_KEY);
    }
  }
