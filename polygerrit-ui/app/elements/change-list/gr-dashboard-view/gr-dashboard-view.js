...
(function() {
  ...
  const DEFAULT_SECTIONS = [
    ...
    },
    {
      ...
      // Non-WIP closed changes where viewed user is owner, reviewer, or
      // assignee. Changes ignored by the viewing user are filtered out, unless
      // owned by the viewing user (the one instance of 'owner:self' is
      // intended.
      query: 'is:closed -is:wip ((owner:${user} (owner:self OR -is:ignored)) ' +
          'OR ((reviewer:${user} OR assignee:${user}) -is:ignored))',
