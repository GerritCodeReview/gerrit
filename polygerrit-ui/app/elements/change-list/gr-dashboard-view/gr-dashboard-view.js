  ...
  _maybeSortResults(name, results) {
    ...
    if (name === 'Your Turn' && userId) {
      results.sort((c1, c2) => {
        ...
        // Should not never happen that an attention set entry has not update.
