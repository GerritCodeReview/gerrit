...
Polymer({
  _template: Polymer.html`
    ...
    <div hidden\$="[[_loading]]" hidden="">
      <gr-user-header user-id="[[params.user]]" class\$="[[_computeUserHeaderClass(params.user)]]"></gr-user-header>
      <gr-change-list show-star="" show-reviewed-state="" account="[[account]]" preferences="[[preferences]]" selected-index="{{viewState.selectedChangeIndex}}" sections="[[_results]]" on-toggle-star="_handleToggleStar" on-toggle-reviewed="_handleToggleReviewed"></gr-change-list>
    </div>
