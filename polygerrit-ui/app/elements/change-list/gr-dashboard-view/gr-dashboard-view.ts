...
export class GrDashboardView extends LitElement {
  ...
  async fetchDashboardChanges(
    ...
    if (isLoggedInUserDashboard) {
      ...
      // Determines whether to show the notifications prompt.
      // The prompt is shown if the user has created any changes
    ...
    // Determines whether to show the notifications prompt.
    // The prompt is shown if the user has any results in their attention set.
