...
suite('gr-dashboard-view tests', () => {
  ...
  suite('drafts banner functionality', () => {
    ...
    test('delete tap opens dialog', () => {
      ...
      queryAndAssert(element, '.banner .delete');
    ...
    test('delete comments flow', async () => {
      ...
      deleteStub.lastCall.returnValue.then(async () => {
        deleteDraftCommentsPromiseResolver(new Response());
