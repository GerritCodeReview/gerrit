  ...
  Polymer({
    ...
    _makeSuggestion(reviewer) {
      ...
      if (reviewer.account) {
        ...
        const reviewerName = reviewer.account.name ? reviewer.account.name :
            this._accountOrAnon(reviewer.account);
        ...
        const reviewerName = reviewer.name ? reviewer.name :
            this._accountOrAnon(reviewer);
