...
import {createParsedChange, createThread} from '../../../test/test-data-generators';
...
suite('gr-ai-prompt-dialog test', () => {
  ...
  test('renders resolve comments prompt', async () => {
    ...
    await element.updateComplete;
    assert.include(Reflect.get(element, 'promptContent') as string, 'No unresolved comments.');
  });
