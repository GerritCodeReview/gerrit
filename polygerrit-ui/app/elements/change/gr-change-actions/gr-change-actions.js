      ...
      for (var label in this.change.labels) {
        ...
        switch (status) {
          case LabelStatus.NEED:
            ...
            result = label;
            break;
          case LabelStatus.OK:  // Label already applied.
          case LabelStatus.MAY: // Label is not required.
            break;
          case LabelStatus.REJECT: // Submit blocked, do not quick approve.
          case LabelStatus.IMPOSSIBLE:
            return null;
        }
      }
      if (result) {
