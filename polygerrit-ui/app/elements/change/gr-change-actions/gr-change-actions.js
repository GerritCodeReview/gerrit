...
Polymer({
  _template: Polymer.html`
      ...
      <span id="actionLoadingMessage" hidden\$="[[!_actionLoadingMessage]]">
        ...
        <section id="primaryActions" hidden\$="[[_shouldHideActions(_topLevelActions.*, _loading)]]">
          <template is="dom-repeat" items="[[_topLevelPrimaryActions]]" as="action">
            <gr-button link="" title\$="[[action.title]]" has-tooltip="[[_computeHasTooltip(action.title)]]" data-action-key\$="[[action.__key]]" data-action-type\$="[[action.__type]]" data-label\$="[[action.label]]" disabled\$="[[_calculateDisabled(action, _hasKnownChainState)]]" on-tap="_handleActionTap">
    ...
    <gr-overlay id="overlay" with-backdrop="">
      <gr-confirm-rebase-dialog id="confirmRebase" class="confirmDialog" change-number="[[change._number]]" on-confirm="_handleRebaseConfirm" on-cancel="_handleConfirmDialogCancel" branch="[[change.branch]]" has-parent="[[hasParent]]" rebase-on-current="[[revisionActions.rebase.rebaseOnCurrent]]" hidden=""></gr-confirm-rebase-dialog>
      ...
      <gr-confirm-submit-dialog id="confirmSubmitDialog" class="confirmDialog" change="[[change]]" action="[[revisionActions.submit]]" on-cancel="_handleConfirmDialogCancel" on-confirm="_handleSubmitConfirm" hidden=""></gr-confirm-submit-dialog>
