  ...
  Polymer({
    ...
    observers: [
      '_actionsChanged(actions.*, revisionActions.*, _additionalActions.*, ' +
          'editLoaded, patchNum, hasRebaseEdit, change)',
    ],
    ...
    _actionsChanged(actionsChangeRecord, revisionActionsChangeRecord,
        additionalActionsChangeRecord, editLoaded, patchNum, hasRebaseEdit,
        change) {
      ...
      if (patchNum && !revisionActions.rebase) {
        this.reload();
      }
