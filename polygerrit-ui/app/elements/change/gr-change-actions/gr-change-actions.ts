  ...
  implements GrChangeActionsElement
{
  ...
  _getTopMissingApproval() {
    ...
    const codeReviewLabel = this.change.labels[STANDARD_LABELS.CODE_REVIEW];
    const codeReviewPermittedValues =
      this.change.permitted_labels[STANDARD_LABELS.CODE_REVIEW];
    if (
      !result &&
      codeReviewLabel &&
      ...
      result = STANDARD_LABELS.CODE_REVIEW;
    }
