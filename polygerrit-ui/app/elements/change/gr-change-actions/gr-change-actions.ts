...
function ensureUIActionInfo(action?: ActionInfo): UIActionInfo {
...
export class GrChangeActions extends GestureEventListeners(
  ...
  _getLabelStatus(label: LabelInfo) {
    ...
    switch (type) {
      ...
      default:
        this._fireAction(
          ...
          ensureUIActionInfo(this.actions[key]),
          false
        );
    }
  }
  ...
  _handleRevisionAction(key: string) {
    switch (key) {
      ...
      default:
        this._fireAction(
          this._prependSlash(key),
          ensureUIActionInfo(this.revisionActions[key]),
          true
        );
    }
  }
  ...
  _handleRebaseConfirm(e: CustomEvent<ConfirmRebaseEventDetail>) {
    ...
    this._fireAction(
      '/rebase',
      ensureUIActionInfo(this.revisionActions.rebase),
      true,
      payload
    );
  }
  ...
  _handleCherryPickRestApi(conflicts: boolean) {
    ...
    this._fireAction(
      '/cherrypick',
      ensureUIActionInfo(this.revisionActions.cherrypick),
      true,
      {
  ...
  _handleMoveConfirm() {
    ...
    this.$.overlay.close();
    el.hidden = true;
    this._fireAction('/move', ensureUIActionInfo(this.actions.move), false, {
  ...
  _handleRevertDialogConfirm(e: CustomEvent<ConfirmRevertEventDetail>) {
    ...
    switch (revertType) {
      case REVERT_TYPES.REVERT_SINGLE_CHANGE:
        this._fireAction(
          '/revert',
          ensureUIActionInfo(this.actions.revert),
          false,
          {message}
        );
        break;
      case REVERT_TYPES.REVERT_SUBMISSION:
        this._fireAction(
          '/revert_submission',
          ensureUIActionInfo(this.actions.revert_submission),
          false,
          {message}
        );
        break;
  ...
  _handleAbandonDialogConfirm() {
    ...
    this._fireAction(
      '/abandon',
      ensureUIActionInfo(this.actions.abandon),
      false,
      {
        message: el.message,
      }
  ...
  _handleDeleteConfirm() {
    this._fireAction(
      '/',
      ensureUIActionInfo(this.actions[ChangeActions.DELETE]),
      false
    );
  }
  ...
  _handleDeleteEditConfirm() {
    ...
    this._fireAction(
      '/edit',
      ensureUIActionInfo(this.actions.deleteEdit),
      false
    );
  }
  ...
  _handleSubmitConfirm() {
    ...
    this._fireAction(
      '/submit',
      ensureUIActionInfo(this.revisionActions.submit),
      true
    );
  }
  ...
  _showActionDialog(dialog: HTMLElement & {resetFocus?: () => void}) {
    this._hideAllDialogs();
  ...
  _setLabelValuesOnRevert(newChangeId: ChangeId | NumericChangeId) {
  ...
  _handleWipTap() {
    ...
    this._fireAction('/wip', ensureUIActionInfo(this.actions.wip), false);
  }
  ...
  _handlePublishEditTap() {
    ...
    this._fireAction(
      '/edit:publish',
      ensureUIActionInfo(this.actions.publishEdit),
      false,
      payload
    );
  }
  ...
  _handleRebaseEditTap() {
    ...
    this._fireAction(
      '/edit:rebase',
      ensureUIActionInfo(this.actions.rebaseEdit),
      false
    );
  }
   ...
   *
   */
  _waitForChangeReachable(changeNum: ChangeId | NumericChangeId) {
