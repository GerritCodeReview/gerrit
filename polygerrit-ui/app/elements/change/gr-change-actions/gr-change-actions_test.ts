  ...
  suite('basic tests', () => {
    ...
    test('_actionComparator sort order', () => {
      const actions = [
        ...
        {label: 'abc-ro', __type: ActionType.REVISION, __key: 'review'},
        {label: 'abc', __type: ActionType.CHANGE, __key: 'review'},
        {label: 'def', __type: ActionType.CHANGE, __key: 'review'},
        {
          label: 'def-p',
    ...
    test('_setReviewOnRevert', () => {
      ...
      const setReviewOnRevert = element._setReviewOnRevert(changeId);
      return setReviewOnRevert.then(() => {
    ...
    suite('quick approve', () => {
      ...
      test('hide quick approve', () => {
        ...
        flush();
        const approveButtonUpdated = queryAndAssert(
          element,
          "gr-button[data-action-key='review']"
        );
    ...
    suite('_send', () => {
      ...
      let onShowError: SinonStub;
      let onShowAlert: SinonStub;
      let getResponseObjectStub: SinonStub;
      ...
      suite('happy path', () => {
        ...
        suite('single changes revert', () => {
          let navigateToSearchQueryStub: SinonStub;
          setup(() => {
        ...
        suite('multiple changes revert', () => {
          let showActionDialogStub: SinonStub;
          let navigateToSearchQueryStub: SinonStub;
          setup(() => {
            getResponseObjectStub.returns(
              Promise.resolve({
    ...
    test('_handleAction reports', () => {
      sinon.stub(element, '_fireAction');
      sinon.stub(element, '_handleRevisionAction');
