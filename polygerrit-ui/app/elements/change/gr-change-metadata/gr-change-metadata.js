...
(function() {
  ...
  Polymer({
    ...
    /**
     * @return {Object} object representing data for the push validation.
     *     - class: the class to be applied to the icon
     *     - icon: the icon name from gr-icons
     *     - message: the tooltip for the icon
     */
