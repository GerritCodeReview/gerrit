    ...
    this.restApiService
      ...
      .then(newTopic => {
        ...
        if (newTopic !== lastTopic) {
          ...
          fireAlert(this, `Topic '${topic}' created.`);
        }
      });
  }
    ...
    this.restApiService
      ...
      .then(newHashtag => {
        if (this.change === change) {
          ...
          fireAlert(this, `Hashtag '${newHashtag}' created.`);
        }
      });
  }
    ...
    this.restApiService
      ...
      .then(() => {
        ...
        if (this.change === change) {
          ...
          this.requestUpdate();
          fireEvent(this, 'topic-changed');
          fireAlert(this, `Topic '${topic}' removed from change.`);
        }
      })
      .catch(() => {
        target.disabled = false;
    ...
    this.restApiService
      ...
      .then(newHashtags => {
        ...
        if (this.change === change) {
          ...
          fireAlert(this, `Hashtag '${target.text}' removed from change.`);
          this.requestUpdate();
        }
      })
      .catch(() => {
