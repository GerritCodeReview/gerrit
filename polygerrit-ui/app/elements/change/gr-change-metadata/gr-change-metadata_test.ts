...
suite('gr-change-metadata tests', () => {
  ...
  test('renders', () => {
    expect(element).shadowDom.to.equal(
      /* HTML */
      '<div>  <div class="metadata-header">    <h3 class="heading-3 metadata-title">      Change Info    </h3>    <gr-button      class="show-all-button"      link=""      role="button"      tabindex="0"    >      Show all      <iron-icon icon="gr-icons:expand-more">      </iron-icon>      <iron-icon        hidden="true"        icon="gr-icons:expand-less"      >      </iron-icon>    </gr-button>  </div>  <dom-if style="display: none;">    <template is="dom-if">    </template>  </dom-if>  <section class="hideDisplay">    <span class="title">      <gr-tooltip-content        has-tooltip=""        title="Last update of (meta)data for this change."      >        Updated      </gr-tooltip-content>    </span>    <span class="value">      <gr-date-formatter        showyesterday=""        withtooltip=""      >      </gr-date-formatter>    </span>  </section>  <section>    <span class="title">      <gr-tooltip-content        has-tooltip=""        title="This user created or uploaded the first patchset of this change."      >        Owner      </gr-tooltip-content>    </span>    <span class="value">      <gr-account-chip highlightattention="">        <dom-if style="display: none;">          <template is="dom-if">          </template>        </dom-if>      </gr-account-chip>      <dom-if style="display: none;">        <template is="dom-if">        </template>      </dom-if>    </span>  </section>  <section class="hideDisplay">    <span class="title">      <gr-tooltip-content        has-tooltip=""        title="This user uploaded the patchset to Gerrit (typically by running the \'git push\' command)."      >        Uploader      </gr-tooltip-content>    </span>    <span class="value">      <gr-account-chip highlightattention="">        <dom-if style="display: none;">          <template is="dom-if">          </template>        </dom-if>      </gr-account-chip>    </span>  </section>  <section class="hideDisplay">    <span class="title">      <gr-tooltip-content        has-tooltip=""        title="This user wrote the code change."      >        Author      </gr-tooltip-content>    </span>    <span class="value">      <gr-account-chip>        <dom-if style="display: none;">          <template is="dom-if">          </template>        </dom-if>      </gr-account-chip>    </span>  </section>  <section class="hideDisplay">    <span class="title">      <gr-tooltip-content        has-tooltip=""        title="This user committed the code change to the Git repository (typically to the local Git repo before uploading)."      >        Committer      </gr-tooltip-content>    </span>    <span class="value">      <gr-account-chip>        <dom-if style="display: none;">          <template is="dom-if">          </template>        </dom-if>      </gr-account-chip>    </span>  </section>  <section>    <span class="title">      Reviewers    </span>    <span class="value">      <gr-reviewer-list reviewers-only="">      </gr-reviewer-list>    </span>  </section>  <section class="hideDisplay">    <span class="title">      CC    </span>    <span class="value">      <gr-reviewer-list ccs-only="">      </gr-reviewer-list>    </span>  </section>  <dom-if style="display: none;">    <template is="dom-if">    </template>  </dom-if>  <dom-if style="display: none;">    <template is="dom-if">    </template>  </dom-if>  <section class="hideDisplay">    <span class="title">    </span>    <span class="value">      <ol>        <dom-repeat          as="parent"          style="display: none;"        >          <template is="dom-repeat">          </template>        </dom-repeat>      </ol>    </span>  </section>  <dom-if style="display: none;">    <template is="dom-if">    </template>  </dom-if>  <dom-if style="display: none;">    <template is="dom-if">    </template>  </dom-if>  <dom-if style="display: none;">    <template is="dom-if">    </template>  </dom-if>  <dom-if style="display: none;">    <template is="dom-if">    </template>  </dom-if>  <section class="hideDisplay strategy">    <span class="title">      Strategy    </span>    <span class="value">    </span>  </section>  <section class="hashtag hideDisplay">    <span class="title">      Hashtags    </span>    <span class="value">      <dom-repeat style="display: none;">        <template is="dom-repeat">        </template>      </dom-repeat>      <dom-if style="display: none;">        <template is="dom-if">        </template>      </dom-if>    </span>  </section>  <dom-if style="display: none;">    <template is="dom-if">    </template>  </dom-if>  <dom-if style="display: none;">    <template is="dom-if">    </template>  </dom-if>  <section id="webLinks">    <span class="title">      Links    </span>    <span class="value">      <dom-repeat        as="link"        style="display: none;"      >        <template is="dom-repeat">        </template>      </dom-repeat>    </span>  </section>  <gr-endpoint-decorator name="change-metadata-item">    <gr-endpoint-param name="labels">    </gr-endpoint-param>    <gr-endpoint-param name="change">    </gr-endpoint-param>    <gr-endpoint-param name="revision">    </gr-endpoint-param>  </gr-endpoint-decorator></div>'
    );
  });
