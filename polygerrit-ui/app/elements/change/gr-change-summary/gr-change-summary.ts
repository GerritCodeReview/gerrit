    ...
    return [
      ...
      css`
        ...
        .summaryChip.warning:hover {
          background: var(--hover-overlay), var(--warning-background);
        }
        ...
        .summaryChip.check:hover {
          background: var(--hover-overlay), var(--gray-background);
        }
    ...
    return [
      ...
      css`
        ...
        .checksChip.error:hover {
          background: var(--hover-overlay), var(--error-background);
        }
        ...
        .checksChip.info-outline:hover {
          background: var(--hover-overlay), var(--info-background);
        }
        ...
        .checksChip.check-circle-outline:hover {
          background: var(--hover-overlay), var(--success-background);
        }
