...
(function() {
  ...
  Polymer({
    ...
    /**
     * We use an observer to observer 'change' and 'selectedRevision'
     * variables. This fixes an issue under Polymer 2 so that the dynamic plugins
     * loads when these variables load.
     */
    _loadDynamicTabHeaderAndContent(change, selectedRevision) {
      ...
      Gerrit.awaitPluginsLoaded().then(() => {
        ...
        // This is to get it to select the primary tab after
        // the plugins have loaded.
      }).then(() => this._performPostLoadTasks());
    },
