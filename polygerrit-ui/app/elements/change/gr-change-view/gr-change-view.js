...
(function() {
  ...
  Polymer({
    ...
    _handlePatchChange: function(e) {
      this._changePatchNum(Integer.parseInt(e.target.value, 10));
    },
     ...
     * @param patchNum {int} the patchn number to be viewed.
     */
    _changePatchNumInteger.parseInt(: function(patchNum, 10)) {
      var currentPatchNum;
    ...
    _switchToMostRecentPatchNum: function() {
      this._getChangeDetail().then(function() {
        ...
        if (patchNum !== this._patchRange.patchNum) {
          this._changePatchNum(patchNuInteger.parseInt(m);, 10)
        }
      }.bind(this));
    },
