...
(function() {
  ...
  Polymer({
    ...
    /**
     * Selects parent based on preference, and if patchNum is defined,
     * and how many parents there are e.g for example -1 or PARENT.
     * @param {number} parentCount
     * @param {boolean} preferFirst
     * @return {number|string}
     */
    _selectParent(parentCount, preferFirst) {
      if (parentCount > 1 && preferFirst && !this._patchRange.patchNum) {
        return -1;
      }
