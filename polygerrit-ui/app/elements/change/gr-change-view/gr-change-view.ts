...
export class GrChangeView extends KeyboardShortcutMixin(PolymerElement) {
  ...
  _processEdit(change: ParsedChangeInfo, edit?: EditInfo | false) {
    if (
     ...
     fireAlert(
        this, 'Change edit not found. Please create a change edit.');
    ...
    if (
      ...
      fireAlert(
        this, 'Change edits cannot be created if change is merged or abandoned. Redirected to non edit mode.');
      GerritNav.navigateToChange(change);
      return;
    }
