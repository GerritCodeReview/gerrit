...
import {SelectionContext} from '../../../embed/diff/gr-selection-action-box/gr-selection-action-box';
        ...
        <div id="commitAndRelated">
          ...
          <div class="relatedChanges">
            <gr-related-changes-list
              @cherry-pick-chain-requested=${this.handleCherryPickChainRequested}
            ></gr-related-changes-list>
          </div>
