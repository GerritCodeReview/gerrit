...
export class GrChangeView extends LitElement {
  ...
  @query('gr-copy-links') private dropdown?: GrCopyLinks;
  ...
  private setupShortcuts() {
    ...
    this.shortcutsController.addAbstract(Shortcut.OPEN_COPY_LINKS_DIALOG, () =>
  ...
  private renderHeaderTitle() {
    ...
    return html` <div class="headerTitle">
      ...
      <gr-button
        ...
        flatten
        down-arrow
        @click=${() => this.dropdown?.toggleDropdown()}
        ><a
          class="changeNumber"
  ...
  private renderCopyLinkDropdown() {
