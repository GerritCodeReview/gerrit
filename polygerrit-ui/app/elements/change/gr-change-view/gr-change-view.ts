...
import '../../shared/gr-sidebar/gr-sidebar';
...
export class GrChangeView extends LitElement {
  ...
  @state()
  private activeSidebar?: Sidebar = Sidebar.CHAT;
  ...
  private renderMainContent() {
    return html`
      ${this.renderHeader()}
      <gr-sidebar .hideSide=${!this.activeSidebar}>
        <div slot="main">
  ...
  private toggleSidebar() {
    this.activeSidebar =
      this.activeSidebar === Sidebar.CHAT ? undefined : Sidebar.CHAT;
  }
  ...
  private renderHeaderTitle() {
    ...
    return html` <div class="headerTitle">
      ...
      <div class="changeStarContainer">
        ...
        <gr-button @click=${this.toggleSidebar}>Toggle Sidebar</gr-button>
      </div>
