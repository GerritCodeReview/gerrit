<<<<<<< PATCH SET (1a9aa32d4aef57a0204d4da99f7b2cf295d951cf Support custom actions in AI chat)
/**
 * @license
...
||||||| BASE      (af119b66aebf346720230ba295e9d4dd23c5c566 Fix file list layout when squeezed by chat panel)
/**
 * @license
 * Copyright 2025 Google LLC
 * SPDX-License-Identifier: Apache-2.0
...
import {testResolver} from '../../../test/common-test-setup';
import {stubRestApi, visualDiffDarkTheme, waitUntil} from '../../../test/test-utils';
import {GerritView} from '../../../services/router/router-model';
import {ChangeChildView} from '../../../models/views/change';
import {RepoName, RevisionPatchSetNum} from '../../../types/common';
import {AiCodeReviewProvider} from '../../../api/ai-code-review';
...
// ... imports
  ...
  test('screenshot with chat panel open', async () => {
    ...
    stubRestApi('getChangeOrEditFiles').returns(
      Promise.resolve(filesObject)
    );

    const files = Object.entries(filesObject).map(([path, info]) => normalize(info, path));
...
=======
>>>>>>> BASE      (a499c6eccd57b89fd0d04db8020f40c0022071e4 Merge "Relax regex for base64 images in comments")
