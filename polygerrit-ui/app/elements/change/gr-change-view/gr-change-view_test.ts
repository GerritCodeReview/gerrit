...
suite('gr-change-view tests', () => {
  ...
  suite('keyboard shortcuts', () => {
    ...
    test('fullscreen-overlay-opened hides content', () => {
      ...
      const dialog = queryAndAssert<GrReplyDialog>(this, '#replyDialog');
  ...
  test(
    ...
    async () => {
      ...
      assert(
        openStub.lastCall.calledWithExactly(FocusTarget.BODY),
  ...
  suite('reply dialog tests', () => {
    setup(() => {
      const dialog = queryAndAssert<GrReplyDialog>(this, '#replyDialog');
      sinon.stub(dialog, '_draftChanged');
      element._change = {
        ...createChangeViewChange(),
        revisions: createRevisions(1),
        messages: createChangeMessages(1),
    ...
    test('reply from same comment preserves quote text', () => {
      ...
      dialog.draft = '> quote text\n\n some draft text';
      dialog.quote = '> quote text\n\n';
      const e = new CustomEvent('', {
        detail: {message: {message: 'quote text'}},
      });
      element._handleMessageReply(e);
