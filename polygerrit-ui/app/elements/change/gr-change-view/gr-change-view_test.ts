...
suite('gr-change-view tests', () => {
  ...
  suite('reply dialog tests', () => {
    ...
    test('reply from comment adds quote text', async () => {
      ...
      console.log(`dialog assert '${dialog.draft}' '${dialog.tagName}'`);
    ...
    test('reply from same comment preserves quote text', async () => {
      element._openReplyDialog();
      const dialog = await waitQueryAndAssert<GrReplyDialog>(
        element,
        '#replyDialog'
    ...
    test('reply from top of page contains previous draft', async () => {
      element._openReplyDialog();
