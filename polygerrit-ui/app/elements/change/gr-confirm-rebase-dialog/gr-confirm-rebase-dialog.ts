  ...
  implements ChangeActionDialog
{
  ...
  private renderContent() {
    const displayTipOption = this.displayTipOption();
    return html`
      <div
        id="rebaseOnParent"
        class="rebaseOption"
      ...
      <div id="rebaseOnTip" class="rebaseOption" ?hidden=${!displayTipOption}>
        <input
          id="rebaseOnTipInput"
          name="rebaseOptions"
          type="radio"
          ?disabled=${!displayTipOption}
        />
      ...
      <div id="tipUpToDateMsg" class="message" ?hidden=${displayTipOption}>
