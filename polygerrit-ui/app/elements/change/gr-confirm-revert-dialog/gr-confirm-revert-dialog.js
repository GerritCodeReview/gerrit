...
(function() {
  ...
  class GrConfirmRevertDialog extends Polymer.mixinBehaviors( [
    ...
    _populateRevertSingleChangeMessage(change, commitMessage, commitHash) {
      ...
      this._originalRevertMessage[REVERT_TYPES.REVERT_SINGLE_CHANGE] =
        this.message;
    }
    ...
    _populateRevertSubmissionMessage(change, changes) {
      ...
      this._originalRevertMessage[this._revertType] = this.message;
    ...
    _handleConfirmTap(e) {
      e.preventDefault();
      e.stopPropagation();
      if (this.message === this._originalRevertMessage[this._revertType]) {
