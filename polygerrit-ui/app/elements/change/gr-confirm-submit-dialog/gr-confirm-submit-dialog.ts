      ...
      return html`
        ...
        <div class="main" slot="main">
          <gr-endpoint-decorator name="confirm-submit-change">
            <p>
              Ready to submit
              “<strong>${this.change?.subject}</strong>”?
            </p>
            ...
            ${this.change?.unresolved_comment_count
              ? html`<p>
                  ...
                  <gr-thread-list
                    id="commentList"
                    .threads="${this._computeUnresolvedThreads(
                      this.commentThreads
                    )}"
                    .change="${this.change}"
              ...
              : ''}
            ${this._computeHasChangeEdit(this.change)
              ? html` <iron-icon
                    icon="gr-icons:warning"
                    class="warningBeforeSubmit"
                  ></iron-icon>
                  Your unpublished edit will not be submitted. Did you forget to
                  click
                  <b>PUBLISH</b>?`
              : ''}
            <gr-endpoint-param
