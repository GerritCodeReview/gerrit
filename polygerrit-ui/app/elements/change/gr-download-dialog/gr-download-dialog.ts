...
export class GrDownloadDialog extends PolymerElement {
  ...
  override connectedCallback() {
    ...
    this.cleanups.push(
      addShortcut(this, {key: '1'}, e => this._handleNumberKey(e))
    );
    this.cleanups.push(
      addShortcut(this, {key: '2'}, e => this._handleNumberKey(e))
    );
    this.cleanups.push(
      addShortcut(this, {key: '3'}, e => this._handleNumberKey(e))
    );
    this.cleanups.push(
      addShortcut(this, {key: '4'}, e => this._handleNumberKey(e))
    );
    this.cleanups.push(
      addShortcut(this, {key: '5'}, e => this._handleNumberKey(e))
    );
  }
