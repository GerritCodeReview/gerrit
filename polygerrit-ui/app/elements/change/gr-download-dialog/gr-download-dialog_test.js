...
suite('gr-download-dialog', () => {
  ...
  test('_computeHidePatchFile', () => {
    ...
    assert.isFalse(element._computeHidePatchFile(changeWithOneParent, patchNum));
    ...
    assert.isTrue(element._computeHidePatchFile(changeWithMultipleParents, patchNum));
  });
});
