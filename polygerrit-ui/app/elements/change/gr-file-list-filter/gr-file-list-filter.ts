  ...
  override render() {
    ...
    return html`
      <span class="filterContainer">
        ...
        <md-menu
          id="filterMenu"
          .menuCorner=${this.horizontalAlign === 'left' ? 'start-start' : 'end-start'}
          .anchorCorner=${this.horizontalAlign === 'left' ? 'start-end' : 'end-end'}
        ...
        >
          <div class="dropdown-content">
            ${this.allFileExtensions.map(ext => this.renderExtensionCheckbox(ext))}
          </div>
        </md-menu>
      </span>
    `;
