...
(function() {
  ...
  Polymer({
    ...
    _computeExpandedClass(filesExpanded) {
      const classes = [];
      if (filesExpanded === GrFileListConstants.FILES_EXPANDED.all) {
        classes.push('expanded');
      }
      if (filesExpanded === GrFileListConstants.FILES_EXPANDED.some ||
            filesExpanded === GrFileListConstants.FILES_EXPANDED.all) {
