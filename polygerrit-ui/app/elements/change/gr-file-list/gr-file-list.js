  ...
  Polymer({
    ...
    keyboardShortcuts() {
      return {
        ...
        [this.Shortcut.NEXT_FILE]: '_handleNextFileOrLine',
        [this.Shortcut.NEXT_LINE]: '_handleNextFileOrLine',
        [this.Shortcut.PREV_FILE]: '_handlePrevFileOrLine',
        [this.Shortcut.PREV_LINE]: '_handlePrevFileOrLine',
