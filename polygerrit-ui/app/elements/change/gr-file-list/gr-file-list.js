...
(function() {
  ...
  Polymer({
    ...
    _computeCommentsString(changeComments, patchNum, path) {
      ...
      const commentString = this.GrCountStringFormatter.computePluralString(
          commentCount, 'comment');
      const unresolvedString = this.GrCountStringFormatter.computeString(
    ...
    _computeDraftsString(changeComments, patchNum, path) {
      ...
      return this.GrCountStringFormatter.computePluralString(draftCount,
          'draft');
    },
    ...
    _computeDraftsStringMobile(changeComments, patchNum, path) {
      const draftCount = changeComments.computeDraftCount(patchNum, path);
      return this.GrCountStringFormatter.computeShortString(draftCount, 'd');
    },
    ...
    _computeCommentsStringMobile(changeComments, patchNum, path) {
      const commentCount = changeComments.computeCommentCount(patchNum, path);
      return this.GrCountStringFormatter.computeShortString(commentCount, 'c');
    },
