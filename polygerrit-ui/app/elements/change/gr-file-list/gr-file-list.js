...
(function() {
  ...
  Polymer({
    ...
    properties: {
      ...
      filesExpanded: {
        type: String,
        value: GrFileListConstants.FILES_EXPANDED.none,
        notify: true,
      },
      _files: {
        type: Array,
    ...
    _computeExpandedFiles(expandedCount, totalCount) {
      if (expandedCount === 0) {
        return GrFileListConstants.FILES_EXPANDED.none;
      } else if (expandedCount === totalCount) {
        return GrFileListConstants.FILES_EXPANDED.all;
      }
      return GrFileListConstants.FILES_EXPANDED.some;
    },
