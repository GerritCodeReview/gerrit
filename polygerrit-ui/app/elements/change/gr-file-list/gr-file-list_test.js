...
suite('gr-file-list tests', () => {
  ...
  suite('basic tests', () => {
    ...
    suite('keyboard shortcuts', () => {
      ...
      test('shift+left/shift+right', () => {
        ...
        sinon.stub(element, '_noDiffsExpanded').callsFake(() => noDiffsExpanded);
  ...
  suite('gr-file-list inline diff tests', () => {
    ...
    test('_displayLine', () => {
      sinon.stub(element, 'shouldSuppressKeyboardShortcut').callsFake(() => false);
      sinon.stub(element, 'modifierPressed').callsFake(() => false);
      element._showInlineDiffs = true;
