...
(function() {
  ...
  Polymer({
    ...
    _hashtagsChanged(changeRecord) {
      let result = [];
      const hashtags = changeRecord.base;
    ...
    _computeCanRemoveHashtag(mutable, change) {
      if (!mutable || !change.actions.hashtags ||
