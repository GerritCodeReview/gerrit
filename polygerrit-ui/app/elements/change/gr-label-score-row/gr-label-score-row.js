...
(function() {
  ...
  Polymer({
    ...
    get selectedValue() {
      ...
      return this.selectedItem.getAttribute('data-value');
    },

    setSelectedValue(value) {
      // The selector may not be present if it’s not at the latest patch set.
      if (!this._ironSelector) { return; }
      const item = this.$$('gr-button[data-value="' + value + '"]');
      if (!item) { return; }
      this._ironSelector.selectIndex(this._ironSelector.indexOf(item));
    },
