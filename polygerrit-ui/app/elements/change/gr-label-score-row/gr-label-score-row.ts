...
import {GrSelectorElement} from '../../shared/gr-selector/gr-selector';
declare global {
...
export class GrLabelScoreRow extends LitElement {
  @query('#labelSelector')
  labelSelector?: GrSelectorElement;
  ...
  get selectedItem(): GrSelectorElement | undefined {
    if (!this.labelSelector) {
      return undefined;
    }
    return this.labelSelector.selectedItem as GrSelectorElement;
  }
  ...
  private setSelectedValueText = (e: Event) => {
    ...
    const selectedItem = (e.target as GrSelectorElement)
    ...
    if (name && value) fire<any>(this, 'labels-changed', {name, value});
  };
