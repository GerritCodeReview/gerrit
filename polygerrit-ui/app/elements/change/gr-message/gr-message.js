...
(function() {
  ...
  Polymer({
    ...
    properties: {
      ...
      hidden: {
        type: Boolean,
        computed: '_isHidden(hideAutomated)',
        reflectToAttribute: true,
      },
      isAutomated: {
        type: Boolean,
        computed: '_isAutomated(message)',
      },
      showAvatar: {
        type: Boolean,
    ...
    _isAutomated: function(message) {
      return !!message.tag && message.tag.slice(0, 13) === 'autogenerated';
    },

    _isHidden: function(hideAutomated) {
      return hideAutomated && this.isAutomated;
    },
