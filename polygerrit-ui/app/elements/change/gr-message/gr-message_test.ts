...
suite('gr-message tests', () => {
  ...
  suite('when admin and logged in', () => {
    ...
    suite('compute messages', () => {
      ...
      test('rebased and submitted message linkified when expanded', () => {
        const original = 'Change has been successfully rebased and submitted as e40dc1a50dc7f457a37579e2755374f3e1a5413b';
        const tag = 'autogenerated:gerrit:merged' as ReviewInputTag;
        const expectedExpanded = 'Change has been successfully rebased and submitted as [e40dc1a50dc7f457a37579e2755374f3e1a5413b](/q/e40dc1a50dc7f457a37579e2755374f3e1a5413b)';
        ...
        assert.equal(actual, expectedExpanded);

        // Should not linkify when collapsed
        actual = element.computeMessageContent(
          false,
          original,
          [],
      ...
      test('cherry-picked message linkified when expanded', () => {
        const original = 'Change has been successfully cherry-picked as e40dc1a50dc7f457a37579e2755374f3e1a5413b';
        const tag = 'autogenerated:gerrit:merged' as ReviewInputTag;
        const expectedExpanded = 'Change has been successfully cherry-picked as [e40dc1a50dc7f457a37579e2755374f3e1a5413b](/q/e40dc1a50dc7f457a37579e2755374f3e1a5413b)';
