...
function isNewPatchSet(message) {
  ...
  return message.tag.includes('autogenerated:gerrit:newPatchSet')
      || message.tag.includes('autogenerated:gerrit:newWipPatchSet');
}
...
function isNewerReviewerUpdate(m, message) {
  ...
  if (m.tag != 'autogenerated:gerrit:reviewerUpdate') return false;
...
function isImportant(message, allMessages) {
  ...
  if (!message.tag || !allMessages) return true;
