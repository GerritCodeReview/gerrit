...
class GrMessagesListExperimental extends mixinBehaviors( [
  ...
  scrollToMessage(messageID) {
    ...
    // If the message is hidden, then show all messages and try again.
    if (!el) {
  ...
  _filterMessages(message) {
    if (!this._hideAutomated) return true;
    if (message.reviewer || message.type === 'REVIEWER_UPDATE') return false;
    if (message.tag && message.tag.startsWith('autogenerated')) return false;
    return true;
  }
