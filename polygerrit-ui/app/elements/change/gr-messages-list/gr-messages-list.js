  ...
  Polymer({
    ...
    */
    ...
    _computeIncrementText: function(messages, listLength) {
      var numExtraMessages = messages.length - listLength;
      return 'Show ' + Math.min(numExtraMessages, INCREMENT_DELTA) + ' more';
    },

    _computeShowHideTextHidden: function(messages, truncateList) {
      if (!truncateList) { return true; }
      return messages.length <= TRUNCATED_LIST_LENGTH;
    },

    _handleShowAllTap: function() {
      this._truncateList = false;
    },

    _handleIncrementShownMessages: function() {
      this._listLength = this._listLength + INCREMENT_DELTA;
      if (this._listLength > this._computedMessagesList.length) {
        this._truncateList = false;
      }
    },

    _computeShownItems: function(truncateList, listLength, messages) {
      return truncateList ?
          messages.slice(-listLength) :
          messages;
    },
