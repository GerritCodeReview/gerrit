...
(function() {
  ...
  Polymer({
    ...
    _hasNoAutomatedMessages: function(messages) {
      var hasNoAutomatedMessages = true;
      messages.forEach(function(message){
        if(!!message.tag && message.tag.indexOf('autogenerated') === 0){
          hasNoAutomatedMessages = false;
        }
      });
      return hasNoAutomatedMessages;
    },
