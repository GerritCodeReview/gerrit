...
(function() {
  ...
  Polymer({
    ...
    properties: {
      ...
      _shownItems: {
        type: Array,
        computed: '_computeShownItems(_listLength, _computedMessagesList)',
      },
      _listLength: {
        type: Number,
        value: TRUNCATED_LIST_LENGTH,
      },
    },
    ...
    */
    ...
    _handleAutomatedMessageToggleTap: function(e) {
      ...
      if (this._listLength !== messages.length) {
        if (this._hideAutomated) {
          var lastMessage = this._shownItems[0];
          this._listLength = messages.length - messages.indexOf(lastMessage);
        } else {
          this._listLength = this._shownItems.filter(function(msg) {
    ...
    _getDelta: function(messages, listLength) {
      return Math.min(messages.length - listLength, INCREMENT_DELTA);
    },
    ...
    _handleShowAllTap: function() {
      this._listLength = this._computedMessagesList.length;
    },

    _handleIncrementShownMessages: function() {
      this._listLength = this._listLength +
          this._getDelta(this._computedMessagesList, this._listLength);
    },

    _computeShownItems: function(listLength, messages) {
