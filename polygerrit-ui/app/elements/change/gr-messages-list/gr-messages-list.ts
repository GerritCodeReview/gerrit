...
export class GrMessagesList extends PolymerElement {
  ...
  override connectedCallback() {
    ...
    this.subscriptions.push(
      threads$.subscribe(x => { this.commentThreads = x; }));
    this.subscriptions.push(
      change$.subscribe(x => { this.change = x; }));
    this.subscriptions.push(
      loggedIn$.subscribe(x => { this.showReplyButtons = x; }));
    this.subscriptions.push(
      repo$.subscribe(x => { this.projectName = x; }));
    this.subscriptions.push(
