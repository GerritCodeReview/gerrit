...
export class GrRelatedChange extends LitElement {
  ...
  override render() {
    ...
    const statusClass = {
      status: true,
      notCurrent:
        (change as RelatedChangeAndCommitInfo)._revision_number !==
        (change as RelatedChangeAndCommitInfo)._current_revision_number,
      indirectAncestor: !!this.isIndirectAncestor(
        change as RelatedChangeAndCommitInfo
      ),
      submittable: !!change.submittable,
