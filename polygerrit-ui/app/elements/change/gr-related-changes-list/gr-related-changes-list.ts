...
import {hasOwnTypeProperty} from '../../../utils/common-util';
...
export class GrRelatedChangesList extends GestureEventListeners(
  ...
  _getChangeNumber(change?: ChangeInfo | RelatedChangeAndCommitInfo) {
    ...
    if (
      hasOwnTypeProperty<RelatedChangeAndCommitInfo>(change, '_change_number')
    ) {
  ...
  _resultsChanged(
    ...
    if (submittedTogether === undefined || sameTopic === undefined) {
      return;
    }
