  ...
  static override get styles() {
    return [
      ...
      css`
        ...
        gr-related-collapse .relatedChangeLine:nth-child(1) {
        ...
        gr-related-collapse[collapsed] .relatedChangeLine.show-when-collapsed:last-child {
          border-bottom: 1px solid var(--border-color);
        }
          ...
          (change, index) =>
            html`<div
              class=${classMap({
                ...
                ['selected']: relatedChangesMarkersPredicate(index).showCurrentChangeArrow,
                ['show-when-collapsed']:
        ...
        ${submittedTogetherChanges.map(
          (change, index) =>
            html`<div
              class=${classMap({
                ['relatedChangeLine']: true,
                ['selected']: submittedTogetherMarkersPredicate(index).showCurrentChangeArrow,
                ['show-when-collapsed']:
        ...
        ${this.sameTopicChanges.map(
          (change, index) =>
            html`<div
              class=${classMap({
                ['relatedChangeLine']: true,
                ['selected']: sameTopicMarkersPredicate(index).showCurrentChangeArrow,
                ['show-when-collapsed']:
        ...
        ${this.conflictingChanges.map(
          (change, index) =>
            html`<div
              class=${classMap({
                ['relatedChangeLine']: true,
                ['selected']: mergeConflictsMarkersPredicate(index).showCurrentChangeArrow,
                ['show-when-collapsed']:
