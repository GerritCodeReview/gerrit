  ...
  static override get styles() {
    return [
      ...
      css`
        ...
        gr-related-collapse[collapsed] .relatedChangeLine.show-when-collapsed.bottom {
          border-bottom: 1px solid var(--border-color);
        }
          ...
          (change, index) =>
            html`<div
              class=${classMap({
                ...
                ['bottom']: relatedChangesMarkersPredicate(index).showBottomArrow,
                ['show-when-collapsed']:
          ...
          (change, index) =>
            html`<div
              class=${classMap({
                ...
                ['bottom']: submittedTogetherMarkersPredicate(index).showBottomArrow,
                ['show-when-collapsed']:
          ...
          (change, index) =>
            html`<div
              class=${classMap({
                ...
                ['bottom']: mergeConflictsMarkersPredicate(index).showBottomArrow,
                ['show-when-collapsed']:
