...
suite('gr-related-changes-list tests', () => {
  ...
  //       assert.isNull(element.shadowRoot.querySelector('.note'));
  //     });
  ...
  //       flush();
  //       assert.notInclude(element.$.submittedTogether.className, 'hidden');
  //       assert.isNotNull(element.shadowRoot.querySelector('.note'));
  //       assert.strictEqual(
  //         element.shadowRoot.querySelector('.note').innerText.trim(),
