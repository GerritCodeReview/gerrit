...
class GrReplyDialog extends mixinBehaviors( [
  ...
  _toggleResolvedPatchsetLevelComment() {
    this._resolvedPatchsetLevelComment = !this._resolvedPatchsetLevelComment;
  }
  ...
  send(includeComments, startReview) {
    ...
    if (this.draft != null) {
      obj.comments = {[PatchsetLevelCommentsFilePath]: [
        {
          message: this.draft,
          unresolved: !this._resolvedPatchsetLevelComment,
        },
      ]};
    }
