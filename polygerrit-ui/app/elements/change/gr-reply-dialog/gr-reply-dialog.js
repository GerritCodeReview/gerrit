...
(function() {
  ...
  Polymer({
     ...
     * @param {Object} opt_accountIdsToKeep map of account IDs that must not be
     *     removed.
     */
    _purgeReviewersPendingRemove: function(isCancel, opt_accountIdsToKeep) {
      var reviewerArr;
      var keep = opt_accountIdsToKeep || {};
