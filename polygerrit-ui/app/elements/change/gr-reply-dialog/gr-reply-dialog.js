...
(function() {
  ...
  Polymer({
    ...
    _chooseFocusTarget: function() {
      // If we are the owner and this is our first reply, focus on REVIEWERS.
      var myAccountId = this._account && this._account._account_id;
      if (this.change.owner && myAccountId === this.change.owner._account_id) {
        var myMessages = (this.change.messages || []).filter(function(msg) {
          return msg.author && myAccountId === msg.author._account_id;
        });
