  ...
  static override styles = [
    ...
    css`
      ...
      .attention .edit-attention-button {
        vertical-align: top;
        --gr-button-padding: 0px var(--spacing-m);
      }
      ...
      .emptyAttentionWarningText {
        margin-left: var(--spacing-xl);
      }
      .attentionSetDocumentationIcon {
        top: var(--spacing-m);
      }
    `,
  ];
      ...
      <section class="attention">
        <div class="attentionSummary">
            ...
            ${when(
              ...
              () => html`
                <div class="warningContainer">
                  ...
                  ></iron-icon>
                  <span class="emptyAttentionWarningText">
                    Attention Set will become empty
                  </span>
          ...
          <div>
            ...
            >
              <iron-icon
                class="attentionSetDocumentationIcon"
