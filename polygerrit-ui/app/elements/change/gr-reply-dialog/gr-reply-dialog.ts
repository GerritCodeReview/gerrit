...
export class GrReplyDialog extends LitElement {
    ...
    return html`
      <div class="peopleList">
        ...
        <gr-account-list
          ...
          @account-remvoed=${(e: ValueChangedEvent<AccountInput>) =>
            this.accountRemoved(e, ReviewerType.REVIEWER)}
    ...
    return html`
      <div class="peopleList">
        ...
        <gr-account-list
          id="reviewers"
          .accounts=${this.ccs}
          @account-added=${(e: ValueChangedEvent<AccountInput>) =>
            this.accountAdded(e, ReviewerType.CC)}
          @account-removed=${(e: ValueChangedEvent<AccountInput>) =>
            this.accountRemoved(e, ReviewerType.CC)}
          .removableValues=${this.change?.removable_reviewers}
          .filter=${this.filterReviewerSuggestion}
  ...
  private accountRemoved(
    e: ValueChangedEvent<AccountInput>,
