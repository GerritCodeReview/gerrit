    ...
    return html`
      <div class="peopleList">
        ...
        <gr-account-list
          id="reviewers"
          .accounts="{{_reviewers}}"
          .removableValues=${ifDefined(this.change?.removable_reviewers)}
          ...
          .suggestionsProvider=${ifDefined(
            this._getReviewerSuggestionsProvider(this.change)
          )}
        >
        </gr-account-list>
      ...
      >
        <gr-endpoint-decorator name="reply-text">
          <gr-textarea
            ...
            .autocomplete=${'on'}
            .placeholder=${ifDefined(this._messagePlaceholder)}
            monospace
        ...
        ${when(
          ...
          () => html`
            <section class="previewContainer">
              <gr-formatted-text
                content=${this.draft}
                config=${ifDefined(this.projectConfig?.commentlinks)}
              ></gr-formatted-text>
            </section>
          `
        )}
