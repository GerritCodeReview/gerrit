...
Polymer({
  _template: Polymer.html`
    ...
    <gr-button class="hiddenReviewers" link="" hidden\$="[[!_hiddenReviewerCount]]" on-tap="_handleViewAll">and [[_hiddenReviewerCount]] more</gr-button>
    <div class="controlsContainer" hidden\$="[[!mutable]]">
      <gr-button link="" id="addReviewer" class="addReviewer" on-tap="_handleAddTap">[[_addLabel]]</gr-button>
    </div>
