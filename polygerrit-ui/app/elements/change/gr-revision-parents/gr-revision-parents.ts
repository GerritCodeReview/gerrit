    ...
    if (
      ...
      return html`
        ${this.renderWarning(
          'info',
          html`
            The change was rebased from patchset ${changePsLeft} onto patchset
            ${changePsRight} of change ${changeNumLeft}
      ...
      return html`
        ${this.renderWarning(
          ...
          html`
            ...
            ${this.renderCommitLink(commitLeft, false)} onto
            ${this.renderCommitLink(commitRight, false)}.
          `
        )}
      `;
    }
    ...
    const infoLeft =
      changeNumLeft && !isMergedLeft
        ...
        : html`Patchset ${psLeft} is based on commit
          ${this.renderCommitLink(commitLeft, false)} in the target branch
          (${branchLeft}).`;
    ...
    const infoRight =
      changeNumRight && !isMergedRight
        ...
        : html`Patchset ${psRight} is based on commit
          ${this.renderCommitLink(commitRight, false)} in the target branch
          (${branchRight}).`;
