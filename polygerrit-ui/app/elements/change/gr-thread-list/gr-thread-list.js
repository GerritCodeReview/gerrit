...
class GrThreadList extends GestureEventListeners(
  ...
  _isFirstThreadWithFileName(thread, unresolvedOnly, draftsOnly,
      onlyShowRobotCommentsWithHumanReply) {
    const threads = this._sortedThreads.filter(t => this._shouldShowThread(
  ...
  _shouldRenderSeparator(thread, unresolvedOnly, draftsOnly,
      onlyShowRobotCommentsWithHumanReply) {
    const threads = this._sortedThreads.filter(t => this._shouldShowThread(
        t, unresolvedOnly, draftsOnly,
        onlyShowRobotCommentsWithHumanReply));
    ...
    return index > 0 && this._isFirstThreadWithFileName(thread, unresolvedOnly,
