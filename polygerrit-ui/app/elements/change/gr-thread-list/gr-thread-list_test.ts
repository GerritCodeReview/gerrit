...
import {GrThreadList, __testOnly_SortDropdownState} from './gr-thread-list';
...
suite('gr-thread-list tests', () => {
  ...
  suite('compareThreads', () => {
    ...
    const sortPredicate = (thread1: CommentThread, thread2: CommentThread) =>
      element.compareThreads(thread1, thread2);
    ...
    test('unresolved first', () => {
      t1 = createThread(true);
      t2 = createThread(false);
      checkOrder([t1, t2]);
    });
    ...
    test('sort all threads', () => {
      ...
      const expected: UrlEncodedCommentId[] = [
        ...
        'ecf0b9fa_fe1a5f62' as UrlEncodedCommentId, // Line 5 on COMMIT_MESSAGE but with drafts
        'rc1' as UrlEncodedCommentId, // Line 5 on COMMIT_MESSAGE without drafts
