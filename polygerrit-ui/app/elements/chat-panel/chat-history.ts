...
export class ChatHistory extends LitElement {
  ...
  private readonly conversations$: Observable<
    readonly Conversation[] | undefined
  > = select(this.getChatModel().state$, chatState => chatState.conversations);
        ...
        conversation => html`
          ...
          >
            ...
            <div class="conversation-content">
              ...
              <p class="ts">
                ${this.renderTimestamp(new Date(conversation.timestamp))}
              </p>
            </div>
          </div>
        `
