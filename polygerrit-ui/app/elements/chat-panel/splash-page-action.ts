...
export class SplashPageAction extends LitElement {
              ...
              () => html`
                <div class="modal-row instruction-row">
                  ...
                  <div class="modal-row-content">
                    ...
                    <div class="modal-row-text instruction-text ${this.isInstructionExpanded ? 'expanded' : 'collapsed'}">
                      ${this.action?.initial_user_prompt}
                    </div>
                    ${when(
                      ...
                      () => html`
                        <button
                          class="expand-button"
                          @click=${() => (this.isInstructionExpanded = !this.isInstructionExpanded)}
                        >
                          ${this.isInstructionExpanded ? 'Show less' : 'Show more'}
                        </button>
                      `
                    )}
                  </div>
  ...
  private async displayDetailsCard(event: MouseEvent) {
    console.log('SplashPageAction details clicked. Action:', this.action);
