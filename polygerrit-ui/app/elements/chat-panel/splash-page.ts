...
export class SplashPage extends LitElement {
  ...
  constructor() {
    ...
    subscribe(
      this,
      () => this.getChangeViewModel().patchNum$,
      x => (this.patchNum = x)
    );
  }
  ...
  private renderContent() {
    ...
    return html`
      ...
      <gr-endpoint-decorator name="chat-panel-splash-extra">
        ...
        <gr-endpoint-param name="changeNum" .value=${this.changeNum}></gr-endpoint-param>
        <gr-endpoint-param name="patchNum" .value=${this.patchNum}></gr-endpoint-param>
