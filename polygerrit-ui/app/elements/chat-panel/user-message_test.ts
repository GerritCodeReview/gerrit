...
suite('user-message tests', () => {
  ...
  //   assert.isOk(avatar);
  //   assert.isOk((avatar as GrAvatar).account);
  //   console.log(`asdf user ${JSON.stringify((avatar as GrAvatar).account)}`);
  //   assert.equal((avatar as GrAvatar).account?.name, 'Test User');
  // });
