...
export class GrChecksResults extends GrLitElement {
  ...
  constructor() {
    super();
    this.isSectionExpanded.set(Category.ERROR, true);
    this.isSectionExpanded.set(Category.WARNING, true);
    this.isSectionExpanded.set(Category.INFO, true);
    this.isSectionExpanded.set('SUCCESS', true);
  }
