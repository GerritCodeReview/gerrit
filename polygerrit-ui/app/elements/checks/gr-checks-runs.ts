...
export class GrChecksRuns extends GrLitElement {
  ...
  constructor() {
    ...
    this.isSectionExpanded.set(RunStatus.COMPLETED, true);
    this.isSectionExpanded.set(RunStatus.RUNNING, true);
    this.isSectionExpanded.set(RunStatus.RUNNABLE, true);
  }
