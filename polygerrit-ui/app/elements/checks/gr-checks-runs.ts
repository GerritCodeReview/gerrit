...
import {assertIsDefined, query as queryEl} from '../../utils/common-util';
...
export class GrChecksRun extends LitElement {
  ...
  protected override updated(changedProperties: PropertyValues) {
    ...
    // here.
    const inputToBeSelected = queryEl<HTMLInputElement>(
      this,
      `.attemptDetails input#attempt-${this.selectedAttempt}`
    );
