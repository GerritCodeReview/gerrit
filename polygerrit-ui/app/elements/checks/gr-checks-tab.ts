...
export class GrChecksTab extends GrLitElement {
  ...
  render() {
    return html`
      <div class="header">
        <span>Placeholder for Patchset-Dropdown</span>
        <span>Placeholder for Filter-Dropdown</span>
      </div>
      <div class="container">
        <gr-checks-runs class="runs" .runs="${this.runs}"></gr-checks-runs>
        <gr-checks-results class="results" .results="${this.results}"></gr-checks-results>
      </div>
    `;
  }
}
