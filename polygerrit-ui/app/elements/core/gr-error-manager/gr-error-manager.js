...
(function() {
  ...
  Polymer({
    ...
    properties: {
      ...
      _boundHandleServerError: {
        type: Function,
        value: function() { return this._handleServerError.bind(this); },
      },
      _boundHandleNetworkError: {
        type: Function,
        value: function() { return this._handleNetworkError.bind(this); },
      },
    },

    attached: function() {
      document.addEventListener('server-error', this._boundHandleServerError);
      document.addEventListener('network-error', this._boundHandleNetworkError);
    },

    detached: function() {
      this._clearHideAlertHandle();
      document.removeEventListener('server-error',
          this._boundHandleServerError);
      document.removeEventListener('network-error',
          this._boundHandleNetworkError);
    },
