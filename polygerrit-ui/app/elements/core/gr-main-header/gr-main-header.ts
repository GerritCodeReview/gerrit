    ...
    return html`
      <nav class="hideOnMobile">
        ...
        <div class="rightItems">
          ...
          We do this instead of using Lit's conditional rendering (e.g., ?hidden or if) inside <gr-endpoint-decorator>,
          because the plugin system may replace or remove this content outside of Lit's control.
          If Lit tries to update a node that was removed by the plugin system, it will throw an error.
          By always rendering the node and only hiding it, we avoid this issue and ensure plugin compatibility.
          -->
          <gr-endpoint-decorator class="feedbackButton" name="header-feedback">
            <a
              ...
              role="button"
              style=${!this.feedbackURL ? 'display:none' : ''}
            >
