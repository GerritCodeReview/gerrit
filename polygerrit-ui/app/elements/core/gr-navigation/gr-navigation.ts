...
export const GerritNav = {
  View: {
    ADMIN: GerritView.ADMIN,
    AGREEMENTS: GerritView.AGREEMENTS,
    CHANGE: GerritView.CHANGE,
    DASHBOARD: GerritView.DASHBOARD,
    DIFF: GerritView.DIFF,
    DOCUMENTATION_SEARCH: GerritView.DOCUMENTATION_SEARCH,
    EDIT: GerritView.EDIT,
    GROUP: GerritView.GROUP,
    PLUGIN_SCREEN: GerritView.PLUGIN_SCREEN,
    REPO: GerritView.REPO,
    ROOT: GerritView.ROOT,
    SEARCH: GerritView.SEARCH,
    SETTINGS: GerritView.SETTINGS,
  },

  GroupDetailView: {
    MEMBERS: GroupDetailView.MEMBERS,
    LOG: GroupDetailView.LOG,
  },

  RepoDetailView: {
    ACCESS: RepoDetailView.ACCESS,
    BRANCHES: RepoDetailView.BRANCHES,
    COMMANDS: RepoDetailView.COMMANDS,
    DASHBOARDS: RepoDetailView.DASHBOARDS,
    TAGS: RepoDetailView.TAGS,
  },

  WeblinkType: {
    CHANGE: WeblinkType.CHANGE,
    FILE: WeblinkType.FILE,
    PATCHSET: WeblinkType.PATCHSET,
  },
