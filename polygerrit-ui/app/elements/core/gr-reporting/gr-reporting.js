  ...
  let GrReporting = Polymer({
    ...
    dashboardDisplayed() {
      if (this._baselines.hasOwnProperty(TIMER.STARTUP_DASHBOARD_DISPLAYED)) {
        this.timeEnd(TIMER.STARTUP_DASHBOARD_DISPLAYED, {rpcList: slowRpcList});
      } else {
        this.timeEnd(TIMER.DASHBOARD_DISPLAYED, {rpcList: slowRpcList});
      }
    },

    changeDisplayed() {
      if (this._baselines.hasOwnProperty(TIMER.STARTUP_CHANGE_DISPLAYED)) {
        this.timeEnd(TIMER.STARTUP_CHANGE_DISPLAYED, {rpcList: slowRpcList});
      } else {
        this.timeEnd(TIMER.CHANGE_DISPLAYED, {rpcList: slowRpcList});
      }
    },
    ...
    diffViewDisplayed() {
      if (this._baselines.hasOwnProperty(TIMER.STARTUP_DIFF_VIEW_DISPLAYED)) {
        this.timeEnd(TIMER.STARTUP_DIFF_VIEW_DISPLAYED, {rpcList: slowRpcList});
      } else {
        this.timeEnd(TIMER.DIFF_VIEW_DISPLAYED, {rpcList: slowRpcList});
      }
    },
