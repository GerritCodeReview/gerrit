...
(function() {
  ...
  Polymer({
    ...
    _startRouter() {
      ...
      this._mapRoute(RoutePattern.DOCUMENTATION_SEARCH_FILTER, '_handleDocumentationSearchRoute');

      // redirects /Documentation/q/* to /Documentation/q/filter:*
      this._mapRoute(RoutePattern.DOCUMENTATION_SEARCH, '_handleDocumentationSearchRedirectRoute');
    ...
    _handleDocumentationSearchRedirectRoute(data) {
      this._redirect('/Documentation/q/filter:' + encodeURIComponent(data.params[0]));
    },
