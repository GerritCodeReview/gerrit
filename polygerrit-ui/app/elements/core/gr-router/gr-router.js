...
(function() {
  ...
  Polymer({
    ...
    _handleChangeRoute(ctx) {
      ...
      this.$.restAPI.getChangeDetail(params.changeNum, undefined, undefined,
          params.project, true);
      this.$.restAPI.getDiffComments(params.changeNum, undefined, undefined,
          undefined, params.project, true);
      this.$.restAPI.getDiffRobotComments(params.changeNum, undefined,
          undefined, undefined, params.project, true);
    ...
    _handleDiffRoute(ctx) {
      ...
      this.$.restAPI.getChangeDetail(params.changeNum, undefined,
          undefined, params.project, true);
      this.$.restAPI.getDiffComments(params.changeNum, undefined,
          undefined, undefined, params.project, true);
      this.$.restAPI.getDiffRobotComments(params.changeNum, undefined,
          undefined, undefined, params.project, true);
      this.$.restAPI.getDiff(params.changeNum, 'PARENT', params.basePatchNum,
          params.path, 'IGNORE_NONE', true);
