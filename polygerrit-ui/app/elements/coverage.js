            ...
            content.addLayer(function() {
              return {
                annotate(el, line) {
                  ...
                  console.log("IN annotate function!");
                  if (line.type === GrDiffLine.Type.ADD || (
                      line.type === GrDiffLine.Type.BOTH &&
                      el.getAttribute('data-side') === 'right')) {
                    // TODO(rmistry): How do we dynamically add a CSS class to the below?
                    GrAnnotation.annotateElement(el, 0, GrAnnotation.getStringLength(line.text),
