  ...
  */
  ...
  Polymer({
    ...
    reloadDrafts(changeNum) {
      ...
      this.$.restAPI.getDiffComments(changeNum).then(drafts => {
        this._changeComments = new ChangeComments(_changeComments.comments,
            _changeComments.robotComments, drafts);
        return this._changeComments;
      });
    },
  });
