...
(function() {
  ...
  ChangeComments.prototype.computeAllThreadsForChange = function() {
    const comments = this._commentObjToArrayWithFile(this.getAllComments(true));
    return this.computeCommentThreads(comments);
  };
   ...
   * @return {!Array}
   */
  ChangeComments.prototype.computeCommentThreads = function(comments) {
  ...
  */
  ...
  // ChangeComments.prototype._calculateLocationRange = function(range, comment) {
