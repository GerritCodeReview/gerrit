  ...
  */
  ...
  Polymer({
    ...
    loadAll(changeNum) {
      ...
      return this._getAllComments(changeNum).then(() => {
        this._changeComments = new ChangeComments(this._comments,
            this._robotComments, this._drafts, this._changeNum);
      });
    },

    _getAllComments(changeNum) {
      const promises = [];
