...
export class ChangeComments {
   ...
   * If the thread is present in the given patchrange, then show the original
   * thread instead of the ported thread.
   *
   * If we cannot find an appropriate range for the ported comments, then attach
   * them as file level comments.
   *
   */
