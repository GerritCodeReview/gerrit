...
suite('gr-context-control tests', () => {
  ...
  test('no +10 buttons for 10 or less lines', async () => {
    ...
    console.log('no +10 buttons - outerDiv.innerHTML', outerDiv.innerHTML);
    console.log('no +10 buttons - outerDiv.outerHTML', outerDiv.outerHTML);
    console.log('no +10 buttons - element.outerHTML', element.outerHTML);
    console.log('no +10 buttons - element.innerHTML', element.innerHTML);
    console.log('no +10 buttons - element.shadowRoot', element.shadowRoot);
    console.log('no +10 buttons - element.shadowRoot?.innerHTML', element.shadowRoot?.innerHTML);
