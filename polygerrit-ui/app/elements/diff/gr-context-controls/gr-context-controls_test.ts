...
import {GrContextControls} from './gr-context-controls.js';
import {flush} from '@polymer/polymer/lib/legacy/polymer.dom.js';
import {html} from '@polymer/polymer/lib/utils/html-tag.js';

import {GrDiffLine, GrDiffLineType} from '../gr-diff/gr-diff-line.js';
import {GrDiffGroup, GrDiffGroupType} from '../gr-diff/gr-diff-group.js';
import {DiffFileMetaInfo, DiffInfo} from '../../../api/diff.js';

const basicFixture = fixtureFromTemplate(
  html`<gr-context-controls></gr-context-controls>`
);
...
suite('gr-context-control tests', () => {
  ...
  setup(() => {
    element = basicFixture.instantiate() as GrContextControls;
