...
export class GrDiffBuilderSideBySide extends GrDiffBuilder {
  ...
  _createRow(
    ...
    if (leftLine.beforeNumber !== "FILE") leftLine.beforeNumber += this.lineOffset - 1;
    if (leftLine.afterNumber !== "FILE") leftLine.afterNumber += this.lineOffset - 1;
    if (rightLine.beforeNumber !== "FILE") rightLine.beforeNumber += this.lineOffset - 1;
    if (rightLine.afterNumber !== "FILE") rightLine.afterNumber += this.lineOffset - 1;
