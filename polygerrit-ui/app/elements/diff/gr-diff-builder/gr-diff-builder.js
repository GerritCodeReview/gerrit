...
(function(window, GrDiffGroup, GrDiffLine) {
  ...
  GrDiffBuilder.prototype._formatText = function(text, tabSize, lineLimit) {
    ...
    // This regex segments |text| along tabs (which are expanded to an
    // appropriate width) and surrogate pairs (which consume two string elements
    // but constitute just one Unicode code point). For more background on JS
    // and unicode, see: https://mathiasbynens.be/notes/javascript-unicode
