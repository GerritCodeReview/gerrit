...
export abstract class GrDiffBuilder {
  ...
  private createLineBreak(responsive: boolean){
    return responsive ? this._createElement('wbr') : this._createElement('span', 'br');
  }
   ...
   */
   _formatText(text: string, responsiveMode: DiffResponsiveMode, tabSize: number, lineLimit: number): HTMLElement {
