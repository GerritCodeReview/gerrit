...
export class TokenHighlightLayer implements DiffLayer {
  ...
  constructor() {
    window.addEventListener('click', _ => this._clearTokenHighlight());
  }
  ...
  private readonly handleMouseOver = (e: MouseEvent) => {
    ...
    this.updateTokenTask = debounce(
      ...
      () => this._updateTokenHighlight(line, newHighlight), HOVER_DELAY_MS);
  }
  ...
  private readonly _clearTokenHighlight = () => {
