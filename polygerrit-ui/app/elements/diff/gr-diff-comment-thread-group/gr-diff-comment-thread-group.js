...
(function() {
  ...
  Polymer({
    ...
    fetchThreadforRange: function(rangeToCheck) {
      var threads = [].filter.call(
          this.root.querySelectorAll('gr-diff-comment-thread'),
          function(thread) {
    ...
    fetchThreadLength: function() {
      return this.root.querySelectorAll('gr-diff-comment-thread').length;
    },
