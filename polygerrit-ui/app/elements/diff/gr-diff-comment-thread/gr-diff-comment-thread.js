...
(function() {
  ...
  Polymer({
     ...
     */
      ...
      *
      * range:
      *     The range of text that the comment refers to (start_line, start_character,
      *     end_line, end_character), serialized as JSON. If set, range's start_line
      *     will have the same value as line-num. Line numbers are 1-based,
      *     char numbers are 0-based. The start position (start_line, start_character)
      *     is inclusive, and the end position (end_line, end_character) is exclusive.
      */
    properties: {
      changeNum: String,
      comments: {
    ...
    _newDraft(opt_lineNum, opt_range) {
      ...
      if (opt_range) {
        d.range = {
          start_line: opt_range.start_line,
          start_character: opt_range.start_character,
          end_line: opt_range.end_line,
          end_character: opt_range.end_character,
        };
      }
      if (this.parentIndex) {
