...
(function() {
  ...
  Polymer({
    ...
    _rowChanged: function(newRow, oldRow) {
      if (oldRow) {
        oldRow.classList.remove(SideClass.LEFT, SideClass.RIGHT);
      }
    ...
    _updateSideClass: function() {
      ...
      this.toggleClass(SideClass.LEFT, this.side === DiffSides.LEFT,
          this.diffRow);
      this.toggleClass(SideClass.RIGHT, this.side === DiffSides.RIGHT,
          this.diffRow);
    },
