...
export class GrDiffCursorElement extends PolymerElement {
  ...
  reInitCursor = this.cursor.reInitCursor.bind(this.cursor);

  reInit = this.cursor.reInit.bind(this.cursor);

  handleDiffUpdate = this.cursor.handleDiffUpdate.bind(this.cursor);
