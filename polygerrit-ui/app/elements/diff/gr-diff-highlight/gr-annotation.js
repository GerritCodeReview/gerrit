...
(function(window) {
  ...
  const GrAnnotation = {
     ...
     * @param {string} tagName tag name of the annotating element.
     * @param {!Object<string, *>=} attributes the attributes to be set on the
     *   annotating element.
     */
    annotateWithElement(parent, offset, length, tagName, opt_attributes = {}) {
      let childNodes;
      ...
      for (const [name, value] of Object.entries(opt_attributes)) {
        wrapper.setAttribute(name, sanitizer
