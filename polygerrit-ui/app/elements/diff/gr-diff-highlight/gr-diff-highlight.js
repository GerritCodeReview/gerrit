...
(function() {
  ...
  Polymer({
     ...
     */
    _traverseContent: function(startNode, callback, opt_flags) {
    ...
    _getLength: function(node) {
      if (node instanceof Element && node.classList.contains('content')) {
        ...
        return node.textContent.replace(regexAstralSymbol, '_').length;
      }
    },
    ...
    _splitText: function(node, offset) {
      if (node.textContent.match(regexAstralSymbol)) {
