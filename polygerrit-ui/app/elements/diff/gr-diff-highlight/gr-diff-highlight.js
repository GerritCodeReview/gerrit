...
(function() {
  ...
  Polymer({
    ...
    handleSelectionChange(selection, isMouseUp) {
      ...
      // quick 'c' press after the selection change. Maybe we should even go
      // lower to 0 or 10 ms.
      this.debounce(
    ...
    _handleSelection(selection, isMouseUp) {
      ...
      // diff area (start will be equal to end), and neither before a new diff
      // section (end line will match the first line of the new section and
      // thus be greater than start line + 1).
