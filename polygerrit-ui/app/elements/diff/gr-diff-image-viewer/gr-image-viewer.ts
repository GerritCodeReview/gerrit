...
export class GrImageViewer extends LitElement {
  ...
  static styles = css`
    :host {
      ...
      --mdc-typography-button-font-size: var(--font-size-normal, 1rem);
      --mdc-typography-button-font-weight: var(--font-weight-normal, 400);
  ...
  render() {
    ...
    const followMouse = html`
      <mwc-formfield label="Magnifier follows mouse" id="follow-mouse">
        <mwc-checkbox
