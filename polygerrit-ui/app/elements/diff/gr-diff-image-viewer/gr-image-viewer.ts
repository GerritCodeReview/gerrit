...
export class GrImageViewer extends LitElement {
  ...
  render() {
    ...
    const shapeLeft = 'border-radius: 4px 0 0 4px; border-left-width: 1px; border-right-width: 0;';
    const shapeRight = 'border-radius: 0 4px 4px 0; border-left-width: 0; border-right-width: 1px;';
    const outlinedBorder = 'border: 1px solid var(--primary-button-background-color);'
