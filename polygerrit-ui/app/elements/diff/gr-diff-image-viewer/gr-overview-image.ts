  ...
  connectedCallback() {
    ...
    if (this.isConnected) {
      ...
      this.overlay.addEventListener(
        'mousemove',
        this.maybeDragFrame.bind(this)
      );
      this.overlay.addEventListener('mouseleave', this.releaseFrame.bind(this));
      this.overlay.addEventListener('mouseup', this.releaseFrame.bind(this));
