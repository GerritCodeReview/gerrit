 ...
 */
import * as GestureEventListenersImports from 'google3/third_party/javascript/polygerrit/shims/mixins/gesture-event-listeners';
const GestureEventListeners =
  GestureEventListenersImports.GestureEventListeners;
import * as LegacyElementMixinImports from 'google3/third_party/javascript/polygerrit/shims/mixins/legacy-element-mixin';
const LegacyElementMixin = LegacyElementMixinImports.LegacyElementMixin;
...
export class GrDiffProcessor extends GestureEventListeners(
  ...
  _chunkToGroup(
    ...
    if (chunk.skip) {
      group.lineRange = {
        left: {start: offsetLeft, end: offsetLeft + chunk.skip},
        right: {start: offsetRight, end: offsetRight + chunk.skip},
      };
    }
    return group;
  }
