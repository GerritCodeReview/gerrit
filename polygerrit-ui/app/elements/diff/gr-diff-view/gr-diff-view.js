  ...
  Polymer({
    ...
    properties: {
      ...
      /**
        ...
        * This comes from gr-diff-host and is not
        * to be confused with _diff.
        **/
      diff: Object,
    ...
    _computeDownloadDropdownLinks(project, changeNum, patchRange, path, side) {
      ...
      if (side && side.meta_a) {
        ...
        if (side.change_type === 'RENAMED') {
          paths = side.meta_a.name;
        }
        links.push(
            {
              // We pass 1 here to indicate this is parent 2.
      ...
      if (side && side.meta_b) {
        links.push(
            {
              // We pass 0 here to indicate this is parent 1.
              url: this._computeDownloadFileLink(
