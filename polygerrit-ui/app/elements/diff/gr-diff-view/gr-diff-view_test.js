...
suite('gr-diff-view tests', () => {
  suite('basic tests', () => {
    ...
    setup(() => {
<<<<<<< HEAD:polygerrit-ui/app/elements/diff/gr-diff-view/gr-diff-view_test.js
=======
      sandbox = sinon.sandbox.create();
      sandbox.stub(appContext.flagsService, 'isEnabled').returns(true);
>>>>>>> a1f6c5b97f... Change default patchset choice for comments:polygerrit-ui/app/elements/diff/gr-diff-view/gr-diff-view_test.html
    ...
    test('diff toast to go to base is shown', () => {
      ...
      const toastStub =
        sandbox.stub(element, '_displayDiffBaseAgainstLeftToast');
      return element._paramsChanged.returnValues[0].then(() => {
    ...
    test('diff toast to go to latest is shown and not base', () => {
      ...
      const latestToastStub =
        sandbox.stub(element, '_displayDiffAgainstLatestToast');
      element._isChangeCommentsLinkExperimentEnabled = true;
      return element._paramsChanged.returnValues[0].then(() => {
