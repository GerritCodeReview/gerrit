  ...
  <style include="shared-styles">
    ...
    .dividerRow.showBoth .dividerCellContainer {
      ...
      /* We need to create enough negative margin such that the two buttons
         ...
         The margin-top also controls the vertical positioning of the buttons
         compared to the table row. It must be pixel perfect and thus depends
         on the exact height of the buttons. */
      margin-top: -20px;
      margin-bottom: -25px;
    }
