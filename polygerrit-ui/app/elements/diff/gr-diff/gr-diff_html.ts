...
export const htmlTemplate = html`
  <style include="shared-styles">
    ...
    .dividerRow.show-both {
      --gr-context-controls-justify-content: center;
      --gr-context-controls-margin-top: calc(
        0px - var(--line-height-normal) - var(--spacing-s)
      );
      --gr-context-controls-margin-bottom: calc(
        0px - var(--line-height-normal) - var(--spacing-s)
      );
    ...
    .dividerRow.show-above {
      --gr-context-controls-justify-content: flex-end;
      --gr-context-controls-margin-top: calc(
        -1px - var(--line-height-normal) - var(--spacing-s)
      );
      --gr-context-controls-height: calc(
        var(--line-height-normal) + var(--spacing-s)
      );
    }
    .dividerRow.show-below {
    ...
    .dividerRow.showBoth {
      ...
      --gr-context-controls-horizontal-height: 100px;
    }
    .dividerRow.show-above {
