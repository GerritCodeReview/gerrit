...
import {runA11yAudit} from '../../../test/test-utils.js';
...
suite('gr-diff tests', () => {
  ...
  suite('logged in', () => {
    ...
    suite('change in preferences', () => {
      ...
      test('adding and removing line_wrapping property in preferences re-renders diff', () => {
        const stub = sandbox.stub(element, '_renderDiffTable');
        const newPrefs1 = Object.assign({}, MINIMAL_PREFS, {line_wrapping: true});
