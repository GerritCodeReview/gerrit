  ...
  Polymer({
    ...
    _computeBaseDropdownContent(availablePatches, patchNum, _sortedRevisions,
      ...
      for (const basePatch of availablePatches) {
        ...
        let entry = this._createDropdownEntry(basePatchNum, 'Patchset ',
    ...
    _computePatchDropdownContent(availablePatches, basePatchNum,
      ...
      for (const patch of availablePatches) {
        ...
        let entry = this._createDropdownEntry(
    ...
    _createDropdownEntry(patchNum, prefix, _sortedRevisions, changeComments) {
      ...
      let date = this._computePatchSetDate(_sortedRevisions, patchNum);
      if (date) {
        entry['date'] = date;
      }
      return entry;
