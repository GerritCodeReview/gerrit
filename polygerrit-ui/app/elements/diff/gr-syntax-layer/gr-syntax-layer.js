...
(function() {
  ...
  Polymer({
     ...
     * Higjlight.js emits and emit a list of text ranges and classes for the
     * markers.
     * @param {String} str The string of HTML.
     * @return {Arrray<Object>} The list of ranges.
     */
     ...
     * lines).
     * @param {Obeject} state The processing state for the layer.
     */
