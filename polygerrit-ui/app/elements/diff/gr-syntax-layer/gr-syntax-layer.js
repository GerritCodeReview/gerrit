  ...
  Polymer({
    ...
    _processNextLine(state) {
      ...
      if (this._baseLanguage && baseLine !== undefined) {
        ...
        console.log(window.document.getElementById('contentTextLeft'));
        // window.document.getElementById('contentText');
        result = CodeMirror(window.document.getElementById('contentTextLeft'), {
            value: baseLine,
      ...
      if (this._revisionLanguage && revisionLine !== undefined) {
        ...
        console.log(window.document.getElementById('contentTextRight'));
        result = CodeMirror(window.document.getElementById('contentTextRight'), {
            value: revisionLine,
