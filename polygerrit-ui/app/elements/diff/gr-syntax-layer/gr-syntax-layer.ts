...
const CLASS_SAFELIST = new Set<string>([
  'gr-diff gr-syntax gr-syntax-addition',
  'gr-diff gr-syntax gr-syntax-attr',
  'gr-diff gr-syntax gr-syntax-attribute',
  'gr-diff gr-syntax gr-syntax-built_in',
  'gr-diff gr-syntax gr-syntax-bullet',
  'gr-diff gr-syntax gr-syntax-char-escape',
  'gr-diff gr-syntax gr-syntax-code',
  'gr-diff gr-syntax gr-syntax-comment',
  'gr-diff gr-syntax gr-syntax-deletion',
  'gr-diff gr-syntax gr-syntax-doctag',
  'gr-diff gr-syntax gr-syntax-emphasis',
  'gr-diff gr-syntax gr-syntax-formula',
  ...
  'gr-diff gr-syntax gr-syntax-meta-string',
  'gr-diff gr-syntax gr-syntax-name',
  'gr-diff gr-syntax gr-syntax-number',
  'gr-diff gr-syntax gr-syntax-operator',
  'gr-diff gr-syntax gr-syntax-params',
  'gr-diff gr-syntax gr-syntax-property',
  'gr-diff gr-syntax gr-syntax-punctuation',
  'gr-diff gr-syntax gr-syntax-quote',
  'gr-diff gr-syntax gr-syntax-regexp',
  'gr-diff gr-syntax gr-syntax-section',
  ...
  'gr-diff gr-syntax gr-syntax-strong',
  'gr-diff gr-syntax gr-syntax-subst',
  'gr-diff gr-syntax gr-syntax-symbol',
  ...
  'gr-diff gr-syntax gr-syntax-title-class',
  'gr-diff gr-syntax gr-syntax-title-class-inherited',
  'gr-diff gr-syntax gr-syntax-title-function',
  'gr-diff gr-syntax gr-syntax-type',
  'gr-diff gr-syntax gr-syntax-variable',
  'gr-diff gr-syntax gr-syntax-variable-language',
  'gr-diff gr-syntax gr-syntax-variable-constant',
]);
