    ...
    <gr-overlay id="overlay" with-backdrop="">
      <gr-dialog id="openDialog" class="invisible dialog" disabled\$="[[!_isValidPath(_path)]]" confirm-label="Confirm" confirm-on-enter="" on-confirm="_handleOpenConfirm" on-cancel="_handleDialogCancel">
        ...
        <div class="main" slot="main">
          ...
          <div id="dragDropArea" on-drop="_handleDragAndDropUpload" on-dragover="_handleOnDragover">
            <p>Drag and drop a file here</p>
            <p>or</p>
            <p>
              <iron-input type="file" on-change="_handleFileUploadChanged">
                <input is="iron-input" id="fileUploadInput" type="file" on-change="_handleFileUploadChanged" slot="input">
              </iron-input>
              <label for="fileUploadInput">
                <gr-button id="fileUploadBrowse" on-click="_onClickOpenFileBrowse">Browse</gr-button>
              </label>
            </p>
          </div>
        </div>
