    ...
    >
      ...
      <div class="main" slot="main">
        <gr-autocomplete
          ...
          text="{{_path}}"
        ></gr-autocomplete>
        <div id="dragDropArea" contenteditable="true" on-drop="_handleDragAndDropUpload" on-keypress="_handleKeyPress">
          ...
          <p contenteditable="false">
            ...
            <label for="fileUploadInput">
              <gr-button id="fileUploadBrowse" contenteditable="false">Browse</gr-button>
            </label>
          </p>
        </div>
      </div>
