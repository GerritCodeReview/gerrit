...
suite('gr-edit-controls tests', () => {
  ...
  suite('edit button CUJ', () => {
    ...
    test('open', () => {
      ...
      return showDialogSpy.lastCall.returnValue.then(() => {
        ...
        MockInteractions.tap(element.$.openDialog.shadowRoot!.querySelector('gr-button[primary]')!);
    ...
    test('cancel', () => {
      ...
      return showDialogSpy.lastCall.returnValue.then(() => {
        ...
        openAutoComplete.text = 'src/test.cpp';
        assert.isFalse(element.$.openDialog.disabled);
        MockInteractions.tap(element.$.openDialog.shadowRoot!.querySelector('gr-button')!);
        assert.isTrue(editDiffStub.called);
        assert.isTrue(navStub.called);
        assert.isTrue(closeDialogSpy.called);
  ...
  suite('delete button CUJ', () => {
    ...
    test('delete', () => {
      ...
      return showDialogSpy.lastCall.returnValue.then(() => {
        ...
        MockInteractions.tap(element.$.deleteDialog.shadowRoot!.querySelector('gr-button[primary]')!);
        flush();
    ...
    test('cancel', () => {
      ...
      return showDialogSpy.lastCall.returnValue.then(() => {
        ...
        element.$.deleteDialog!.querySelector('gr-autocomplete')!.text =
            'src/test.cpp';
        assert.isFalse(element.$.deleteDialog.disabled);
        MockInteractions.tap(element.$.deleteDialog.shadowRoot!.querySelector('gr-button')!);
        assert.isFalse(navStub.called);
        assert.isTrue(closeDialogSpy.called);
        assert.equal(element._path, 'src/test.cpp');
      });
  ...
  suite('rename button CUJ', () => {
    ...
    test('rename', () => {
      ...
      return showDialogSpy.lastCall.returnValue.then(() => {
        ...
        const input = element.$.renameDialog.querySelector('.newPathIronInput');
        if (!input) {
          assert.fail('<iron-input> with class \'newPathIronInput\' not found.');
        }
        input.bindValue = 'src/test.newPath';

        assert.isFalse(element.$.renameDialog.disabled);
        MockInteractions.tap(element.$.renameDialog.shadowRoot!.querySelector('gr-button[primary]')!);
        flush();
    ...
    test('rename fails', () => {
      ...
      return showDialogSpy.lastCall.returnValue.then(() => {
        ...
        element.$.renameDialog!.querySelector('.newPathIronInput')!.bindValue =
            'src/test.newPath';
    ...
    test('cancel', () => {
      ...
      return showDialogSpy.lastCall.returnValue.then(() => {
        ...
        element.$.renameDialog!.querySelector('.newPathIronInput')!.bindValue =
            'src/test.newPath';
        assert.isFalse(element.$.renameDialog.disabled);
        MockInteractions.tap(element.$.renameDialog.shadowRoot!.querySelector('gr-button')!);
        assert.isFalse(navStub.called);
        assert.isTrue(closeDialogSpy.called);
        assert.equal(element._path, 'src/test.cpp');
  ...
  suite('restore button CUJ', () => {
    ...
    test('restore hidden by default', () => {
      assert.isTrue(element.shadowRoot!.querySelector('#restore')!.classList!.contains('invisible')!);
    });
    ...
    test('restore', () => {
      ...
      return showDialogSpy.lastCall.returnValue.then(() => {
        MockInteractions.tap(element.$.restoreDialog.shadowRoot!.querySelector('gr-button[primary]')!);
        flush();
    ...
    test('cancel', () => {
      ...
      MockInteractions.tap(element.shadowRoot!.querySelector('#restore')!);
      return showDialogSpy.lastCall.returnValue.then(() => {
        MockInteractions.tap(element.$.restoreDialog.shadowRoot!.querySelector('gr-button')!);
        assert.isFalse(navStub.called);
        assert.isTrue(closeDialogSpy.called);
        assert.equal(element._path, 'src/test.cpp');
      });
