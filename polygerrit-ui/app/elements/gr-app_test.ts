...
import {GrRouter} from './core/gr-router/gr-router.js';
...
suite('gr-app tests', () => {
  ...
  test('reporting called before router start', () => {
    const routerStartStub = queryAndAssert<GrRouter>(
      queryAndAssert(element, '#app-element'),
      'gr-router'
    ).start as sinon.SinonStub;
