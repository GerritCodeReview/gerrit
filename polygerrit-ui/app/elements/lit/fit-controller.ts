...
<<<<<<< PATCH SET (a8c8bc Convert GrAutocompleteDropdown to Lit)
 ...
 */
>>>>>>> BASE      (2911f6 Add basic FitController)
...
>>>>>>> BASE      (2911f6 Add basic FitController)
  ...
  private discoverInfo() {
    ...
    this.fitInfo = {
      sizedBy: {
        minWidth: parseInt(target.minWidth, 10) || 0,
        minHeight: parseInt(target.minHeight, 10) || 0,
      },
      margin: {
...
<<<<<<< PATCH SET (a8c8bc Convert GrAutocompleteDropdown to Lit)
  ...
  private sizeDimension(
    ...
    const key = ('max' + extent) as keyof CSSStyleDeclaration;
    Object.assign(this.host.style, {
      [key]: max - margin - offset - sizingOffset + 'px',
    });
  }
