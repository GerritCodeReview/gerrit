...
(function(window) {
   ...
   * @param {string} text
   * @param {string} url
   * @param {boolean|undefined} opt_external
   */
  GrAdminApi.prototype.addMenuLink = function(text, url, opt_external) {
    this._menuLinks.push({text, url, external: !!opt_external});
  };
