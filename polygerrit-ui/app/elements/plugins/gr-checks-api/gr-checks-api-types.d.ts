...
export type ResponseCode = 'OK' | 'ERROR' | 'NOT_LOGGED_IN';
...
export type RunStatus = 'RUNNABLE' | 'RUNNING' | 'COMPLETED';
...
export type TagColor = 'GRAY' | 'GREEN';
...
// TBD: Add more ...
export type LinkIcon = 'EXTERNAL' | 'DOWNLOAD';
