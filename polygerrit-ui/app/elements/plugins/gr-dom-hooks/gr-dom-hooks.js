...
(function(window) {
  ...
  GrDomHooks.prototype._getHookName = function(endpointName, opt_moduleName) {
    if (opt_moduleName) {
  ...
  GrDomHooks.prototype.getDomHook = function(endpointName, opt_moduleName) {
  ...
  function GrDomHook(hookName, opt_moduleName) {
    ...
    if (opt_moduleName) {
      ...
      this._createWrapper(hookName);
    }
  }

  GrDomHook.prototype._createWrapper = function(hookName) {
    Polymer({
      is: hookName,
      properties: {
        plugin: Object,
  ...
  GrDomHook.prototype._onInstanceDetached = function(instance) {
    debugger
  ...
  GrDomHook.prototype._onNewInstance = function(instance) {
