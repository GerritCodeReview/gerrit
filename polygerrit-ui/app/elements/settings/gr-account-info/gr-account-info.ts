  ...
  override render() {
    ...
    return html`<div class="gr-form-styles">
      ...
      <section class="discoverability">
        <div class="title">
          <gr-tooltip-content
            title="When your account is discoverable by someone they will be able to search for your account, navigate to your dashboard, add you to a change, or mention you in a comment."
            has-tooltip
            show-icon
          >
