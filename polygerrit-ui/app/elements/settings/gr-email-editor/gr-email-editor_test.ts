...
suite('gr-email-editor tests', () => {
  ...
  test('renders', () => {
    ...
    assert.isFalse((rows[0].querySelector('md-radio.preferredRadio') as MdRadio).checked);
    assert.isNotOk(rows[0].querySelector('gr-button')!.disabled);

    assert.isTrue((rows[1].querySelector('md-radio.preferredRadio') as MdRadio).checked);
    assert.isOk(rows[1].querySelector('gr-button')!.disabled);

    assert.isFalse((rows[2].querySelector('md-radio.preferredRadio') as MdRadio).checked);
