  ...
  Polymer({
    ...
    _save() {
      ...
      if (this.$.username && this.$.username.value &&
          this.$.username.value !== this._account.username) {
        promises.push(this.$.restAPI.setAccountUsername(this.$.username.value));
      }
      if (this.$.name && this.$.name.value &&
          this.$.name.value !== this._account.name) {
        promises.push(this.$.restAPI.setAccountName(this.$.name.value));
      }
      if (this.$.email && this.$.email.value &&
          this.$.username.value !== this._account.username) {
        promises.push(this.$.restAPI.setPreferredAccountEmail(this.$.email.value));
      }
