...
import '../../shared/gr-button/gr-butto';
import '../../shared/gr-rest-api-interface/gr-rest-api-interface';
import '../../../styles/shared-style';
...
export class GrRegistrationDialog extends GestureEventListeners(
  ...
  _computeUsernameMutable(config?: ServerInfo, username?: string) {
    ...
    if (config === undefined || username === undefined) {
      return undefined;
    }
  ...
  _computeSaveDisabled(name?: string, email?: string, saving?: string) {
