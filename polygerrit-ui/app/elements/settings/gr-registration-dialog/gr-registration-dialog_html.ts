  ...
  <div class="container gr-form-styles">
      ...
      <section>
        ...
        <span hidden$="[[!_usernameMutable]]" class="value">
          <iron-input bind-value="{{_username}}">
            <input is="iron-input" id="usernameInput" disabled="[[_saving]]" />
          </iron-input>
        </span>
      </section>
      <section>
        <span class="title">Preferred Email</span>
        <span class="value">
          <iron-input bind-value="{{_account.email}}">
            <input
              is="iron-input"
              id="email"
    ...
    <footer>
      ...
      <gr-button
        ...
        primary=""
        link=""
        disabled="[[_computeSaveDisabled(_account.name, _username, _account.email, _saving)]]"
