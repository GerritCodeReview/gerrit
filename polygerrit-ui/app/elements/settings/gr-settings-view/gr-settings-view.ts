  ...
  override connectedCallback() {
    ...
    promises.push(
      this.restApiService.getConfig().then(config => {
        ...
        if (this._serverConfig?.receive?.enable_signed_push) {
      ...
      <div class="main gr-form-styles">
        ...
        <fieldset id="watchedProjects">
          <gr-watched-projects-editor
            ...
            @has-unsaved-changes-changed=${(e: ValueChangedEvent<boolean>) => {
        ...
        ${when(
          ...
          () => html`<div>
            ...
            <gr-gpg-editor
              ...
              @has-unsaved-changes-changed=${this
                ._handleGpgEditorHasSavedChanges}
            ></gr-gpg-editor>
          </div>`
        )}
