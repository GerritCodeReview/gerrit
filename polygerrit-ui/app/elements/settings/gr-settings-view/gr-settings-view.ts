...
export class GrSettingsView extends LitElement {
  ...
  @query('#accountInfo') accountInfo!: GrAccountInfo;

  @query('#watchedProjectsEditor')
  watchedProjectsEditor!: GrWatchedProjectsEditor;

  @query('#groupList') groupList!: GrGroupList;

  @query('#identities') identities!: GrIdentities;
  ...
  @query('#emailEditor') emailEditor!: GrEmailEditor;
    ...
    return html`<div>
      <gr-page-nav class="navStyles">
        <ul>
          ...
          ${when(
            this._showHttpAuth(this._serverConfig),
      ...
      <div class="main gr-form-styles">
        ...
        <fieldset id="profile">
          <gr-account-info
            ...
            @unsaved-changes-changed="_handleAccountInfoUnsavedChanges"
          ></gr-account-info>
          <gr-button
            @click="_handleSaveAccountInfo"
            disabled="${!this._accountInfoChanged}"
            >Save changes</gr-button
          >
        </fieldset>
        <h2 id="Preferences" class="${this._computeHeaderClass(_prefsChanged)}">
          Preferences
        </h2>
        <fieldset id="preferences">
          <section>
            ...
            <span class="value">
              <gr-select
                bind-value="${this._convertToString(_localPrefs.changes_per_page)}"
                @change=${this._handleChangesPerPage}
              >
          ...
          <section>
            ...
            <span class="value">
              <gr-select
                bind-value="${this._convertToString(_localPrefs.date_format)}"
                @change=${this._handleDateFormat}
              >
              ...
              <gr-select
                bind-value="${this._convertToString(_localPrefs.time_format)}"
                aria-label="Time Format"
                @change=${this._handleTimeFormat}
              >
          ...
          <section>
            ...
            <span class="value">
              <gr-select
                bind-value="${this._convertToString(_localPrefs.email_strategy)}"
                @change=${this._handleEmailStrategy}
              >
          ...
          <section ?hidden="${!this._convertToString(_localPrefs.email_format)}">
            <label class="title" for="emailFormatSelect">Email format</label>
            <span class="value">
              <gr-select
                bind-value="${this._convertToString(_localPrefs.email_format)}"
                @change=${this._handleEmailFormat}
              >
          ...
          <section ?hidden="${!this._localPrefs.default_base_for_merges}">
            ...
            <span class="value">
              <gr-select
                bind-value="${this._convertToString(_localPrefs.default_base_for_merges)}"
                @change=${this._handleDefaultBaseForMerges}
              >
          ...
          <section>
            ...
            <span class="value">
              <input
                ...
                @change=${this._handleRelativeDateInChangeTable}
              />
            </span>
          </section>
          <section>
            ...
            <span class="value">
              <gr-select
                bind-value="${this._convertToString(_localPrefs.diff_view)}"
                @change=${this._handleDiffView}
              >
          ...
          <section>
            ...
            <span class="value">
              <input
                ...
                @change=${this._handleShowSizeBarsInFileListChanged}
              />
            </span>
          </section>
          <section>
            ...
            <span class="value">
              <input
                ...
                @change=${this._handlePublishCommentsOnPushChanged}
              />
            </span>
          </section>
          <section>
            ...
            <span class="value">
              <input
                ...
                @change=${this._handleWorkInProgressByDefault}
              />
            </span>
          </section>
          <section>
            ...
            <span class="value">
              <input
                ...
                @change=${this._handleDisableKeyboardShortcutsChanged}
              />
            </span>
          </section>
          <section>
            ...
            <span class="value">
              <input
                ...
                @change=${this._handleDisableTokenHighlightingChanged}
              />
            </span>
          </section>
          <section>
            ...
            <span class="value">
              <input
                ...
                @change=${this._handleInsertSignedOff}
              />
            </span>
          </section>
          <gr-button
            id="savePrefs"
            @click="_handleSavePreferences"
        ...
        <h2
          id="DiffPreferences"
          class="${this._computeHeaderClass(_diffPrefsChanged)}"
        >
          Diff Preferences
        </h2>
        <fieldset id="diffPreferences">
          <gr-diff-preferences
            id="diffPrefs"
            @has-unsaved-changes-changed="_handleHasUnsavedChangesChanged"
          ></gr-diff-preferences>
          <gr-button
            id="saveDiffPrefs"
            @click="_handleSaveDiffPreferences"
        ...
        <h2
          ...
          class="${this._computeHeaderClass(_changeTableChanged)}"
        >
        ...
        <fieldset id="changeTableColumns">
          <gr-change-table-editor
            ...
            @show-number-changed="_handleShowNumberChanged"
            server-config="${this._serverConfig}"
            displayed-columns="${this._localChangeTableColumns}"
            @displayed-columns-changed="_handleDisplayedColumnsChanged"
          >
          </gr-change-table-editor>
          <gr-button
            id="saveChangeTable"
            @click="_handleSaveChangeTable"
        ...
        <h2
          id="Notifications"
          class="${this._computeHeaderClass(_watchedProjectsChanged)}"
        >
          Notifications
        </h2>
        <fieldset id="watchedProjects">
          <gr-watched-projects-editor
            has-unsaved-changes="${this._watchedProjectsChanged}"
            @has-unsaved-changes-changed="_handleHasProjectsChanged"
            id="watchedProjectsEditor"
          ></gr-watched-projects-editor>
          <gr-button
            @click="_handleSaveWatchedProjects"
        ...
        <h2
          id="EmailAddresses"
          class="${this._computeHeaderClass(_emailsChanged)}"
        >
          Email Addresses
        </h2>
        <fieldset id="email">
          <gr-email-editor
            id="emailEditor"
            has-unsaved-changes="${this._emailsChanged}"
            @has-unsaved-changes-changed="_handleHasEmailsChanged"
          ></gr-email-editor>
          <gr-button
            @click="_handleSaveEmails"
        ...
        <fieldset id="newEmail">
          <section>
            ...
            <span class="value">
              <iron-input
                ...
                type="text"
                @keydown="_handleNewEmailKeydown"
          ...
          >
            <p>
              ...
              <em>${this._lastSentVerificationEmail}</em>. Please check your inbox.
            </p>
          </section>
          <gr-button
            disabled="${!this._computeAddEmailButtonEnabled(_newEmail, _addingEmail)}"
            @click="_handleAddEmailButton"
            >Send verification</gr-button
          >
        </fieldset>
        <template is="dom-if" if="${this._showHttpAuth(_serverConfig)}">
          <div>
        ...
        <div ?hidden="${!this._serverConfig.sshd}">
          <h2 id="SSHKeys" class="${this._computeHeaderClass(_keysChanged)}">
            SSH keys
          </h2>
          <gr-ssh-editor
            id="sshEditor"
        ...
        <div ?hidden="${!this._serverConfig.receive.enable_signed_push}">
          <h2 id="GPGKeys" class="${this._computeHeaderClass(_gpgKeysChanged)}">
            GPG keys
          </h2>
          <gr-gpg-editor
            id="gpgEditor"
            has-unsaved-changes="${this._gpgKeysChanged}"
            @has-unsaved-changes-changed=${this._handleGpgEditorHasSavedChanges}
          ></gr-gpg-editor>
        </div>
        ...
        <template
          is="dom-if"
          if="${this._serverConfig.auth.use_contributor_agreements}"
        >
        ...
        <fieldset class="filters">
          ...
          <p>
            ...
            <a
              href$="${this._getFilterDocsLink(_docsBaseUrl)}"
              target="_blank"
              rel="nofollow"
  ...
  _handleEmailStrategy() {
    this.set('_localPrefs.email_strategy', this.emailNotificationsSelect.value);
  }
