      ...
      <div class="main gr-form-styles">
        ...
        <fieldset id="profile">
          <gr-account-info
            ...
            @unsaved-changes-changed=${this._handleAccountInfoUnsavedChanges}
          ></gr-account-info>
          <gr-button
            @click=${this._handleSaveAccountInfo}
        ...
        <fieldset id="preferences">
          <section>
            ...
            <span class="value">
              <gr-select
                bind-value=${this._convertToString(
          ...
          <section>
            ...
            <span class="value">
              <gr-select
                bind-value=${this._convertToString(this._localPrefs.diff_view)}
        ...
        <fieldset id="diffPreferences">
          <gr-diff-preferences
            id="diffPrefs"
            @has-unsaved-changes-changed=${this._handleHasUnsavedChangesChanged}
          ></gr-diff-preferences>
          <gr-button
            id="saveDiffPrefs"
            @click=${this._handleSaveDiffPreferences}
        ...
        <fieldset id="changeTableColumns">
          <gr-change-table-editor
            ...
            @show-number-changed=${this._handleShowNumberChanged}
            .serverConfig=${this._serverConfig}
            .defaultColumns=${this._localChangeTableColumns}
            @displayed-columns-changed=${this._handleDisplayedColumnsChanged}
          >
          </gr-change-table-editor>
          <gr-button
            id="saveChangeTable"
        ...
        <fieldset id="watchedProjects">
          <gr-watched-projects-editor
            ...
            @has-unsaved-changes-changed=${this._handleHasProjectsChanged}
            id="watchedProjectsEditor"
          ></gr-watched-projects-editor>
          <gr-button
            @click=${this._handleSaveWatchedProjects}
        ...
        <fieldset id="email">
          <gr-email-editor
            ...
            @has-unsaved-changes-changed=${this._handleHasEmailsChanged}
          ></gr-email-editor>
          <gr-button
            @click=${this._handleSaveEmails}
