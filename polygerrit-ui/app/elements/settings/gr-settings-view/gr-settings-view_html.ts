    ...
    <div class="main gr-form-styles">
      ...
      <fieldset id="preferences">
        <section>
          ...
          >
          <span class="value">
            <gr-select bind-value="[[_convertToString(_localPrefs.changes_per_page)]]" on-change="_handleChangesPerPage">
        ...
        <section>
          ...
          >
          <span class="value">
            <gr-select bind-value="[[_convertToString(_localPrefs.date_format)]]" on-change="_handleDateFormat">
        ...
        <section>
          ...
          >
          <span class="value">
            <gr-select bind-value="[[_convertToString(_localPrefs.email_strategy)]]" on-change="_handleEmailStrategy">
        ...
        <section hidden$="[[!_localPrefs.email_format]]">
          ...
          <span class="value">
            <gr-select bind-value="[[_convertToString(_localPrefs.email_format)]]" on-change="_handleEmailFormat">
        ...
        <section hidden$="[[!_localPrefs.default_base_for_merges]]">
          ...
          <span class="value">
            <gr-select bind-value="[[_convertToString(_localPrefs.default_base_for_merges)]]" on-change="_handleDefaultBaseForMerges">
              <select>
        ...
        <section>
          ...
          <span class="value">
            <gr-select bind-value="[[_convertToString(_localPrefs.diff_view)]]" on-change="_handleDiffView">
              <select>
