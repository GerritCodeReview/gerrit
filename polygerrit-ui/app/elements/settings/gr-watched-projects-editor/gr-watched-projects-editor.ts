...
type NotificationKey = PropertiesOfType<Concrete<ProjectWatchInfo>, boolean>;
...
export class GrWatchedProjectsEditor extends LitElement {
  ...
  _query: AutocompleteQuery = input => this._getProjectSuggestions(input);
  ...
  private renderNotifyControl(project: ProjectWatchInfo, key: NotificationKey) {
    return html`
      <td class="notifControl" @click=${this.handleNotifCellClick}>
        <input
          type="checkbox"
          data-key=${key}
  ...
  private handleCheckboxChange(
    project: ProjectWatchInfo, key: NotificationKey, e: Event) {
