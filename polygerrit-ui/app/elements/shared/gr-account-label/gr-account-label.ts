...
export class GrAccountLabel extends GrLitElement {
  ...
  render() {
    ...
    if (!account || !change) return;
    const hasAttention = this._hasAttention(
      highlightAttention,
      account,
      change,
      forceAttention
    ...
    this.cancelLeftPadding = this._computeCancelLeftPadding(
      this.hideAvatar,
      highlightAttention,
      account,
      change,
    ...
    return html`<span>
      ...
      <span
        id="hovercardTarget"
        class="${classMap({
          hasAttention: !!this._hasAttention(
            highlightAttention,
            account,
            change,
            forceAttention
      ...
      >
        ...
        <span class="text" part="gr-account-label-text">
          <span class="name"
            >${this._computeName(account, this._config, this.firstName)}</span
          >
  ...
  _computeAttentionButtonEnabled(
    ...
    account: AccountInfo,
    change: ChangeInfo,
    selfAccount: AccountInfo | undefined,
    selected: boolean
  ) {
