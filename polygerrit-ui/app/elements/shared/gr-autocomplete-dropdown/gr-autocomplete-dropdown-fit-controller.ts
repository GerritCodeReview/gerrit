...
declare global {
  interface HTMLElementTagNameMap {
    'gr-autocomplete-dropdown-with-fit-controller': GrAutocompleteDropdownWithFitController;
  }
}
 ...
 */
@customElement('gr-autocomplete-dropdown-with-fit-controller')
export class GrAutocompleteDropdownWithFitController extends base {
  static get template() {
    return htmlTemplate;
  }
