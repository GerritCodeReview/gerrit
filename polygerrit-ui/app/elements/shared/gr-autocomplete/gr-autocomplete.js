...
(function() {
  ...
  Polymer({
    ...
    properties: {
       ...
       * promise yields an array of suggestion objects with "name", "hint",
       * "value" properties. The "name" property will be displayed in the
       * suggestion entry. The "hint" property will, when specified, appear next
       * to the "name" as hint text. The "value" property will be emitted if
       * that suggestion is selected.
       *
