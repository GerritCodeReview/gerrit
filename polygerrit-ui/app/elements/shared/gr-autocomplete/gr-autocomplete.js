...
(function() {
  ...
  Polymer({
    ...
    observers: [
      ...
      '_updateSuggestions(text, _disableSuggestions, threshold, noDebounce)',
    ],
    ...
    _onInputFocus() {
      this._focused = true;
      this._updateSuggestions(this.text, this._disableSuggestions,
          this.threshold, this.noDebounce);
    ...
    _updateSuggestions(text, disable, threshold, noDebounce) {
      if (disable) { return; }
