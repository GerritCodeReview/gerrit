...
(function() {
  ...
  Polymer({
    ...
    observers: [
      '_adjustSuggestionsHidden(_suggestions, _focused)'
    ],
    ...
    _handleItemSelect: function(e) {
      var silent = false;
      if (e.detail.key === 'tab' && this.tabCompleteWithoutCommit) {
        silent = true;
      }
    ...
    _adjustSuggestionsHidden: function(suggestions, focused) {
      var hidden = !(suggestions.length && focused);
      if (hidden) {
