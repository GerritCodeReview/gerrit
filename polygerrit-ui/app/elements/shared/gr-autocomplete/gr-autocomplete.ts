    ...
    return [
      ...
      css`
        ...
        md-outlined-text-field {
          ...
          --md-outlined-text-field-label-text-color: var(--primary-text-color);
          ...
          //--md-sys-color-primary: var(--border-color);
          --md-outlined-text-field-focus-outline-color: var(--border-color);
          --md-outlined-text-field-outline-color: var(--border-color);
          --md-outlined-text-field-hover-outline-color: var(--border-color);
