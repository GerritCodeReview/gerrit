...
export class GrAutocomplete extends LitElement {
  ...
  @query('#suggestionsDropdown') suggestionsDropdown!: GrAutocompleteDropdown;
  ...
  get nativeInput() {
    return this.input.inputElement as HTMLInputElement;
  }
  ...
  _handleInputCommit(_tabComplete?: boolean) {
    ...
    this.selected = this.suggestionsDropdown.getCursorTarget();
