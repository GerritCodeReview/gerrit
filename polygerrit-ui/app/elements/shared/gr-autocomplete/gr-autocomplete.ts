...
export interface GrAutocompleteGeneric {
  $: {
...
@customElement('gr-autocomplete-generic')
export class GrAutocompleteGeneric<T = string> extends base {
  static get template() {
    return htmlTemplate;
  }
  /**
...
export class GrAutocomplete extends GrAutocompleteGeneric<string> {}

declare global {
  interface HTMLElementTagNameMap {
    'gr-autocomplete': GrAutocomplete;
    'gr-autocomplete-generic': GrAutocompleteGeneric;
  }
}
