...
import {AccountInfo, AvatarInfo} from '../../../types/common';
import {
...
suite('gr-avatar tests', () => {
  ...
  suite('config has avatars', () => {
    ...
    setup(() => {
      ...
      const orig = element.buildAvatarURL;
      sinon
        .stub(element, 'buildAvatarURL')
        .callsFake(function (this: GrAvatar, account: AccountInfo | undefined) {
