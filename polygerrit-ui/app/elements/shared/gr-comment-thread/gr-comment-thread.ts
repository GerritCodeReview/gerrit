...
import {CustomKeyboardEvent, KeyboardShortcutMixin,} from '../../../mixins/keyboard-shortcut-mixin/keyboard-shortcut-mixin';
import {isDraft, isRobot, sortComments, UIComment, UIDraft, UIRobot} from '../../diff/gr-comment-api/gr-comment-api';
...
import {CommentRange, ConfigInfo, NumericChangeId, PatchSetNum, RepoName, UrlEncodedCommentId,} from '../../../types/common';
...
export class GrCommentThread extends KeyboardShortcutMixin(
  ...
  _handleCommentSavedOrDiscarded() {
    console.log('_handleCommentSavedOrDiscarded');
    this.dispatchEvent(
