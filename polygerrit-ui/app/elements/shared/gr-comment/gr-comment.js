  ...
  class GrComment extends Polymer.mixinBehaviors( [
    ...
    get confirmDeleteOverlay() {
      if (!this._overlays.confirmDelete) {
        ...
        Polymer.dom.flush();
        this._overlays.confirmDelete = this.shadowRoot.querySelector('#confirmDeleteOverlay');
      }
    ...
    get confirmDiscardOverlay() {
      if (!this._overlays.confirmDiscard) {
        this._enableOverlay = true;
        Polymer.dom.flush();
        this._overlays.confirmDiscard = this.shadowRoot.querySelector('#confirmDiscardOverlay');
      }
