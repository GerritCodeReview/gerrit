...
export class GrComment extends LitElement {
  ...
  private async checkGeneratedSuggestionAvailability() {
    ...
    // TODO(milutin): Remove once implemented by plugin prototype
    if (typeof suggestionProvider.isAvailable !== 'function') return true;
    return await suggestionProvider.isAvailable();
  }
