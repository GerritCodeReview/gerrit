...
export class GrComment extends LitElement {
  ...
  /**
   * When the user clicks 'save' while auto-saving is in progress, then this is
   * set to 'true'. Then when auto-saving has completed a proper save() can be
   * triggered.
   */
  private shouldSaveAfterAutoSave = false;

  /**
   * Set when entering editing mode to the content of DraftInfo.
