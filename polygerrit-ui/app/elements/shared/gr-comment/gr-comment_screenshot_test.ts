...
import './gr-comment';
import {CommentInfo, Timestamp, UrlEncodedCommentId} from '../../../types/common';
import {createAccountDetailWithId, createComment} from '../../../test/test-data-generators';
...
suite('gr-comment screenshot tests', () => {
  ...
  test('normal comment', async () => {
    element = await fixture(html`<gr-comment .comment=${c_normal}></gr-comment>`);
