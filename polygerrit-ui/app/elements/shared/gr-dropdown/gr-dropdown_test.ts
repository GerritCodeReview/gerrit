...
suite('gr-dropdown tests', () => {
  ...
  suite('keyboard navigation', () => {
    ...
    test('down', async () => {
      ...
      pressKey(queryAndAssert<HTMLElement>(element, '#trigger'), 'ArrowDown');
      await element.updateComplete;
      assert.isTrue(element.dropdown.open);
      pressKey(queryAll<HTMLElement>(element, 'md-menu-item')[0], 'ArrowDown');
      await element.updateComplete;
    ...
    test('up', async () => {
      ...
      pressKey(queryAndAssert<HTMLElement>(element, '#trigger'), 'ArrowUp');
      await element.updateComplete;
      assert.isTrue(element.dropdown.open);
      pressKey(queryAll<HTMLElement>(element, 'md-menu-item')[0], 'ArrowUp');
      await element.updateComplete;
      assert.isTrue(stub.called);
    });
    ...
    test('enter/space', async () => {
      ...
      pressKey(queryAndAssert<HTMLElement>(element, '#trigger'), ' ');
      await element.updateComplete;
      assert.isTrue(element.dropdown.open);
      await element.updateComplete;
      await waitUntil(() =>
      ...
      pressKey(queryAll<HTMLElement>(element, 'md-menu-item')[0], ' ');
      await element.updateComplete;
      assert.isTrue(stub.called);
    });
  });
