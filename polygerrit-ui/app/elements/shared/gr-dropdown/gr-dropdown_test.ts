...
suite('gr-dropdown tests', () => {
        ...
        >
          <div class="dropdown-content">
            <gr-tooltip-content has-tooltip="" title="hello">
              <md-menu-item active="" data-id="foo" md-menu-item="" selected="">
                <div slot="headline">item one</div>
              </md-menu-item>
            </gr-tooltip-content>
            <md-divider role="separator" tabindex="-1"> </md-divider>
            <gr-tooltip-content>
              <md-menu-item data-id="bar" md-menu-item="">
                <div slot="headline">item two</div>
              </md-menu-item>
            </gr-tooltip-content>
          </div>
        </md-menu>
  ...
  test('non link items', async () => {
    ...
    await element.updateComplete;
    queryAndAssert<MdMenuItem>(element, 'md-menu-item').click();
