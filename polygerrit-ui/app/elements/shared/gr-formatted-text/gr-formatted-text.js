  ...
  Polymer({
    ...
    _contentChanged: function(content) {
      ...
      while (container.firstChild) {
        container.replaceChild(container.firstChild);
      }
    ...
    _makeLinkedText: function(content, isPre) {
      var text = this._createElement('gr-linked-text');
    ...
    /**
     * Create a DOM element with the specified tag name, and initialized with
     * class-names tha permit styling from the element stylesheet.
     */
    _createElement: function(tag) {
      var e = document.createElement(tag);
      e.classList.add('style-scope', 'gr-formatted-text');
      return e;
    },
    ...
    _computeNodes: function(blocks) {
      return blocks.map(function(block) {
        ...
        if (block.type === 'quote') {
          var bq = this._createElement('blockquote');
          bq.appendChild(this._makeLinkedText(block.text));
          return bq;
        }
