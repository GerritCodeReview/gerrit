...
suite('gr-formatted-text tests', () => {
  ...
  suite('as plaintext', () => {
    ...
    // NEEDS ATTENTION: default linkification interferes with this test.
    ...
    // ATTENTION NEEDED;  MODIFIED;  - not sure why the indentation is off
    ...
    // ATTENTION NEEDED; issue due to linkification
  ...
  suite('as markdown', () => {
    ...
    test('does not render if too long', async () => {
      // "marked" linkifies http links by default, so they will be linkified
      ...
      // NOTE: The test was changed since the custom linkification was disabled
      // for http(s) links.
      assert.shadowDom.equal(
        element,
        /* HTML */ `
    ...
    // // ATTENTION NEEDED to the codespan method and code
