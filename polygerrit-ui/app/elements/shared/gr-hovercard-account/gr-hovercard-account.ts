...
export class GrHovercardAccount extends base {
    ...
    return html`
      <div class="action">
        <gr-button
          ...
          link=""
          no-uppercase
          @click="${this._handleRemoveReviewerOrCC}"
        >
      ...
      <div class="action">
        <gr-button
          ...
          link=""
          no-uppercase
          @click="${this._handleChangeReviewerOrCCStatus}"
        >
    ...
    return html`
      <div class="action">
        <gr-button
          ...
          link=""
          no-uppercase
          @click="${this._handleClickAddToAttentionSet}"
        >
    ...
    return html`
      <div class="action">
        <gr-button
          ...
          link=""
          no-uppercase
          @click="${this._handleClickRemoveFromAttentionSet}"
        >
  ...
  _handleClickAddToAttentionSet(e: MouseEvent) {
  ...
  _handleClickRemoveFromAttentionSet(e: MouseEvent) {
    if (!this.change || !this.account._account_id) return;
    this.dispatchEventThroughTarget('show-alert', {
      message: 'Saving attention set update ...',
      dismissOnNavigation: true,
