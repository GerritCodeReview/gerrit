...
export const htmlTemplate = html`
  ...
  <div id="container" role="tooltip" tabindex="-1">
    ...
    <template
      is="dom-if"
      if="[[_computeShowLabelNeedsAttention()]]"
    >
      <div class="attention">
        <div>
          <iron-icon
    ...
    <template
      is="dom-if"
      if="[[_computeShowActionAddToAttentionSet()]]"
    >
      <div class="action">
        <gr-button
    ...
    <template
      is="dom-if"
      if="[[_computeShowActionRemoveFromAttentionSet()]]"
    >
      <div class="action">
        <gr-button
    ...
    <template
      is="dom-if"
      if="[[_showReviewerOrCCActions(account, change)]]"
    >
      <div class="action">
        <gr-button
