...
(function() {
  ...
  Polymer({
    ...
    attached() {
      ...
      this.listen(this._target, 'blue', 'hide');
    ...
    removeListeners() {
      ...
      this.unlisten(this._target, 'blue', 'hide');
     ...
     *
     * @param {Event} evt DOM Event (e.g. `mouseleave` event)
     */
    hide(evt) {
      ...
      if (!this._isShowing || evt.toElement === this ||
          (evt.fromElement === this && evt.toElement === this._target)) {
        return;
      }
     ...
     *
     * @param {Event} evt DOM Event (e.g., `mouseenter` event)
     */
    show(evt) {
      if (this._isShowing) {
        return;
