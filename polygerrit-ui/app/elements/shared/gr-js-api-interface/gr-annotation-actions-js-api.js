...
(function(window) {
  ...
  AnnotationLayer.prototype.annotate = function(el, line) {
    var annotationActionsContext = new GrAnnotationActionsContext(
        el, line, this._path, this._changeNum, this._patchNum, this._annotateRange)
    this._addLayerFunc(annotationActionsContext);
  };
  ...
  AnnotationLayer.prototype._annotateRange = function(startRange, endRange, el, cssClass) {
    GrAnnotation.annotateElement(el, startRange, endRange, cssClass);
  };
