...
(function(window) {
  ...
  function GrChangeReplyInterface(plugin) {
    this.plugin = plugin;
  ...
  GrChangeReplyInterface.prototype.addReplyTextChangedCallback = function(handler) {
    this.getDomHook().then(function(el) {
      if (!el.content) { return; }
      el.content.addEventListener('value-changed', function(e) {
