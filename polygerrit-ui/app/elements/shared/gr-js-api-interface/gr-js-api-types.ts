...
export interface JsApiService extends Finalizable {
   ...
   */
  handleBeforeChangeAction(key: string, change?: ParsedChangeInfo): Promise<boolean>;
   ...
   */
  handleBeforeReplySent(change: ChangeInfo | ParsedChangeInfo, reviewInput: ReviewInput): Promise<boolean>;
