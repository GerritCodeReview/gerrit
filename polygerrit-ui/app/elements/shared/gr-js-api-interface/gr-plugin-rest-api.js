...
(function(window) {
   ...
   * @return {!Promise} resolves on success, rejects on error.
   */
  GrPluginRestApi.prototype.post = function(url, opt_payload, opt_contentType) {
    return this.send('POST', url, opt_payload, null, opt_contentType);
  };
   ...
   * @return {!Promise} resolves on success, rejects on error.
   */
  GrPluginRestApi.prototype.put = function(url, opt_payload, opt_contentType) {
    return this.send('PUT', url, opt_payload, null, opt_contentType);
  };
