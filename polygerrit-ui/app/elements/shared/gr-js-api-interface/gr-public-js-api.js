...
(function(window) {
  ...
  const PLUGIN_LOADING_TIMEOUT_MS = 7000;
  ...
  const _resolveAllPluginsLoaded = null;
  const _allPluginsPromise = null;
  ...
  Gerrit.awaitPluginsLoaded = function() {
    if (!Gerrit._allPluginsPromise) {
      if (Gerrit._arePluginsLoaded()) {
        ...
        let timeoutId;
        Gerrit._allPluginsPromise =
          Promise.race([
            new Promise(resolve => Gerrit._resolveAllPluginsLoaded = resolve),
