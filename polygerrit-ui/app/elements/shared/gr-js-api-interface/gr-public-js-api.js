...
(function(window) {
  ...
  Plugin.prototype.changeReply = function() {
    const replyApi = new GrChangeReplyInterface(this);
  ...
  Gerrit._getModulesForEndoint = function(name, opt_options) {
    const modeulesData = Gerrit._getEndpointDetails(name, opt_options);
  ...
  /**
   * Get .html plugins that should be imported into endpoints.
   */
