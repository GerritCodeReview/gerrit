...
(function(window) {
  ...
  Plugin.prototype.changeReply = function() {
    var replyApi = new GrChangeReplyInterface(this);
    // TODO (viktard): remove _el when GrChangeReplyInterfaceOld is removed.
    replyApi._el = Plugin._sharedAPIElement.getElement(
