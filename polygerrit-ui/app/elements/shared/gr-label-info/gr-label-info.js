...
$_documentContainer.innerHTML = `<dom-module id="gr-label-info">
    ...
    <p class\$="placeholder [[_computeShowPlaceholder(labelInfo, change.labels.*)]]">
      ...
      <template is="dom-repeat" items="[[_mapLabelInfo(labelInfo, account, change.labels.*)]]" as="mappedLabel">
        <tr class="labelValueContainer">
          ...
          <td>
            <gr-button link="" aria-label="Remove" on-tap="_onDeleteVote" tooltip="Remove vote" data-account-id\$="[[mappedLabel.account._account_id]]" class\$="deleteBtn [[_computeDeleteClass(mappedLabel.account, mutable, change)]]">
