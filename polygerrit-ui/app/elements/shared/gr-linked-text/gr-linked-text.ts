...
export class GrLinkedText extends LitElement {
  ...
  // configuration.  This is how commentLinks are implemented.
  // Lit doesn't allow dynamically mutating dom that it owns. Therefore,
  // to get around this we create a single element that we slot into the Lit-owned
  // DOM.  This element will not be part of this LitElement as it's slotted in
  // and thus can be modified on the fly by _handleParseResult.
