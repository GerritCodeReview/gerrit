...
export class GrLinkedText extends LitElement {
  ...
  // NOTE: Lit doesn't allow modifying dom that it owns. Therefore, to get
  // around this we create a single element that we slot into the Lit-owned
  // DOM.  This element will not be part of this LitElement as it's slotted in
  // and thus can be modified on the fly by code.
