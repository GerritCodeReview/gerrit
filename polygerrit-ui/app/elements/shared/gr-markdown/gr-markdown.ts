...
export class GrMarkdown extends LitElement {
  ...
  override render() {
    // TODO: Handle \u200B added in gr-change-view
    // TODO: ba-linkify links seem to get mangled later.
    // TODO: Link rewrites should display the entire match as text and not "$1"
    // which is only the first group in the match.
    // TODO: make a link-util.ts for the helper function at the end of the file
