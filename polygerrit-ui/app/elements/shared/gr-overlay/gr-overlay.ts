...
export class GrOverlay extends IronOverlayMixin(
  ...
  get _focusableNodes() {
    ...
    // Currently IronFocsablesHelper is not exported from iron-focusables-helper as it should
    // so we use Polymer.IronFocsablesHelper here instead (can not use the IronFocsablesHelperClass
