...
(function() {
  ...
  Polymer({
     ...
     * @return {Promise}
     */
    executeChangeAction(changeNum, method, endpoint, opt_payload, opt_revision,
        opt_errFn) {
      return this._getChangeURLAndSend(changeNum, method, opt_patchNum,
          opt_payload, opt_errFn);
    },
