...
(function() {
  ...
  Polymer({
    ...
    saveFileReviewed(changeNum, patchNum, path, reviewed, opt_errFn, opt_ctx) {
      ...
      return this.getChangeURLAndSend(changeNum, patchNum, method, e, null,
          opt_errFn, opt_ctx);
    },
    ...
    getFileInChangeEdit(changeNum, path) {
      ...
      return this.getChangeURLAndSend(changeNum, null, 'GET', e);
    },

    rebaseChangeEdit(changeNum) {
      return this.getChangeURLAndSend(changeNum, null, 'POST', '/edit:rebase');
    },

    deleteChangeEdit(changeNum) {
      return this.getChangeURLAndSend(changeNum, null, 'DELETE', '/edit');
    },

    restoreFileInChangeEdit(changeNum, restore_path) {
      const p = {restore_path};
      return this.getChangeURLAndSend(changeNum, null, 'POST', '/edit', p);
    },
    ...
    deleteFileInChangeEdit(changeNum, path) {
      const e = '/edit/' + encodeURIComponent(path);
      return this.getChangeURLAndSend(changeNum, null, 'DELETE', e);
    },

    saveChangeEdit(changeNum, path, contents) {
      const e = '/edit/' + encodeURIComponent(path);
      return this.getChangeURLAndSend(changeNum, null, 'PUT', e, contents);
    },

    // Deprecated, prefer to use putChangeCommitMessage instead.
    saveChangeCommitMessageEdit(changeNum, message) {
      const p = {message};
      return this.getChangeURLAndSend(changeNum, null, 'PUT', '/edit:message',
          p);
    },

    publishChangeEdit(changeNum) {
      return this.getChangeURLAndSend(changeNum, null, 'POST',
          '/edit:publish');
    },

    putChangeCommitMessage(changeNum, message) {
      const p = {message};
      return this.getChangeURLAndSend(changeNum, null, 'PUT', '/message', p);
    },
    ...
    _sendDiffDraftRequest(method, changeNum, patchNum, draft) {
      ...
      const promise = this.getChangeURLAndSend(changeNum, patchNum, method,
          endpoint, body);
    ...
    setChangeTopic(changeNum, topic) {
      const p = {topic};
      return this.getChangeURLAndSend(changeNum, null, 'PUT', '/topic', p)
          .then(this.getResponseObject);
    },

    setChangeHashtag(changeNum, hashtag) {
      return this.getChangeURLAndSend(changeNum, null, 'POST', '/hashtags',
    ...
    setDescription(changeNum, patchNum, desc) {
      ...
      return this.getChangeURLAndSend(changeNum, patchNum, 'PUT',
          '/description', p);
    },
    ...
    setAssignee(changeNum, assignee) {
      const p = {assignee};
      return this.getChangeURLAndSend(changeNum, null, 'PUT', '/assignee', p);
    },

    deleteAssignee(changeNum) {
      return this.getChangeURLAndSend(changeNum, null, 'DELETE', '/assignee');
    },
    ...
    startWorkInProgress(changeNum, opt_message) {
      ...
      return this.getChangeURLAndSend(changeNum, null, 'POST', '/wip', payload)
          .then(response => {
            if (response.status === 204) {
    ...
    startReview(changeNum, opt_body, opt_errFn) {
      return this.getChangeURLAndSend(changeNum, null, 'POST', '/ready',
          opt_body, opt_errFn);
    },
    ...
    deleteComment(changeNum, patchNum, commentID, reason) {
      ...
      return this.getChangeURLAndSend(changeNum, patchNum, 'POST', endpoint,
     ...
     * @return {Promise<Object>}
     */
    getChangeURLAndSend(changeNum, opt_patchNum, method, endpoint, opt_payload,
    ...
    * @return {Promise<Object>}
    */
    _getChangeURLAndFetch(changeNum, opt_patchNum, endpoint, opt_errFn,
