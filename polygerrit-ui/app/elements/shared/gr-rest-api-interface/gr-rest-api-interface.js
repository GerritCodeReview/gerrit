...
(function() {
  ...
  Polymer({
     ...
     * @param {string} url
     * @param {object|undefined} opt_fetchOptions
     * @return {Promise}
     */
     ...
     */
    _logCall(url, opt_fetchOptions, startTime, status) {
      const method = (opt_fetchOptions && opt_fetchOptions.method) ?
          opt_fetchOptions.method : 'GET';
