  ...
  Polymer({
    ...
    _getDiffComments(changeNum, endpoint, opt_basePatchNum,
      ...
      function onlyParent(c) {
        return c.side == PARENT_PATCH_NUM ||
            c.side == AUTOMERGE_PARENT_PATCH_NUM;
      }
    ...
    getImagesForDiff(changeNum, diff, patchRange) {
      ...
      if (diff.meta_a && diff.meta_a.content_type.startsWith('image/')) {
        if (patchRange.basePatchNum === PARENT_PATCH_NUM ||
           patchRange.basePatchNum === AUTOMERGE_PARENT_PATCH_NUM) {
