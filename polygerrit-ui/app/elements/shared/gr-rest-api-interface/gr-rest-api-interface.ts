...
import {hasOwnProperty, assertNever} from '../../../utils/common-util';
...
export class GrRestApiInterface extends GestureEventListeners(
  ...
  getChangeFiles(changeNum: ChangeNum, patchRange: PatchRange) {
  ...
  getChangeEditFiles(changeNum: ChangeNum, patchRange: PatchRange) {
