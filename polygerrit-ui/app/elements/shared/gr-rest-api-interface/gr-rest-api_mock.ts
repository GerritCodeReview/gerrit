...
import {ParsedChangeInfo} from './gr-reviewer-updates-parser';
import {readResponsePayload} from './gr-rest-apis/gr-rest-api-helper';
import {
...
export const grRestApiMock: RestApiService = {
  ...
  getDiffPreferences(): Promise<DiffPreferencesInfo | undefined> {
    return Promise.resolve(DEFAULT_DIFF_PREFS);
  },
  ...
  getEditPreferences(): Promise<EditPreferencesInfo | undefined> {
    return Promise.resolve(DEFAULT_EDIT_PREFS);
  },
