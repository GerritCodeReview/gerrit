...
const TAG_REVIEWER_UPDATE = 'autogenerated:gerrit:reviewerUpdate';
const TAG_DELETE_REVIEWER = 'autogenerated:gerrit:deleteReviewer';
...
GrReviewerUpdatesParser.prototype._filterRemovedMessages = function() {
  this.result.messages = this.result.messages
      .filter(message => message.tag !== TAG_DELETE_REVIEWER);
};
