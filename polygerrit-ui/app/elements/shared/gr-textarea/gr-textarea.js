...
(function() {
  ...
  Polymer({
     ...
     * the text up until the point of interest. Then a span element is added to
     * the end so that the emojiSuggestions are positioned by.
     */
    _updateCaratPosition() {
      ...
      const caratSpan = document.createElement('span')
          .appendChild(this.$.emojiSuggestions);
