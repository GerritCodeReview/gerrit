...
export class GrTooltip extends GrLitElement {
  ...
  set maxWidth(value: string) {
    ...
    // lit-elements do not have updateStyles
    // so we have to manually define what was in polymer.
    //window.ShadyCSS.styleSubtree(/** @type {!HTMLElement} */(this), {'--tooltip-max-width': value});
    this.style.setProperty('--tooltip-max-width', value);
  }
}
