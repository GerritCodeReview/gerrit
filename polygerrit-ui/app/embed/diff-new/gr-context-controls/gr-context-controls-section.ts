...
@customElement('gr-context-controls-section-new')
export class GrContextControlsSectionNew extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'gr-context-controls-section-new': GrContextControlsSectionNew;
  }
}
