...
import {GrContextControlsSectionNew} from './gr-context-controls-section';
import {fixture, html, assert} from '@open-wc/testing';

suite('gr-context-controls-section test', () => {
  let element: GrContextControlsSectionNew;

  setup(async () => {
    const diffModel = new DiffModel();
    element = await fixture<GrContextControlsSectionNew>(
      html`<gr-context-controls-section-new></gr-context-controls-section-new>`
    );
          ...
          <tbody>
            ...
            <tr class="dividerRow gr-diff show-both">
              ...
              <td class="dividerCell gr-diff" colspan="3">
                <gr-context-controls-new class="gr-diff" showconfig="both">
