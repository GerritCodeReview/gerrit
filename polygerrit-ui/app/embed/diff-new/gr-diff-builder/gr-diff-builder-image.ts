...
@customElement('gr-diff-image-new-new')
class GrDiffImageNewNew extends LitElement {
...
@customElement('gr-diff-image-old-new')
class GrDiffImageOldNew extends LitElement {
  @property() baseImage?: ImageInfo;
...
declare global {
  interface HTMLElementTagNameMap {
    'gr-diff-image-new-new': GrDiffImageNewNew;
    'gr-diff-image-old-new': GrDiffImageOldNew;
  }
}
