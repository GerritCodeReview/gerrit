...
import {GrDiffSectionNew} from './gr-diff-section';
...
suite('gr-diff-section test', () => {
  let element: GrDiffSectionNew;

  setup(async () => {
    element = await fixture<GrDiffSectionNew>(
      html`<gr-diff-section-new></gr-diff-section-new>`
    );
  ...
  test('3 normal unchanged rows', async () => {
    ...
    assert.lightDom.equal(
      element,
      /* HTML */ `
        <gr-diff-row-new class="left-1 right-1"> </gr-diff-row-new>
            ...
            >
              ...
              <td class="both content gr-diff left no-intraline-info">
                <div
                  ...
                  id="left-content-1"
                >
                  <gr-diff-text-new>asdf</gr-diff-text-new>
                </div>
              </td>
            ...
            >
              ...
              <td class="both content gr-diff left no-intraline-info">
                <div
                  ...
                  id="left-content-1"
                >
                  <gr-diff-text-new>qwer</gr-diff-text-new>
                </div>
              </td>
              <td class="gr-diff lineNum right" data-value="1">
                <button
            ...
            >
              ...
              <td class="both content gr-diff left no-intraline-info">
                <div
                  ...
                  id="left-content-1"
                >
                  <gr-diff-text-new>zxcv</gr-diff-text-new>
                </div>
              </td>
              <td class="gr-diff lineNum right" data-value="1">
                <button
