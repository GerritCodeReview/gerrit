...
suite('gr-diff a11y test', () => {
  test('audit', async () => {
    assert.isAccessible(await fixture(html`<gr-diff-new></gr-diff-new>`));
  });
});
...
suite('gr-diff tests', () => {
    ...
    suite('binary diffs', () => {
      test('render binary diff', async () => {
        ...
        assert.shadowDom.equal(
          ...
          /* HTML */ `
            <div class="diffContainer sideBySide">
              <gr-diff-section-new class="left-FILE right-FILE">
              </gr-diff-section-new>
              <gr-diff-row-new class="left-FILE right-FILE"> </gr-diff-row-new>
              <table class="selected-right" id="diffTable">
                <colgroup>
                  <col class="blame gr-diff" />
                  <col class="gr-diff left" width="48" />
  ...
  suite('trailing newline warnings', () => {
    ...
    const getWarning = (element: GrDiffNew) => {
