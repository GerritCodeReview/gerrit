...
export class GrContextControls extends LitElement {
  ...
  //border: 1px solid var(--border-color);
          ...
          --md-text-button-container-height: 0;
          /* From paper-button */
  ...
  //border: 1px solid var(--border-color);
          --md-outlined-button-outline-color: var(--border-color);
          --md-outlined-button-hover-state-layer-color: rgba(0, 0, 0, 0.12);
          --md-outlined-button-pressed-outline-color: var(--border-color);
          --md-outlined-button-container-shape: var(--border-radius);
          //border: solid var(--border-color);
          //border-width: 1px;
          //border-radius: var(--border-radius);
          padding: var(--spacing-s) var(--spacing-l);
          --md-outlined-button-container-color: var(--background-color);
          --md-sys-color-primary: var(--diff-context-control-color);
          /* We set this to 0 which defaults to 12px under text-button.
            This is because for some reason it makes the size of it bigger
            which makes some of the buttons look wrong. E.g. attention set has
            a bigger width and thus a lot of space. This fixes it. */
          --md-outlined-button-leading-space: 0;
          --md-outlined-button-trailing-space: 0;
          /* Brings back the round corners we had with paper-button */
          /* Needed to resize properly */
          --md-outlined-button-container-height: none;
          /* From paper-button */
          -webkit-font-smoothing: antialiased;
        }
  ...
  private createContextButton(
    ...
    let button = html` <md-outlined-button
      touch-target="none"
      class=${classes}
