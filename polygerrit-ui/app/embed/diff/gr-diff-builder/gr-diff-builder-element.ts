...
export class GrDiffBuilderElement implements GroupConsumer {
  ...
  init() {
    this.cleanup();
    this.diffElement?.addEventListener('diff-context-expanded', e =>
      this.onDiffContextExpanded(
        e as CustomEvent<DiffContextExpandedEventDetail>
      )
    );
    this.builder?.init();
  }
  ...
  cleanup() {
    ...
    this.diffElement?.removeEventListener('diff-context-expanded', e =>
      this.onDiffContextExpanded(
        e as CustomEvent<DiffContextExpandedEventDetail>
      )
    );
