...
class GrDiffImageOld extends LitElement {
  ...
  override render() {
    console.log(`asdf render ${this.revisionImageEl?.naturalWidth}`);
    return html`
      <tbody class="gr-diff image-diff">
          ...
          <td class="gr-diff" colspan="4">
            <gr-endpoint-decorator class="gr-diff" name="image-diff">
              <gr-endpoint-param
                class="gr-diff"
                name="baseImage"
                .value=${this.baseImage}
              >
              </gr-endpoint-param>
              <gr-endpoint-param
                class="gr-diff"
                name="revisionImage"
                .value=${this.revisionImage}
              >
              </gr-endpoint-param>
  ...
  private handleLoad() {
    console.log(`asdf handleLoad ${this.revisionImageEl?.naturalWidth}`);
    this.requestUpdate();
  }
