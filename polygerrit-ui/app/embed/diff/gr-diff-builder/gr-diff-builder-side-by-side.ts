  ...
  private createRow(leftLine: GrDiffLine, rightLine: GrDiffLine) {
    ...
    if (
      ...
      row.setAttribute(
        'aria-labelledby',
        [
          leftLine.beforeNumber ? `leftButton${leftLine.beforeNumber}` : '',
          leftLine.beforeNumber ? `leftContent${leftLine.beforeNumber}` : '',
          rightLine.afterNumber ? `rightButton${rightLine.afterNumber}` : '',
          rightLine.afterNumber ? `rightContent${rightLine.afterNumber}` : '',
        ].join(' ')
      );
    }
