...
export class GrDiffRow extends LitElement {
  ...
  static override styles = [
     ...
     */
      ...
      */
      ...
      /* TODO: Remember to add support for unified diff for text selection. */

      /* --diff-user-select-... variables are controlled and set by gr-diff-selection. */
      .left.contentText {
        -webkit-user-select: var(--diff-user-select-left-text, none);
        user-select: var(--diff-user-select-left-text, none);
      }
      .right.contentText {
        -webkit-user-select: var(--diff-user-select-right-text, none);
        user-select: var(--diff-user-select-right-text, none);
      }
      .blame {
        -webkit-user-select: var(--diff-user-select-blame, none);
        user-select: var(--diff-user-select-blame, none);
      }
      .side-by-side .left.content .message,
      ::slotted(gr-comment-thread[diff-side='left']),
        -webkit-user-select: var(--diff-user-select-left-comment, none);
        user-select: var(--diff-user-select-left-comment, none);
      }
      .side-by-side .right.content .message,
      ::slotted(gr-comment-thread[diff-side='right']) {
        -webkit-user-select: var(--diff-user-select-right-comment, none);
        user-select: var(--diff-user-select-right-comment, none);
      }
  ...
  private renderThreadGroup(side: Side, lineNumber?: LineNumber) {
    ...
    // prettier-ignore
    return html`<div class="thread-group" data-side=${side}><slot name="${side}"></slot></div>`;
  }
