...
export const grDiffStyles = css`
  ...
  gr-diff-row td.content.add div.contentText .semantic-token.navigable {
    text-decoration-style: dotted;
    text-decoration-line: underline;
  }
  gr-diff-row
    td.content.add
    div.contentText.semantic-token.navigable.clickable {
  ...
  td.content.add div.contentText .intraline,
  td.content.add.no-intraline-info div.contentText,
  gr-diff-row td.sign.add.no-intraline-info,
  .delta.total td.content.add div.contentText {
  ...
  /* If there are no intraline info, consider everything changed */
  td.content.remove div.contentText .intraline,
  td.content.remove.no-intraline-info div.contentText,
  .delta.total td.content.remove div.contentText,
