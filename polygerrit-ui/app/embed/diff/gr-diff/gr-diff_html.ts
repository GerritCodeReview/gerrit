...
export const htmlTemplate = html`
  <style include="shared-styles">
    ...
    /**
     * For all line numbers where a top-bottom border (box-shadow) will rendered we need
    ...
    * column that don't contain an actual line number. Also excluding .content as it receives
    * 'right' marker even for an unchanged line.
    */
