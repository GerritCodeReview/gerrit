...
export const htmlTemplate = html`
  <style include="shared-styles">
    ...
    .lineNumButton {
      display: block;
      width: 100%;
      /* Remove 2px of height to allow external outline to appear. */
    ...
    .diff-row.target-row.target-side-left .left.content,
    .diff-row.target-row.target-side-right .right.content {
      /* Border right: */
      box-shadow: inset -1px 0 0 0 var(--focused-line-outline-color),
        /* Border top: */ inset 0 1px 0 0 var(--focused-line-outline-color),
        /* Border bottom: */ inset 0 -1px 0 0 var(--focused-line-outline-color);
    }

    /* 
    * Unified diff - keep outline top/bottom borders for right line number cell
    * even if selection is for left.
    */
    .diff-row.unified.target-row.target-side-left .right {
      box-shadow: 
        /* Border top: */ inset 0 1px 0 0
          var(--focused-line-outline-color),
        /* Border bottom: */ inset 0 -1px 0 0 var(--focused-line-outline-color);
    ...
    */
    ...
    .content .contentContainer:empty:after {
    ...
    #diffTable {
      /*
      This is needed so individual cells (TD elements) take the full height whenever lines wrap.
      Details: https://stackoverflow.com/questions/10910438/div-height100-not-working-with-displaytable-cell/10910802
      */
      height: 100%;
    }
