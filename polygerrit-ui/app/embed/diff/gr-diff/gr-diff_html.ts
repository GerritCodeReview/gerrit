...
export const htmlTemplate = html`
  <style include="shared-styles">
    ...
    .diff-row.target-row.target-side-right .right.lineNum {
      ...
      box-shadow: inset 0 1px 0 0 var(--focused-line-outline-color),
        /* Border top*/ inset 0 -1px 0 0 var(--focused-line-outline-color),
        /* Border bottom */ inset 1px 0 0 0 var(--focused-line-outline-color); /* Border left */
    }
    ...
    .diff-row.target-row.target-side-right .contentText.right {
      box-shadow: inset -1px 0 0 0 var(--focused-line-outline-color),
        /* Border right */ inset 0 1px 0 0 var(--focused-line-outline-color),
        /* Border top */ inset 0 -1px 0 0 var(--focused-line-outline-color); /* Border bottom */
    }
