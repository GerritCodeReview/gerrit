...
export const htmlTemplate = html`
  <style include="shared-styles">
     ...
     * Since we want to remove the first 3 cells consistently in all rows.
     */
    :host(.no-left) .sideBySide colgroup col:nth-child(-n + 3),
    :host(.no-left) .sideBySide tr td:nth-child(-n + 3) {
      display: none;
    }
     ...
     * the outline.
     */
    .sideBySide .target-row.target-side-left td.left.lineNum::before,
    .sideBySide .target-row.target-side-right td.right.lineNum::before {
