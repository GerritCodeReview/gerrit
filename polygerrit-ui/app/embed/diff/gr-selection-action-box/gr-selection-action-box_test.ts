    ...
    assert.equal(
      ...
      /* HTML */ `
        <slot name="selectionActionBox" style="visibility: 'hidden'">
          <gr-tooltip id="tooltip" style="position: absolute; width: 22ch; cursor: pointer;" invisible="" text="Press c to comment"></gr-tooltip>
        </slot>
      `
    );
  });
      ...
      assert.equal(
        ...
        /* HTML */ `
          <slot name="selectionActionBox" style="visibility: 'visible'">
            <gr-tooltip id="tooltip" style="position: absolute; width: 22ch; cursor: pointer;" text="Press c to comment"></gr-tooltip>
          </slot>
        `
      );
    });
