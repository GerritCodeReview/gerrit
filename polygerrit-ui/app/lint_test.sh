...
${eslint_bin} -c ./polygerrit-ui/app/.eslintrc.json --ignore-pattern 'bower_components/' --ignore-pattern 'gr-linked-text' --ignore-pattern 'scripts/vendor' --ext .html,.js ./polygerrit-ui/app
