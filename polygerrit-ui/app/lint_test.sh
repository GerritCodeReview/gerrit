...
${eslint_bin} --ignore-pattern 'bower_components/' --ignore-pattern 'gr-linked-text' --ignore-pattern 'scripts/vendor' --ignore-pattern 'node_modules/' --ignore-pattern 'polymer_legacy_support/' --ext .html,.js .
