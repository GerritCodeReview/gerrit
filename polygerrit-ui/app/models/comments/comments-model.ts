 ...
 *
 * Deletion of drafts is handled asynchronously by the server, becuase of that it's possible that after the draft is published the server still returns it as part of the drafts.
 */
function filterOutPublishedDrafts(
  drafts: {[path: string]: DraftInfo[]},
