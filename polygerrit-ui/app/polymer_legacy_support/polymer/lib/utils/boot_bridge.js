...
function polyfillDeclareNamespace() {
  ...
  if (window.goog.declareModuleId) {
    ...
    // later.
    // TODO(b/111271858): remove this defineProperty hack of goog.module.
    //   Youtube's tests load goog's base.js _after_ Polymer, so we have to be
    //   able to patch declareNamespace even if goog.module is set later.
