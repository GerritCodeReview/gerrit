...
Polymer.Settings = {
  ...
  get legacyUndefined() {
    return settingsObj.legacyUndefined;
  },
  setLegacyUndefined: settingsObj.setLegacyUndefined,
  get legacyWarnings() {
    return settingsObj.legacyWarnings;
  },
  setLegacyWarnings: settingsObj.setLegacyWarnings,
  get orderedComputed() {
    return settingsObj.orderedComputed;
  },
  setOrderedComputed: settingsObj.setOrderedComputed,
  get fastDomIf() {
    return settingsObj.fastDomIf;
  },
  setFastDomIf: settingsObj.setFastDomIf,
  get removeNestedTemplates() {
    return settingsObj.removeNestedTemplates;
  },
  setRemoveNestedTemplates: settingsObj.setRemoveNestedTemplates,
  get suppressTemplateNotifications() {
    return settingsObj.suppressTemplateNotifications;
  },
  setSuppressTemplateNotifications: settingsObj.suppressTemplateNotifications,
};
...
if (Polymer.legacyUndefined !== undefined) {
  settingsObj.setLegacyUndefined(Polymer.legacyUndefined);
}
if (Polymer.legacyWarnings !== undefined) {
  settingsObj.setLegacyWarnings(Polymer.legacyWarnings);
}
if (Polymer.orderedComputed !== undefined) {
  settingsObj.setOrderedComputed(Polymer.orderedComputed);
}
if (Polymer.fastDomIf !== undefined) {
  settingsObj.setFastDomIf(Polymer.fastDomIf);
}
if (Polymer.removeNestedTemplates !== undefined) {
  settingsObj.setRemoveNestedTemplates(Polymer.removeNestedTemplates);
}
if (Polymer.suppressTemplateNotifications !== undefined) {
  settingsObj.setSuppressTemplateNotifications(Polymer.suppressTemplateNotifications);
}
