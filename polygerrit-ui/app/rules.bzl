...
def polygerrit_bundle(name, bundle, outs, app):
    ...
    genrule2(
        ...
        cmd = " && ".join([
            ...
            "mkdir webcomponentsjs && cp -p $(location @ui_npm//:node_modules/@webcomponents/webcomponentsjs/webcomponents-lite.js) $$TMP/polygerrit_ui/bower_components/webcomponentsjs/webcomponents-lite.js",
            "cd $$TMP",
