...
def polygerrit_bundle(name, srcs, outs, entry_point, app_name):
    ...
    genrule2(
        ...
        srcs = [
            ...
            "//polygerrit-ui/app:node_modules/@webcomponents/webcomponentsjs/dir",
        ...
        cmd = " && ".join([
            ...
            "WEBCOMPONENTJS_DIR=$(location //polygerrit-ui/app:node_modules/@webcomponents/webcomponentsjs/dir)",
