...
def polygerrit_bundle(name, srcs, outs, entry_point, app_name):
    ...
    genrule2(
        ...
        cmd = " && ".join([
            ...
            "cp $(location @ui_npm//:node_modules/@webcomponents/webcomponentsjs/webcomponents-loader.js) $$TMP/polygerrit_ui/bower_components/webcomponentsjs/webcomponents-loader.js",
            "cp $(location @ui_npm//:node_modules/@webcomponents/webcomponentsjs/bundles/*.js*) $$TMP/polygerrit_ui/bower_components/webcomponentsjs/bundles",
