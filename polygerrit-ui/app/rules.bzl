...
def polygerrit_bundle(name, srcs, outs, app):
  ...
  genrule2(
    ...
    outs = outs,
    cmd = " && ".join([
      "mkdir -p $$TMP/polygerrit_ui/{styles,fonts,bower_components/{codemirror,highlightjs,webcomponentsjs},elements}",
      ...
      "unzip -qd $$TMP/polygerrit_ui/bower_components $(location @codemirror//:zipfile) codemirror/lib/codemirror.css",
      "unzip -qd $$TMP/polygerrit_ui/bower_components $(location @codemirror//:zipfile) codemirror/lib/codemirror.js",
