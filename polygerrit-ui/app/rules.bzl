...
def polygerrit_bundle(name, srcs, outs, entry_point, app_name):
    ...
    genrule2(
        ...
        srcs = [
            ...
            "//polygerrit-ui/app:node_modules/@webcomponents/webcomponentsjs",
            "//polygerrit-ui/app:node_modules/resemblejs/resemble.js",
            "//polygerrit-ui/app:node_modules/@polymer/font-roboto-local",
        ],
        outs = outs,
        cmd = " && ".join([
            "FONT_DIR=$$(echo $(locations //polygerrit-ui/app:node_modules/@polymer/font-roboto-local) | cut -d' ' -f1)/fonts",
            "WEBCOMPONENTJS_DIR=$$(echo $(locations //polygerrit-ui/app:node_modules/@webcomponents/webcomponentsjs) | cut -d' ' -f1)",
            ...
            "cp $(location //polygerrit-ui/app:node_modules/resemblejs/resemble.js) $$TMP/polygerrit_ui/bower_components/resemblejs/resemble.js",
