...
def polygerrit_bundle(name, srcs, outs, entry_point, redirects):
    ...
    # After update, all references to bower_components are replaced with a correct references
    # to a node_modules.
    ...
    #      another generated js file ('path/to/file.html_gen.js').
    ...
    #
    # Note: prepare_for_bundling and polymer_bundler_tool will be removed after switch
    #   to ES6 modules.
    #
