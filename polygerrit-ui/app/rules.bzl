...
def polygerrit_bundle(name, srcs, outs, app):
  ...
  genrule2(
    ...
    srcs = [
      ...
      "//lib/fonts:robotoregular",
      "//lib/fonts:robotomedium",
    ...
    cmd = " && ".join([
      ...
      "cp $(locations //lib/fonts:robotoregular) $$TMP/polygerrit_ui/fonts/",
      "cp $(locations //lib/fonts:robotomedium) $$TMP/polygerrit_ui/fonts/",
