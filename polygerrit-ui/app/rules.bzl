...
def polygerrit_bundle(name, srcs, outs, app):
  ...
  genrule2(
    ...
    outs = outs,
    cmd = " && ".join([
      "mkdir -p $$TMP/polygerrit_ui/{styles,fonts,bower_components/{highlightjs,prism,webcomponentsjs},elements}",
      ...
      "unzip -qd $$TMP/polygerrit_ui/bower_components $(location @prism//:zipfile) prism/**",
      "cd $$TMP",
