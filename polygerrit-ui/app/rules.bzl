...
def polygerrit_bundle(name, srcs, outs, app):
    ...
    genrule2(
        ...
        cmd = " && ".join([
            ...
            "unzip -qd $$TMP/polygerrit_ui/bower_components $(location @font-roboto-local//:zipfile) font-roboto-local/fonts/roboto/*.ttf",
            "unzip -qd $$TMP/polygerrit_ui/bower_components $(location @font-roboto-local//:zipfile) font-roboto-local/fonts/robotomono/*.ttf",
            "cd $$TMP",
