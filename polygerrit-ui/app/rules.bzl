...
def polygerrit_bundle(name, srcs, outs, entry_point):
    ...
    genrule2(
        ...
        cmd = " && ".join([
            ...
            "mkdir -p $$TMP/polygerrit_ui/{styles/themes,fonts/{roboto,robotomono},bower_components/{highlightjs,resemblejs,webcomponentsjs},elements}",
            ...
            "for f in $(locations //lib/js:resemblejs__files); do cp $$f $$TMP/polygerrit_ui/bower_components/resemblejs/ ; done",
