...
class ReviewerShortcut extends Polymer.Element {
  ...
  toggleControlContent() {
    ...
    this.dispatchEvent(new CustomEvent('toggle-reviewer-controls-content', {
...
Gerrit.install(plugin => {
  plugin.registerCustomComponent(
      'reviewer-controls', ReviewerShortcut.is);
  plugin.registerCustomComponent(
      'reviewer-controls-content', ReviewerShortcutContent.is);
});