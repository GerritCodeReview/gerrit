(function(window) {
  ...
  class GrDisplayNameUtils {
    ...
    static getAccountDisplayName(account, enableEmail) {
      const reviewerName = this._accountOrAnon(account, enableEmail);
    ...
    static _accountOrAnon(reviewer, enableEmail) {
      return this.getUserName(this._config, reviewer, !!enableEmail);
    }
