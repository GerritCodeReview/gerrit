  ...
  implements ReviewerSuggestionsProvider
{
  ...
  makeSuggestionItem(
    ...
    if (this.isAccountSuggestions(suggestion)) {
  ...
  private areSameSuggestions(a: Suggestion, b: Suggestion): boolean {
    ...
    } else if (this.isAccountSuggestions(a) && this.isAccountSuggestions(b)) {
      return accountKey(a) === accountKey(b);
    }
    return false;
  }

  private isAccountSuggestions(s: Suggestion): s is AccountInfo {
