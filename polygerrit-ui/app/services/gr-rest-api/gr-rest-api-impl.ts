...
import {QueueingScheduler} from '../scheduler/queueing-scheduler';
...
function createQueueingScheduler() {
  return new QueueingScheduler<Response>(
    new MaxInFlightScheduler<Response>(new BaseScheduler<Response>(), 1),
    500
  );
}
