...
export class GrRestApiServiceImpl implements RestApiService, Finalizable {
  ...
  savePreferences(
    ...
    this._fetchPromisesCache.delete('/accounts/self/preferences');
  ...
  saveDiffPreferences(prefs: DiffPreferenceInput): Promise<Response> {
    ...
    this._fetchPromisesCache.delete('/accounts/self/preferences.diff');
  ...
  saveEditPreferences(prefs: EditPreferencesInfo): Promise<Response> {
    ...
    this._fetchPromisesCache.delete('/accounts/self/preferences.edit');
