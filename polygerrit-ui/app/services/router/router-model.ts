...
export function updateState(
  ...
  console.log('updateRouterState, before: ' + JSON.stringify(privateState$.getValue(), undefined, 2));
  privateState$.next({
  ...
  console.log('updateRouterState, after: ' + JSON.stringify(privateState$.getValue(), undefined, 2));
}
