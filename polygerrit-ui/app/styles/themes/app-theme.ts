...
const styleSheet = safeStyleSheet`
  html {
    ...
    /* syntax colors */
    --syntax-addition-color: #50a14f;
    --syntax-attr-color: #219;
    --syntax-attribute-color: var(--primary-text-color);
    --syntax-built_in-color: #30a;
    --syntax-bullet-color: #c18401;
    --syntax-code-color: #2a00ff;
    --syntax-char-escape-color: #219;
    --syntax-comment-color: #3f7f5f;
    --syntax-default-color: var(--primary-text-color);
    --syntax-deletion-color: #d11;
    ...
    --syntax-formula-color: #9e0069;
    --syntax-keyword-color: #9e0069;
    --syntax-link-color: #219;
    --syntax-link-decoration: underline;
    --syntax-literal-color: #219;
    --syntax-meta-color: #d11;
    --syntax-meta-keyword-color: var(--syntax-keyword-color);
    --syntax-meta-string-color: var(--syntax-string-color);
    --syntax-name-color: #c18401;
    --syntax-number-color: #2a00ff;
    --syntax-operator-color: var(--primary-text-color);
    --syntax-params-color: var(--primary-text-color);
    --syntax-property-color: #c18401;
    --syntax-punctuation-color: var(--primary-text-color);
    --syntax-quote-color: #3f7f5f;
    --syntax-regexp-color: #c18401;
    --syntax-section-color: #c18401;
    --syntax-section-style: normal;
    --syntax-section-weight: bold;
    --syntax-selector-attr-color: #219;
    --syntax-selector-class-color: #164;
    --syntax-selector-id-color: #2a00ff;
    --syntax-selector-pseudo-color: #164;
    --syntax-selector-tag-color: #219;
    --syntax-strong-color: var(--primary-text-color);
    --syntax-strong-style: normal;
    --syntax-strong-weight: bold;
    --syntax-string-color: #2a00ff;
    --syntax-subst-color: #219;
    --syntax-symbol-color: #c18401;
    --syntax-tag-color: #170;
    --syntax-template-tag-color: #c18401;
    --syntax-template-variable-color: #0000c0;
    --syntax-title-color: #0000c0;
    --syntax-title-class-color: #c18401;
    --syntax-title-class-inherited-color: #c18401;
    --syntax-title-function-color: var(--syntax-title-color);
    --syntax-type-color: #219;
    --syntax-variable-color: #219;
