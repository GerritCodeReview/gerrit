...
const styleSheet = safeStyleSheet`
  html {
    ...
    --vote-color-rejected: var(--red-400);

    --background-color-hover: var(--gray-900-04);
    --background-color-focus: var(--gray-900-12);
