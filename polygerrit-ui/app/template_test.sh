...
python $TEST_SRCDIR/gerrit/polygerrit-ui/app/template_test/convert_to_goog_module.py

# ${node_bin} $TEST_SRCDIR/gerrit/polygerrit-ui/app/template_test_files/template_test.js

# python $TEST_SRCDIR/gerrit/polygerrit-ui/app/template_test_files/remove_goog_modules.py