...
def generateStubBehavior(behaviorName):
  with open("temp/behaviors/" + behaviorName + ".js", "w+") as f:
...
if __name__ == "__main__":
  ...
  replaceBehaviorLikeHTML("app/bower_components/iron-a11y-keys-behavior/iron-a11y-keys-behavior.html", "iron-a11y-keys-behavior.html")
