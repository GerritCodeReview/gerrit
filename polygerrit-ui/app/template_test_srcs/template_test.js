...
fs.readdir( path.join(__dirname, '../../temp/behaviors/'), (err, data) => {
  ...
  externs.push({
    ...
    src: '/** @externs */ var page; var Gerrit; var GrRangeNormalizer; var GrAnnotation; var GrEtagDecorator; var GrGapiAuth; var GrGerritAuth; var GrReviewerUpdatesParser; var GrDiffBuilderUnified; var GrDiffBuilderSideBySide; var GrDiffLine; var util',
  });
