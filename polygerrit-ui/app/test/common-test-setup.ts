...
import {browserModelToken, BrowserModel} from '../services/browser/browser-model';
import {DependencyRequestEvent, DependencyError, DependencyToken, Provider} from '../services/dependency';
...
let injectedDependencies:
  Map<DependencyToken<unknown>, Provider<unknown>> = new Map();
