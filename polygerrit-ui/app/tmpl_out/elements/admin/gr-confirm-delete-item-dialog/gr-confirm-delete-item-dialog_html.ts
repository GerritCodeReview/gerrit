...
import {GrConfirmDeleteItemDialog} from '../../../../elements/admin/gr-confirm-delete-item-dialog/gr-confirm-delete-item-dialog';
...
export class GrConfirmDeleteItemDialogCheck extends GrConfirmDeleteItemDialog
{
  templateCheck()
  {
    {
      ...
      useVars(el);
      el.confirmLabel = `Delete ${this.itemTypeName}`;
    ...
    setTextContent(`${this.itemTypeName} Deletion`);
    ...
    setTextContent(`
        Do you really want to delete the following ${this.itemTypeName}?
      `);
