...
import {GrDiffSelection} from '../../../../elements/diff/gr-diff-selection/gr-diff-selection';
...
export class GrDiffSelectionCheck extends GrDiffSelection
{
  templateCheck()
  {
    {
      ...
      useVars(el);
      el.setAttribute('class', `contentWrapper`);
    }
    {
