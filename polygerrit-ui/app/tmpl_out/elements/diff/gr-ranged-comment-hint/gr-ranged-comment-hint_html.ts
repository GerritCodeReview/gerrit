...
import {GrRangedCommentHint} from '../../../../elements/diff/gr-ranged-comment-hint/gr-ranged-comment-hint';
...
export class GrRangedCommentHintCheck extends GrRangedCommentHint
{
  templateCheck()
  {
    {
      ...
      useVars(el);
      el.setAttribute('class', `rangeHighlight row`);
    }
    {
      const el: HTMLElementTagNameMap['gr-range-header'] = null!;
      useVars(el);
      el.icon = `gr-icons:comment`;
    }
    setTextContent(`${this._computeRangeLabel(this.range)}`);
