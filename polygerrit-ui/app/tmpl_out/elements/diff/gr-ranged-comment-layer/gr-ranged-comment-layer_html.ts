...
import {GrRangedCommentLayer} from '../../../../elements/diff/gr-ranged-comment-layer/gr-ranged-comment-layer';
...
export class GrRangedCommentLayerCheck extends GrRangedCommentLayer
{
  templateCheck()
  {
  }
