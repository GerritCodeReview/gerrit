...
import {GrSelectionActionBox} from '../../../../elements/diff/gr-selection-action-box/gr-selection-action-box';
...
export class GrSelectionActionBoxCheck extends GrSelectionActionBox
{
  templateCheck()
  {
    {
      const el: HTMLElementTagNameMap['gr-tooltip'] = null!;
      useVars(el);
      el.setAttribute('id', `tooltip`);
      el.text = `Press c to comment`;
      el.positionBelow = this.positionBelow;
    }
  }
}
