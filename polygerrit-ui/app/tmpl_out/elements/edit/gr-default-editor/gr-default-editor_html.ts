...
import {GrDefaultEditor} from '../../../../elements/edit/gr-default-editor/gr-default-editor';
...
export class GrDefaultEditorCheck extends GrDefaultEditor
{
  templateCheck()
  {
    {
      const el: HTMLElementTagNameMap['textarea'] = null!;
      useVars(el);
      el.setAttribute('id', `textarea`);
      el.value = this.fileContent;
      el.addEventListener('input', this._handleTextareaInput.bind(this));
    }
  }
}
