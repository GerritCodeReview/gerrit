...
import {GrApp} from '../../elements/gr-app';
...
export class GrAppCheck extends GrApp
{
  templateCheck()
  {
    {
      const el: HTMLElementTagNameMap['gr-app-element'] = null!;
      useVars(el);
      el.setAttribute('id', `app-element`);
    }
  }
}
