...
import {GrEndpointDecorator} from '../../../../elements/plugins/gr-endpoint-decorator/gr-endpoint-decorator';
...
export class GrEndpointDecoratorCheck extends GrEndpointDecorator
{
  templateCheck()
  {
    {
