...
import {GrCustomPluginHeader} from '../../../../elements/plugins/gr-theme-api/gr-custom-plugin-header';
...
export class GrCustomPluginHeaderCheck extends GrCustomPluginHeader
{
  templateCheck()
  {
    {
    ...
    {
      const el: HTMLElementTagNameMap['img'] = null!;
      useVars(el);
      el.src = this.logoUrl;
      el.setAttribute('hidden', `${!this.logoUrl}`);
    }
    {
      const el: HTMLElementTagNameMap['span'] = null!;
      useVars(el);
