...
import {GrSettingsItem} from '../../../../elements/settings/gr-settings-view/gr-settings-item';
...
export class GrSettingsItemCheck extends GrSettingsItem
{
  templateCheck()
  {
    {
      ...
      useVars(el);
      el.setAttribute('id', `${this.anchor}`);
      el.setAttribute('class', `heading-2`);
    }
