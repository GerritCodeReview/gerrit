...
import {GrSettingsMenuItem} from '../../../../elements/settings/gr-settings-view/gr-settings-menu-item';
...
export class GrSettingsMenuItemCheck extends GrSettingsMenuItem
{
  templateCheck()
  {
    {
