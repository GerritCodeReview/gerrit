...
import {GrLimitedText} from '../../../../elements/shared/gr-limited-text/gr-limited-text';
...
export class GrLimitedTextCheck extends GrLimitedText
{
  templateCheck()
  {
    setTextContent(` ${this._computeDisplayText(this.text, this.limit)} `);
