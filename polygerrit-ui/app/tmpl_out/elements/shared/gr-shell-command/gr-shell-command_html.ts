...
import {GrShellCommand} from '../../../../elements/shared/gr-shell-command/gr-shell-command';
...
export class GrShellCommandCheck extends GrShellCommand
{
  templateCheck()
  {
    {
...

    {
      ...
      useVars(el);
      el.setAttribute('class', `commandContainer`);
    }
    {
      const el: HTMLElementTagNameMap['gr-copy-clipboard'] = null!;
      useVars(el);
      el.text = this.command;
      el.buttonTitle = this.tooltip;
    }
  }
}
