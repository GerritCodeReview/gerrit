 ...
 *
 * These form the API of the gr-diff component, which should remain stable to
 * avoid breaking other projects embedding gr-diff.
 *
 * @license
 ...
 * newlines.
 */
export type SkipLength = number;
export type MarkLength = number;
export type DiffIntralineInfo = [SkipLength, MarkLength];
