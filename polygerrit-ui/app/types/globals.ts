...
declare global {
  interface Window {
    ...
    /**
     * Gerrit can be available from a different host inside the corporate
     * (internal) network (due to some internal policies). As a result all users
     * within internal network see different ULRs in browser which makes them
     * harder to share.
     *
