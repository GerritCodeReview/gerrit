...
import {isServiceUser, removeServiceUsers, Tag} from './account-util.js';

const EMPTY = {};
const ERNIE = {name: 'Ernie'};
const KERMIT = {name: 'Kermit', tags: ['FROG']};
const SERVY = {name: 'Servy', tags: [Tag.SERVICE_USER]};
const BOTTY = {name: 'Botty', tags: [Tag.SERVICE_USER]};
