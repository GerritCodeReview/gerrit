...
import {createProxyRegistry} from './mock-proxy-support';
...
function _listChangesOptionsToHex(...args: number[]) {
  let v = 0;
...
const proxyRegistry = createProxyRegistry();
export const listChangesOptionsToHex = proxyRegistry.add(
  _listChangesOptionsToHex
);
export const changeUtilMockProxy = proxyRegistry.mockProxy;
