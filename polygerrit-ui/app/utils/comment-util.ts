    ...
    if (comment.in_reply_to) {
      ...
      if (parent) {
        if (parent.range) {
          if (
            !comment.range ||
            comment.range.start_line !== parent.range.start_line ||
            comment.range.start_character !== parent.range.start_character ||
            comment.range.end_line !== parent.range.end_line ||
            comment.range.end_character !== parent.range.end_character
          ) {
