 ...
 * given class within the same shadow root?
 */
export function descendedFromClass(
  ...
  return parentWithClass(element, className, stopElement) !== null;
}

/**
 * Returns an ancestor of the element (or the element itself) with a
 * given class within the same shadow root.
 */
