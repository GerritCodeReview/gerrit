...
export class FitController implements ReactiveController {
  ...
  __getPosition(size, sizeNoMargins, positionRect, fitRect) {
    ...
    this._localeHorizontalAlign =
      this._localeHorizontalAlign === 'auto'
        ? null
        : this._localeHorizontalAlign;

    if (
      !this._localeHorizontalAlign ||
      this._localeHorizontalAlign === 'center'
    ) {
      positions.push({
        verticalAlign: 'top',
    ...
    for (var i = 0; i < positions.length; i++) {
      ...
      const hAlignOk =
        candidate.horizontalAlign === this._localeHorizontalAlign;

      // If both this.verticalAlign and this._localeHorizontalAlign are defined, return exact match.
      ...
      const alignOk =
        ...
        (!this._localeHorizontalAlign || hAlignOk);
