...
import {createProxyRegistry} from './mock-proxy-support.js';
...
function _computeLatestPatchNum(allPatchSets) {
 ...
 */
function _fetchChangeUpdates(change, restAPI) {
...
export const fetchChangeUpdates = proxyRegistry.add(_fetchChangeUpdates);
export const computeLatestPatchNum = proxyRegistry.add(_computeLatestPatchNum);
export const patchSetUtilMockProxy = proxyRegistry.mockProxy;
