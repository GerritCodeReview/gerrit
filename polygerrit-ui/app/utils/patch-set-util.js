...
export const patchSetUtilMockProxy = mockProxyRegistry.mockProxy;
...
export const computeLatestPatchNum =
    mockProxyRegistry.add(_computeLatestPatchNum);
...
export const fetchChangeUpdates = mockProxyRegistry.add(_fetchChangeUpdates);
