import {RevisionInfo, ChangeInfo, RevisionWithSha} from '../types/common';
 ...
 * @return {boolean}
 */
export function patchNumEquals(a: string | number, b: string | number) {
  return `${a}` === `${b}`;
}
 ...
 * @return {boolean}
 */
export function isMergeParent(n: string | number) {
  return `${n}`[0] === '-';
}
