...
class DirectoryCopier {
  ...
  copyRecursively(dirNameRelativeToRoot, predicate) {
    const entries = fs.readdirSync(path.join(rootDir, dirNameRelativeToRoot), {withFileTypes: true});
    for(const dirEnt of entries) {
      ...
      if(dirEnt.isFile() && predicate(dirEntPath)) {
