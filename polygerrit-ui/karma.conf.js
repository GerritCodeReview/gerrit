...
module.exports = function(config) {
    ...
    const testFilesLocationPattern = 'polygerrit-ui/app/**/!(template_test_srcs)/';
    ...
    const testFilesPattern = (typeof config.testFiles == 'string') ? testFilesLocationPattern + config.testFiles
