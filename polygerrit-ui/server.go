...
var (
	...
	webComponentPattern   = regexp.MustCompile("https://cdn.googlesource.com/polygerrit_ui/[0-9.]*/bower_components/webcomponentsjs-p2")
...
func rewriteHostPage(reader io.Reader) io.Reader {
	...
	replaced := webComponentPattern.ReplaceAllString(original, "bower_components/webcomponentsjs")
