  ...
  groups: [
    {
      ...
      files: [
        "app/embed/diff-new/**/*_test.{ts,js}",
        "app/elements/change/gr-file-list/**/*_test.{ts,js}",
        "app/elements/diff/gr-apply-fix-dialog/**/*_test.{ts,js}",
        "app/elements/diff/gr-diff-host/**/*_test.{ts,js}",
        "app/elements/diff/gr-diff-view/**/*_test.{ts,js}",
        "app/elements/shared/gr-comment-thread/**/*_test.{ts,js}",
      ],
