...
const config = {
  ...
  // Specifies the maximum number of total browser instances to run concurrently across all launchers. [1]
  // Default is 2.
  ...
  concurrentBrowsers: 4, // Added: Set to match the Playwright launcher's concurrency.
