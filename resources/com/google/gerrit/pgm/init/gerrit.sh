...
#####################################################
DEF_STOP_TIMEOUT=30
HTTPD_STOP_TIMEOUT=$(get_time_unit_sec "$(get_config --get httpd.gracefulStopTimeout || echo $DEF_STOP_TIMEOUT)")
SSHD_STOP_TIMEOUT=$(get_time_unit_sec "$(get_config --get sshd.gracefulStopTimeout || echo $DEF_STOP_TIMEOUT)")

STOP_TIMEOUT=`max $HTTPD_STOP_TIMEOUT $SSHD_STOP_TIMEOUT`
