...
public abstract class AbstractPatchContentTable extends NavigationTable<Object> {
  ...
  protected void bindComment(final int row, final int col,
    ...
    // Create a panel with a Reply button if we are looking at the last comment for this line
    final LineCommentPanel mp = isLast ? new LineCommentPanel(line, this, row, col, line)
        : new LineCommentPanel(line);
    String panelHeader;
