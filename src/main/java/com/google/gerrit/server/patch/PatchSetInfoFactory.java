...
public class PatchSetInfoFactory {
  ...
  public PatchSetInfo patchSetInfoFromRevCommit(RevCommit src, PatchSet.Id
      patchSetId) throws OrmException {
    PatchSetInfo info = new PatchSetInfo(patchSetId);
  ...
  public PatchSetInfo patchSetInfoFromPatchSetId(PatchSet.Id patchSetId)
    ...
    try {
      ...
      return patchSetInfoFromRevCommit(src, patchSetId);
