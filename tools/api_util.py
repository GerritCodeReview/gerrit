...
#TODO(davido): install {plugin-api,extension-api}-sources.jar
...
version_file = pathjoin(gendir, '../../VERSION')
version = open(version_file).read().strip()

print("URL : %s"  % URL, file=stderr)
...
check_output( cmd[action] + cmd['plugin'] + cmd['common'] )
check_output( cmd[action] + cmd['extension'] + cmd['common'] )
