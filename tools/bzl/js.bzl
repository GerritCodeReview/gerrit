...
def polygerrit_plugin(name, app, srcs = [], assets = None, plugin_name = None, deps = [], externs = None, **kwargs):
    ...
    Args:
      ...
      deps: Additional dependencies for generating combined plugin webcomponent_binary().
    """
    if plugin_name == None:
        plugin_name = name
