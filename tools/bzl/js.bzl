...
_vulcanize_rule = rule(
  ...
  attrs = {
    ...
    "_run_npm": attr.label(default=Label("//tools/js:run_npm_binary.py"), allow_single_file=True),
    "_vulcanize_archive": attr.label(default=Label("@vulcanize//:%s" % _npm_tarball("vulcanize")), allow_single_file=True),
    "_crisper_archive": attr.label(default=Label("@crisper//:%s" % _npm_tarball("crisper")), allow_single_file=True),
  },
  outputs = {
