...
def main():
    ...
    if args.asciidoctor:
        ...
        printUTF8("""= Gerrit Code Review - Licenses
...
""")
    ...
    for data in xml_data + json_map_data:
        ...
        for p in data.packages:
            ...
            printUTF8("* " + get_package_display_name(p) + package_notice)
            for file in p.licensed_files.files:
                printUTF8("** " + file)
        printUTF8()
        printUTF8("[[%s_license]]" % safename)
        printUTF8("----")
        license_text = data.license_text
        printUTF8(data.license_text.rstrip("\r\n"))
        printUTF8()
        printUTF8("----")
        printUTF8()
