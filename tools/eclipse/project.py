...
JGIT_SRC = dict([
    ('org.eclipse.jgit/libjgit', 'lib/jgit/org.eclipse.jgit/src'),
    ('org.eclipse.jgit.archive/libjgit-archive', 'lib/jgit/org.eclipse.jgit.archive/src'),
    ('org.eclipse.jgit.http.server/libjgit-servlet', 'lib/jgit/org.eclipse.jgit.http.server/src'),
])
