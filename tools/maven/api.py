...
check_output(['buck', 'build', 'api_%s' % args.a])

# TODO(davido): Check the timestamp of output file from the previous
# step and prevent further script execution, when the timestamp was
# changed, because the deployment was done in context of buck `build`.
