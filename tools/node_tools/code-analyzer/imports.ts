...
class SourceFileUtils {
  public static isImportForSideEffectsOnly(importDecl: ImportDeclaration): boolean {
    return !!importDecl.compilerNode.importClause;
  }

  public static isAbsoluteOrRelativeImportPath(path: string): path is WebPath {
  ...
  public extractDependenciesForJsFile(sourceFile: SourceFile): FileDependency[] {
    ...
    return decls.map((importDecl) => {
      ...
      const dependencyType = SourceFileUtils.isImportForSideEffectsOnly(importDecl) ?
          FileDependencyType.JsImportForSideEffect : FileDependencyType.JsModuleImport;
      if(!SourceFileUtils.isAbsoluteOrRelativeImportPath(moduleSpecifierValue)) {
        return {
...
//project.addSourceFileAtPath('/Users/dmfilippov/gerrit/gerrit/polygerrit-ui/app/elements/change/gr-change-actions/gr-change-actions.js');
//project.addSourceFileAtPath('/Users/dmfilippov/gerrit/gerrit/polygerrit-ui/app/behaviors/fire-behavior/fire-behavior.js');
//const imports = getImportsFromJsFile('/Users/dmfilippov/gerrit/gerrit/polygerrit-ui/app/elements/change/gr-change-actions/gr-change-actions.js');
//console.log(imports);
console.log("Init");
...
// webAppProject.registerJsFile(<FilePath>'./test/common-test-setup.js');
// webAppProject.registerJsFile(<FilePath>'./scripts/bundled-polymer.js');
// webAppProject.registerJsFile(<FilePath>'./scripts/import-href.js');
// webAppProject.registerJsFile(<FilePath>'./behaviors/safe-types-behavior/safe-types-behavior.js');
// webAppProject.registerJsFile(<FilePath>'./test/test-router.js');
// webAppProject.registerJsFile(<FilePath>'./elements/change/gr-related-changes-list/gr-related-changes-list.js');
//const deps = webAppProject.getDependenciesForHtmlFile(<AbsoluteWebPath>'/elements/change/gr-related-changes-list/gr-related-changes-list_test.html');
