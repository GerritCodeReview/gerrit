...
//const modulizedFiles = ["./styles/dashboard-header-styles.js"];
//const modulizedFiles = ["./behaviors/gr-tooltip-behavior/gr-tooltip-behavior.js"];
...
class ImportHrefCallExpressionTransformer implements NodeTransformer {
  ...
  public transformNode(node: ts.Node): ts.CallExpression | undefined {
    ...
    return ts.updateCall(node, ts.createPropertyAccess(ts.createIdentifier("Polymer"),
        ts.createIdentifier("importHref")), node.typeArguments, node.arguments);
  }
}
