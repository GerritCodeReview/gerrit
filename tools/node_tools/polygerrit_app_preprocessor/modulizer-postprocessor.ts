...
import {Project, QuoteKind, SourceFile, ts, VariableDeclarationKind} from "ts-morph";
...
//const files = ["./elements/gr-app-element.js"]
...
class TsFileUpdater {
  ...
  private replaceImportPath(file: SourceFile, oldPath: string, newPath: string): boolean {
  ...
  public updateFile(relativePath: string) {
    ...
    this.replaceImportPath(updatedSourceFile, 'page/page.js', 'page/page.mjs');
