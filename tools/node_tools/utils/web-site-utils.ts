...
export class SrcWebSite {
  ...
  public isNodeModule(file: FilePath): boolean {
    const absPath = path.resolve(file);
    const absNodeModulePath = path.resolve(this.webSiteRoot, "node_modules");
    const relPath = path.relative(absNodeModulePath, absPath);
