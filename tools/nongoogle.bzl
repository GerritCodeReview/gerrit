...
def declare_nongoogle_deps():
    ...
    maven_jar(
        ...
        sha1 = "52f4ab3e4f5a80d52183842b7c81513f89f09f91",
    )

    maven_jar(
        name = "lucene-analyzers-common",
        artifact = "org.apache.lucene:lucene-analysis-common:" + LUCENE_VERS,
        sha1 = "f36ca5625e2e9a2d8281919c965a77218a08a1bd",
    )

    maven_jar(
        name = "lucene-backward-codecs",
        artifact = "org.apache.lucene:lucene-backward-codecs:" + LUCENE_VERS,
        sha1 = "d9ed7664b9c6382b5c4c00d5e42c5f575121cffb",
    )

    maven_jar(
        name = "lucene-misc",
        artifact = "org.apache.lucene:lucene-misc:" + LUCENE_VERS,
        sha1 = "46e751e324317303014249482f8ccccda9ae570e",
    )

    maven_jar(
        name = "lucene-queryparser",
        artifact = "org.apache.lucene:lucene-queryparser:" + LUCENE_VERS,
        sha1 = "26c01624ab71a13350992e289d2abb90c34e9e98",
    )
