  ...
  private parseLegacyComponentSettings(info: ts.ObjectLiteralExpression): LegacyPolymerComponentSettings {
    ...
    return {
      reservedDeclarations: {
        is: codeUtils.getStringLiteralValue(this.getLegacyPropertyInitializer(props, "is")),
        _legacyUndefinedCheck: codeUtils.getBooleanLiteralValue(this.getLegacyPropertyInitializer(props, "_legacyUndefinedCheck")),
        properties: codeUtils.getObjectLiteralExpression(this.getLegacyPropertyInitializer(props, "properties")),
        behaviors: codeUtils.getArrayLiteralExpression(this.getLegacyPropertyInitializer(props, "behaviors")),
        observers: codeUtils.getArrayLiteralExpression(this.getLegacyPropertyInitializer(props, "observers")),
        listeners: codeUtils.getObjectLiteralExpression(this.getLegacyPropertyInitializer(props, "listeners")),
        hostAttributes: codeUtils.getObjectLiteralExpression(this.getLegacyPropertyInitializer(props, "hostAttributes")),
      },
