...
import {LegacyPolymerComponent, LegacyPolymerComponentParser} from './functToClassConversion/polymerComponentParser';
import {ClassBasedPolymerElement} from './functToClassConversion/polymerElementBuilder';
import {PolymerFuncToClassBasedConverter} from './functToClassConversion/funcToClassBasedElementConverter';
import {LegacyPolymerFuncReplacer} from './functToClassConversion/legacyPolymerFuncReplacer';
import {UpdatedFileWriter} from './functToClassConversion/updatedFileWriter';
...
async function updateLegacyComponent(component: LegacyPolymerComponent, params: UpdaterParameters) {
  ...
  try {
    ...
    writer.write(replaceResult, classBasedElement.eventsComments);
  }
  finally {
