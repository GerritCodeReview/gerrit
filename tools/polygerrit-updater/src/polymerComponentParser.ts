...
export type Methods<T> = Map<T, ts.MethodDeclaration>;
export type LegacyLifecycleMethodName = typeof LegacyLifecycleMethodsArray[number];
export type LegacyLifecycleMethods = Methods<LegacyLifecycleMethodName>;
export type OrdinaryMethods = Methods<string>;
